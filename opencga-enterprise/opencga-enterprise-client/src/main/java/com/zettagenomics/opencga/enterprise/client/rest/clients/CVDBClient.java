...
public class CVDBClient extends ParentClient {
     ...
     */
    public RestResponse<Job> updateAcl(CvdbUpdateAclTaskParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "cvdb/acl", null, "update", params, POST, Job.class);
    }
