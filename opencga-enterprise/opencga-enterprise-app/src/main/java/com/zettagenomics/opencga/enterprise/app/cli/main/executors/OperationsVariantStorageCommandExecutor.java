...
public class OperationsVariantStorageCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> variantAnnotationExtensionConfigure() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseVariantOperationClient().variantAnnotationExtensionConfigure(variantAnnotationExtensionConfigureParams, queryParams);
    }
    ...
    private RestResponse<VariantSetupResult> setupVariant() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseVariantOperationClient().setupVariant(variantSetupParams, queryParams);
    }
