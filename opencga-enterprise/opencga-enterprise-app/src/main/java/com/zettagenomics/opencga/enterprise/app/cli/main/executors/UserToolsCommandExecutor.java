...
public class UserToolsCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Job> runCustomBuilder() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runCustomBuilder(jobToolBuildParams, queryParams);
    }
    ...
    private RestResponse<Job> runCustomDocker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runCustomDocker(customToolRunParams, queryParams);
    }
    ...
    private RestResponse<ExternalTool> createWalker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().createWalker(customToolCreateParams, queryParams);
    }
    ...
    private RestResponse<Job> runWalker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runWalker(variantWalkerToolParams, queryParams);
    }
    ...
    private RestResponse<ExternalTool> updateWalker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().updateWalker(commandOptions.toolId, customToolUpdateParams, queryParams);
    }
    ...
    private RestResponse<Job> runWorkflow() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runWorkflow(workflowParams, queryParams);
    }
