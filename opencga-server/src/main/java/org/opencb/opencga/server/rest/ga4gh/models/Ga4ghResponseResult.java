...
@JsonPropertyOrder({
  Ga4ghResponseResult.JSON_PROPERTY_DEFAULT,
  Ga4ghResponseResult.JSON_PROPERTY_ALTERNATIVE_SCHEMAS
})
...
public class Ga4ghResponseResult   {
  public static final String JSON_PROPERTY_DEFAULT = "default";
  @JsonProperty(JSON_PROPERTY_DEFAULT)
  private Ga4ghResponseBasicStructure _default;
  ...
  public Ga4ghResponseResult _default(Ga4ghResponseBasicStructure _default) {
  ...
  @Valid 
  public Ga4ghResponseBasicStructure getDefault() {
    return _default;
  }

  public void setDefault(Ga4ghResponseBasicStructure _default) {
    this._default = _default;
  }

  public Ga4ghResponseResult alternativeSchemas(List<Ga4ghResponseBasicStructure> alternativeSchemas) {
    this.alternativeSchemas = alternativeSchemas;
    return this;
  }

  public Ga4ghResponseResult addAlternativeSchemasItem(Ga4ghResponseBasicStructure alternativeSchemasItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Ga4ghResponseResult responseResult = (Ga4ghResponseResult) o;
    return Objects.equals(this._default, responseResult._default) &&
        Objects.equals(this.alternativeSchemas, responseResult.alternativeSchemas);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ga4ghResponseResult {\n");
