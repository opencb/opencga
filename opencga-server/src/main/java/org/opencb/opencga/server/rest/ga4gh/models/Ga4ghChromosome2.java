...
public enum Ga4ghChromosome2 {
  ...
  @JsonCreator
  public static Ga4ghChromosome2 fromValue(String value) {
    for (Ga4ghChromosome2 b : Ga4ghChromosome2.values()) {
