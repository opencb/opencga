...
public class IndividualWSServer extends OpenCGAWSServer {
    ...
    public Response searchIndividuals(
            ...
            @ApiParam(value = ParamConstants.INDIVIDUAL_PGX_SAMPLE_ID_DESCRIPTION) @QueryParam(ParamConstants.INDIVIDUAL_PGX_SAMPLE_ID_PARAM) String pgxSampleId,
            @ApiParam(value = ParamConstants.INDIVIDUAL_PGX_SOURCE_DESCRIPTION) @QueryParam(ParamConstants.INDIVIDUAL_PGX_SOURCE_PARAM) String pgxSource,
            @ApiParam(value = ParamConstants.INDIVIDUAL_PGX_ACTIONABLE_GENE_DESCRIPTION) @QueryParam(ParamConstants.INDIVIDUAL_PGX_ACTIONABLE_GENE_PARAM) String pgxActionableGene,
            @ApiParam(value = ParamConstants.INDIVIDUAL_PGX_ACTIONABLE_DRUG_DESCRIPTION) @QueryParam(ParamConstants.INDIVIDUAL_PGX_ACTIONABLE_DRUG_PARAM) String pgxActionableDrug,
