...
//    }
    ...
    public Response load(
        ...
        try {
            ...
            return submitJob(ClinicalAnalysisLoadTask.ID, study, params, jobId, jobDescription, dependsOn, jobTags, scheduledStartTime);
        } catch (Exception e) {
...
//            @ApiImplicitParam(name = "transcriptBiotype", value = RgaQueryParams.TRANSCRIPT_BIOTYPE_DESCR, dataType = "string", paramType = "query"),
    ...
    public Response rgaIndexRun(
        ...
        if (indexAuxiliarColl) {
            ...
            return submitJob(AuxiliarRgaAnalysis.ID, null, study, paramsMap, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
        } else {
            return submitJob(RgaAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
        }
    }
    ...
    public Response interpretationTieringRun(
        ...
        return submitJob(TieringInterpretationAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response interpretationExomiserRun(
        ...
        return submitJob(ExomiserInterpretationAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response interpretationTeamRun(
        ...
        return submitJob(TeamInterpretationAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response interpretationZettaRun(
        ...
        return submitJob(ZettaInterpretationAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response interpretationCancerTieringRun(
        ...
        return submitJob(CancerTieringInterpretationAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
}
