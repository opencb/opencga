...
public class VariantAnalysisWSService extends AnalysisWSService {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "include-format", value = DEPRECATED + INCLUDE_FORMAT_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "include-genotype", value = DEPRECATED + INCLUDE_GENOTYPE_DESCR, dataType = "string", paramType = "query"),

            @ApiImplicitParam(name = "annot-ct", value = DEPRECATED + ANNOT_CONSEQUENCE_TYPE_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-xref", value = DEPRECATED + ANNOT_XREF_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-biotype", value = DEPRECATED + ANNOT_BIOTYPE_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "polyphen", value = DEPRECATED + ANNOT_POLYPHEN_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "sift", value = DEPRECATED + ANNOT_SIFT_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "protein_substitution", value = DEPRECATED + ANNOT_PROTEIN_SUBSTITUTION_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "alternate_frequency", value = DEPRECATED + ANNOT_POPULATION_ALTERNATE_FREQUENCY_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "reference_frequency", value = DEPRECATED + ANNOT_POPULATION_REFERENCE_FREQUENCY_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-population-maf", value = DEPRECATED + ANNOT_POPULATION_MINOR_ALLELE_FREQUENCY_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-transcription-flags", value = DEPRECATED + ANNOT_TRANSCRIPTION_FLAG_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-gene-trait-id", value = DEPRECATED + ANNOT_GENE_TRAIT_ID_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-gene-trait-name", value = DEPRECATED + ANNOT_GENE_TRAIT_NAME_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-hpo", value = DEPRECATED + ANNOT_HPO_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-go", value = DEPRECATED + ANNOT_GO_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-expression", value = DEPRECATED + ANNOT_EXPRESSION_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-protein-keywords", value = DEPRECATED + ANNOT_PROTEIN_KEYWORD_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-drug", value = DEPRECATED + ANNOT_DRUG_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annot-functional-score", value = DEPRECATED + ANNOT_FUNCTIONAL_SCORE_DESCR, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "traits", value = DEPRECATED + "Perform a full-text search on a list of traits", dataType = "string", paramType = "query"),
    })
