...
public enum Ga4ghSharingMode {
  ...
  @JsonCreator
  public static Ga4ghSharingMode fromValue(String value) {
    for (Ga4ghSharingMode b : Ga4ghSharingMode.values()) {
