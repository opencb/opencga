...
public class VariantOperationWebService extends OpenCGAWSServer {
    ...
    public Response variantIndex(
        ...
        return submitOperation(VariantIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantDelete(
        ...
        return submitOperation(VariantFileDeleteOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantStudyDelete(
        ...
        return submitOperation(VariantStudyDeleteOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantIndexLauncher(
        ...
        return submitOperation(VariantFileIndexJobLauncherTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantMetadataSynchronize(
        ...
        return submitJobAdmin(VariantStorageMetadataSynchronizeOperationTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantMetadataRepair(
        ...
        return submitJobAdmin(VariantStorageMetadataRepairTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response statsIndex(
        ...
        return submitJob(VariantStatsIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response statsDelete(
        ...
        return submitJob(VariantStatsDeleteOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response secondaryIndex(
        ...
        return variantSecondaryAnnotationIndex(jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, project, study, params);
    }
    ...
    public Response variantSecondaryAnnotationIndex(
            ...
            @ApiParam(value = ParamConstants.STUDY_DESCRIPTION) @QueryParam(ParamConstants.STUDY_PARAM) String study,
            @ApiParam(value = VariantSecondaryAnnotationIndexParams.DESCRIPTION) VariantSecondaryAnnotationIndexParams params) {
        return submitOperation(VariantSecondaryAnnotationIndexOperationTool.ID, project, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response secondaryIndex(
        ...
        return submitOperation(VariantSecondaryIndexSamplesDeleteOperationTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response annotation(
        ...
        return submitOperation(VariantAnnotationIndexOperationTool.ID, project, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response scoreIndex(
        ...
        return submitOperation(VariantScoreIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response scoreDelete(
        ...
        return submitOperation(VariantScoreDeleteParams.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response sampleGenotypeIndex(
        ...
        return sampleIndex(jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, study, params);
    }
    ...
    public Response sampleIndex(
            ...
            @ApiParam(value = ParamConstants.STUDY_DESCRIPTION) @QueryParam(ParamConstants.STUDY_PARAM) String study,
            @ApiParam(value = VariantSecondarySampleIndexParams.DESCRIPTION) VariantSecondarySampleIndexParams params) {
        return variantSecondarySampleIndex(jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, study, params);
    }
    ...
    public Response variantSecondarySampleIndex(
            ...
            @ApiParam(value = ParamConstants.STUDY_DESCRIPTION) @QueryParam(ParamConstants.STUDY_PARAM) String study,
            @ApiParam(value = VariantSecondarySampleIndexParams.DESCRIPTION) VariantSecondarySampleIndexParams params) {
        return submitOperation(VariantSecondarySampleIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantSampleDelete(
        ...
        return submitOperation(VariantSampleDeleteOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response familyGenotypeIndex(
        ...
        return familyIndex(jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, study, params);
    }
    ...
    public Response familyIndex(
            ...
            @ApiParam(value = ParamConstants.STUDY_DESCRIPTION) @QueryParam(ParamConstants.STUDY_PARAM) String study,
            @ApiParam(value = VariantFamilyIndexParams.DESCRIPTION) VariantFamilyIndexParams params) {
        return submitOperation(VariantFamilyIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response aggregateFamily(
        ...
        return submitOperation(VariantAggregateFamilyOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response aggregate(
        ...
        return submitOperation(VariantAggregateOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response julie(
        ...
        return submitOperationToProject(JulieTool.ID, project, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantPrune(
        ...
        return submitOperationToProject(VariantPruneOperationTool.ID, params.getProject(), params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }

    public Response submitOperation(String toolId, String study, ToolParams params, String jobName, String jobDescription,
                                    String jobDependsOn, String jobTags, String jobScheduledStartTime) {
        return submitOperation(toolId, null, study, params, jobName, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime);
    }
    ...
    public Response submitOperationToProject(String toolId, String project, ToolParams params, String jobName, String jobDescription,
                                             String jobDependsOn, String jobTags, String jobScheduledStartTime) {
        return submitOperation(toolId, project, null, params, jobName, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime);
    }
    ...
    public Response submitOperation(String toolId, String project, String study, Map<String, Object> paramsMap, String jobName,
        ...
        return submitJob(toolId, project, study, paramsMap, jobName, jobDescription, jobDependsOne, jobTags, jobScheduledStartTime);
    }
}
