...
//        classMap.put("ga4gh", Ga4ghWSServer.class);
    ...
    public String openApi(@ApiParam(value = "Environment of the app.") @QueryParam("environment") String environment,
                          @ApiParam(value = "Opencga host without environment.") @QueryParam("host") String host,
        ...
        Swagger swagger = generator.generateJsonOpenApi(new ApiCommonsImpl(), token, environment, host, apiVersion, study);
