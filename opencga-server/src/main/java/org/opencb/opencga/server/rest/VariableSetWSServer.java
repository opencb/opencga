...
public class VariableSetWSServer extends OpenCGAWSServer {
    ...
    public Response createSet(@ApiParam(value = "DEPRECATED: studyId", required = true) @QueryParam("studyId") String studyIdStr,
                              ...
                              @ApiParam(name = "variables", value = "Variables of the variable set", required = true)
