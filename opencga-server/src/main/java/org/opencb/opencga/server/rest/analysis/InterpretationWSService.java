...
//        clinicalInterpretationManager = new ClinicalInterpretationManager(catalogManager, storageEngineFactory);
    ...
    public Response info(@ApiParam(value = "Comma separated list of clinical analysis IDs up to a maximum of 100")
        ...
        try {
            ...
            List<DataResult<ClinicalAnalysis>> analysisResult = clinicalManager.get(studyStr, analysisList, queryOptions, silent, token);
...
//        }
    ...
    public Response tiering(
        ...
        try {
            ...
            if (save) {
                // Queue job
                result = catalogInterpretationManager.queue(studyId, "tiering", clinicalAnalysisId, panelList, tieringAnalysisOptions, token);
            } else {
