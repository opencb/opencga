...
@JsonPropertyOrder({
  Ga4ghVariant.JSON_PROPERTY_DEFAULT,
  Ga4ghVariant.JSON_PROPERTY_ALTERNATIVE_SCHEMAS
})
...
public class Ga4ghVariant   {
  ...
  private Ga4ghVariantDefault _default;
  ...
  public Ga4ghVariant _default(Ga4ghVariantDefault _default) {
  ...
  @Valid 
  public Ga4ghVariantDefault getDefault() {
    return _default;
  }

  public void setDefault(Ga4ghVariantDefault _default) {
    this._default = _default;
  }

  public Ga4ghVariant alternativeSchemas(List<Ga4ghResponseBasicStructure> alternativeSchemas) {
    this.alternativeSchemas = alternativeSchemas;
    return this;
  }

  public Ga4ghVariant addAlternativeSchemasItem(Ga4ghResponseBasicStructure alternativeSchemasItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this._default, variant._default) &&
        Objects.equals(this.alternativeSchemas, variant.alternativeSchemas);
  }
