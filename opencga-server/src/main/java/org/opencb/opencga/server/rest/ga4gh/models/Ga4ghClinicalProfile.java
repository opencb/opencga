 ...
 */
public enum Ga4ghClinicalProfile {
  ...
  Ga4ghClinicalProfile(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static Ga4ghClinicalProfile fromValue(String value) {
    for (Ga4ghClinicalProfile b : Ga4ghClinicalProfile.values()) {
