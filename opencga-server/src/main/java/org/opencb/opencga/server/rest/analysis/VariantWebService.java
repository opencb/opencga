...
public class VariantWebService extends AnalysisWebService {
    ...
    public Response variantFileIndex(
        ...
        return submitJob(VariantIndexOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response variantFileDelete(
        ...
        return submitJob(VariantFileDeleteOperationTool.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
...
//            @ApiImplicitParam(name = "traits", value = DEPRECATED + "Use 'trait' instead", dataType = "string", paramType = "query"),
    ...
    public Response export(
        ...
        return submitJob(VariantExportTool.ID, project, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response statsRun(
        ...
        return submitJob(VariantStatsAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response statsExport(
        ...
        return submitJob("variant-stats-export", project, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
...
//    }
    ...
    public Response sampleRun(
        ...
        return submitJob(SampleVariantFilterAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response sampleEligibility(
        ...
        return submitJob(SampleEligibilityAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response exomiserRun(
        ...
        return submitJob(ExomiserWrapperAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response sampleStatsRun(
        ...
        return submitJob(SampleVariantStatsAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
...
//                    queryOptions.getBoolean("filterTranscript", false), queryOptions.get("filterTranscript"));
    ...
    public Response cohortStatsRun(
        ...
        return submitJob(CohortVariantStatsAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
...
//            @ApiImplicitParam(name = "familyProband", value = VariantCatalogQueryUtils.FAMILY_PROBAND_DESC, dataType = "string", paramType = "query"),
    ...
    public Response gwasRun(
        ...
        return submitJob(GwasAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
...
//    }
    ...
    public Response mutationalSignatureRun(
        ...
        return submitJob(MutationalSignatureAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response hrDetectRun(
        ...
        return submitJob(HRDetectAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response mendelianErrorRun(
        ...
        return submitJob(MendelianErrorAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response inferredSexRun(
        ...
        return run(() -> {
            ...
            return submitJobRaw(InferredSexAnalysis.ID, null, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
        });
    }
    ...
    public Response relatednessRun(
        ...
        return submitJob(RelatednessAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response familyQcRun(
        ...
        return submitJob(FamilyQcAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response individualQcRun(
        ...
        return run(() -> {
            ...
            return submitJobRaw(IndividualQcAnalysis.ID, null, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
        });
    }
    ...
    public Response sampleQcRun(
        ...
        return submitJob(SampleQcAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response plinkRun(
        ...
        return submitJob(PlinkWrapperAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response rvtestsRun(
        ...
        return submitJob(RvtestsWrapperAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response gatkRun(
        ...
        return submitJob(GatkWrapperAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response knockoutRun(
        ...
        return submitJob(KnockoutAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
    ...
    public Response genomePlotRun(
        ...
        return submitJob(GenomePlotAnalysis.ID, study, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime);
    }
