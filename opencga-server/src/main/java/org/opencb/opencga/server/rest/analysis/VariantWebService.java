...
public class VariantWebService extends AnalysisWebService {
    ...
    public Response variantFileIndex(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, VariantIndexOperationTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response variantFileDelete(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, VariantFileDeleteOperationTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
...
//            @ApiImplicitParam(name = "traits", value = DEPRECATED + "Use 'trait' instead", dataType = "string", paramType = "query"),
    ...
    public Response export(
        ...
        return submitJob(project, study, JobType.NATIVE_TOOL, VariantExportTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }

    @POST
    @Path("/walker/run")
    @ApiOperation(value = VariantWalkerTool.DESCRIPTION, response = Job.class)
    @ApiImplicitParams({
            @ApiImplicitParam(name = QueryOptions.INCLUDE, value = ParamConstants.INCLUDE_DESCRIPTION, example = "name,attributes", dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = QueryOptions.EXCLUDE, value = ParamConstants.EXCLUDE_DESCRIPTION, example = "id,status", dataType = "string", paramType = "query"),
    })
    public Response walker(
            @ApiParam(value = ParamConstants.PROJECT_DESCRIPTION) @QueryParam(ParamConstants.PROJECT_PARAM) String project,
            @ApiParam(value = ParamConstants.STUDY_DESCRIPTION) @QueryParam(ParamConstants.STUDY_PARAM) String study,
            @ApiParam(value = ParamConstants.JOB_ID_CREATION_DESCRIPTION) @QueryParam(ParamConstants.JOB_ID) String jobName,
            @ApiParam(value = ParamConstants.JOB_DESCRIPTION_DESCRIPTION) @QueryParam(ParamConstants.JOB_DESCRIPTION) String jobDescription,
            ...
            @ApiParam(value = ParamConstants.JOB_PRIORITY_DESCRIPTION) @QueryParam(ParamConstants.SUBMIT_JOB_PRIORITY_PARAM) String jobPriority,
            @ApiParam(value = ParamConstants.JOB_DRY_RUN_DESCRIPTION) @QueryParam(ParamConstants.JOB_DRY_RUN) Boolean dryRun,
            @ApiParam(value = DeprecatedVariantWalkerParams.DESCRIPTION, required = true) DeprecatedVariantWalkerParams params) {
        return submitJob(project, study, JobType.NATIVE_TOOL, VariantWalkerTool.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response statsRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, VariantStatsAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response statsExport(
        ...
        return submitJob(project, study, JobType.NATIVE_TOOL, "variant-stats-export", params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
...
//    }
    ...
    public Response sampleRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, SampleVariantFilterAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response sampleEligibility(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, SampleEligibilityAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response sampleStatsRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, SampleVariantStatsAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
...
//                    queryOptions.getBoolean("filterTranscript", false), queryOptions.get("filterTranscript"));
    ...
    public Response cohortStatsRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, CohortVariantStatsAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
...
//            @ApiImplicitParam(name = "familyProband", value = VariantCatalogQueryUtils.FAMILY_PROBAND_DESC, dataType = "string", paramType = "query"),
    ...
    public Response gwasRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, GwasAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
...
//    }
    ...
    public Response mutationalSignatureRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, MutationalSignatureAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response hrDetectRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, HRDetectAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response mendelianErrorRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, MendelianErrorAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response inferredSexRun(
        ...
        return run(() -> {
            ...
            return submitJobRaw(null, study, JobType.NATIVE_TOOL, InferredSexAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
        });
    }
    ...
    public Response relatednessRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, RelatednessAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response familyQcRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, FamilyQcAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response individualQcRun(
        ...
        return run(() -> {
            ...
            return submitJobRaw(null, study, JobType.NATIVE_TOOL, IndividualQcAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
        });
    }
    ...
    public Response sampleQcRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, SampleQcAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response liftoverRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, LiftoverWrapperAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response plinkRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, PlinkWrapperAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response rvtestsRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, RvtestsWrapperAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response gatkRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, GatkWrapperAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response knockoutRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, KnockoutAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
    ...
    public Response genomePlotRun(
        ...
        return submitJob(study, JobType.NATIVE_TOOL, GenomePlotAnalysis.ID, params, jobName, jobDescription, dependsOn, jobTags, scheduledStartTime, jobPriority, dryRun);
    }
