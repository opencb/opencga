...
#' | downloadAllResource | /{apiVersion}/admin/resource/downloadAll | jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
...
setMethod("adminClient", "OpencgaR", function(OpencgaR, user, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' Fetch all resources from the public server and save them into the OpenCGA local installation.
        ...
        downloadAllResource=fetchOpenCGA(object=OpencgaR, category="admin", categoryId=NULL, subcategory="resource",
                subcategoryId=NULL, action="downloadAll", params=params, httpMethod="POST", as.queryParam=NULL, ...),
