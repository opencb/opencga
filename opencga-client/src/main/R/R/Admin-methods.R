...
setMethod("adminClient", "OpencgaR", function(OpencgaR, user, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param entity Entity to be grouped by. Allowed values: ['AUDIT NOTIFICATION NOTE ORGANIZATION USER PROJECT STUDY FILE SAMPLE JOB INDIVIDUAL COHORT DISEASE_PANEL FAMILY CLINICAL_ANALYSIS INTERPRETATION VARIANT ALIGNMENT CLINICAL EXPRESSION RGA FUNCTIONAL WORKFLOW RESOURCE']
        ...
        fetchResource=fetchOpenCGA(object=OpencgaR, category="admin", categoryId=NULL, subcategory="resource",
                subcategoryId=NULL, action="fetch", params=params, httpMethod="POST", as.queryParam=NULL, ...),
