...
#' | updateUsersGroups | /{apiVersion}/admin/users/{user}/groups/update | user[*], action, body[*] |
#'
#' @md
...
setMethod("adminClient", "OpencgaR", function(OpencgaR, user, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param data JSON containing the parameters.
        updateUsersGroups=fetchOpenCGA(object=OpencgaR, category="admin/users", categoryId=user, subcategory="groups",
