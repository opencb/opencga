...
#' | distinct | /{apiVersion}/cohorts/distinct | study, type, creationDate, modificationDate, deleted, internalStatus, status, annotation, acl, samples, release, field[*] |
#' | generate | /{apiVersion}/cohorts/generate | study, id, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, phenotypes, annotation, acl, release, snapshot, body[*] |
...
setMethod("cohortClient", "OpencgaR", function(OpencgaR, cohorts, members, annotationSet, cohort, endpointName, params=NULL, ...) {
    switch(endpointName,
