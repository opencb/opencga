...
setMethod("cohortClient", "OpencgaR", function(OpencgaR, cohort, cohorts, annotationSet, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param type Cohort type. Allowed values: ['CASE_CONTROL CASE_SET CONTROL_SET PAIRED PAIRED_TUMOR AGGREGATE TIME_SERIES FAMILY TRIO COLLECTION']
