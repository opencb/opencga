...
#' | search | /{apiVersion}/cohorts/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, type, creationDate, modificationDate, deleted, status, annotation, acl, samples, release |
...
#' | update | /{apiVersion}/cohorts/{cohorts}/update | cohorts[*], study, annotationSetsAction, body |
