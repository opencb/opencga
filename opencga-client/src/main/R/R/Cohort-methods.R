...
#' | distinct | /{apiVersion}/cohorts/distinct | study, type, creationDate, modificationDate, deleted, internalStatus, status, annotation, acl, samples, numSamples, release, field[*] |
...
#' | search | /{apiVersion}/cohorts/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, type, creationDate, modificationDate, deleted, internalStatus, status, annotation, acl, samples, numSamples, release |
...
setMethod("cohortClient", "OpencgaR", function(OpencgaR, cohort, annotationSet, cohorts, members, endpointName, params=NULL, ...) {
    switch(endpointName,
