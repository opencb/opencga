...
#' | runInterpreterCancerTiering | /{apiVersion}/analysis/clinical/interpreter/cancerTiering/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runInterpreterExomiser | /{apiVersion}/analysis/clinical/interpreter/exomiser/run | study, executionId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runInterpreterTeam | /{apiVersion}/analysis/clinical/interpreter/team/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runInterpreterTiering | /{apiVersion}/analysis/clinical/interpreter/tiering/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runInterpreterZetta | /{apiVersion}/analysis/clinical/interpreter/zetta/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runRgaIndex | /{apiVersion}/analysis/clinical/rga/index/run | study, jobId, executionDescription, executionDependsOn, executionTags, auxiliarIndex, body[*] |
...
setMethod("clinicalanalysisClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, interpretation, members, clinicalAnalyses, interpretations, endpointName, params=NULL, ...) {
    switch(endpointName,
