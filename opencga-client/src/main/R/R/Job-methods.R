...
#' | search | /{apiVersion}/jobs/search | include, exclude, limit, skip, count, study, otherStudies, id, toolId, userId, priority, internalStatus, creationDate, modificationDate, visited, tags, input, output, acl, release, deleted |
...
setMethod("jobClient", "OpencgaR", function(OpencgaR, job, jobs, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param internalStatus Job internal status.
