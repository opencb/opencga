...
#' | distinct | /{apiVersion}/jobs/distinct | study, otherStudies, id, toolId, userId, priority, internalStatus, creationDate, modificationDate, visited, tags, input, output, execution.start, execution.end, acl, release, field[*] |
#' | search | /{apiVersion}/jobs/search | include, exclude, limit, skip, count, study, otherStudies, id, toolId, userId, priority, internalStatus, creationDate, modificationDate, visited, tags, input, output, execution.start, execution.end, acl, release, deleted |
...
#' | update | /{apiVersion}/jobs/{jobs}/update | jobs[*], study, body |
...
setMethod("jobClient", "OpencgaR", function(OpencgaR, members, job, jobs, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param execution.start Execution start date. Format: yyyyMMddHHmmss. Examples: >2018, 2017-2018, <201805.
        #' @param execution.end Execution end date. Format: yyyyMMddHHmmss. Examples: >2018, 2017-2018, <201805.
