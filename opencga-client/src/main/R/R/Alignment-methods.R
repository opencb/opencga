...
#' | infoStats | /{apiVersion}/analysis/alignment/stats/info | file[*], study |
#' | runStats | /{apiVersion}/analysis/alignment/stats/run | study, jobId, jobDependsOn, jobDescription, jobTags, body[*] |
#'
#' @md
...
setMethod("alignmentClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/alignment/stats/info:
        #' Show the stats for a given alignment file.
        #' @param file File ID.
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        infoStats=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="alignment/stats",
                subcategoryId=NULL, action="info", params=params, httpMethod="GET", as.queryParam=c("file"), ...),

        #' @section Endpoint /{apiVersion}/analysis/alignment/stats/run:
        ...
        runStats=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="alignment/stats",
                subcategoryId=NULL, action="run", params=params, httpMethod="POST", as.queryParam=NULL, ...),
    )
})