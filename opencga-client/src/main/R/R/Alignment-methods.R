...
#' | -- | :-- | --: |
#' | runBwa | /{apiVersion}/analysis/alignment/bwa/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runCoverageIndex | /{apiVersion}/analysis/alignment/coverage/index/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | coverageQcGeneCoverageStatsRun | /{apiVersion}/analysis/alignment/coverage/qc/geneCoverageStats/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
...
#' | runDeeptools | /{apiVersion}/analysis/alignment/deeptools/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runFastqc | /{apiVersion}/analysis/alignment/fastqc/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runIndex | /{apiVersion}/analysis/alignment/index/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runPicard | /{apiVersion}/analysis/alignment/picard/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runQc | /{apiVersion}/analysis/alignment/qc/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
...
#' | runSamtools | /{apiVersion}/analysis/alignment/samtools/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#'
#' @md
