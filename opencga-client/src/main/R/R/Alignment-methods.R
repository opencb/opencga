...
#' | runQcGeneCoverageStats | /{apiVersion}/analysis/alignment/coverage/qc/geneCoverageStats/run | study, jobId, jobDependsOn, jobDescription, jobTags, body[*] |
...
setMethod("alignmentClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        runQcGeneCoverageStats=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
