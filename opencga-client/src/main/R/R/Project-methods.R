...
#' | -- | :-- | --: |
#' | create | /{apiVersion}/projects/create | body[*] |
#' | search | /{apiVersion}/projects/search | include, exclude, limit, skip, owner, id, name, fqn, organization, description, study, creationDate, modificationDate, status, attributes |
...
#' | update | /{apiVersion}/projects/{project}/update | project[*], body[*] |
#'
#' @md
