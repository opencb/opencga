...
#' | importPanels | /{apiVersion}/panels/import | study, jobId, executionDependsOn, executionDescription, executionTags, body |
...
setMethod("diseasepanelClient", "OpencgaR", function(OpencgaR, panels, members, endpointName, params=NULL, ...) {
    switch(endpointName,
