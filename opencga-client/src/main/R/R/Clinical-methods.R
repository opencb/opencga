...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, members, interpretations, annotationSet, interpretation, clinicalAnalyses, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
