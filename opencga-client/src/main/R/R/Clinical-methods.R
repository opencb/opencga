...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretation, annotationSet, members, interpretations, clinicalAnalyses, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
