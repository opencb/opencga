...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretation, clinicalAnalysis, clinicalAnalyses, annotationSet, interpretations, members, endpointName, params=NULL, ...) {
    switch(endpointName,
