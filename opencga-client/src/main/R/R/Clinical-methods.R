...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalyses, interpretation, annotationSet, interpretations, members, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
