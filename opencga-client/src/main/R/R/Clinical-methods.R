...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, members, annotationSet, clinicalAnalyses, interpretation, interpretations, endpointName, params=NULL, ...) {
    switch(endpointName,
