...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretation, interpretations, members, annotationSet, clinicalAnalyses, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
