...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, clinicalAnalyses, annotationSet, members, clinicalAnalysis, interpretation, endpointName, params=NULL, ...) {
    switch(endpointName,
