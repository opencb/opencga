...
<<<<<<< HEAD
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalyses, members, interpretation, clinicalAnalysis, interpretations, endpointName, params=NULL, ...) {
=======
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, interpretation, clinicalAnalysis, members, clinicalAnalyses, endpointName, params=NULL, ...) {
>>>>>>> release-2.2.x
    switch(endpointName,
