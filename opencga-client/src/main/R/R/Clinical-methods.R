...
#' | load | /{apiVersion}/analysis/clinical/load | file, study[*], study, jobId, jobDescription, jobDependsOn, jobTags |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, members, study, clinicalAnalyses, interpretation, interpretations, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        load=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="clinical",
                subcategoryId=NULL, action="load", params=params, httpMethod="POST", as.queryParam=c("study"), ...),
