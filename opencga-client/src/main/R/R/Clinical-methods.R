...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, clinicalAnalyses, annotationSet, members, interpretations, interpretation, endpointName, params=NULL, ...) {
    switch(endpointName,
