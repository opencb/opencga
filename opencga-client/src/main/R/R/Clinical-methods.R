...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, members, interpretations, clinicalAnalyses, clinicalAnalysis, annotationSet, interpretation, endpointName, params=NULL, ...) {
    switch(endpointName,
