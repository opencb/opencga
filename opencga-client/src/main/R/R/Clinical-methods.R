...
<<<<<<< HEAD
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, interpretations, interpretation, clinicalAnalyses, members, endpointName, params=NULL, ...) {
=======
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, interpretation, members, clinicalAnalyses, clinicalAnalysis, endpointName, params=NULL, ...) {
>>>>>>> release-2.4.x
    switch(endpointName,
