...
#' | search | /{apiVersion}/analysis/clinical/search | include, exclude, limit, skip, count, study, id, type, priority, creationDate, modificationDate, internalStatus, status, dueDate, description, family, proband, sample, member, analystAssignee, disorder, flags, deleted, release, attributes |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, interpretationId, clinicalAnalysis, clinicalAnalyses, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param member Proband id or any member id of a family.
