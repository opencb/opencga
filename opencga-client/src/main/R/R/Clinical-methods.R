...
=======
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, annotationSet, clinicalAnalyses, interpretation, members, interpretations, endpointName, params=NULL, ...) {
>>>>>>> develop
    switch(endpointName,
