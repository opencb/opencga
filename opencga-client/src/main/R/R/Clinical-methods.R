...
#' | interpreter | /{apiVersion}/analysis/clinical/interpreter | clinicalAnalysisId, probandId, familyId, disorderId, panelIds, configFile[*], study |
...
#' | runPharmacogenomicsAlleleTyper | /{apiVersion}/analysis/clinical/pharmacogenomics/alleleTyper/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
#' | runPharmacogenomicsAnnotation | /{apiVersion}/analysis/clinical/pharmacogenomics/annotation/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
#' | runPharmacogenomicsOpenarray | /{apiVersion}/analysis/clinical/pharmacogenomics/openarray/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, annotationSet, clinicalAnalyses, clinicalAnalysis, interpretation, interpretations, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/interpreter:
        ...
        #' @param configFile Interpretation configuration file.
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        interpreter=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="clinical",
                subcategoryId=NULL, action="interpreter", params=params, httpMethod="GET",
                as.queryParam=c("configFile"), ...),
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/interpreter/rd:
        #' Rare disease interpretation analysis.
        #' @param clinicalAnalysisId Clinical analysis ID.
        #' @param probandId Proband ID.
        #' @param familyId Family ID.
        ...
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        rdInterpreter=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/interpreter", subcategoryId=NULL, action="rd", params=params, httpMethod="GET",
                as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/clinical/interpreter/rd/run:
        ...
        runInterpreterRd=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/interpreter/rd", subcategoryId=NULL, action="run", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/clinical/interpreter/run:
        #' Run interpretation analysis for rare diseases.
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        ...
        #' @param jobDryRun Flag indicating that the job will be executed in dry-run mode. In this mode, OpenCGA will validate that all parameters and prerequisites are correctly set for successful execution, but the job will not actually run.
        #' @param data Parameters to execute the rare disease interpretation analysis.
        runInterpreter=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/interpreter", subcategoryId=NULL, action="run", params=params, httpMethod="POST",
                as.queryParam=NULL, ...),
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/pharmacogenomics/alleleTyper/run:
        #' pharmacogenomics-allele-typer-analysis.
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        #' @param jobPriority Priority of the job.
        #' @param jobDryRun Flag indicating that the job will be executed in dry-run mode. In this mode, OpenCGA will validate that all parameters and prerequisites are correctly set for successful execution, but the job will not actually run.
        #' @param data JSON with parameters to execute the tool pharmacogenomics-allele-typer-analysis.
        runPharmacogenomicsAlleleTyper=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/pharmacogenomics/alleleTyper", subcategoryId=NULL, action="run", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/clinical/pharmacogenomics/annotation/run:
        #' Annotate the star alleles for the input samples with pharmacogenomics data.
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        #' @param jobPriority Priority of the job.
        #' @param jobDryRun Flag indicating that the job will be executed in dry-run mode. In this mode, OpenCGA will validate that all parameters and prerequisites are correctly set for successful execution, but the job will not actually run.
        #' @param data JSON with parameters to execute the tool pharmacogenomics-annotation-analysis.
        runPharmacogenomicsAnnotation=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/pharmacogenomics/annotation", subcategoryId=NULL, action="run", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/clinical/pharmacogenomics/openarray/run:
        #' OpenArray pharmacogenomics analysis: infer star alleles from ThermoFisher OpenArray genotyping data and optionally annotate with CPIC.
        #' @param study Study [[organization@]project:]study where study and project can be either the ID or UUID.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        #' @param jobPriority Priority of the job.
        #' @param jobDryRun Flag indicating that the job will be executed in dry-run mode. In this mode, OpenCGA will validate that all parameters and prerequisites are correctly set for successful execution, but the job will not actually run.
        #' @param data OpenArray pharmacogenomics analysis params.
        runPharmacogenomicsOpenarray=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="clinical/pharmacogenomics/openarray", subcategoryId=NULL, action="run", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),
