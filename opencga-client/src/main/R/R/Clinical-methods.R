...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, members, annotationSet, interpretation, interpretations, clinicalAnalysis, clinicalAnalyses, endpointName, params=NULL, ...) {
    switch(endpointName,
