...
#' | clearInterpretation | /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/clear | study, clinicalAnalysis |
#' | createInterpretation | /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/create | clinicalAnalysis, study, saveAs, body[*] |
#' | mergeInterpretation | /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/{interpretationId}/merge | study, clinicalAnalysis, interpretationId, secondaryInterpretationId, findings, body |
#' | updateInterpretation | /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/{interpretationId}/update | study, primaryFindingsAction, methodsAction, secondaryFindingsAction, commentsAction, saveAs, clinicalAnalysis, interpretationId, body[*] |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalyses, interpretations, clinicalAnalysis, interpretationId, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        #' @param commentsAction Action to be performed if the array of comments is being updated. Allowed values: ['ADD', 'REMOVE']
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/clear:
        ...
        clearInterpretation=fetchOpenCGA(object=OpencgaR, category="analysis/clinical", categoryId=clinicalAnalysis,
                subcategory="interpretation", subcategoryId=NULL, action="clear", params=params, httpMethod="POST",
                as.queryParam=NULL, ...),
        ...
        #' @param clinicalAnalysis Clinical analysis ID.
        #' @param study [[user@]project:]study id.
        #' @param saveAs Save interpretation as. Allowed values: ['PRIMARY', 'SECONDARY']
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/{interpretationId}/merge:
        #' Merge interpretation.
        #' @param study [[user@]project:]study ID.
        #' @param clinicalAnalysis Clinical analysis ID.
        #' @param interpretationId Interpretation ID where it will be merged.
        ...
        mergeInterpretation=fetchOpenCGA(object=OpencgaR, category="analysis/clinical", categoryId=clinicalAnalysis,
                subcategory="interpretation", subcategoryId=interpretationId, action="merge", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/{interpretationId}/update:
        #' Update interpretation fields.
        #' @param study [[user@]project:]study ID.
        #' @param primaryFindingsAction Action to be performed if the array of primary findings is being updated. Allowed values: ['ADD', 'SET', 'REMOVE']
        #' @param methodsAction Action to be performed if the array of methods is being updated. Allowed values: ['ADD', 'SET', 'REMOVE']
        #' @param secondaryFindingsAction Action to be performed if the array of secondary findings is being updated. Allowed values: ['ADD', 'SET', 'REMOVE']
        #' @param commentsAction Action to be performed if the array of comments is being updated. Allowed values: ['ADD', 'SET', 'REMOVE']
        #' @param saveAs Save interpretation as. Allowed values: ['PRIMARY', 'SECONDARY']
        #' @param clinicalAnalysis Clinical analysis ID.
        ...
        updateInterpretation=fetchOpenCGA(object=OpencgaR, category="analysis/clinical", categoryId=clinicalAnalysis,
                subcategory="interpretation", subcategoryId=interpretationId, action="update", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),
