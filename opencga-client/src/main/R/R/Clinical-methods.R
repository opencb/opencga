...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, annotationSet, clinicalAnalysis, interpretation, clinicalAnalyses, members, endpointName, params=NULL, ...) {
    switch(endpointName,
