...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, interpretation, interpretations, study, members, clinicalAnalyses, endpointName, params=NULL, ...) {
    switch(endpointName,
