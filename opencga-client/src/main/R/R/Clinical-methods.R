...
#    Autogenerated on: 2021-10-19 16:38:50
#    
...
#' | distinctInterpretation | /{apiVersion}/analysis/clinical/interpretation/distinct | study, id, uuid, clinicalAnalysisId, analystId, methodsName, panels, primaryFindings, secondaryFindings, creationDate, modificationDate, status, internalStatus, release, field[*] |
#' | searchInterpretation | /{apiVersion}/analysis/clinical/interpretation/search | include, exclude, limit, skip, sort, study, id, uuid, clinicalAnalysisId, analystId, methodsName, panels, primaryFindings, secondaryFindings, creationDate, modificationDate, status, internalStatus, release |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, members, interpretation, interpretations, clinicalAnalysis, clinicalAnalyses, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param methodsName Interpretation method name.
