...
#    Autogenerated on: 2022-03-17 12:21:55
#    
...
#' | configureSampleIndex | /{apiVersion}/operation/variant/sample/index/configure | study, skipRebuild, body |
...
setMethod("operationClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        configureSampleIndex=fetchOpenCGA(object=OpencgaR, category="operation", categoryId=NULL,
