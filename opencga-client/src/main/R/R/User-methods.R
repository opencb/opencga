...
setMethod("userClient", "OpencgaR", function(OpencgaR, user, action, params=NULL) {
    switch(action,
           delete=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
                               action="delete", params=params, httpMethod="GET"),
           info=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
                             action="info", params=params, httpMethod="GET"),
           projects=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user,
                                 action="projects", params=params, httpMethod="GET"),
           create=fetchOpenCGA(object=OpencgaR, category="users", action="create", 
                               params=params, httpMethod="POST"),
           login=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
                              action="login", params=params, httpMethod="POST"),
           `change-password`=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
                                          action="change-password", params=params, 
                                          httpMethod="POST"),
           update=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
...
setMethod("userConfigClient", "OpencgaR", function(OpencgaR, user, name, action, params=NULL) {
    switch(action,
           ...
           info=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
                             subcategory="configs", subcategoryId=name, 
                             action="info", params=params, httpMethod="GET"),
           create=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
...
setMethod("userFilterClient", "OpencgaR", function(OpencgaR, user, name, action, params=NULL) {      
    switch(action,
           list=fetchOpenCGA(object=OpencgaR, category="users", categoryId=user, 
