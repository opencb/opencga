...
#' | pipelines | /{apiVersion}/studies/{study}/pipelines | study[*], pipelineId |
#' | updatePipelines | /{apiVersion}/studies/{study}/pipelines/update | study[*], action, body[*] |
#' | runTemplates | /{apiVersion}/studies/{study}/templates/run | study[*], jobId, executionDependsOn, executionDescription, executionTags, body[*] |
...
setMethod("studyClient", "OpencgaR", function(OpencgaR, templateId, group, members, variableSet, study, studies, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/studies/{study}/pipelines:
        #' Return the pipelines available for the study.
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        #' @param pipelineId Pipeline id. If provided, it will only fetch the requested pipeline.
        pipelines=fetchOpenCGA(object=OpencgaR, category="studies", categoryId=study, subcategory=NULL,
                subcategoryId=NULL, action="pipelines", params=params, httpMethod="GET", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/studies/{study}/pipelines/update:
        #' Add or remove a pipeline.
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        #' @param action Action to be performed: ADD, REMOVE or REPLACE a pipeline. Allowed values: ['ADD', 'REMOVE', 'REPLACE']
        #' @param data JSON containing the parameters.
        updatePipelines=fetchOpenCGA(object=OpencgaR, category="studies", categoryId=study, subcategory="pipelines",
                subcategoryId=NULL, action="update", params=params, httpMethod="POST", as.queryParam=NULL, ...),
