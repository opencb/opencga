...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, group, study, templateId, variableSet, studies, members, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, templateId, group, members, study, variableSet, studies, endpointName, params=NULL, ...) {
>>>>>>> release-2.4.x
    switch(endpointName,
