...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, study, studies, variableSet, group, members, templateId, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, templateId, study, members, studies, group, variableSet, endpointName, params=NULL, ...) {
>>>>>>> develop
    switch(endpointName,
        ...
        #' @param resource Resource involved. Allowed values: ['AUDIT ORGANIZATION USER PROJECT STUDY FILE SAMPLE JOB INDIVIDUAL COHORT DISEASE_PANEL FAMILY CLINICAL_ANALYSIS INTERPRETATION VARIANT ALIGNMENT CLINICAL EXPRESSION RGA FUNCTIONAL']
