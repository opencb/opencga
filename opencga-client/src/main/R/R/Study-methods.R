...
#' | uploadTemplates | /{apiVersion}/studies/{study}/templates/upload | study |
...
setMethod("studyClient", "OpencgaR", function(OpencgaR, members, studies, study, variableSet, group, templateId, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        deleteTemplates=fetchOpenCGA(object=OpencgaR, category="studies", categoryId=study, subcategory="templates",
                subcategoryId=templateId, action="delete", params=params, httpMethod="POST", as.queryParam=NULL, ...),
