...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, studies, study, group, templateId, members, variableSet, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, studies, templateId, study, variableSet, members, group, endpointName, params=NULL, ...) {
>>>>>>> develop
    switch(endpointName,
