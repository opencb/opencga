...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, variableSet, group, members, study, studies, templateId, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, templateId, studies, group, members, study, variableSet, endpointName, params=NULL, ...) {
>>>>>>> release-2.2.x
    switch(endpointName,
