...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, members, study, group, variableSet, templateId, studies, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, group, members, templateId, studies, study, variableSet, endpointName, params=NULL, ...) {
>>>>>>> develop
    switch(endpointName,
