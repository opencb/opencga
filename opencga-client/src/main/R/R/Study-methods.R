...
#' | create | /{apiVersion}/studies/create | projectId, project, body[*] |
#' | search | /{apiVersion}/studies/search | include, exclude, limit, skip, count, project[*], name, id, alias, fqn, creationDate, modificationDate, status, attributes, release |
...
#' | groups | /{apiVersion}/studies/{study}/groups | study[*], id, name, silent |
#' | updateGroups | /{apiVersion}/studies/{study}/groups/update | study, action, body[*] |
#' | updateUsers | /{apiVersion}/studies/{study}/groups/{group}/users/update | study, group, action, body[*] |
...
#' | update | /{apiVersion}/studies/{study}/update | study[*], body[*] |
...
#' | updateVariables | /{apiVersion}/studies/{study}/variableSets/{variableSet}/variables/update | study, variableSet, action, body[*] |
#'
#' @md
...
setMethod("studyClient", "OpencgaR", function(OpencgaR, studies, members, group, variableSet, study, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param data JSON containing the parameters.
        updateUsers=fetchOpenCGA(object=OpencgaR, category="studies", categoryId=study, subcategory="groups",
        ...
        updateVariables=fetchOpenCGA(object=OpencgaR, category="studies", categoryId=study, subcategory="variableSets",
