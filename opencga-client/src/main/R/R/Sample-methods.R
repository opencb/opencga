...
#' | create | /{apiVersion}/samples/create | study, body[*] |
#' | distinct | /{apiVersion}/samples/distinct | study, id, uuid, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, processingProduct, processingPreparationMethod, processingExtractionMethod, processingLabSampleId, collectionTissue, collectionOrgan, collectionMethod, phenotypes, annotation, acl, internalRgaStatus, release, snapshot, deleted, statsId, statsVariantCount, statsChromosomeCount, statsTypeCount, statsGenotypeCount, statsTiTvRatio, statsQualityAvg, statsQualityStdDev, statsHeterozygosityRate, statsDepthCount, statsBiotypeCount, statsClinicalSignificanceCount, statsConsequenceTypeCount, field[*] |
#' | load | /{apiVersion}/samples/load | study, file[*], variableSet |
#' | search | /{apiVersion}/samples/search | include, exclude, limit, skip, count, includeIndividual, flattenAnnotations, study, id, uuid, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, processingProduct, processingPreparationMethod, processingExtractionMethod, processingLabSampleId, collectionTissue, collectionOrgan, collectionMethod, phenotypes, annotation, acl, internalRgaStatus, release, snapshot, deleted, statsId, statsVariantCount, statsChromosomeCount, statsTypeCount, statsGenotypeCount, statsTiTvRatio, statsQualityAvg, statsQualityStdDev, statsHeterozygosityRate, statsDepthCount, statsBiotypeCount, statsClinicalSignificanceCount, statsConsequenceTypeCount |
...
#' | update | /{apiVersion}/samples/{samples}/update | samples[*], study, incVersion, annotationSetsAction, phenotypesAction, body |
...
setMethod("sampleClient", "OpencgaR", function(OpencgaR, members, samples, annotationSet, sample, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param collectionTissue Collection tissue.
        #' @param collectionOrgan Collection organ.
        ...
        #' @param internalRgaStatus Index status of the sample for the Recessive Gene Analysis.
