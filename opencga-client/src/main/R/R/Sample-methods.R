...
#' | search | /{apiVersion}/samples/search | include, exclude, limit, skip, count, includeIndividual, flattenAnnotations, study, id, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, phenotypes, annotation, acl, attributes, release, deleted, snapshot |
...
setMethod("sampleClient", "OpencgaR", function(OpencgaR, sample, annotationSet, samples, members, endpointName, params=NULL, ...) {
    switch(endpointName,
