...
#' | -- | :-- | --: |
#' | updateAcl | /{apiVersion}/samples/acl/{members}/update | study, members[*], action[*], propagate, body[*] |
...
#' | create | /{apiVersion}/samples/create | study, individual, body[*] |
#' | distinct | /{apiVersion}/samples/distinct | study, id, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, phenotypes, annotation, acl, attributes, release, snapshot, field[*] |
#' | load | /{apiVersion}/samples/load | study, file[*], variableSet |
#' | search | /{apiVersion}/samples/search | include, exclude, limit, skip, count, includeIndividual, flattenAnnotations, study, id, somatic, individualId, fileIds, creationDate, modificationDate, internalStatus, status, phenotypes, annotation, acl, attributes, release, snapshot, deleted, stats.id, stats.variantCount, stats.chromosomeCount, stats.typeCount, stats.genotypeCount, stats.tiTvRatio, stats.qualityAvg, stats.qualityStdDev, stats.heterozygosityRate, stats.depthCount, stats.biotypeCount, stats.clinicalSignificanceCount, stats.consequenceTypeCount |
...
#' | update | /{apiVersion}/samples/{samples}/update | samples[*], study, incVersion, annotationSetsAction, body |
#' | updateAnnotations | /{apiVersion}/samples/{sample}/annotationSets/{annotationSet}/annotations/update | sample[*], study, annotationSet, action, incVersion, body |
#'
#' @md
...
setMethod("sampleClient", "OpencgaR", function(OpencgaR, annotationSet, members, samples, sample, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param propagate Propagate sample permissions to related individuals.
        ...
        #' @param stats.id Sample variant stats id. If filtering by other stats fields and not provided, it will be automatically set to ALL.
        #' @param stats.variantCount Sample variant stats variantCount.
        #' @param stats.chromosomeCount Sample variant stats chromosomeCount.
        #' @param stats.typeCount Sample variant stats typeCount.
        #' @param stats.genotypeCount Sample variant stats genotypeCount.
        #' @param stats.tiTvRatio Sample variant stats tiTvRatio.
        #' @param stats.qualityAvg Sample variant stats qualityAvg.
        #' @param stats.qualityStdDev Sample variant stats qualityStdDev.
        #' @param stats.heterozygosityRate Sample variant stats heterozygosityRate.
        #' @param stats.depthCount Sample variant stats depthCount.
        #' @param stats.biotypeCount Sample variant stats biotypeCount.
        #' @param stats.clinicalSignificanceCount Sample variant stats clinicalSignificanceCount.
        #' @param stats.consequenceTypeCount Sample variant stats consequenceTypeCount.
        ...
        updateAnnotations=fetchOpenCGA(object=OpencgaR, category="samples", categoryId=sample,
