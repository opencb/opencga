...
#' | updateAnnotationSetsAnnotations | /{apiVersion}/samples/{sample}/annotationSets/{annotationSet}/annotations/update | sample[*], study, annotationSet[*], action, incVersion, body |
#'
#' @md
...
setMethod("sampleClient", "OpencgaR", function(OpencgaR, annotationSet, samples, sample, members, endpointName, params=NULL, ...) {
    switch(endpointName,
