...
#' | update | /{apiVersion}/samples/{samples}/update | include, exclude, samples[*], study, incVersion, annotationSetsAction, phenotypesAction, includeResult, body |
...
setMethod("sampleClient", "OpencgaR", function(OpencgaR, members, annotationSet, samples, sample, endpointName, params=NULL, ...) {
    switch(endpointName,
