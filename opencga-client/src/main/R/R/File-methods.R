...
#' | fetch | /{apiVersion}/files/fetch | jobId, executionDescription, executionDependsOn, executionTags, study, body[*] |
#' | formats | /{apiVersion}/files/formats |  |
#' | link | /{apiVersion}/files/link | study, parents, body[*] |
#' | runLink | /{apiVersion}/files/link/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runPostlink | /{apiVersion}/files/postlink/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
...
setMethod("fileClient", "OpencgaR", function(OpencgaR, members, annotationSet, file, folder, files, endpointName, params=NULL, ...) {
    switch(endpointName,
