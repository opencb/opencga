...
#' | search | /{apiVersion}/files/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, path, type, bioformat, format, status, directory, creationDate, modificationDate, description, tags, size, samples, jobId, annotation, acl, deleted, attributes, release |
...
#' | update | /{apiVersion}/files/{files}/update | files, study, samplesAction, annotationSetsAction, relatedFilesAction, tagsAction, body[*] |
...
#' | tree | /{apiVersion}/files/{folder}/tree | include, exclude, limit, folder, study, maxDepth |
#'
#' @md
...
setMethod("fileClient", "OpencgaR", function(OpencgaR, file, files, members, annotationSet, folder, endpointName, params=NULL, ...) {
    switch(endpointName,
