...
#' | create | /{apiVersion}/files/create | study, body[*] |
#' | distinct | /{apiVersion}/files/distinct | study, name, path, type, bioformat, format, status, internalStatus, directory, creationDate, modificationDate, description, tags, size, sampleIds, jobId, annotation, acl, attributes, release, field[*] |
#' | fetch | /{apiVersion}/files/fetch | study, body[*] |
...
#' | search | /{apiVersion}/files/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, path, type, bioformat, format, status, internalStatus, directory, creationDate, modificationDate, description, tags, size, sampleIds, jobId, annotation, acl, deleted, attributes, release |
#' | upload | /{apiVersion}/files/upload | body, body[*], body[*], body, body, body, body |
...
#' | update | /{apiVersion}/files/{files}/update | files, study, sampleIdsAction, annotationSetsAction, relatedFilesAction, tagsAction, body[*] |
#' | updateAnnotations | /{apiVersion}/files/{file}/annotationSets/{annotationSet}/annotations/update | file[*], study, annotationSet, action, body |
...
setMethod("fileClient", "OpencgaR", function(OpencgaR, annotationSet, files, folder, file, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        updateAnnotations=fetchOpenCGA(object=OpencgaR, category="files", categoryId=file,
