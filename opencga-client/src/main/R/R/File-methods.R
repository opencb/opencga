...
#' | distinct | /{apiVersion}/files/distinct | study, id, uuid, name, path, uri, type, bioformat, format, external, status, internalStatus, internalIndexStatus, softwareName, directory, creationDate, modificationDate, description, tags, size, sampleIds, jobId, annotation, acl, deleted, release, field[*] |
...
#' | search | /{apiVersion}/files/search | include, exclude, limit, skip, count, flattenAnnotations, study, id, uuid, name, path, uri, type, bioformat, format, external, status, internalStatus, internalIndexStatus, softwareName, directory, creationDate, modificationDate, description, tags, size, sampleIds, jobId, annotation, acl, deleted, release |
#' | upload | /{apiVersion}/files/upload | body, body, body, body, body, body, body, body |
...
setMethod("fileClient", "OpencgaR", function(OpencgaR, members, annotationSet, folder, files, file, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param internalIndexStatus Filter by internal index status.
