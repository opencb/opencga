...
#' | search | /{apiVersion}/panels/search | include, exclude, limit, skip, count, study, name, phenotypes, variants, genes, regions, categories, tags, description, author, deleted, creationDate, modificationDate, acl, release, snapshot |
