...
#' | create | /{apiVersion}/panels/create | include, exclude, study, source, id, includeResult, body |
#' | distinct | /{apiVersion}/panels/distinct | study, id, uuid, name, disorders, variants, genes, regions, categories, tags, deleted, status, creationDate, modificationDate, acl, release, snapshot, field[*] |
#' | search | /{apiVersion}/panels/search | include, exclude, limit, skip, count, study, id, uuid, name, disorders, variants, genes, regions, categories, tags, deleted, status, creationDate, modificationDate, acl, release, snapshot |
...
#' | update | /{apiVersion}/panels/{panels}/update | include, exclude, study, panels[*], incVersion, includeResult, body |
#'
#' @md
...
setMethod("panelClient", "OpencgaR", function(OpencgaR, panels, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        #' @param source Comma separated list of sources to import panels from. Current supported sources are 'panelapp' and 'cancer-gene-census'.
