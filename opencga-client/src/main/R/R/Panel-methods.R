...
#' | distinct | /{apiVersion}/panels/distinct | study, name, phenotypes, variants, genes, regions, categories, tags, description, author, deleted, status, creationDate, modificationDate, acl, release, snapshot, field[*] |
