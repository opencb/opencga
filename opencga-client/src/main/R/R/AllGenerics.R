...
# ##############################################################################
## StudyClient
setGeneric("studyClient", function(OpencgaR, members, studies, templateId, study, group, variableSet, endpointName, params=NULL, ...)
...
# ##############################################################################
## ClinicalClient
setGeneric("clinicalClient", function(OpencgaR, members, clinicalAnalyses, interpretation, clinicalAnalysis, interpretations, endpointName, params=NULL, ...)
