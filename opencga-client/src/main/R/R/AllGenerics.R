...
# ##############################################################################
## StudyClient
setGeneric("studyClient", function(OpencgaR, members, templateId, study, group, variableSet, studies, id, endpointName, params=NULL, ...)
...
# ##############################################################################
## ClinicalClient
setGeneric("clinicalClient", function(OpencgaR, members, annotationSet, interpretation, interpretations, clinicalAnalysis, clinicalAnalyses, endpointName, params=NULL, ...)
