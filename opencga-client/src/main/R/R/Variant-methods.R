...
#' | -- | :-- | --: |
#' | aggregationStats | /{apiVersion}/analysis/variant/aggregationStats | savedFilter, region, type, project, study, file, filter, sample, genotype, sampleAnnotation, cohort, cohortStatsRef, cohortStatsAlt, cohortStatsMaf, cohortStatsMgf, cohortStatsPass, missingAlleles, missingGenotypes, score, family, familyDisorder, familySegregation, familyMembers, familyProband, annotationExists, gene, ct, xref, biotype, proteinSubstitution, conservation, populationFrequencyAlt, populationFrequencyRef, populationFrequencyMaf, transcriptFlag, geneTraitId, go, expression, proteinKeyword, drug, functionalScore, clinicalSignificance, customAnnotation, trait, fields |
...
#' | circos | /{apiVersion}/analysis/variant/circos | study, sample, ct, biotype, filter, qual, region, gene, panel, plotCopyNumber, plotIndels, plotRearrangements, density |
...
#' | runGeneticChecks | /{apiVersion}/analysis/variant/geneticChecks/run | study, jobId, jobDescription, jobDependsOn, jobTags, body[*] |
...
#' | queryMutationalSignature | /{apiVersion}/analysis/variant/mutationalSignature/query | study, sample, ct, biotype, filter, qual, region, gene, panel, fitting |
...
#' | deleteSampleStats | /{apiVersion}/analysis/variant/sample/stats/delete | study, sample |
#' | infoSampleStats | /{apiVersion}/analysis/variant/sample/stats/info | study, sample[*] |
...
setMethod("variantClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/circos:
        ...
        #' @param plotCopyNumber Plot copy-number track.
        #' @param plotIndels Plot INDELs track.
        #' @param plotRearrangements Plot rearrangements track.
        #' @param density Density plot: LOW, MEDIUM or HIGH.
        circos=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="variant",
                subcategoryId=NULL, action="circos", params=params, httpMethod="GET", as.queryParam=NULL, ...),
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/geneticChecks/run:
        ...
        runGeneticChecks=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="variant/geneticChecks", subcategoryId=NULL, action="run", params=params,
        ...
        #' @param geneTraitId List of gene trait association id. e.g. "umls:C0007222" , "OMIM:269600".
        #' @param clinicalSignificance Clinical significance: benign, likely_benign, likely_pathogenic, pathogenic.
        #' @param fields List of facet fields separated by semicolons, e.g.: studies;type. For nested faceted fields use >>, e.g.: chromosome>>type . Accepted values: chromosome, type, genotype, consequenceType, biotype, clinicalSignificance, dp, qual, filter.
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/sample/stats/delete:
        #' Delete sample variant stats from a sample.
        #' @param study study.
        #' @param sample Sample.
        deleteSampleStats=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="variant/sample/stats", subcategoryId=NULL, action="delete", params=params,
                httpMethod="DELETE", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/variant/sample/stats/info:
        ...
        infoSampleStats=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="variant/sample/stats", subcategoryId=NULL, action="info", params=params, httpMethod="GET",
                as.queryParam=c("sample"), ...),
