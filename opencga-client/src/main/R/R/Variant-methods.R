...
#' | runExomizer | /{apiVersion}/analysis/variant/exomizer/run | study, jobId, jobDependsOn, jobDescription, jobTags, body[*] |
...
setMethod("variantClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/exomizer/run:
        ...
        runExomizer=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="variant/exomizer",
                subcategoryId=NULL, action="run", params=params, httpMethod="POST", as.queryParam=NULL, ...),
