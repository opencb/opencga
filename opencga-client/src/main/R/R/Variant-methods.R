...
#' | runLiftover | /{apiVersion}/analysis/variant/liftover/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
...
#' | runRegenieBuilder | /{apiVersion}/analysis/variant/regenie/builder/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
#' | runRegenieStep1 | /{apiVersion}/analysis/variant/regenie/step1/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
#' | runRegenieStep2 | /{apiVersion}/analysis/variant/regenie/step2/run | study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
...
#' | runWalker | /{apiVersion}/analysis/variant/walker/run | include, exclude, project, study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
#'
#' @md
...
setMethod("variantClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/liftover/run:
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/regenie/builder/run:
        #' Regenie is a program for whole genome regression modelling of large genome-wide association studies. The tool regenie-builder creates the regenie-walker docker with the files from step1, to execute the step2 of the regenie analysis in the OpenCGA framework.
        #' @param study study.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        #' @param jobPriority Priority of the job.
        #' @param jobDryRun Flag indicating that the job will be executed in dry-run mode. In this mode, OpenCGA will validate that all parameters and prerequisites are correctly set for successful execution, but the job will not actually run.
        #' @param data Params of regenie-builder analysis.
        runRegenieBuilder=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL,
                subcategory="variant/regenie/builder", subcategoryId=NULL, action="run", params=params,
                httpMethod="POST", as.queryParam=NULL, ...),

        #' @section Endpoint /{apiVersion}/analysis/variant/regenie/step1/run:
        #' Regenie is a program for whole genome regression modelling of large genome-wide association studies. This performs the step1 of the regenie analysis.
        #' @param study study.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        #' @section Endpoint /{apiVersion}/analysis/variant/regenie/step2/run:
        #' Regenie is a program for whole genome regression modelling of large genome-wide association studies. This performs the step2 of the regenie analysis.
        #' @param study study.
        #' @param jobId Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
        #' @param jobDescription Job description.
        #' @param jobDependsOn Comma separated list of existing job IDs the job will depend on.
        ...
        runWalker=fetchOpenCGA(object=OpencgaR, category="analysis", categoryId=NULL, subcategory="variant/walker",
                subcategoryId=NULL, action="run", params=params, httpMethod="POST", as.queryParam=NULL, ...),
    )
})