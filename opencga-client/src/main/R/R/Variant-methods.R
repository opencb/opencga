...
#' | queryMutationalSignature | /{apiVersion}/analysis/variant/mutationalSignature/query | study, sample, ct, biotype, fileData, filter, qual, region, gene, panel, panelModeOfInheritance, panelConfidence, panelFeatureType, panelRoleInCancer, panelIntersection, catalogues, cataloguesContent, fitMethod, nBoot, sigVersion, organ, thresholdPerc, thresholdPval, maxRareSigs |
