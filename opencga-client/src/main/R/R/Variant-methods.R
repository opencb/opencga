...
#' | runCohortStats | /{apiVersion}/analysis/variant/cohort/stats/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runExomiser | /{apiVersion}/analysis/variant/exomiser/run | study, jobId, jobDependsOn, jobDescription, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runExport | /{apiVersion}/analysis/variant/export/run | include, exclude, project, study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runFamilyQc | /{apiVersion}/analysis/variant/family/qc/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | deleteFile | /{apiVersion}/analysis/variant/file/delete | jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, study, file, resume |
#' | runGatk | /{apiVersion}/analysis/variant/gatk/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runGenomePlot | /{apiVersion}/analysis/variant/genomePlot/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runGwas | /{apiVersion}/analysis/variant/gwas/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runHrDetect | /{apiVersion}/analysis/variant/hrDetect/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runIndex | /{apiVersion}/analysis/variant/index/run | study, jobId, jobDependsOn, jobDescription, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runIndividualQc | /{apiVersion}/analysis/variant/individual/qc/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runInferredSex | /{apiVersion}/analysis/variant/inferredSex/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runKnockout | /{apiVersion}/analysis/variant/knockout/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runMendelianError | /{apiVersion}/analysis/variant/mendelianError/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runMutationalSignature | /{apiVersion}/analysis/variant/mutationalSignature/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runPlink | /{apiVersion}/analysis/variant/plink/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runRelatedness | /{apiVersion}/analysis/variant/relatedness/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runRvtests | /{apiVersion}/analysis/variant/rvtests/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runSampleEligibility | /{apiVersion}/analysis/variant/sample/eligibility/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runSampleQc | /{apiVersion}/analysis/variant/sample/qc/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | querySample | /{apiVersion}/analysis/variant/sample/query | limit, skip, variant, study, genotype |
#' | runSample | /{apiVersion}/analysis/variant/sample/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
...
#' | runSampleStats | /{apiVersion}/analysis/variant/sample/stats/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runStatsExport | /{apiVersion}/analysis/variant/stats/export/run | project, study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#' | runStats | /{apiVersion}/analysis/variant/stats/run | study, jobId, jobDescription, jobDependsOn, jobTags, scheduledStartTime, priority, dryRun, body[*] |
#'
#' @md
