...
#    Autogenerated on: 2022-06-30 13:31:18
#    
...
#' | runCohortStats | /{apiVersion}/analysis/variant/cohort/stats/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runExport | /{apiVersion}/analysis/variant/export/run | include, exclude, project, study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runFamilyQc | /{apiVersion}/analysis/variant/family/qc/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | deleteFile | /{apiVersion}/analysis/variant/file/delete | jobId, executionDescription, executionDependsOn, executionTags, study, file, resume |
#' | runGatk | /{apiVersion}/analysis/variant/gatk/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runGenomePlot | /{apiVersion}/analysis/variant/genomePlot/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runGwas | /{apiVersion}/analysis/variant/gwas/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runIndex | /{apiVersion}/analysis/variant/index/run | study, jobId, executionDependsOn, executionDescription, executionTags, body[*] |
#' | runIndividualQc | /{apiVersion}/analysis/variant/individual/qc/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runInferredSex | /{apiVersion}/analysis/variant/inferredSex/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runKnockout | /{apiVersion}/analysis/variant/knockout/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runMendelianError | /{apiVersion}/analysis/variant/mendelianError/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | queryMutationalSignature | /{apiVersion}/analysis/variant/mutationalSignature/query | study, sample, ct, biotype, fileData, filter, qual, region, gene, panel, panelModeOfInheritance, panelConfidence, panelFeatureType, panelRoleInCancer, panelIntersection, fitting |
#' | runMutationalSignature | /{apiVersion}/analysis/variant/mutationalSignature/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runPlink | /{apiVersion}/analysis/variant/plink/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runRelatedness | /{apiVersion}/analysis/variant/relatedness/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runRvtests | /{apiVersion}/analysis/variant/rvtests/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runSampleEligibility | /{apiVersion}/analysis/variant/sample/eligibility/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runSampleQc | /{apiVersion}/analysis/variant/sample/qc/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | querySample | /{apiVersion}/analysis/variant/sample/query | limit, skip, variant, study, genotype |
#' | runSample | /{apiVersion}/analysis/variant/sample/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
...
#' | runSampleStats | /{apiVersion}/analysis/variant/sample/stats/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runStatsExport | /{apiVersion}/analysis/variant/stats/export/run | project, study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#' | runStats | /{apiVersion}/analysis/variant/stats/run | study, jobId, executionDescription, executionDependsOn, executionTags, body[*] |
#'
#' @md
...
setMethod("variantClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param executionDependsOn Comma separated list of existing execution IDs the execution will depend on.
        #' @param executionTags Execution tags.
        #' @param data Family QC analysis params. Family ID. Relatedness method, by default 'PLINK/IBD'. Minor  allele frequence (MAF) is used to filter variants before computing relatedness, e.g.: 1kg_phase3:CEU>0.35 or cohort:ALL>0.05.
        ...
        #' @param fitting Compute the relative proportions of the different mutational signatures demonstrated by the tumour.
