...
#' | update | /{apiVersion}/individuals/{individuals}/update | include, exclude, individuals[*], study, samplesAction, phenotypesAction, disordersAction, annotationSetsAction, incVersion, includeResult, body |
#' | updateAnnotationSetsAnnotations | /{apiVersion}/individuals/{individual}/annotationSets/{annotationSet}/annotations/update | individual[*], study, annotationSet[*], action, incVersion, body |
...
setMethod("individualClient", "OpencgaR", function(OpencgaR, individual, individuals, members, annotationSet, endpointName, params=NULL, ...) {
    switch(endpointName,
