...
#' | distinct | /{apiVersion}/individuals/distinct | study, id, uuid, name, father, mother, samples, sex, ethnicity, dateOfBirth, disorders, phenotypes, populationName, populationSubpopulation, karyotypicSex, lifeStatus, internalStatus, status, deleted, creationDate, modificationDate, annotation, acl, release, snapshot, field[*] |
#' | search | /{apiVersion}/individuals/search | include, exclude, limit, skip, count, flattenAnnotations, study, id, uuid, name, father, mother, samples, sex, dateOfBirth, ethnicity, disorders, phenotypes, populationName, populationSubpopulation, karyotypicSex, lifeStatus, internalStatus, status, deleted, creationDate, modificationDate, annotation, acl, release, snapshot |
...
#' | update | /{apiVersion}/individuals/{individuals}/update | individuals[*], study, samplesAction, phenotypesAction, disordersAction, annotationSetsAction, incVersion, body |
#' | updateAnnotations | /{apiVersion}/individuals/{individual}/annotationSets/{annotationSet}/annotations/update | individual[*], study, annotationSet, action, incVersion, body |
