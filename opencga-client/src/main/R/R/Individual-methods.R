...
#' | create | /{apiVersion}/individuals/create | study, samples, body[*] |
#' | distinct | /{apiVersion}/individuals/distinct | study, name, father, mother, samples, sex, ethnicity, disorders, population.name, population.subpopulation, population.description, phenotypes, karyotypicSex, lifeStatus, affectationStatus, internalStatus, status, creationDate, modificationDate, annotationsetName, variableSet, annotation, acl, release, snapshot, field[*] |
#' | search | /{apiVersion}/individuals/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, father, mother, samples, sex, ethnicity, disorders, population.name, population.subpopulation, population.description, phenotypes, karyotypicSex, lifeStatus, affectationStatus, internalStatus, status, deleted, creationDate, modificationDate, annotationsetName, variableSet, annotation, acl, release, snapshot |
...
#' | update | /{apiVersion}/individuals/{individuals}/update | individuals[*], study, samplesAction, annotationSetsAction, incVersion, updateSampleVersion, body |
#' | updateAnnotations | /{apiVersion}/individuals/{individual}/annotationSets/{annotationSet}/annotations/update | individual[*], study, annotationSet, action, incVersion, updateSampleVersion, body |
...
setMethod("individualClient", "OpencgaR", function(OpencgaR, members, individual, individuals, annotationSet, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        updateAnnotations=fetchOpenCGA(object=OpencgaR, category="individuals", categoryId=individual,
