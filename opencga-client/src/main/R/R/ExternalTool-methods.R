...
# ##############################################################################
#' ExternalToolClient methods
#' @include AllClasses.R
#' @include AllGenerics.R
#' @include commons.R

#' @description This function implements the OpenCGA calls for managing External Tools.
...
setMethod("externaltoolClient", "OpencgaR", function(OpencgaR, members, toolId, tools, endpointName, params=NULL, ...) {
    switch(endpointName,
