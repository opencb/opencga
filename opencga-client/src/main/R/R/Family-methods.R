...
#' | pedigreeGraph | /{apiVersion}/families/pedigreeGraph | study, familyId |
...
setMethod("familyClient", "OpencgaR", function(OpencgaR, annotationSet, family, members, families, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/families/pedigreeGraph:
        #' Compute pedigree graph image.
        #' @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
        #' @param familyId Family ID.
        pedigreeGraph=fetchOpenCGA(object=OpencgaR, category="families", categoryId=NULL, subcategory=NULL,
                subcategoryId=NULL, action="pedigreeGraph", params=params, httpMethod="GET", as.queryParam=NULL, ...),
