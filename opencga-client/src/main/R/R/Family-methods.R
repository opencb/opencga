...
#' | distinct | /{apiVersion}/families/distinct | study, name, parentalConsanguinity, members, samples, phenotypes, disorders, creationDate, modificationDate, deleted, annotationsetName, variableSet, internalStatus, status, annotation, acl, release, snapshot, field[*] |
#' | search | /{apiVersion}/families/search | include, exclude, limit, skip, count, flattenAnnotations, study, name, parentalConsanguinity, members, samples, phenotypes, disorders, creationDate, modificationDate, deleted, annotationsetName, variableSet, internalStatus, status, annotation, acl, release, snapshot |
...
#' | update | /{apiVersion}/families/{families}/update | families[*], study, incVersion, updateRoles, updateIndividualVersion, annotationSetsAction, body |
...
setMethod("familyClient", "OpencgaR", function(OpencgaR, families, annotationSet, family, members, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param propagate Propagate family permissions to related individuals and samples.
