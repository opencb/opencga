...
#    Autogenerated on: 2022-04-26 13:10:13
#    
...
#' | update | /{apiVersion}/families/{families}/update | include, exclude, families[*], study, incVersion, updateRoles, annotationSetsAction, includeResult, body |
#' | updateAnnotationSetsAnnotations | /{apiVersion}/families/{family}/annotationSets/{annotationSet}/annotations/update | family[*], study, annotationSet[*], action, incVersion, body |
#'
#' @md
...
setMethod("familyClient", "OpencgaR", function(OpencgaR, annotationSet, members, families, family, endpointName, params=NULL, ...) {
    switch(endpointName,
