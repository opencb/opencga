...
#' | update | /{apiVersion}/families/{families}/update | families[*], study, incVersion, updateRoles, annotationSetsAction, body |
#' | updateAnnotations | /{apiVersion}/families/{family}/annotationSets/{annotationSet}/annotations/update | family[*], study, annotationSet, action, incVersion, body |
#'
#' @md
