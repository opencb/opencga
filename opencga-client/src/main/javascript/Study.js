...
export default class Study extends OpenCGAParentClass {
    ...
    */
    ...
    /** Return the pipelines available for the study.
    * @param {String} study - Study [[user@]project:]study where study and project can be either the ID or UUID.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.pipelineId] - Pipeline id. If provided, it will only fetch the requested pipeline.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    pipelines(study, params) {
        return this._get("studies", study, null, null, "pipelines", params);
    }
    ...
    * @param {Object} data - JSON containing the parameters.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {"ADD"|"REMOVE"|"REPLACE"} [params.action = "ADD"] - Action to be performed: ADD, REMOVE or REPLACE a pipeline. The default
    *     value is ADD.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    updatePipelines(study, data, params) {
        return this._post("studies", study, "pipelines", null, "update", data, params);
    }
    ...
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {"ADD"|"REMOVE"|"FORCE_REMOVE"} [params.action = "ADD"] - Action to be performed: ADD, REMOVE or FORCE_REMOVE a variableSet.
