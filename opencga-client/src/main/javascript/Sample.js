...
export default class Sample extends OpenCGAParentClass {
    ...
    * @param {String} [params.internalRgaStatus] - Index status of the sample for the Recessive Gene Analysis.
    ...
    * @param {"ADD"|"SET"|"REMOVE"} [params.phenotypesAction = "ADD"] - Action to be performed if the array of phenotypes is being updated
    *     [SET, ADD, REMOVE]. The default value is ADD.
    * @param {Boolean} [params.includeResult = "false"] - Flag indicating to include the created or updated document result in the response.
    *     The default value is false.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
