...
export default class ClinicalAnalysis extends OpenCGAParentClass {
    ...
    * @param {String} configFile - Interpretation configuration file.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.clinicalAnalysisId] - Clinical analysis ID.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    interpreter(configFile, params) {
        return this._get("analysis", null, "clinical", null, "interpreter", {configFile, ...params});
    }
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runInterpreter(data, params) {
        return this._post("analysis", null, "clinical/interpreter", null, "run", data, params);
    }
    ...
    * @param {Object} data - JSON with parameters to execute the tool pharmacogenomics-allele-typer-analysis.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[organization@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPharmacogenomicsAlleleTyper(data, params) {
        return this._post("analysis", null, "clinical/pharmacogenomics/alleleTyper", null, "run", data, params);
    }

    /** Annotate the star alleles for the input samples with pharmacogenomics data
    * @param {Object} data - JSON with parameters to execute the tool pharmacogenomics-annotation-analysis.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[organization@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPharmacogenomicsAnnotation(data, params) {
        return this._post("analysis", null, "clinical/pharmacogenomics/annotation", null, "run", data, params);
    }
    ...
    * @param {Object} data - OpenArray pharmacogenomics analysis params.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[organization@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPharmacogenomicsOpenarray(data, params) {
        return this._post("analysis", null, "clinical/pharmacogenomics/openarray", null, "run", data, params);
    }
