...
export default class ClinicalAnalysis extends OpenCGAParentClass {
    ...
    */
    ...
    /** NGS pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant indexing in OpenCGA
    * storage.
    * @param {Object} data - Variant caller pipeline parameters.
    * @param {Object} [params] - The Object containing the following optional parameters:
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runNgsPipeline(data, params) {
        return this._post("analysis", null, "clinical/ngsPipeline", null, "run", data, params);
    }

    /** Execute the clinical pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant indexing
    * in OpenCGA storage.
    * @param {Object} data - Parameters to execute the clinical pipeline.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runPipelineExecute(data, params) {
        return this._post("analysis", null, "clinical/pipeline/execute", null, "run", data, params);
    }

    /** Prepare the clinical pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant indexing
    * in OpenCGA storage.
    * @param {Object} data - Parameters to prepare the clinical pipeline.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
