...
export default class Variant extends OpenCGAParentClass {
    ...
    */
    ...
    /** Regenie is a program for whole genome regression modelling of large genome-wide association studies. The tool regenie-builder creates
    * the regenie-walker docker with the files from step1, to execute the step2 of the regenie analysis in the OpenCGA framework.
    * @param {Object} data - Params of regenie-builder analysis.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runRegenieBuilder(data, params) {
        return this._post("analysis", null, "variant/regenie/builder", null, "run", data, params);
    }
    ...
    * regenie analysis.
    * @param {Object} data - Params of regenie-step1 analysis.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runRegenieStep1(data, params) {
        return this._post("analysis", null, "variant/regenie/step1", null, "run", data, params);
    }
    ...
    * regenie analysis.
    * @param {Object} data - Params of regenie-step2 analysis.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - study.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    *     provided.
    ...
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    runRegenieStep2(data, params) {
        return this._post("analysis", null, "variant/regenie/step2", null, "run", data, params);
    }
