...
export default class Variant extends OpenCGAParentClass {
    ...
    * @param {String} [params.nBoot = "200"] - Number of bootstrap to be used. The default value is 200.
    ...
    *     Stomach, Uterus.
    * @param {String} [params.thresholdPerc = "5f"] - Threshold in percentage of total mutations in a sample, only exposures larger than
    *     THRPERC are considered. If not specified 5. The default value is 5f.
    * @param {String} [params.thresholdPval = "0.05f"] - P-value to determine the empirical probability that the exposure is lower than the
    *     threshold. If not specified then 0.05. The default value is 0.05f.
    * @param {String} [params.maxRareSigs = "1"] - Maximum number of rare signatures that are allowed to be present in each sample. If not
