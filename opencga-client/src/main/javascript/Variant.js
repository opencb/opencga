...
export default class Variant extends OpenCGAParentClass {
    ...
    * @param {String} [params.nBoot] - Number of bootstrap to be used.
    ...
    *     Stomach, Uterus.
    * @param {String} [params.thresholdPerc = "5"] - Threshold in percentage of total mutations in a sample, only exposures larger than
    *     THRPERC are considered. If not specified 5. The default value is 5.
    * @param {String} [params.thresholdPval = "0.05"] - P-value to determine the empirical probability that the exposure is lower than the
    *     threshold. If not specified then 0.05. The default value is 0.05.
