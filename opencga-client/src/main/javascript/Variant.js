...
export default class Variant extends OpenCGAParentClass {
    ...
    * @param {String} [params.signaturesFile] - The file name containing mutational signatures. Each signature is in a column, with
    ...
    *     only to provide your own signatures. When fitmethod=FitMS, these signatures are considered common signatures.
    * @param {String} [params.rareSignaturesFile] - The file name containing mutational signatures. Each signature is in a column, with
    *     signature names as column hearders and channel names as row names in the first column with no header. Each column must sum to 1. Use
    *     only to provide your own signatures. When fitmethod=FitMS, these signatures are considered rare signatures.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
