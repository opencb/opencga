...
export default class CVDB extends OpenCGAParentClass {
    ...
    * @param {Object} data - Parameters for the ACL updating task (cvdb-acl-update).
    ...
    */
    updateAcl(data, params) {
        return this._post("analysis", null, "cvdb/acl", null, "update", data, params);
    }
