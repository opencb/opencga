...
public class JobClient extends AbstractParentClient {
     ...
     *       tail: Flag indicating to output the last part of the file.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<FileContent> log(String job, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("jobs", job, null, null, "log", params, GET, FileContent.class);
    }
}
