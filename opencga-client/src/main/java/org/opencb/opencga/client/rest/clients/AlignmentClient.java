...
public class AlignmentClient extends AbstractParentClient {
    ...
    public RestResponse<Job> runIndex(AlignmentIndexParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/alignment", null, "index", null, "run", params, POST, Job.class);
    }
    ...
    public RestResponse<AlignmentStats> infoStats(String file, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.putIfNotNull("file", file);
        return execute("analysis/alignment", null, "stats", null, "info", params, GET, AlignmentStats.class);
    }
