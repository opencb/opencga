...
* Autogenerated on: 2021-04-23 09:23:56
*
...
public class AlignmentClient extends AbstractParentClient {
    ...
    /**
     * Compute sequence stats (based on FastQC tool) for a given alignment file.
     * @param data Alignment FastQC metrics params.
     * @param params Map containing any of the following optional parameters.
     *       study: study.
     *       jobId: Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
     *       jobDependsOn: Comma separated list of existing job IDs the job will depend on.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runFastqcmetrics(AlignmentFastQcMetricsParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "alignment/fastqcmetrics", null, "run", params, POST, Job.class);
    }

    /**
     * Compute flag stats (based on samtools/flagstat command) for a given alignment file.
     * @param data Alignment flag stats params.
     * @param params Map containing any of the following optional parameters.
     *       study: study.
     *       jobId: Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
     *       jobDependsOn: Comma separated list of existing job IDs the job will depend on.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runFlagstats(AlignmentFlagStatsParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "alignment/flagstats", null, "run", params, POST, Job.class);
    }

    /**
     * Compute hybrid-selection (HS) metrics (based on Picard tool) for a given alignment file.
     * @param data Alignment hybrid-selection (HS) metrics params.
     * @param params Map containing any of the following optional parameters.
     *       study: study.
     *       jobId: Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
     *       jobDependsOn: Comma separated list of existing job IDs the job will depend on.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runHsmetrics(AlignmentHsMetricsParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "alignment/hsmetrics", null, "run", params, POST, Job.class);
    }
    ...
    /**
     * Compute quality control (QC) metrics for a given alignment file (including stats, flag stats, FastQC and HS metrics).
     * @param data Alignment QC params.
     * @param params Map containing any of the following optional parameters.
     *       study: study.
     *       jobId: Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
     *       jobDependsOn: Comma separated list of existing job IDs the job will depend on.
    ...
    /**
     * Compute stats (based on samtools/stats command) for a given alignment file.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runStats(AlignmentStatsParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "alignment/stats", null, "run", params, POST, Job.class);
    }
}
