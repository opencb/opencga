 ...
 *    PATH: workflows
 */
public class WorkflowClient extends AbstractParentClient {
     ...
     */
    public RestResponse<Workflow> create(WorkflowCreateParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("workflows", null, null, null, "create", params, POST, Workflow.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> run(HRDetectAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Workflow> search(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("workflows", null, null, null, "search", params, GET, Workflow.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Workflow> update(String workflowId, WorkflowUpdateParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("workflows", workflowId, null, null, "update", params, POST, Workflow.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<WorkflowAclEntryList> acl(String workflows, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("workflows", workflows, null, null, "acl", params, GET, WorkflowAclEntryList.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Workflow> delete(String workflows, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("workflows", workflows, null, null, "delete", params, DELETE, Workflow.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Workflow> info(String workflows, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("workflows", workflows, null, null, "info", params, GET, Workflow.class);
    }
}
