...
public class IndividualClient extends AbstractParentClient {
     ...
     */
    public RestResponse<AclEntryList> updateAcl(String members, String action, IndividualAclUpdateParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.putIfNotNull("action", action);
        params.put("body", data);
        return execute("individuals", null, "acl", members, "update", params, POST, AclEntryList.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<AclEntryList> acl(String individuals, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("individuals", individuals, null, null, "acl", params, GET, AclEntryList.class);
    }
