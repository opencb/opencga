...
public class FileClient extends AbstractParentClient {
     ...
     */
    public RestResponse<FileAclEntryList> updateAcl(String members, String action, FileAclUpdateParams data, ObjectMap params)
     ...
     * @param params Map containing any of the following optional parameters.
     *       study: Comma separated list of Studies [[organization@]project:]study where study and project can be either the ID or UUID up
     *            to a maximum of 100.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<FileAclEntryList> acl(String files, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("files", files, null, null, "acl", params, GET, FileAclEntryList.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<File> move(String file, FileMoveParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("files", file, null, null, "move", params, POST, File.class);
    }
