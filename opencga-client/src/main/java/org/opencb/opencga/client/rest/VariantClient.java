...
public class VariantClient extends AbstractParentClient {
     ...
     *       skipCount: Do not count total number of results.
     ...
     *       groupBy: Group variants by: [ct, gene, ensemblGene].
     *       histogram: Calculate histogram. Requires one region.
     *       interval: Histogram interval size.
     *       rank: Ranks different entities with the most number of variants. Rank by: [ct, gene, ensemblGene].
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
     ...
     * @param params Map containing any of the following optional parameters.
     *       study: Study where all the samples belong to.
     *       sample: Comma separated list sample IDs or UUIDs up to a maximum of 100.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
     ...
     * @param params Map containing any of the following optional parameters.
     *       study: study.
     *       cohort: Comma separated list of cohort names or ids up to a maximum of 100.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
