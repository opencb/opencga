...
public class VariantOperationClient extends ParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<ObjectMap> variantAnnotationExtensionConfigure(VariantAnnotationExtensionConfigureParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("operation", null, "variant/annotation/extension", null, "configure", params, POST, ObjectMap.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> variantSecondaryAnnotationIndex(VariantSecondaryAnnotationIndexParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
