 ...
 *    PATH: panels
 */
public class DiseasePanelClient extends ParentClient {
     ...
     */
    public RestResponse<PanelAclEntryList> updateAcl(String members, String action, PanelAclUpdateParams data, ObjectMap params)
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Panel> importPanels(PanelImportParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("panels", null, null, null, "import", params, POST, Panel.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<PanelAclEntryList> acl(String panels, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("panels", panels, null, null, "acl", params, GET, PanelAclEntryList.class);
    }
