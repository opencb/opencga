...
public class ClinicalClient extends AbstractParentClient {
     ...
     *       member: Proband id or any member id of a family.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Interpretation> clearInterpretation(String clinicalAnalysis, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis/clinical", clinicalAnalysis, "interpretation", null, "clear", params, POST, Interpretation.class);
    }
     ...
     *       study: [[user@]project:]study ID.
     *       clinicalAnalysis: Clinical analysis ID.
     *       interpretationId: Interpretation ID where it will be merged.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Interpretation> mergeInterpretation(String clinicalAnalysis, String interpretationId, InterpretationMergeParams
        data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", clinicalAnalysis, "interpretation", interpretationId, "merge", params, POST,
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Interpretation> updateInterpretation(String clinicalAnalysis, String interpretationId, InterpretationUpdateParams
        data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", clinicalAnalysis, "interpretation", interpretationId, "update", params, POST,
                Interpretation.class);
    }
