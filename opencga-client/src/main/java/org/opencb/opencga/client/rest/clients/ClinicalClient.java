...
* Autogenerated on: 2020-04-15 14:20:49
*
...
public class ClinicalClient extends AbstractParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<ObjectMap> searchInterpretation(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis/clinical", null, "interpretation", null, "search", params, GET, ObjectMap.class);
    }

    /**
     * Run TEAM interpretation analysis.
     * @param data GEL tiering interpretation analysis params.
     * @param params Map containing any of the following optional parameters.
     *       study: Study [[user@]project:]study where study and project can be either the ID or UUID.
     *       jobId: Job ID. It must be a unique string within the study. An id will be autogenerated automatically if not provided.
     *       jobDescription: Job description.
    ...
    /**
     * Run custom interpretation analysis.
