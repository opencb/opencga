...
public class ClinicalClient extends AbstractParentClient {
    ...
    public RestResponse<Interpretation> searchInterpretation(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis/clinical", null, "interpretation", null, "search", params, GET, Interpretation.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runInterpretersCancerTiering(CancerTieringInterpretationAnalysisParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", null, "interpreters/cancerTiering", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runInterpretersTeam(TeamInterpretationAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", null, "interpreters/team", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runInterpretersTiering(TieringInterpretationAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", null, "interpreters/tiering", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runInterpretersZetta(ZettaInterpretationAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis/clinical", null, "interpreters/zetta", null, "run", params, POST, Job.class);
    }
    ...
    public RestResponse<ClinicalAnalysis> delete(String clinicalAnalyses, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis/clinical", clinicalAnalyses, null, null, "delete", params, DELETE, ClinicalAnalysis.class);
    }
    ...
    public RestResponse<ClinicalAnalysis> info(String clinicalAnalysis, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis/clinical", clinicalAnalysis, null, null, "info", params, GET, ClinicalAnalysis.class);
    }
