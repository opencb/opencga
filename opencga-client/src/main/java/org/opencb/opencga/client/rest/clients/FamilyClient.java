...
public class FamilyClient extends AbstractParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<String> pedigreeGraph(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("families", null, null, null, "pedigreeGraph", params, GET, String.class);
    }
