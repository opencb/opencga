...
public class FileClient extends AnnotationClient<File, FileAclEntry> {
    ...
    public QueryResponse<File> createFolder(String studyId, String path, ObjectMap params) throws IOException {
    ...
    public QueryResponse<File> relink(String fileId, String uri, QueryOptions options) throws IOException {
    ...
    public QueryResponse<File> unlink(String fileId, ObjectMap params) throws IOException {
        params = addParamsToObjectMap(params, "fileId", fileId);
        return execute(FILES_URL, "unlink", params, GET, File.class);
    }

    public QueryResponse<File> content(String fileId, ObjectMap params) throws IOException {
        return execute(FILES_URL, fileId.replace("/", ":"), "content", params, GET, File.class);
    }

    public QueryResponse<File> download(String fileId, ObjectMap params) throws IOException {
        return execute(FILES_URL, fileId.replace("/", ":"), "download", params, GET, File.class);
    }

    public QueryResponse<File> grep(String fileId, String pattern, ObjectMap params) throws IOException {
        params = addParamsToObjectMap(params, "pattern", pattern);
        return execute(FILES_URL, fileId.replace("/", ":"), "grep", params, GET, File.class);
    }

    public QueryResponse<File> list(String folderId, ObjectMap options) throws IOException {
        folderId = folderId.replace('/', ':');
        return execute(FILES_URL, folderId, "list", options, GET, File.class);
    }

    public QueryResponse<File> delete(String fileId, ObjectMap params) throws IOException {
        return execute(FILES_URL, fileId.replace("/", ":"), "delete", params, GET, File.class);
    }

    public QueryResponse<FileTree> tree(String folderId, ObjectMap params) throws IOException {
        return execute(FILES_URL, folderId.replace("/", ":"), "tree", params, GET, FileTree.class);
    }

    public QueryResponse<File> refresh(String fileId, ObjectMap options) throws IOException {
        return execute(FILES_URL, fileId.replace("/", ":"), "refresh", options, GET, File.class);
    }

    public QueryResponse<File> upload(String studyId, String filePath, ObjectMap params) throws IOException {
        params = addParamsToObjectMap(params, STUDY, studyId, "file", filePath);
        return execute(FILES_URL, "upload", params, POST, File.class);
    }

    public QueryResponse<File> groupBy(String studyId, String fields, ObjectMap params) throws IOException {
    ...
    public QueryResponse<FacetQueryResult> stats(String study, Query query, QueryOptions queryOptions) throws IOException {
        ...
        return execute(FILES_URL, "stats", params, GET, FacetQueryResult.class);
    }
}
