...
public class JobClient extends AbstractParentClient {
     ...
     */
    public RestResponse<AclEntryList> updateAcl(String members, String action, JobAclUpdateParams data) throws ClientException {
        ObjectMap params = new ObjectMap();
        params.putIfNotNull("action", action);
        params.put("body", data);
        return execute("jobs", null, "acl", members, "update", params, POST, AclEntryList.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<AclEntryList> acl(String jobs, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("jobs", jobs, null, null, "acl", params, GET, AclEntryList.class);
    }
