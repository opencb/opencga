...
public class JobClient extends AbstractParentClient {
     ...
     *       execution.start: Execution start date. Format: yyyyMMddHHmmss. Examples: >2018, 2017-2018, <201805.
     *       execution.end: Execution end date. Format: yyyyMMddHHmmss. Examples: >2018, 2017-2018, <201805.
    ...
    public RestResponse<ObjectMap> distinct(String field, ObjectMap params) throws ClientException {
        ...
        return execute("jobs", null, null, null, "distinct", params, GET, ObjectMap.class);
    }
