...
public class UserClient extends AbstractParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<UserFilter> updateFilter(String user, String id, FilterUpdateParams data) throws ClientException {
        ObjectMap params = new ObjectMap();
        params.put("body", data);
        return execute("users", user, "filters", id, "update", params, POST, UserFilter.class);
    }
