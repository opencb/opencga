...
public class CohortClient extends AbstractParentClient {
     ...
     */
    public RestResponse<AclEntryList> updateAcl(String members, String action, CohortAclUpdateParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.putIfNotNull("action", action);
        params.put("body", data);
        return execute("cohorts", null, "acl", members, "update", params, POST, AclEntryList.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<AclEntryList> acl(String cohorts, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cohorts", cohorts, null, null, "acl", params, GET, AclEntryList.class);
    }
