...
public class AdminClient extends AbstractParentClient {
     ...
     * @param params Map containing any of the following optional parameters.
     *       panelApp: Import panels from PanelApp (GEL).
     *       overwrite: Flag indicating to overwrite installed panels in case of an ID conflict.
     *       delete: Comma separated list of global panel ids to delete.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
