...
* Autogenerated on: 2020-02-17 16:27:45
*
...
public class FileClient extends AbstractParentClient {
     ...
     *       lazy: False to return entire job and experiment object.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<FileContent> content(String file, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("files", file, null, null, "content", params, GET, FileContent.class);
    }
     ...
     *       include: Fields included in the response, whole JSON path must be provided.
     *       exclude: Fields excluded in the response, whole JSON path must be provided.
     *       limit: [PENDING] Number of results to be returned.
     *       folder: Folder id, name or path. Paths must be separated by : instead of /.
     *       study: Study [[user@]project:]study where study and project can be either the ID or UUID.
     ...
     *       job.id: Job id that created the file(s) or folder(s).
     *       annotation: Annotation, e.g: key1=value(,key2=value).
