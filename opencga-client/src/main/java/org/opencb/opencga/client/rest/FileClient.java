...
* Autogenerated on: 2020-02-14 09:36:22
*
...
public class FileClient extends AbstractParentClient {
     ...
     * @param params Map containing any of the following optional parameters.
     *       study: Study [[user@]project:]study where study and project can be either the ID or UUID.
     *       path: Folder path where the file will be downloaded.
     *       url: External url where the file to be registered can be downloaded from.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
