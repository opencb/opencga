...
public class VariantClient extends AbstractParentClient {
    ...
    public RestResponse<Job> runGeneticChecks(GeneticChecksAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "variant/geneticChecks", null, "run", params, POST, Job.class);
    }
     ...
     *       image: Compute mutational signature summary image.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<MutationalSignatureAnalysisParams> queryMutationalSignature(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis", null, "variant/mutationalSignature", null, "query", params, GET,
                MutationalSignatureAnalysisParams.class);
    }
    ...
    public RestResponse<SampleVariantStats> deleteSampleStats(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("analysis", null, "variant/sample/stats", null, "delete", params, DELETE, SampleVariantStats.class);
    }
    ...
    public RestResponse<SampleVariantStats> infoSampleStats(String sample, ObjectMap params) throws ClientException {
        ...
        return execute("analysis", null, "variant/sample/stats", null, "info", params, GET, SampleVariantStats.class);
    }
