...
public class VariantClient extends ParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runHrDetect(HRDetectAnalysisParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runLiftover(LiftoverWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "variant/liftover", null, "run", params, POST, Job.class);
    }
    ...
    /**
     * Regenie is a program for whole genome regression modelling of large genome-wide association studies. The tool regenie-builder
     *     creates the regenie-walker docker with the files from step1, to execute the step2 of the regenie analysis in the OpenCGA
     *     framework.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runRegenieBuilder(RegenieBuilderWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "variant/regenie/builder", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runRegenieStep1(RegenieStep1WrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "variant/regenie/step1", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runRegenieStep2(RegenieStep2WrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "variant/regenie/step2", null, "run", params, POST, Job.class);
    }
