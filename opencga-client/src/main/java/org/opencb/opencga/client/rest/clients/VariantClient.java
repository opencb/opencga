...
public class VariantClient extends AbstractParentClient {
     ...
     * @param data Family QC analysis params. Family ID. Relatedness method based on the PLINK/IBD method. Minor allele frequency (MAF) is
     *     used to filter variants before computing relatedness, e.g.: 1000G:CEU>0.35 or cohort:ALL>0.05.
     * @param params Map containing any of the following optional parameters.
     *       study: Study [[organization@]project:]study where study and project can be either the ID or UUID.
     *       jobId: Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not provided.
     *       jobDescription: Job description.
