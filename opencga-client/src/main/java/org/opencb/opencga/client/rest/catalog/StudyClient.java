...
public class StudyClient extends CatalogClient<Study> {
    ...
    public RestResponse<Study> create(String projectId, String studyId, ObjectMap params) throws IOException {
    ...
    public RestResponse<ObjectMap> getStats(String studyId, Query query, QueryOptions options) throws IOException {
    ...
    @Deprecated
    public RestResponse<Sample> getSamples(String studyId, QueryOptions options) throws IOException {
        return execute(STUDY_URL, studyId, "samples", options, GET, Sample.class);
    }

    @Deprecated
    public RestResponse<File> getFiles(String studyId, QueryOptions options) throws IOException {
        return execute(STUDY_URL, studyId, "files", options, GET, File.class);
    }

    @Deprecated
    public RestResponse<Job> getJobs(String studyId, QueryOptions options) throws IOException {
        return execute(STUDY_URL, studyId, "jobs", options, GET, Job.class);
    }

    public RestResponse scanFiles(String studyId, QueryOptions options) throws IOException {
        return execute(STUDY_URL, studyId, "scanFiles", options, GET, Object.class);
    }

    public RestResponse resyncFiles(String studyId, QueryOptions options) throws IOException {
        return execute(STUDY_URL, studyId, "resyncFiles", options, GET, Object.class);
    }

    public RestResponse<ObjectMap> createGroup(String studyId, String groupId, String groupName, String users) throws IOException {
    ...
    public RestResponse<ObjectMap> deleteGroup(String studyId, String groupId, QueryOptions options) throws IOException {
        ObjectMap queryParams = new ObjectMap();
    ...
    public RestResponse<ObjectMap> updateGroup(String studyId, String groupId, ObjectMap objectMap) throws IOException {
    ...
    public RestResponse<ObjectMap> updateGroupMember(String studyId, ObjectMap objectMap) throws IOException {
        ObjectMap bodyParams = new ObjectMap("body", objectMap);
        return execute(STUDY_URL, studyId, "groups", "members", "update", bodyParams, POST, ObjectMap.class);
    }

    public RestResponse<ObjectMap> updateGroupAdmins(String studyId, ObjectMap objectMap) throws IOException {
        ObjectMap bodyParams = new ObjectMap("body", objectMap);
        return execute(STUDY_URL, studyId, "groups", "admins", "update", bodyParams, POST, ObjectMap.class);
    }

    public RestResponse<ObjectMap> groups(String studyId, ObjectMap objectMap) throws IOException {
        ObjectMap params = new ObjectMap(objectMap);
        return execute(STUDY_URL, studyId, "groups", params, GET, ObjectMap.class);
    }

    public RestResponse<Study> update(String studyId, String study, ObjectMap bodyParams) throws IOException {
    ...
    public RestResponse<Study> delete(String studyId, ObjectMap params) throws IOException {
        return execute(STUDY_URL, studyId, "delete", params, GET, Study.class);
    }

    public RestResponse<VariableSet> getVariableSets(String studyId, Query query) throws IOException {
        return execute(STUDY_URL, studyId, "variableSets", query, GET, VariableSet.class);
    }

    public RestResponse<VariableSet> updateVariableSet(String studyId, Query query, ObjectMap variableSet) throws IOException {
        ObjectMapper mapper = JacksonUtils.getUpdateObjectMapper();
    ...
    public RestResponse<VariableSet> updateVariableSetVariable(String studyId, String variableSet, Query query, ObjectMap variable)
            throws IOException {
        ObjectMapper mapper = JacksonUtils.getUpdateObjectMapper();
