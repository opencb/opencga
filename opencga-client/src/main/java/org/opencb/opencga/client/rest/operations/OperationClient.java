...
public class OperationClient extends AbstractParentClient {
    ...
    public DataResponse<Job> variantSecondaryIndex(String project, String study, ObjectMap params) throws IOException {
    ...
    public DataResponse<Job> variantAnnotationIndex(String project, String study, ObjectMap params) throws IOException {
    ...
    public DataResponse<Job> variantAnnotationSave(String project, ObjectMap params) throws IOException {
