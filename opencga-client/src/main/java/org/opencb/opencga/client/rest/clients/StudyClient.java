...
public class StudyClient extends AbstractParentClient {
     ...
     * @param study Study [[user@]project:]study where study and project can be either the ID or UUID.
     * @param params Map containing any of the following optional parameters.
     *       pipelineId: Pipeline id. If provided, it will only fetch the requested pipeline.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Pipeline> pipelines(String study, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("studies", study, null, null, "pipelines", params, GET, Pipeline.class);
    }
     ...
     * @param data JSON containing the parameters.
     * @param params Map containing any of the following optional parameters.
     *       action: Action to be performed: ADD, REMOVE or REPLACE a pipeline.
     * @return a RestResponse object.
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Pipeline> updatePipelines(String study, PipelineCreateParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("studies", study, "pipelines", null, "update", params, POST, Pipeline.class);
    }
