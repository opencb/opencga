...
public class ClinicalAnalysisClient extends AbstractParentClient {
     ...
     *                         include: Fields included in the response, whole JSON path must be provided.
     *                         exclude: Fields excluded in the response, whole JSON path must be provided.
     *                         <<<<<<< HEAD:opencga-client/src/main/java/org/opencb/opencga/client/rest/clients/ClinicalAnalysisClient.java
     *                         =======
     *                         clinicalAnalyses: Comma separated list of clinical analysis IDs.
     *                         >>>>>>> release-2.2.x:opencga-client/src/main/java/org/opencb/opencga/client/rest/clients/ClinicalClient.java
     *                         study: Study [[user@]project:]study where study and project can be either the ID or UUID.
