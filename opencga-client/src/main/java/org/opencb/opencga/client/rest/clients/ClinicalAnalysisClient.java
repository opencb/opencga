...
public class ClinicalAnalysisClient extends ParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runNgsPipeline(NgsPipelineWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/ngsPipeline", null, "run", params, POST, Job.class);
    }

    /**
     * Execute the clinical pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPipelineExecute(ClinicalPipelineExecuteWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pipeline/execute", null, "run", params, POST, Job.class);
    }

    /**
     * Prepare the clinical pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant
     *     indexing in OpenCGA storage.
