...
public class ClinicalAnalysisClient extends ParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Interpretation> interpreter(String configFile, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.putIfNotNull("configFile", configFile);
        return execute("analysis", null, "clinical", null, "interpreter", params, GET, Interpretation.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runInterpreter(RdInterpretationAnalysisToolParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/interpreter", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> load(ClinicalAnalysisLoadParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPharmacogenomicsAlleleTyper(PharmacogenomicsAlleleTyperToolParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pharmacogenomics/alleleTyper", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPharmacogenomicsAnnotation(PharmacogenomicsAnnotationAnalysisToolParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pharmacogenomics/annotation", null, "run", params, POST, Job.class);
    }

    /**
     * OpenArray pharmacogenomics analysis: infer star alleles from ThermoFisher OpenArray genotyping data and optionally annotate with
     *     CPIC.
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPharmacogenomicsOpenarray(OpenArrayPharmacogenomicsAnalysisParams data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pharmacogenomics/openarray", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPipelineAffy(AffyClinicalPipelineWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pipeline/affy", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runPipelineGenomics(GenomicsClinicalPipelineWrapperParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("analysis", null, "clinical/pipeline/genomics", null, "run", params, POST, Job.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Sample> updateAnnotationSetsAnnotations(String clinicalAnalysis, String annotationSet, ObjectMap data, ObjectMap
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<ClinicalReport> updateReport(String clinicalAnalysis, ClinicalReport data, ObjectMap params)
            throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
