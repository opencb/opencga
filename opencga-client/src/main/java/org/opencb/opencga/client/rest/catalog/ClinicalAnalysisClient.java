...
public class ClinicalAnalysisClient extends CatalogClient<ClinicalAnalysis, ClinicalAnalysisAclEntry> {
    ...
    public QueryResponse<ClinicalAnalysis> create(String studyId, ObjectMap bodyParams) throws IOException, ClientException {
    ...
    public QueryResponse<ClinicalAnalysis> groupBy(String studyId, String fields, ObjectMap params) throws IOException {
