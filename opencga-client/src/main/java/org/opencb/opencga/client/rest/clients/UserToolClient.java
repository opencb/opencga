...
public class UserToolClient extends ParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Job> runWalker(VariantWalkerToolParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("tools", null, "walker", null, "run", params, POST, Job.class);
    }
