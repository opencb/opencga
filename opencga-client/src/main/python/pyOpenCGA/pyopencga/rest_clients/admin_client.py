...
class Admin(_ParentRestClient):
    ...
    def sync_users(self, data, **options):
        ...
        return self._post('users/sync', data=data, **options)
    ...
    def import_users(self, data, **options):
        ...
        return self._post('users/import', data=data, **options)

    def install_catalog(self, data, **options):
        """
        ...
        return self._post('catalog/install', data=data, **options)
    ...
    def index_stats_catalog(self, **options):
        ...
        return self._post('catalog/indexStats', **options)

    def jwt_catalog(self, data, **options):
        """
        ...
        return self._post('catalog/jwt', data=data, **options)
    ...
    def panel_catalog(self, data=None, **options):
        ...
        return self._post('catalog/panel', data=data, **options)
    ...
    def group_by_audit(self, fields, entity, **options):
        ...
        return self._get('audit/groupBy', **options)

    def create_users(self, data, **options):
        """
        Create a new user
        ...
        return self._post('users/create', data=data, **options)
