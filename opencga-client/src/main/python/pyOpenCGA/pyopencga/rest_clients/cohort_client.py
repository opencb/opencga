...
class Cohort(_ParentRestClient):
    ...
    def __init__(self, configuration, token=None, login_handler=None, *args, **kwargs):
        _category = 'cohorts'
        super(Cohort, self).__init__(configuration, _category, token, login_handler, *args, **kwargs)
    ...
    def update_annotations(self, cohort, annotation_set, data=None, **options):
        ...
        return self._post('annotations/update', query_id=cohort, subcategory='annotationSets', second_query_id=annotation_set, data=data, **options)
