...
class Clinical(_ParentRestClient):
    ...
    def update_comments(self, clinical_analysis, interpretation, data, **options):
        ...
        return self._post('interpretations', query_id=clinical_analysis, subcategory='comments/update', second_query_id=interpretation, data=data, **options)

    def update_primary_findings(self, clinical_analysis, interpretation, data, **options):
        """
        ...
        return self._post('interpretations', query_id=clinical_analysis, subcategory='primaryFindings/update', second_query_id=interpretation, data=data, **options)
    ...
    def stats_interpretation(self, **options):
        ...
        return self._get('interpretation/stats', **options)
    ...
    def update_interpretations(self, clinical_analysis, data, **options):
        """
        ...
        return self._post('interpretations/update', query_id=clinical_analysis, data=data, **options)
    ...
    def index_interpretation(self, **options):
        ...
        return self._get('interpretation/index', **options)

    def update(self, clinical_analyses, data, **options):
        """
    ...
    def update_interpretation(self, clinical_analysis, interpretation, data, **options):
        ...
        return self._post('interpretations', query_id=clinical_analysis, subcategory='update', second_query_id=interpretation, data=data, **options)
    ...
    def query_interpretation(self, **options):
        ...
        return self._get('interpretation/query', **options)
