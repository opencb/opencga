...
class Users(_ParentRestClient):
    ...
    def update_configs(self, user, data=None, **options):
        ...
        return self._post('update', query_id=user, subcategory='configs', data=data, **options)

    def password(self, user, data=None, **options):
        """
    ...
    def filters_configs(self, user, **options):
        ...
        return self._get('filters', query_id=user, subcategory='configs', **options)
    ...
    def update_filters(self, user, data=None, **options):
        ...
        return self._post('update', query_id=user, subcategory='configs/filters', data=data, **options)

    def update_filter(self, user, name, data=None, **options):
        """
        ...
        return self._post('update', query_id=user, subcategory='configs/filters', second_query_id=name, data=data, **options)
