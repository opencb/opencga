...
class Files(_ParentBasicCRUDClient, _ParentAclRestClient, _ParentAnnotationSetRestClient):
    ...
    def aggregation_stats(self, **options):
        ...
        :param external: external (bool: ['true','false'])
        :param size: size
    ...
    def search(self, **options):
        ...
        :param skipCount: skip count (bool: ['true','false' default])
        ...
        :param skip: number of results to skip in the queries
        :param count: total number of results (bool: ['true','false' default])
        :param lazy: false to return entire job and experiment object (bool: ['true' default,'false'])
        :param flattenAnnotations: flatten the annotations? (bool: ['true','false' default])
        """
    ...
    def grep(self, file, **options):
        ...
        :param ignoreCase: Do a case insensitive search (bool: ['true','false' default])
        :param multi: Return multiple matches (bool: ['true' default,'false'])
        """
    ...
    def tree_folder(self, folder, **options):
        ...
        :param folder: Folder id, name or path. Paths must be separated by ':' instead of '/' (default root -> ":")
        :param study: study [[user@]project:]study where study and project can be either the id or alias
    ...
    def upload(self, data, **options):
        ...
        :param description: description
        :param parents: create the parent directories if they do not exist (bool: ['true' default,'false'])
        """
