...
class Files(_ParentBasicCRUDClient, _ParentAclRestClient):
    ...
    def get_formats(self, **kwargs):
        ...
        return self._get('formats', **kwargs)
    ...
    def scan_folder(self, folder, **kwargs):
        """
        Scans a folder
    ...
    def list(self, folder, **kwargs):
        ...
        return self._get('list', query_id=folder, **kwargs)

    def content(self, file, **kwargs):
        """
        ...
        return self._get('content', query_id=file, **kwargs)

    def grep(self, file, **kwargs):
        """
        ...
        return self._get('grep', query_id=file, **kwargs)

    def refresh(self, file, **kwargs):
        """
    ...
    def tree(self, folder, **kwargs):
        ...
        return self._get('tree', query_id=folder, **kwargs)
