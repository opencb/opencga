...
class VariantOperations(_ParentRestClient):
    ...
    def secondary_index_variant(self, data=None, **options):
        ...
        return self._post('variant/secondaryIndex', data=data, **options)
    ...
    def delete_variant_secondary_index(self, **options):
        ...
        return self._delete('variant/secondaryIndex/delete', **options)
    ...
    def delete_variant_annotation(self, **options):
        ...
        return self._delete('variant/annotation/delete', **options)
    ...
    def save_variant_annotation(self, data=None, **options):
        ...
        return self._post('variant/annotation/save', data=data, **options)
    ...
    def index_variant_score(self, data=None, **options):
        ...
        :param str job_tags: Job tags
        :param str study: Study [[user@]project:]study where study and project can be either the ID or UUID
        :param dict data: Variant score index params.
            scoreName: Unique name of the score within the study.
            cohort1: Cohort used to compute the score. Use the cohort 'ALL' if all samples from the study where used to compute the score.
            cohort2: Second cohort used to compute the score, typically to compare against the first cohort. If only one cohort was used to compute the score, leave empty.
            inputColumns: Indicate which columns to load from the input file. Provide the column position (starting in 0) for the column with the score with 'SCORE=n'. Optionally, the PValue column with 'PVALUE=n'. The, to indicate the variant associated with the score, provide either the columns ['CHROM', 'POS', 'REF', 'ALT'], or the column 'VAR' containing a variant representation with format 'chr:start:ref:alt'. e.g. 'CHROM=0,POS=1,REF=3,ALT=4,SCORE=5,PVALUE=6' or 'VAR=0,SCORE=1,PVALUE=2'.
            resume: Resume a previously failed indexation
        """

        return self._post('variant/score/index', data=data, **options)
    ...
    def delete_variant_score(self, **options):
        ...
        return self._delete('variant/score/delete', **options)
    ...
    def index_sample_genotype(self, data=None, **options):
        ...
        return self._post('variant/sample/genotype/index', data=data, **options)
    ...
    def index_family_genotype(self, data=None, **options):
        ...
        return self._post('variant/family/genotype/index', data=data, **options)
    ...
    def aggregate_variant_family(self, data=None, **options):
        ...
        return self._post('variant/family/aggregate', data=data, **options)
    ...
    def aggregate_variant(self, data=None, **options):
        ...
        return self._post('variant/aggregate', data=data, **options)
    ...
    def index_variant_annotation(self, data=None, **options):
        ...
        return self._post('variant/annotation/index', data=data, **options)
