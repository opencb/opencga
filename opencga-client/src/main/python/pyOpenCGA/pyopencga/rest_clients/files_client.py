...
class Files(_ParentRestClient):
    ...
    # def upload(self, data, data, **options):
    #     """
    #     Resource to upload a file by chunks
    #     PATH: /{apiVersion}/files/upload
    #
    #     :param dict data: filename
    #     :param dict data: fileFormat
    #     :param dict data: bioformat
    #     :param dict data: Study [[user@]project:]study where study and project can be either the ID or UUID
    #     :param dict data: Path within catalog where the file will be located (default: root folder)
    #     :param dict data: description
    #     :param dict data: Create the parent directories if they do not exist
    #     """
    #
    ...
    def update(self, files, data, **options):
        """
        ...
        :param str study: Study [[user@]project:]study where study and project can be either the ID or UUID
        :param str samples_action: Action to be performed if the array of samples is being updated.
        :param str annotation_sets_action: Action to be performed if the array of annotationSets is being updated.
        :param str related_files_action: Action to be performed if the array of relatedFiles is being updated.
        :param str tags_action: Action to be performed if the array of tags is being updated.
    ...
    def update_annotations(self, file, annotation_set, data=None, **options):
        ...
        return self._post('annotationSets', query_id=file, subcategory='annotations/update', second_query_id=annotation_set, data=data, **options)
