...
class ClinicalAnalysis(_ParentRestClient):
    ...
    def interpreter(self, config_file, **options):
        """
        Rare disease interpretation analysis.
        PATH: /{apiVersion}/analysis/clinical/interpreter

        :param str config_file: Interpretation configuration file. (REQUIRED)
        :param str clinical_analysis_id: Clinical analysis ID.
        ...
        return self._get(category='analysis', resource='interpreter', subcategory='clinical', **options)
    ...
    def run_interpreter(self, data=None, **options):
        """
        Run interpretation analysis for rare diseases.
        PATH: /{apiVersion}/analysis/clinical/interpreter/run
        ...
        return self._post(category='analysis', resource='run', subcategory='clinical/interpreter', data=data, **options)
    ...
    def run_pharmacogenomics_allele_typer(self, data=None, **options):
        """
        pharmacogenomics-allele-typer-analysis.
        PATH: /{apiVersion}/analysis/clinical/pharmacogenomics/alleleTyper/run

        :param dict data: JSON with parameters to execute the tool
            pharmacogenomics-allele-typer-analysis. (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        ...
        return self._post(category='analysis', resource='run', subcategory='clinical/pharmacogenomics/alleleTyper', data=data, **options)

    def run_pharmacogenomics_annotation(self, data=None, **options):
        """
        Annotate the star alleles for the input samples with pharmacogenomics
            data.
        PATH: /{apiVersion}/analysis/clinical/pharmacogenomics/annotation/run

        :param dict data: JSON with parameters to execute the tool
            pharmacogenomics-annotation-analysis. (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        ...
        return self._post(category='analysis', resource='run', subcategory='clinical/pharmacogenomics/annotation', data=data, **options)

    def run_pharmacogenomics_openarray(self, data=None, **options):
        """
        OpenArray pharmacogenomics analysis: infer star alleles from
            ThermoFisher OpenArray genotyping data and optionally annotate with
            CPIC.
        PATH: /{apiVersion}/analysis/clinical/pharmacogenomics/openarray/run

        :param dict data: OpenArray pharmacogenomics analysis params.
            (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
        ...
        return self._post(category='analysis', resource='run', subcategory='clinical/pharmacogenomics/openarray', data=data, **options)
