...
class File(_ParentRestClient):
    ...
    def search(self, **options):
        ...
        :param bool deleted: Boolean to retrieve only deleted files.
        :param str attributes: Text attributes (Format: sex=male,age>20 ...).
        :param str release: Release when the file was registered.
        """
    ...
    def image(self, file, **options):
        ...
        return self._get('image', query_id=file, **options)
