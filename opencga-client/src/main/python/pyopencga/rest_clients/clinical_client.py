...
class Clinical(_ParentRestClient):
    ...
    def run_interpreter_cancer_tiering(self, data=None, **options):
        ...
        return self._post('run', subcategory='interpreter/cancerTiering', data=data, **options)
    ...
    def run_interpreter_team(self, data=None, **options):
        ...
        return self._post('run', subcategory='interpreter/team', data=data, **options)
    ...
    def run_interpreter_tiering(self, data=None, **options):
        ...
        return self._post('run', subcategory='interpreter/tiering', data=data, **options)
    ...
    def run_interpreter_zetta(self, data=None, **options):
        ...
        return self._post('run', subcategory='interpreter/zetta', data=data, **options)
