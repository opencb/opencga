...
WARNING: AUTOGENERATED CODE
    ...
    Autogenerated on: 2020-05-07 13:48:26
...
class Clinical(_ParentRestClient):
    ...
    def search_interpretation(self, **options):
        ...
        return self._get('search', subcategory='interpretation', **options)

    def run_interpreters_cancer_tiering(self, data=None, **options):
        """
        Run cancer tiering interpretation analysis.
        PATH: /{apiVersion}/analysis/clinical/interpreters/cancerTiering/run
        ...
        return self._post('run', subcategory='interpreters/cancerTiering', data=data, **options)

    def run_interpreters_team(self, data=None, **options):
        """
        Run TEAM interpretation analysis.
        PATH: /{apiVersion}/analysis/clinical/interpreters/team/run
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: TEAM interpretation analysis params.
        """

        return self._post('run', subcategory='interpreters/team', data=data, **options)

    def run_interpreters_tiering(self, data=None, **options):
        """
        Run tiering interpretation analysis.
        PATH: /{apiVersion}/analysis/clinical/interpreters/tiering/run
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Tiering interpretation analysis params.
        """

        return self._post('run', subcategory='interpreters/tiering', data=data, **options)

    def run_interpreters_zetta(self, data=None, **options):
        """
        Run Zetta interpretation analysis.
        PATH: /{apiVersion}/analysis/clinical/interpreters/zetta/run
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Zetta interpretation analysis params.
        """

        return self._post('run', subcategory='interpreters/zetta', data=data, **options)
    ...
    def actionable_variant(self, **options):
        ...
        return self._get('actionable', subcategory='variant', **options)
    ...
    def query_variant(self, **options):
        ...
        return self._get('query', subcategory='variant', **options)
    ...
    def delete(self, clinical_analyses, **options):
        ...
        return self._delete('delete', query_id=clinical_analyses, **options)
    ...
    def info(self, clinical_analysis, **options):
        ...
        return self._get('info', query_id=clinical_analysis, **options)

    def update_interpretation(self, clinical_analysis, data=None, **options):
        """
        Update interpretation fields of primary interpretation.
        PATH: /{apiVersion}/analysis/clinical/{clinicalAnalysis}/interpretation/update
        ...
        return self._post('update', query_id=clinical_analysis, subcategory='interpretation', data=data, **options)
    ...
    def update_quality_control(self, clinical_analysis, data=None, **options):
        ...
        return self._post('update', query_id=clinical_analysis, subcategory='qualityControl', data=data, **options)

    def update_secondary_interpretations(self, clinical_analysis, data=None, **options):
        """
        Add or remove secondary interpretations to/from a Clinical Analysis.
        PATH: /{apiVersion}/analysis/clinical/{clinicalAnalysis}/secondaryInterpretations/update
        ...
        return self._post('update', query_id=clinical_analysis, subcategory='secondaryInterpretations', data=data, **options)
