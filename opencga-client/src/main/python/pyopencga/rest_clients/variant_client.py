...
WARNING: AUTOGENERATED CODE
    ...
    Autogenerated on: 2022-09-19 16:19:38
...
class Variant(_ParentRestClient):
    ...
    Client version: 2.4.5-SNAPSHOT [b888e5c5d8243660a06055f74c3bcb458b0f8862]
    ...
    def query_mutational_signature(self, **options):
        ...
        :param str fit_method: Either Fit or FitMS. If not specified then
            FitMS.
        :param str n_boot: Number of bootstrap to be used.
        ...
        :param str organ: When using RefSigv1 or RefSigv2 as SIGVERSION,
            ...
            Stomach, Uterus.
        :param str threshold_perc: Threshold in percentage of total mutations
            in a sample, only exposures larger than THRPERC are considered. If
            not specified 5.
        :param str threshold_pval: P-value to determine the empirical
            probability that the exposure is lower than the threshold. If not
            specified then 0.05.
        :param str max_rare_sigs: Maximum number of rare signatures that are
