...
class Variant(_ParentRestClient):
    ...
    def run_regenie_builder(self, data=None, **options):
        """
        Regenie is a program for whole genome regression modelling of large
            genome-wide association studies. The tool regenie-builder creates
            the regenie-walker docker with the files from step1, to execute the
            step2 of the regenie analysis in the OpenCGA framework.
        PATH: /{apiVersion}/analysis/variant/regenie/builder/run

        :param dict data: Params of regenie-builder analysis. (REQUIRED)
        :param str study: study.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        :param str job_description: Job description.
        ...
        return self._post(category='analysis', resource='run', subcategory='variant/regenie/builder', data=data, **options)

    def run_regenie_step1(self, data=None, **options):
        """
        Regenie is a program for whole genome regression modelling of large
            genome-wide association studies. This performs the step1 of the
            regenie analysis.
        PATH: /{apiVersion}/analysis/variant/regenie/step1/run

        :param dict data: Params of regenie-step1 analysis. (REQUIRED)
        :param str study: study.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        :param str job_description: Job description.
        ...
        return self._post(category='analysis', resource='run', subcategory='variant/regenie/step1', data=data, **options)
    ...
    def run_regenie_step2(self, data=None, **options):
        ...
        :param dict data: Params of regenie-step2 analysis. (REQUIRED)
        :param str study: study.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        :param str job_description: Job description.
        ...
        return self._post(category='analysis', resource='run', subcategory='variant/regenie/step2', data=data, **options)
