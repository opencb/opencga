...
WARNING: AUTOGENERATED CODE
    ...
    Autogenerated on: 2020-02-19 12:32:17
...
class Variant(_ParentRestClient):
    ...
    def query(self, **options):
        ...
        :param str info: Filter by INFO attributes from file.
            [{file}:]{key}{op}{value}[,;]* . If no file is specified, will use
            all files from 'file' filter. e.g. AN>200 or
        ...
        :param str format: Filter by any FORMAT field from samples.
        ...
        :param str include_format: List of FORMAT names from Samples Data to
            include in the output. e.g: DP,AD. Accepts 'all' and 'none'.
