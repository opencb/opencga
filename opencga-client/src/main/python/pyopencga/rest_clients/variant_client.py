...
class Variant(_ParentRestClient):
    ...
    def run_regenie(self, data=None, **options):
        """
        Program for whole genome regression modelling of large genome-wide
            association studies.
        PATH: /{apiVersion}/analysis/variant/regenie/run

        :param dict data: Regenie parameters. (REQUIRED)
        :param str study: study.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        :param str job_description: Job description.
        ...
        return self._post(category='analysis', resource='run', subcategory='variant/regenie', data=data, **options)
    ...
    def run_regenie_step2(self, data=None, **options):
        ...
        :param dict data: Regenie step2 parameters. (REQUIRED)
        :param str study: study.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
        :param str job_description: Job description.
