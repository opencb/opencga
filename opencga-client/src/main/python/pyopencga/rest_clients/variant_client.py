...
class Variant(_ParentRestClient):
    ...
    def aggregation_stats(self, **options):
        ...
        return self._get(category='analysis', resource='aggregation_stats', subcategory='variant', **options)
    ...
    def circos(self, **options):
        """
        Generate a Circos plot for a given sample. Use context index.
        PATH: /{apiVersion}/analysis/variant/circos
        ...
        :param bool plot_copy_number: Plot copy-number track.
        :param bool plot_indels: Plot INDELs track.
        :param bool plot_rearrangements: Plot rearrangements track.
        :param str density: Density plot: LOW, MEDIUM or HIGH.
        """

        return self._get(category='analysis', resource='circos', subcategory='variant', **options)
    ...
    def aggregation_stats_sample(self, **options):
        ...
        return self._get(category='analysis', resource='aggregation_stats', subcategory='variant/sample', **options)
