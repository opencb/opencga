...
class Variant(_ParentRestClient):
    ...
    def run_individual_qc(self, data=None, **options):
        ...
        Run quality control (QC) for a given individual. This includes
            inferred sex, Mendelian errors (UDP), and, if parents are present,
            a relatedness analysis is also performed.
    ...
    def run_inferred_sex(self, data=None, **options):
        ...
        :param dict data: Inferred sex analysis parameters. (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
    ...
    def run_mendelian_error(self, data=None, **options):
        ...
        :param dict data: Mendelian error analysis parameters. (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
            study. An ID will be autogenerated automatically if not provided.
