...
WARNING: AUTOGENERATED CODE
    ...
    Autogenerated on: 2020-05-14 10:35:20
...
class Variant(_ParentRestClient):
    ...
    def aggregation_stats(self, **options):
        ...
        :param str sample: Filter variants by sample genotype. This will
            ...
            segregation modes: [ monoallelic, monoallelicIncompletePenetrance,
            biallelic, biallelicIncompletePenetrance, XlinkedBiallelic,
            XlinkedMonoallelic, Ylinked, MendelianError, DeNovo,
            CompoundHeterozygous ]. Value is case insensitive. e.g.
            HG0097:DeNovo Sample must have parents defined and indexed. .
        ...
        :param str family_segregation: Filter by segregation mode from a given
            family. Accepted values: [ monoallelic,
    ...
    def metadata_annotation(self, **options):
        ...
        return self._get('metadata', subcategory='annotation', **options)
    ...
    def query_annotation(self, **options):
        ...
        return self._get('query', subcategory='annotation', **options)
    ...
    def delete_cohort_stats(self, **options):
        ...
        return self._delete('delete', subcategory='cohort/stats', **options)
    ...
    def info_cohort_stats(self, cohort, **options):
        ...
        return self._get('info', subcategory='cohort/stats', **options)
    ...
    def run_cohort_stats(self, data=None, **options):
        ...
        return self._post('run', subcategory='cohort/stats', data=data, **options)
    ...
    def run_export(self, data=None, **options):
        ...
        return self._post('run', subcategory='export', data=data, **options)
    ...
    def genotypes_family(self, mode_of_inheritance, **options):
        ...
        return self._get('genotypes', subcategory='family', **options)
    ...
    def delete_file(self, **options):
        ...
        return self._delete('delete', subcategory='file', **options)
    ...
    def run_gatk(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: gatk params.
        """

        return self._post('run', subcategory='gatk', data=data, **options)
    ...
    def run_genetic_checks(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Genetic checks analysis params.
        """

        return self._post('run', subcategory='geneticChecks', data=data, **options)
    ...
    def run_gwas(self, data=None, **options):
        ...
        return self._post('run', subcategory='gwas', data=data, **options)
    ...
    def run_index(self, data=None, **options):
        ...
        return self._post('run', subcategory='index', data=data, **options)
    ...
    def run_inferred_sex(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Inferred sex analysis params.
        """

        return self._post('run', subcategory='inferredSex', data=data, **options)
    ...
    def run_knockout(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Gene knockout analysis params.
        """

        return self._post('run', subcategory='knockout', data=data, **options)
    ...
    def run_mendelian_error(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Mendelian error analysis params.
        """

        return self._post('run', subcategory='mendelianError', data=data, **options)
    ...
    def run_mutational_signature(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Mutational signature analysis params.
        """

        return self._post('run', subcategory='mutationalSignature', data=data, **options)
    ...
    def run_plink(self, data=None, **options):
        ...
        return self._post('run', subcategory='plink', data=data, **options)
    ...
    def run_relatedness(self, data=None, **options):
        ...
        :param str job_depends_on: Comma separated list of existing job ids
            the job will depend on.
        :param str job_tags: Job tags.
        :param dict data: Relatedness analysis params.
        """

        return self._post('run', subcategory='relatedness', data=data, **options)
    ...
    def run_rvtests(self, data=None, **options):
        ...
        return self._post('run', subcategory='rvtests', data=data, **options)
    ...
    def run_sample_eligibility(self, data=None, **options):
        ...
        return self._post('run', subcategory='sample/eligibility', data=data, **options)
    ...
    def query_sample(self, **options):
        ...
        return self._get('query', subcategory='sample', **options)
    ...
    def run_sample(self, data=None, **options):
        ...
        return self._post('run', subcategory='sample', data=data, **options)
    ...
    def delete_sample_stats(self, **options):
        ...
        return self._delete('delete', subcategory='sample/stats', **options)
    ...
    def info_sample_stats(self, sample, **options):
        ...
        return self._get('info', subcategory='sample/stats', **options)
    ...
    def run_sample_stats(self, data=None, **options):
        ...
        return self._post('run', subcategory='sample/stats', data=data, **options)
    ...
    def run_stats_export(self, data=None, **options):
        ...
        return self._post('run', subcategory='stats/export', data=data, **options)
    ...
    def run_stats(self, data=None, **options):
        ...
        return self._post('run', subcategory='stats', data=data, **options)
