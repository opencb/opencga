...
class DiseasePanel(_ParentRestClient):
    ...
    def __init__(self, configuration, token=None, login_handler=None, *args, **kwargs):
        _category = 'panels'
        super(DiseasePanel, self).__init__(configuration, _category, token, login_handler, *args, **kwargs)
    ...
    def info(self, panels, **options):
        ...
        :param bool global: Boolean indicating which panels are queried
            (installation or study specific panels).
        """
    ...
    def create(self, data=None, **options):
        ...
        :param str study: Study [[user@]project:]study where study and project
            can be either the ID or UUID.
        :param str import: Comma separated list of installation panel ids to
            be imported. To import them all at once, write the special word
            'ALL_GLOBAL_PANELS'.
