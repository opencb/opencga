...
class Admin(_ParentRestClient):
    ...
    def group_by_audit(self, fields, entity, **options):
        ...
        return self._get(category='admin', resource='group_by', subcategory='audit', **options)
    ...
    def index_stats_catalog(self, **options):
        ...
        return self._post(category='admin', resource='index_stats', subcategory='catalog', **options)
