...
class Alignment(_ParentRestClient):
    ...
    def run_bwa(self, data=None, **options):
        ...
        return self._post('run', subcategory='bwa', data=data, **options)
    ...
    def run_coverage_index(self, data=None, **options):
        ...
        return self._post('run', subcategory='coverage/index', data=data, **options)
    ...
    def stats_coverage(self, file, gene, **options):
        ...
        options['file'] = file
        options['gene'] = gene
        return self._get('stats', subcategory='coverage', **options)
    ...
    def run_deeptools(self, data=None, **options):
        ...
        return self._post('run', subcategory='deeptools', data=data, **options)
    ...
    def run_fastqc(self, data=None, **options):
        ...
        return self._post('run', subcategory='fastqc', data=data, **options)
    ...
    def run_samtools(self, data=None, **options):
        ...
        return self._post('run', subcategory='samtools', data=data, **options)
