...
class VariantOperation(_ParentRestClient):
    ...
    def __init__(self, configuration, token=None, login_handler=None, *args, **kwargs):
        _category = 'operation'
        super(VariantOperation, self).__init__(configuration, _category, token, login_handler, *args, **kwargs)
    ...
    def configure_variant(self, data=None, **options):
        ...
        return self._post('configure', subcategory='variant', data=data, **options)
