...
class User(_ParentRestClient):
    ...
    def __init__(self, configuration, token=None, login_handler=None, *args, **kwargs):
        _category = 'users'
        super(User, self).__init__(configuration, _category, token, login_handler, *args, **kwargs)
    ...
    def filters(self, user, **options):
        ...
        return self._get('filters', query_id=user, **options)
    ...
    def update_filters(self, user, data=None, **options):
        ...
        return self._post('update', query_id=user, subcategory='filters', data=data, **options)
    ...
    def update_filter(self, user, filter_id, data=None, **options):
        ...
        return self._post('update', query_id=user, subcategory='filters', second_query_id=filter_id, data=data, **options)
    ...
    def password(self, user, data=None, **options):
        ...
        :param dict data: JSON containing the params 'password' (old password)
            and 'newPassword' (new password). (REQUIRED)
        :param str user: User id. (REQUIRED)
        """
