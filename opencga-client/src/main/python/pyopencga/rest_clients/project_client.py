...
class Project(_ParentRestClient):
    ...
    def aggregation_stats(self, projects, **options):
        ...
        return self._get(category='projects', resource='aggregation_stats', query_id=projects, **options)
    ...
    def inc_release(self, project, **options):
        ...
        return self._post(category='projects', resource='inc_release', query_id=project, **options)
