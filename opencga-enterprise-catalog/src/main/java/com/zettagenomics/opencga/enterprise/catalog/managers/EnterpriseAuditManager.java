...
public class EnterpriseAuditManager extends AuditManager {
    ...
    protected void audit(String organizationId, String userId, AuditAction action, Enums.Resource resource,
    ...
    protected void audit(String organizationId, String userId, AuditAction action, Enums.Resource resource, String resourceId,
    ...
    protected void audit(String organizationId, String operationId, String userId, AuditAction action, Enums.Resource resource,
                         String resourceId, String resourceUuid, String studyId, String studyUuid, ObjectMap params,
