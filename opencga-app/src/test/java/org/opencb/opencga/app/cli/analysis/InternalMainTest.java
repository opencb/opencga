...
//        Job job;
        ...
        File file1 = opencga.createFile(studyId, "1000g_batches/1-50.filtered.10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        File file2 = opencga.createFile(studyId, "1000g_batches/51-100.filtered.10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        File file3 = opencga.createFile(studyId, "1000g_batches/101-150.filtered.10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        File file4 = opencga.createFile(studyId, "1000g_batches/151-200.filtered.10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        File file5 = opencga.createFile(studyId, "1000g_batches/201-250.filtered.10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        ...
        execute("variant", "index",
                ...
                "--file", file1.getPath());
        assertEquals(VariantIndexStatus.READY, catalogManager.getFileManager().get(studyId, file1.getId(), null, sessionId).first().getInternal().getVariant().getIndex().getStatus().getId());

        assertEquals(CohortStatus.NONE, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "ALL"), null, sessionId).first().getInternal().getStatus().getId());
...
//        assertEquals(outdirId, job.getOutDir().getId());
        ...
        assertEquals(VariantIndexStatus.READY, catalogManager.getFileManager().get(studyId, file2.getId(), null, sessionId).first().getInternal().getVariant().getIndex()
                .getStatus().getId());
        assertEquals(CohortStatus.READY, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "ALL"), null, sessionId).first().getInternal().getStatus().getId());
...
//        assertEquals(outdirId, job.getOutDir().getId());
        ...
        assertEquals(VariantIndexStatus.READY, catalogManager.getFileManager().get(studyId, file3.getId(), null, sessionId).first().getInternal().getVariant().getIndex().getStatus().getId());
        assertEquals(CohortStatus.INVALID, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "ALL"), null, sessionId).first().getInternal().getStatus().getId());
...
//        assertEquals(Job.JobStatus.READY, job.getStatus().getName());
        ...
        execute("variant", "index",
                ...
                "--annotate");
        assertEquals(VariantIndexStatus.READY, catalogManager.getFileManager().get(studyId, file5.getId(), null, sessionId).first().getInternal().getVariant().getIndex().getStatus().getId());
        assertEquals(CohortStatus.INVALID, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "ALL"), null, sessionId).first().getInternal().getStatus().getId());
...
//        assertEquals(Job.JobStatus.READY, job.getStatus().getName());
        ...
        catalogManager.getCohortManager().create(studyId, new CohortCreateParams("coh1", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null, null,
        ...
        catalogManager.getCohortManager().create(studyId, new CohortCreateParams("coh2", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null, null,
        ...
        assertEquals(CohortStatus.READY, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "coh1"), null, sessionId).first().getInternal().getStatus().getId());
        assertEquals(CohortStatus.NONE, catalogManager.getCohortManager().search(studyId, new Query(CohortDBAdaptor.QueryParams.ID.key(), "coh2"), null, sessionId).first().getInternal().getStatus().getId());
...
//        File file1 = opencga.createFile(studyId, "10k.chr22.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz", sessionId);
        ...
        String c1 = catalogManager.getCohortManager().create(studyId, new CohortCreateParams("C1", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null,
        ...
        String c2 = catalogManager.getCohortManager().create(studyId, new CohortCreateParams("C2", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null,
        ...
        String c3 = catalogManager.getCohortManager().create(studyId, new CohortCreateParams("C3", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null,
        ...
        String c4 = catalogManager.getCohortManager().create(studyId, new CohortCreateParams("C4", "", Enums.CohortType.CONTROL_SET, Collections.emptyList(), "", null,
