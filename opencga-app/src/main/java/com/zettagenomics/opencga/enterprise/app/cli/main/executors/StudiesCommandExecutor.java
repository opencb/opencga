...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.StudiesCommandOptions;
 ...
 */
public class StudiesCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Group> syncGroups() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseStudyClient().syncGroups(commandOptions.study, groupSyncParams);
    }
    ...
    private RestResponse<Note> createNotes() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseStudyClient().createNotes(commandOptions.study, noteCreateParams, queryParams);
    }
    ...
    private RestResponse<Note> searchNotes() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseStudyClient().searchNotes(commandOptions.study, queryParams);
    }
    ...
    private RestResponse<Note> updateNotes() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseStudyClient().updateNotes(commandOptions.study, commandOptions.id, noteUpdateParams, queryParams);
    }
    ...
    private RestResponse<Object> syncUsers() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseStudyClient().syncUsers(commandOptions.study, commandOptions.authenticationOriginId);
    }
