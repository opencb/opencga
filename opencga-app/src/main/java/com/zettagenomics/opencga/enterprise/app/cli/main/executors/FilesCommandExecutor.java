...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.FilesCommandOptions;
 ...
 */
public class FilesCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<File> upload() throws Exception {
        ...
        queryParams.putIfNotNull("format", commandOptions.format);
    ...
    private RestResponse<File> updateUri() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseFileClient().updateUri(fileUriChangeRestParam, queryParams);
    }
    ...
    private RestResponse<File> updateContent() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseFileClient().updateContent(commandOptions.file, fileContentUpdateParams, queryParams);
    }
    ...
    private RestResponse<File> move() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseFileClient().move(commandOptions.file, fileMoveParams, queryParams);
    }
