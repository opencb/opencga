...
public class DiseasePanelCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getDiseasePanelClient().updateAcl(commandOptions.members,commandOptions.action.name(), panelAclUpdateParams, queryParams);
    }
    ...
    private RestResponse<DiseasePanel> distinct() throws ClientException {
        ...
        return openCGAClient.getDiseasePanelClient().distinct(commandOptions.field.name(), queryParams);
    }
