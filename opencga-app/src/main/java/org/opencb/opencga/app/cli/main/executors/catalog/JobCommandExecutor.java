...
public class JobCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getJobClient().updateAcl(commandOptions.members,commandOptions.action.name(), jobAclUpdateParams);
    }
    ...
    private RestResponse<Job> distinct() throws ClientException {
        ...
        return openCGAClient.getJobClient().distinct(commandOptions.field.name(), queryParams);
    }
