...
import org.opencb.opencga.app.cli.main.parent.ParentProjectsCommandExecutor;
 ...
 */
public class ProjectsCommandExecutor extends ParentProjectsCommandExecutor {

    private ProjectsCommandOptions projectsCommandOptions;

    public ProjectsCommandExecutor(ProjectsCommandOptions projectsCommandOptions) {
        super(projectsCommandOptions.commonCommandOptions, getParsedSubCommand(projectsCommandOptions.jCommander).startsWith("log"),projectsCommandOptions);
