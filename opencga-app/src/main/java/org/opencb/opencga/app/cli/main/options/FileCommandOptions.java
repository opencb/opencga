...
//excluded upload
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"-s","--study"}, description = "Comma separated list of Studies [[user@]project:]study where study and "
                              + "project can be either the ID or UUID up to a maximum of 100", required = false, arity = 1)
        public String study; 
