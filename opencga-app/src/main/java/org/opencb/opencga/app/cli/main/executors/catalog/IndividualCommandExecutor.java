...
public class IndividualCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getIndividualClient().updateAcl(commandOptions.members,commandOptions.action.name(), individualAclUpdateParams, queryParams);
    }
    ...
    private RestResponse<Job> loadAnnotationSets() throws ClientException {
        ...
        return openCGAClient.getIndividualClient().loadAnnotationSets(commandOptions.variableSetId.name(),commandOptions.path.name(), tsvAnnotationParams, queryParams);
    }
    ...
    private RestResponse<Individual> create() throws ClientException {
        ...
        IndividualCreateParams individualCreateParams = new IndividualCreateParams()
                ...
                .setFather(commandOptions.father)
                .setMother(commandOptions.mother)
    ...
    private RestResponse<Individual> distinct() throws ClientException {
        ...
        queryParams.putIfNotEmpty("karyotypicSex", commandOptions.karyotypicSex);
        queryParams.putIfNotEmpty("lifeStatus", commandOptions.lifeStatus);
        queryParams.putIfNotEmpty("affectationStatus", commandOptions.affectationStatus);
        ...
        return openCGAClient.getIndividualClient().distinct(commandOptions.field.name(), queryParams);
    }
    ...
    private RestResponse<Individual> updateAnnotations() throws ClientException {
        ...
        return openCGAClient.getIndividualClient().updateAnnotations(commandOptions.individual,commandOptions.annotationSet, queryParams);
    }
