...
public class MigrationCommandOptions extends GeneralCliOptions {
    ...
    private final MigrateV2_0_5CommandOptions migrateV205CommandOptions;
    ...
    public MigrationCommandOptions(JCommander jCommander, AdminCliOptionsParser.AdminCommonCommandOptions commonOptions) {
        ...
        this.migrateV205CommandOptions = new MigrateV2_0_5CommandOptions();
    }
    ...
    @Parameters(commandNames = {"v2.0.5"}, commandDescription = "Migrate OpenCGA from version 2.0.3 to 2.0.5")
    public class MigrateV2_0_5CommandOptions extends AdminCliOptionsParser.CatalogDatabaseCommandOptions {
    ...
    public MigrateV2_0_5CommandOptions getMigrateV205CommandOptions() {
        return migrateV205CommandOptions;
    }
