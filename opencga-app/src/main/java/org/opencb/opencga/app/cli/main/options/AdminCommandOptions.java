...
public class AdminCommandOptions {
        ...
        public UpdateUsersGroupsCommandOptions updateUsersGroupsCommandOptions;
    ...
    public AdminCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.updateUsersGroupsCommandOptions = new UpdateUsersGroupsCommandOptions();
    ...
    public class InstallCatalogCommandOptions {
        ...
        @Parameter(names = {"--secret-key"}, description = "The body secretKey InstallationParams web service parameter", required = false, arity = 1)
        public String secretKey;
    
        @Parameter(names = {"--password"}, description = "The body password InstallationParams web service parameter", required = false, arity = 1)
        public String password;
    
        @Parameter(names = {"--email"}, description = "The body email InstallationParams web service parameter", required = false, arity = 1)
        public String email;
    
        @Parameter(names = {"--organization"}, description = "The body organization InstallationParams web service parameter", required = false, arity = 1)
    ...
    public class JwtCatalogCommandOptions {
        ...
        @Parameter(names = {"--secret-key"}, description = "The body secretKey JWTParams web service parameter", required = false, arity = 1)
        public String secretKey;
    ...
    public class CreateUsersCommandOptions {
        ...
        @Parameter(names = {"--id"}, description = "The body id UserCreateParams web service parameter", required = false, arity = 1)
        public String id;
    
        @Parameter(names = {"--name", "-n"}, description = "The body name UserCreateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--email"}, description = "The body email UserCreateParams web service parameter", required = false, arity = 1)
        public String email;
    
        @Parameter(names = {"--password"}, description = "The body password UserCreateParams web service parameter", required = false, arity = 1)
        public String password;
    
        @Parameter(names = {"--organization"}, description = "The body organization UserCreateParams web service parameter", required = false, arity = 1)
        public String organization;
    
        @Parameter(names = {"--type"}, description = "The body type UserCreateParams web service parameter", required = false, arity = 1)
        public String type;
    ...
    public class ImportUsersCommandOptions {
        ...
        @Parameter(names = {"--authentication-origin-id"}, description = "The body authenticationOriginId UserImportParams web service parameter", required = false, arity = 1)
        public String authenticationOriginId;
    
        @Parameter(names = {"--id"}, description = "The body id UserImportParams web service parameter", required = false, arity = 1)
        public String id;
    
        @Parameter(names = {"--resource-type"}, description = "The body resourceType UserImportParams web service parameter", required = false, arity = 1)
        public String resourceType;
    
        @Parameter(names = {"--study", "-s"}, description = "The body study UserImportParams web service parameter", required = false, arity = 1)
        public String study;
    
        @Parameter(names = {"--study-group"}, description = "The body studyGroup UserImportParams web service parameter", required = false, arity = 1)
    ...
    public class SyncUsersCommandOptions {
        ...
        @Parameter(names = {"--authentication-origin-id"}, description = "The body authenticationOriginId GroupSyncParams web service parameter", required = false, arity = 1)
        public String authenticationOriginId;
    
        @Parameter(names = {"--from"}, description = "The body from GroupSyncParams web service parameter", required = false, arity = 1)
        public String from;
    
        @Parameter(names = {"--to"}, description = "The body to GroupSyncParams web service parameter", required = false, arity = 1)
        public String to;
    ...
    @Parameters(commandNames = {"users-groups-update"}, commandDescription ="Add or remove users from existing groups")
    public class UpdateUsersGroupsCommandOptions {
