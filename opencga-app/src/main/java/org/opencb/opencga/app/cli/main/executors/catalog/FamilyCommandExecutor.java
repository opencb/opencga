...
public class FamilyCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getFamilyClient().updateAcl(commandOptions.members,commandOptions.action.name(), familyAclUpdateParams, queryParams);
    }
    ...
    private RestResponse<Job> loadAnnotationSets() throws ClientException {
        ...
        return openCGAClient.getFamilyClient().loadAnnotationSets(commandOptions.variableSetId.name(),commandOptions.path.name(), tsvAnnotationParams, queryParams);
    }
    ...
    private RestResponse<Family> distinct() throws ClientException {
        ...
        return openCGAClient.getFamilyClient().distinct(commandOptions.field.name(), queryParams);
    }
    ...
    private RestResponse<Family> updateAnnotations() throws ClientException {
        ...
        return openCGAClient.getFamilyClient().updateAnnotations(commandOptions.family,commandOptions.annotationSet, queryParams);
    }
