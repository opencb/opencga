...
public class AlignmentCommandOptions {
    ...
    public class RunBwaCommandOptions {
        ...
        @Parameter(names = {"--fastq1-file"}, description = "The body web service fastq1File parameter", required = false, arity = 1)
        public String fastq1File; 
    
        @Parameter(names = {"--fastq2-file"}, description = "The body web service fastq2File parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--bwa-params"}, description = "The body web service bwaParams parameter", required = false, arity = 1)
        public Map bwaParams; 
    ...
    public class RunDeeptoolsCommandOptions {
        ...
        @Parameter(names = {"--deeptools-params"}, description = "The body web service deeptoolsParams parameter",
                              required = false, arity = 1)
        public Map deeptoolsParams; 
    ...
    public class RunFastqcCommandOptions {
        ...
        @Parameter(names = {"--fastqc-params"}, description = "The body web service fastqcParams parameter", required = false, arity = 1)
        public Map fastqcParams; 
    ...
    public class RunPicardCommandOptions {
        ...
        @Parameter(names = {"--picard-params"}, description = "The body web service picardParams parameter", required = false, arity = 1)
        public Map picardParams; 
    ...
    public class RunSamtoolsCommandOptions {
        ...
        @Parameter(names = {"--samtools-params"}, description = "The body web service samtoolsParams parameter",
                              required = false, arity = 1)
        public Map samtoolsParams; 
