...
//                custom();
    ...
    private void team() throws Exception {
        ...
        // Run interpretation
        TeamAnalysis teamAnalysis = new TeamAnalysis(Paths.get(configuration.getDataDir()).getParent().toString(),
                studyStr, token, clinicalAnalysisId, panelList, teamAnalysisOptions);
    ...
    private void tiering() throws Exception {
        ...
        // Run interpretation
        TieringAnalysis tieringAnalysis = new TieringAnalysis(Paths.get(configuration.getDataDir()).getParent().toString(),
                studyStr, token, clinicalAnalysisId, panelList, tieringAnalysisOptions);
