...
public class JobsCommandOptions extends ParentJobsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--input-path"}, description = "The body web service path parameter", required = false, arity = 1)
        public String inputPath; 
    
        @Parameter(names = {"--output-path"}, description = "The body web service path parameter", required = false, arity = 1)
