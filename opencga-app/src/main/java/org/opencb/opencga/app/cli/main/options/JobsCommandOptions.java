...
public class JobsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--tool-id"}, description = "The body web service id parameter", required = true, arity = 1)
        public String toolId;
        ...
        @Parameter(names = {"--result-id"}, description = "The body web service id parameter", required = true, arity = 1)
