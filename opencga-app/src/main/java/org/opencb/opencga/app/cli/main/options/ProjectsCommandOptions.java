...
public class ProjectsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name ProjectCreateParams web service parameter", required = false, arity = 1)
        public String name;
        ...
        @Parameter(names = {"--organism-scientific-name"}, description = "The body scientificName ProjectOrganism web service parameter", required = false, arity = 1)
        public String organismScientificName;
    
        @Parameter(names = {"--organism-common-name"}, description = "The body commonName ProjectOrganism web service parameter", required = false, arity = 1)
        public String organismCommonName;
    
        @Parameter(names = {"--organism-assembly"}, description = "The body assembly ProjectOrganism web service parameter", required = false, arity = 1)
