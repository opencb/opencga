 ...
 */
public abstract class ParentUserCommandExecutor extends OpencgaCommandExecutor {
    // TODO: Add include/exclude/skip/... (queryOptions) to the client calls !!!!

    private UserCommandOptions usersCommandOptions;

    public ParentUserCommandExecutor(GeneralCliOptions.CommonCommandOptions options, boolean command,
                                     UserCommandOptions usersCommandOptions) {
