...
/**
 * This class contains methods for the Cohort command line.
 *    Command line version: 1.0
 *    PATH: cohorts
 */
@Parameters(commandNames = {"cohorts"}, commandDescription = "Cohort commands")
public class CohortCommandOptions {
    ...
    public CohortCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    @Parameters(commandNames = {"aggregation-stats"}, commandDescription = "Fetch catalog cohort stats.")
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--variable-set"}, description = "Deprecated: Use /generate web service and filter by annotation",
                              required = false, arity = 1)
        public String variableSet; 
    
        @Parameter(names = {"--variable"}, description = "Deprecated: Use /generate web service and filter by annotation",
                              required = false, arity = 1)
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--samples"}, description = "Sample list", required = false, arity = 1)
    ...
    public class SearchCommandOptions {
        ...
        @Parameter(names = {"--name"}, description = "DEPRECATED: Name of the cohort", required = false, arity = 1)
        public String name; 
    ...
    @Parameters(commandNames = {"acl"}, commandDescription = "Return the acl of the cohort. If member is provided, it will only return "
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"--cohorts"}, description = "Comma separated list of cohort names or IDs up to a maximum of 100",
                              required = true, arity = 1)
