...
public class OpencgaCliOptionsParser extends ParentCliOptionsParser {
    ...
    public OpencgaCliOptionsParser() {
        ...
        studiesSubCommands.addCommand("pipelines", studiesCommandOptions.pipelinesCommandOptions);
        studiesSubCommands.addCommand("pipelines-update", studiesCommandOptions.updatePipelinesCommandOptions);
