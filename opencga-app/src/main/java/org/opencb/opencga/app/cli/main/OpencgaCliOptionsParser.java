/*
 * Copyright 2015-2022-01-18 OpenCB
 *
 ...
 *    Command line commit: 4a34d398a9fa7a1a194d8b76d49b354586b155ee
 */
...
public class OpencgaCliOptionsParser extends ParentCliOptionsParser {
    ...
    public OpencgaCliOptionsParser() {
        ...
        usersSubCommands.addCommand("reset-password", usersCommandOptions.resetPasswordCommandOptions);
        ...
        studiesSubCommands.addCommand("delete-templates", studiesCommandOptions.deleteTemplatesCommandOptions);
        ...
        operationsVariantStorageSubCommands.addCommand("delete-variant-study", operationsVariantStorageCommandOptions.deleteVariantStudyCommandOptions);
    ...
    public boolean isValid(String parsedCommand) {
        ...
        if (StringUtils.isEmpty(parsedCommand)) {
            ...
            CommandLineUtils.debug("IS EMPTY COMMAND " + parsedCommand);
            return false;
        } else {
            // 2. Check if a subcommand has been provided
            String parsedSubCommand = getSubCommand();
            CommandLineUtils.debug("PARSED SUBCOMMAND " + parsedCommand);
