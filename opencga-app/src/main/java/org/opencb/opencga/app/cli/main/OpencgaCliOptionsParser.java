/*
* Copyright 2015-2022-08-11 OpenCB
*
...
*    Command line commit: 0a5785a7377e342bf2d664ab4e8541d3ab56f8d1
*/
...
public class OpencgaCliOptionsParser extends ParentCliOptionsParser {
    ...
    public OpencgaCliOptionsParser() {
        ...
        analysisClinicalSubCommands.addCommand(CANCER_TIERING_INTERPRETATION_RUN_COMMAND, analysisClinicalCommandOptions.runInterpreterCancerTieringCommandOptions);
        analysisClinicalSubCommands.addCommand(EXOMISER_INTERPRETATION_RUN_COMMAND, analysisClinicalCommandOptions.runInterpreterExomiserCommandOptions);
        analysisClinicalSubCommands.addCommand(TEAM_INTERPRETATION_RUN_COMMAND, analysisClinicalCommandOptions.runInterpreterTeamCommandOptions);
        analysisClinicalSubCommands.addCommand(TIERING_INTERPRETATION_RUN_COMMAND, analysisClinicalCommandOptions.runInterpreterTieringCommandOptions);
        analysisClinicalSubCommands.addCommand(ZETTA_INTERPRETATION_RUN_COMMAND, analysisClinicalCommandOptions.runInterpreterZettaCommandOptions);
