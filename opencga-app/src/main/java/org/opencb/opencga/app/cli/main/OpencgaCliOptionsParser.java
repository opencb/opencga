...
public class OpencgaCliOptionsParser extends CliOptionsParser {
    ...
    public OpencgaCliOptionsParser() {
        ...
        jCommander.addCommand("analysis/clinical", clinicalAnalysisCommandOptions);
        JCommander clinicalAnalysisSubCommands = jCommander.getCommands().get("analysis/clinical");
