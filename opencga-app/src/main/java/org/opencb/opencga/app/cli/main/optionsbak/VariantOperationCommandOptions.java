...
public class VariantOperationCommandOptions {
    ...
    public class ConfigureSampleIndexCommandOptions {
        ...
        @Parameter(names = {"--default_file_position_size_bits"}, description = "The body web service DEFAULT_FILE_POSITION_SIZE_BITS "
                              + "parameter", required = false, arity = 1)
        public int defaultFilePositionSizeBits; 
