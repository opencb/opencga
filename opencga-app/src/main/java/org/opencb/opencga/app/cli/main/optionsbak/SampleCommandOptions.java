...
/**
 * This class contains methods for the Sample command line.
 *    Command line version: 1.0
 *    PATH: samples
 */
@Parameters(commandNames = {"samples"}, commandDescription = "Sample commands")
public class SampleCommandOptions {
    ...
    public SampleCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    @Parameters(commandNames = {"aggregation-stats"}, commandDescription = "Fetch catalog sample stats.")
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--id"}, description = "Comma separated list sample IDs or UUIDs up to a maximum of 100",
                              required = false, arity = 1)
        public String id; 
        ...
        @Parameter(names = {"--snapshot"}, description = "Snapshot value (Latest version of the entry in the specified release)",
                              required = false, arity = 1)
        public int snapshot; 
    ...
    public class SearchCommandOptions {
        ...
        @Parameter(names = {"--stats-id"}, description = "Sample variant stats id. If filtering by other stats fields and not provided, "
                              + "it will be automatically set to ALL", required = false, arity = 1)
        ...
        @Parameter(names = {"--stats-heterozygosity-rate"}, description = "Sample variant stats heterozygosityRate.",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--stats-clinical-significance-count"}, description = "Sample variant stats clinicalSignificanceCount.",
                              required = false, arity = 1)
        public String statsClinicalsignificancecount; 
    
        @Parameter(names = {"--stats-consequence-type-count"}, description = "Sample variant stats consequenceTypeCount.",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"acl"}, commandDescription = "Returns the acl of the samples. If member is provided, it will only return "
    ...
    public class DeleteCommandOptions {
        ...
        @Parameter(names = {"--force"}, description = "Force the deletion of samples even if they are associated to files, individuals "
                              + "or cohorts.", required = false, arity = 1)
        public boolean force; 
    
        @Parameter(names = {"--empty-files-action"}, description = "Action to be performed over files that were associated only to the "
                              + "sample to be deleted. Possible actions are NONE, TRASH, DELETE", required = false, arity = 1)
        public String emptyFilesAction; 
    
        @Parameter(names = {"--delete-empty-cohorts"}, description = "Boolean indicating if the cohorts associated only to the sample to "
                              + "be deleted should be also deleted.", required = false, arity = 1)
    ...
    public class InfoCommandOptions {
        ...
        @Parameter(names = {"--version"}, description = "Comma separated list of sample versions. 'all' to get all the sample versions. "
                              + "Not supported if multiple sample ids are provided", required = false, arity = 1)
        public String version; 
