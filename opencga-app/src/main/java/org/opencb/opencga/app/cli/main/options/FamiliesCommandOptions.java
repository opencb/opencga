...
public class FamiliesCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--members-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String membersId; 
    
        @Parameter(names = {"--members-name"}, description = "The body web service name parameter", required = false, arity = 1)
        public String membersName; 
    
        @Parameter(names = {"--members-creation-date"}, description = "The body web service creationDate parameter", required = false, arity = 1)
        public String membersCreationDate; 
    
        @Parameter(names = {"--members-modification-date"}, description = "The body web service modificationDate parameter", required = false, arity = 1)
        public String membersModificationDate; 
    
        @Parameter(names = {"--members-parental-consanguinity"}, description = "The body web service parentalConsanguinity parameter", required = false, arity = 1)
        public Boolean membersParentalConsanguinity; 
    
        @Parameter(names = {"--members-date-of-birth"}, description = "The body web service dateOfBirth parameter", required = false, arity = 1)
        public String membersDateOfBirth; 
        ...
        @Parameter(names = {"--members-karyotypic-sex"}, description = "Enum param allowed values: UNKNOWN, XX, XY, XO, XXY, XXX, XXYY, XXXY, XXXX, XYY, OTHER", required = false, arity = 1)
        public String membersKaryotypicSex; 
    
        @Parameter(names = {"--members-life-status"}, description = "Enum param allowed values: ALIVE, ABORTED, DECEASED, UNBORN, STILLBORN, MISCARRIAGE, UNKNOWN", required = false, arity = 1)
        public String membersLifeStatus; 
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--members-uuid"}, description = "The body web service uuid parameter", required = false, arity = 1)
