...
public class FamiliesCommandOptions {
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--release"}, description = "Release value (Current release from the moment the families were first created)", required = false, arity = 1)
        public String release; 
    
        @Parameter(names = {"--snapshot"}, description = "Snapshot value (Latest version of families in the specified release)", required = false, arity = 1)
        public int snapshot; 
