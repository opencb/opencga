...
public class FamiliesCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--family"}, description = "The body family FamilyAclUpdateParams web service parameter", required = false, arity = 1)
        public String family;
    
        @Parameter(names = {"--individual"}, description = "The body individual FamilyAclUpdateParams web service parameter", required = false, arity = 1)
        public String individual;
    
        @Parameter(names = {"--sample"}, description = "The body sample FamilyAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name FamilyUpdateParams web service parameter", required = false, arity = 1)
        public String name;
        ...
        @Parameter(names = {"--expected-size"}, description = "The body expectedSize FamilyUpdateParams web service parameter", required = false, arity = 1)
        public Integer expectedSize;
