...
public class OrganizationsCommandOptions {
    ...
    public class UpdateConfigurationCommandOptions {
        ...
        @Parameter(names = {"--user-default-expiration-date"}, description = "The body web service defaultExpirationDate parameter", required = false, arity = 1)
        public String userDefaultExpirationDate;
    
        @Parameter(names = {"--user-add-to-study-members"}, description = "The body web service addToStudyMembers parameter", required = false, help = true, arity = 0)
        public boolean userAddToStudyMembers = false;
