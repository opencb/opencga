...
public class SamplesCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--sample"}, description = "The body sample SampleAclUpdateParams web service parameter", required = false, arity = 1)
        public String sample;
    
        @Parameter(names = {"--individual"}, description = "The body individual SampleAclUpdateParams web service parameter", required = false, arity = 1)
        public String individual;
    
        @Parameter(names = {"--family"}, description = "The body family SampleAclUpdateParams web service parameter", required = false, arity = 1)
        public String family;
    
        @Parameter(names = {"--file"}, description = "The body file SampleAclUpdateParams web service parameter", required = false, arity = 1)
        public String file;
    
        @Parameter(names = {"--cohort"}, description = "The body cohort SampleAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--somatic"}, description = "The body somatic SampleCreateParams web service parameter", required = false, arity = 1)
        public Boolean somatic;
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--somatic"}, description = "The body somatic SampleUpdateParams web service parameter", required = false, arity = 1)
        public Boolean somatic;
