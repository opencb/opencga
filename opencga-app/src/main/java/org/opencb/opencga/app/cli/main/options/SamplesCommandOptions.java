...
public class SamplesCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--source-id"}, description = "The body web service id parameter", required = true, arity = 1)
        public String sourceId;
    
        @Parameter(names = {"--source-name"}, description = "The body web service name parameter", required = false, arity = 1)
        public String sourceName;
    
        @Parameter(names = {"--source-description"}, description = "The body web service description parameter", required = false, arity = 1)
        public String sourceDescription;
    
        @Parameter(names = {"--source-source"}, description = "The body web service source parameter", required = false, arity = 1)
        public String sourceSource;
    
        @Parameter(names = {"--source-url"}, description = "The body web service url parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--collection-type"}, description = "The body web service type parameter", required = false, arity = 1)
