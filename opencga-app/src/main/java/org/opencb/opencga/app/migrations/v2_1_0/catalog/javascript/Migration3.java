...
@Migration(id="2.1.0-CATALOG-JS-3", description = "Initialise panels array in Clinical Analysis #1759", version = "2.1.0",
...
public class Migration3 extends MigrationTool {
    ...
    protected void run() throws MigrationException {
        Path path = Paths.get(appHome).resolve("misc/migration/v2.1.0/migration3.js");
        runJavascript(path);
    }
}