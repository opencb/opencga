...
/**
 * This class contains methods for the DiseasePanel command line.
 *    Command line version: 2.1.0
 *    PATH: panels
 */
@Parameters(commandNames = {"disease panels"}, commandDescription = "DiseasePanel commands")
public class DiseasePanelCommandOptions {
    ...
    public DiseasePanelCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--source"}, description = "Comma separated list of sources to import panels from. Current supported sources "
                              + "are 'panelapp' and 'cancer-gene-census'", required = false, arity = 1)
        public String source; 
    
        @Parameter(names = {"--id"}, description = "Comma separated list of panel IDs to be imported from the defined source.If 'source' "
                              + "is provided and 'id' is empty, it will import all the panels from the source. When 'id' is provided, "
                              + "only one 'source' will be allowed.", required = false, arity = 1)
        public String id; 
        ...
        @Parameter(names = {"--stats"}, description = "The body web service stats parameter", required = false, arity = 1)
        public Map stats; 
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--name"}, description = "Panel name", required = false, arity = 1)
        public String name; 
    
        @Parameter(names = {"--phenotypes"}, description = "Panel phenotypes", required = false, arity = 1)
        public String phenotypes; 
    
        @Parameter(names = {"--variants"}, description = "Panel variants", required = false, arity = 1)
        public String variants; 
    
        @Parameter(names = {"--genes"}, description = "Panel genes", required = false, arity = 1)
        public String genes; 
    
        @Parameter(names = {"--regions"}, description = "Panel regions", required = false, arity = 1)
        public String regions; 
    
        @Parameter(names = {"--categories"}, description = "Panel categories", required = false, arity = 1)
        ...
        @Parameter(names = {"--author"}, description = "Panel author", required = false, arity = 1)
        public String author; 
        ...
        @Parameter(names = {"--release"}, description = "Release value (Current release from the moment the samples were first created)",
                              required = false, arity = 1)
        public String release; 
    
        @Parameter(names = {"--snapshot"}, description = "Snapshot value (Latest version of samples in the specified release)",
                              required = false, arity = 1)
        public int snapshot; 
    ...
    @Parameters(commandNames = {"acl"}, commandDescription = "Returns the acl of the panels. If member is provided, it will only return "
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"--panels"}, description = "Comma separated list of panel IDs up to a maximum of 100",
    ...
    public class InfoCommandOptions {
        ...
        @Parameter(names = {"--version"}, description = "Comma separated list of panel versions. 'all' to get all the panel versions. "
                              + "Not supported if multiple panel ids are provided", required = false, arity = 1)
