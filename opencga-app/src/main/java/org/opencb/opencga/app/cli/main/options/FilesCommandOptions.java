...
public class FilesCommandOptions extends ParentFilesCommandOptions {
    ...
    public class LinkCommandOptions {
        ...
        @Parameter(names = {"--related-files-file"}, description = "The body web service file parameter", required = false, arity = 1)
        public String relatedFilesFile; 
        ...
        @Parameter(names = {"--related-files-relation"}, description = "Enum param allowed values: PRODUCED_FROM, PART_OF_PAIR, PEDIGREE, REFERENCE_GENOME", required = false, arity = 1)
        public String relatedFilesRelation; 
