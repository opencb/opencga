...
public class FilesCommandOptions extends ParentFilesCommandOptions {
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--uri"}, description = "Comma separated list of uris", required = false, arity = 1)
        public String uri; 
    ...
    public class LinkCommandOptions {
        ...
        @Parameter(names = {"--uri"}, description = "The body web service uri parameter", required = false, arity = 1)
        public String uri;
    ...
    @Parameters(commandNames = {"run-postlink"}, commandDescription ="Associate non-registered samples for files with high volumes of samples.")
    ...
    public class InfoCommandOptions {
        ...
        @Parameter(names = {"--files"}, description = "Comma separated list of file IDs or names up to a maximum of 100", required = false, arity = 1)
        public String files; 
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--files"}, description = "Comma separated list of file ids, names or paths. Paths must be separated by : instead of /", required = false, arity = 1)
        public String files; 
        ...
        @Parameter(names = {"--software-name", "-n"}, description = "The body web service name parameter", required = false, arity = 1)
        public String softwareName;
    
        @Parameter(names = {"--software-version"}, description = "The body web service version parameter", required = false, arity = 1)
        public String softwareVersion;
    
        @Parameter(names = {"--software-repository"}, description = "The body web service repository parameter", required = false, arity = 1)
        public String softwareRepository;
    
        @Parameter(names = {"--software-commit"}, description = "The body web service commit parameter", required = false, arity = 1)
        public String softwareCommit;
    
        @Parameter(names = {"--software-website"}, description = "The body web service website parameter", required = false, arity = 1)
    ...
    public class DownloadCommandOptions {
        ...
        @Parameter(names = {"--file"}, description = "File id, name or path. Paths must be separated by : instead of /", required = false, arity = 1)
        public String file; 
    ...
    public class TreeCommandOptions {
        ...
        @Parameter(names = {"--folder"}, description = "Folder id or name. Paths must be separated by : instead of /", required = false, arity = 1)
        public String folder; 
