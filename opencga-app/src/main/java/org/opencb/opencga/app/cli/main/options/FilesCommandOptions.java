...
public class FilesCommandOptions extends ParentFilesCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--file"}, description = "The body file FileAclUpdateParams web service parameter", required = false, arity = 1)
        public String file;
    
        @Parameter(names = {"--sample"}, description = "The body sample FileAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--path"}, description = "The body path FileCreateParams web service parameter", required = false, arity = 1)
        public String path;
    
        @Parameter(names = {"--description"}, description = "Field to store information of the item", required = false, arity = 1)
        public String description;
    
        @Parameter(names = {"--type"}, description = "The body type FileCreateParams web service parameter", required = false, arity = 1)
        public String type;
    
        @Parameter(names = {"--format"}, description = "The body format FileCreateParams web service parameter", required = false, arity = 1)
        public String format;
    
        @Parameter(names = {"--bioformat"}, description = "The body bioformat FileCreateParams web service parameter", required = false, arity = 1)
        public String bioformat;
    
        @Parameter(names = {"--sample-ids"}, description = "The body sampleIds FileCreateParams web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--job-id"}, description = "The body jobId FileCreateParams web service parameter", required = false, arity = 1)
        public String jobId;
    ...
    public class LinkCommandOptions {
        ...
        @Parameter(names = {"--path"}, description = "The body path FileLinkParams web service parameter", required = false, arity = 1)
        public String path;
    ...
    public class RunLinkCommandOptions {
        ...
        @Parameter(names = {"--uri", "--input", "-i"}, description = "The body uri FileLinkToolParams web service parameter", required = false, arity = 1)
        public String uri;
    
        @Parameter(names = {"--path"}, description = "The body path FileLinkToolParams web service parameter", required = false, arity = 1)
        public String path;
    ...
    public class RunPostlinkCommandOptions {
        ...
        @Parameter(names = {"--files"}, description = "The body files PostLinkToolParams web service parameter", required = false, arity = 1)
        public String files;
    
        @Parameter(names = {"--batch-size"}, description = "The body batchSize PostLinkToolParams web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--sample-ids"}, description = "The body sampleIds FileUpdateParams web service parameter", required = false, arity = 1)
        public String sampleIds;
    
        @Parameter(names = {"--checksum"}, description = "The body checksum FileUpdateParams web service parameter", required = false, arity = 1)
        public String checksum;
    
        @Parameter(names = {"--format"}, description = "The body format FileUpdateParams web service parameter", required = false, arity = 1)
        public String format;
    
        @Parameter(names = {"--bioformat"}, description = "The body bioformat FileUpdateParams web service parameter", required = false, arity = 1)
        public String bioformat;
        ...
        @Parameter(names = {"--experiment-method"}, description = "The body method FileExperiment web service parameter", required = false, arity = 1)
        public String experimentMethod;
    
        @Parameter(names = {"--experiment-nucleic-acid-type"}, description = "The body nucleicAcidType FileExperiment web service parameter", required = false, arity = 1)
        public String experimentNucleicAcidType;
    
        @Parameter(names = {"--experiment-manufacturer"}, description = "The body manufacturer FileExperiment web service parameter", required = false, arity = 1)
        public String experimentManufacturer;
    
        @Parameter(names = {"--experiment-platform"}, description = "The body platform FileExperiment web service parameter", required = false, arity = 1)
        public String experimentPlatform;
    
        @Parameter(names = {"--experiment-library"}, description = "The body library FileExperiment web service parameter", required = false, arity = 1)
        public String experimentLibrary;
    
        @Parameter(names = {"--experiment-date"}, description = "The body date FileExperiment web service parameter", required = false, arity = 1)
        public String experimentDate;
    
        @Parameter(names = {"--experiment-center"}, description = "The body center FileExperiment web service parameter", required = false, arity = 1)
        public String experimentCenter;
    
        @Parameter(names = {"--experiment-lab"}, description = "The body lab FileExperiment web service parameter", required = false, arity = 1)
        public String experimentLab;
    
        @Parameter(names = {"--experiment-responsible"}, description = "The body responsible FileExperiment web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--size"}, description = "The body size FileUpdateParams web service parameter", required = false, arity = 1)
        public Long size;
