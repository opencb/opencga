...
public class AdminCommandExecutor extends OpencgaCommandExecutor {
    ...
    public void execute() throws Exception {
        ...
        switch (subCommandString) {
            ...
            case "users-groups-update":
                queryResponse = updateUsersGroups();
                break;
            default:
    ...
    private RestResponse<Group> updateUsersGroups() throws Exception {
        logger.debug("Executing updateUsersGroups in Admin command line");

        AdminCommandOptions.UpdateUsersGroupsCommandOptions commandOptions = adminCommandOptions.updateUsersGroupsCommandOptions;
        ...
        return openCGAClient.getAdminClient().updateUsersGroups(commandOptions.user, userUpdateGroup, queryParams);
    }
}