...
public class AdminCliOptionsParser extends CliOptionsParser {
    ...
    public AdminCliOptionsParser() {
        ...
        migrationSubCommands.addCommand("summary", this.migrationCommandOptions.getSummaryCommandOptions());
        ...
        migrationSubCommands.addCommand("v3.0.0", this.migrationCommandOptions.getOrganizationCommandOptions());
