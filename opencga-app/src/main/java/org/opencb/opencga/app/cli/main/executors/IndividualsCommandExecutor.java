...
public class IndividualsCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<FacetField> aggregationStats() throws Exception {
        ...
        queryParams.putIfNotEmpty("analysisPharmacogenomicsSampleId", commandOptions.analysisPharmacogenomicsSampleId);
        queryParams.putIfNotEmpty("analysisPharmacogenomicsSource", commandOptions.analysisPharmacogenomicsSource);
        queryParams.putIfNotEmpty("analysisPharmacogenomicsSummaryActionableResultsGene", commandOptions.analysisPharmacogenomicsSummaryActionableResultsGene);
        queryParams.putIfNotEmpty("analysisPharmacogenomicsSummaryActionableResultsDrugsDrugName", commandOptions.analysisPharmacogenomicsSummaryActionableResultsDrugsDrugName);
