...
public class IndividualsCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<Individual> create() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotNull(beanParams, "body_parentalConsanguinity",commandOptions.bodyParentalConsanguinity, true);
            ...
            putNestedIfNotEmpty(beanParams, "body_dateOfBirth",commandOptions.bodyDateOfBirth, true);
            putNestedIfNotNull(beanParams, "body_karyotypicSex",commandOptions.bodyKaryotypicSex, true);
            putNestedIfNotNull(beanParams, "body_lifeStatus",commandOptions.bodyLifeStatus, true);
