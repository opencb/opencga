...
//            GeneralConfiguration openCGAGeneralConfiguration = getOpenCGAConfiguration();catalogConfiguration
            ...
            WebTarget target = client.target("http://localhost:" + catalogConfiguration.getRest().getPort())
                    .path("opencga")
                    .path("webservices")
                    .path("rest")
                    .path("admin")
...
//            GeneralConfiguration openCGAGeneralConfiguration = getOpenCGAConfiguration();
            Client client = ClientBuilder.newClient();
            WebTarget target = client.target("http://localhost" + catalogConfiguration.getGrpc().getPort())
                    .path("opencga")
                    .path("webservices")
                    .path("rest")
                    .path("admin")
