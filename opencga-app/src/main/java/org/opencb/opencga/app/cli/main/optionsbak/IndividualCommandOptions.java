...
/**
 * This class contains methods for the Individual command line.
...
public class IndividualCommandOptions {
    ...
    public IndividualCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--propagate"}, description = "Propagate individual permissions to related samples",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"aggregation-stats"}, commandDescription = "Fetch catalog individual stats.")
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--samples"}, description = "Comma separated list of sample ids to be associated to the created individual",
                              required = false, arity = 1)
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--father"}, description = "father", required = false, arity = 1)
        public String father; 
    
        @Parameter(names = {"--mother"}, description = "mother", required = false, arity = 1)
        public String mother; 
    
        @Parameter(names = {"--family-ids"}, description = "Comma separated list of family ids the individuals may belong to.",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--population-description"}, description = "Population description", required = false, arity = 1)
        ...
        @Parameter(names = {"--release"}, description = "Release value (Current release from the moment the individuals were first "
                              + "created)", required = false, arity = 1)
        public String release; 
    
        @Parameter(names = {"--snapshot"}, description = "Snapshot value (Latest version of individuals in the specified release)",
                              required = false, arity = 1)
        public int snapshot; 
    ...
    @Parameters(commandNames = {"acl"}, commandDescription = "Return the acl of the individual. If member is provided, it will only "
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"--individuals"}, description = "Comma separated list of individual names or IDs up to a maximum of 100",
                              required = true, arity = 1)
    ...
    public class DeleteCommandOptions {
        ...
        @Parameter(names = {"--force"}, description = "Force the deletion of individuals that already belong to families",
                              required = false, arity = 1)
    ...
    public class InfoCommandOptions {
        ...
        @Parameter(names = {"--version"}, description = "Comma separated list of individual versions. 'all' to get all the individual "
                              + "versions. Not supported if multiple individual ids are provided", required = false, arity = 1)
        public String version; 
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--samples-action"}, description = "Action to be performed if the array of samples is being updated.",
                              required = false, arity = 1)
    ...
    public class UpdateAnnotationsCommandOptions {
        ...
        @Parameter(names = {"--individual"}, description = "Individual ID or UUID", required = true, arity = 1)
