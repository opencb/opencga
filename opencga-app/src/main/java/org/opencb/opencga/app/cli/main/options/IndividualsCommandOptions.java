...
public class IndividualsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--ethnicity-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String ethnicityId;
    
        @Parameter(names = {"--ethnicity-name"}, description = "The body web service name parameter", required = false, arity = 1)
        public String ethnicityName;
    
        @Parameter(names = {"--ethnicity-description"}, description = "The body web service description parameter", required = false, arity = 1)
        public String ethnicityDescription;
    
        @Parameter(names = {"--ethnicity-source"}, description = "The body web service source parameter", required = false, arity = 1)
        public String ethnicitySource;
    
        @Parameter(names = {"--ethnicity-url"}, description = "The body web service url parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--karyotypic-sex"}, description = "Enum param allowed values: UNKNOWN, XX, XY, XO, XXY, XXX, XXYY, XXXY, XXXX, XYY, OTHER", required = false, arity = 1)
        public String karyotypicSex;
    
        @Parameter(names = {"--life-status"}, description = "Enum param allowed values: ALIVE, ABORTED, DECEASED, UNBORN, STILLBORN, MISCARRIAGE, UNKNOWN", required = false, arity = 1)
        public String lifeStatus;
