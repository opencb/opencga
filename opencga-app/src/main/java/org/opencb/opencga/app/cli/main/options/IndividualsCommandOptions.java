...
public class IndividualsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--samples-description"}, description = "The body web service description parameter", required = false, arity = 1)
        public String samplesDescription; 
    
        @Parameter(names = {"--samples-creation-date"}, description = "The body web service creationDate parameter", required = false, arity = 1)
        public String samplesCreationDate; 
    
        @Parameter(names = {"--samples-modification-date"}, description = "The body web service modificationDate parameter", required = false, arity = 1)
        public String samplesModificationDate; 
    
        @Parameter(names = {"--samples-individual-id"}, description = "The body web service individualId parameter", required = false, arity = 1)
        public String samplesIndividualId; 
    
        @Parameter(names = {"--samples-somatic"}, description = "The body web service somatic parameter", required = false, arity = 1)
        public Boolean samplesSomatic; 
        ...
        @Parameter(names = {"--phenotypes-id"}, description = "Id to identify the object", required = false, arity = 1)
        public String phenotypesId; 
    
        @Parameter(names = {"--phenotypes-name"}, description = "Object name", required = false, arity = 1)
        public String phenotypesName; 
    
        @Parameter(names = {"--phenotypes-description"}, description = "Users may provide a description for the entry.", required = false, arity = 1)
        public String phenotypesDescription; 
    
        @Parameter(names = {"--phenotypes-source"}, description = "Ontology source", required = false, arity = 1)
        public String phenotypesSource; 
    
        @Parameter(names = {"--phenotypes-url"}, description = "Ontology url", required = false, arity = 1)
        public String phenotypesUrl; 
    
        @Parameter(names = {"--phenotypes-age-of-onset"}, description = "Indicates the age of on set of the phenotype", required = false, arity = 1)
        public String phenotypesAgeOfOnset; 
    
        @Parameter(names = {"--disorders-id"}, description = "Id to identify the object", required = false, arity = 1)
        public String disordersId; 
    
        @Parameter(names = {"--disorders-name"}, description = "Object name", required = false, arity = 1)
        public String disordersName; 
    
        @Parameter(names = {"--disorders-description"}, description = "Users may provide a description for the entry.", required = false, arity = 1)
        public String disordersDescription; 
    
        @Parameter(names = {"--disorders-source"}, description = "Ontology source", required = false, arity = 1)
        public String disordersSource; 
    
        @Parameter(names = {"--disorders-url"}, description = "Ontology url", required = false, arity = 1)
        public String disordersUrl; 
        ...
        @Parameter(names = {"--phenotypes-status"}, description = "Status of phenotype OBSERVED, NOT_OBSERVED, UNKNOWN", required = false, arity = 1)
        public String phenotypesStatus; 
