...
public class IndividualsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--body_karyotypic-sex"}, description = "Enum param allowed values: UNKNOWN, XX, XY, XO, XXY, XXX, XXYY, XXXY, XXXX, XYY, OTHER", required = false, arity = 1)
        public String bodyKaryotypicSex;
    
        @Parameter(names = {"--body_life-status"}, description = "Enum param allowed values: ALIVE, ABORTED, DECEASED, UNBORN, STILLBORN, MISCARRIAGE, UNKNOWN", required = false, arity = 1)
