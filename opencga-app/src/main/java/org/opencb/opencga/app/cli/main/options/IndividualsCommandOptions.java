...
public class IndividualsCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--individual"}, description = "The body individual IndividualAclUpdateParams web service parameter", required = false, arity = 1)
        public String individual;
    
        @Parameter(names = {"--sample"}, description = "The body sample IndividualAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--father-uuid"}, description = "The body id IndividualReferenceParam web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--mother-uuid"}, description = "The body id IndividualReferenceParam web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name IndividualUpdateParams web service parameter", required = false, arity = 1)
        public String name;
        ...
        @Parameter(names = {"--parental-consanguinity"}, description = "The body parentalConsanguinity IndividualUpdateParams web service parameter", required = false, arity = 1)
        public Boolean parentalConsanguinity;
        ...
        @Parameter(names = {"--date-of-birth"}, description = "The body dateOfBirth IndividualUpdateParams web service parameter", required = false, arity = 1)
        public String dateOfBirth;
    
        @Parameter(names = {"--karyotypic-sex"}, description = "The body karyotypicSex IndividualUpdateParams web service parameter", required = false, arity = 1)
        public String karyotypicSex;
    
        @Parameter(names = {"--life-status"}, description = "The body lifeStatus IndividualUpdateParams web service parameter", required = false, arity = 1)
        public String lifeStatus;
