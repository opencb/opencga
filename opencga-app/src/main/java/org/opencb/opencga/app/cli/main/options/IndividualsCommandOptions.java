...
public class IndividualsCommandOptions {
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--study", "-s"}, description = "Study [[user@]project:]study where study and project can be either the id or alias", required = false, arity = 1)
        public String study; 
        ...
        @Parameter(names = {"--annotationset-name"}, description = "DEPRECATED: Use annotation queryParam this way: annotationSet[=|==|!|!=]{annotationSetName}", required = false, arity = 1)
        public String annotationsetName; 
    
        @Parameter(names = {"--variable-set"}, description = "DEPRECATED: Use annotation queryParam this way: variableSet[=|==|!|!=]{variableSetId}", required = false, arity = 1)
        ...
        @Parameter(names = {"--release"}, description = "Release value (Current release from the moment the individuals were first created)", required = false, arity = 1)
        public String release; 
    
        @Parameter(names = {"--snapshot"}, description = "Snapshot value (Latest version of individuals in the specified release)", required = false, arity = 1)
        public int snapshot; 
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"--individuals"}, description = "Comma separated list of individual names or IDs up to a maximum of 100", required = true, arity = 1)
