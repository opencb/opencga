...
public class StudyCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updateAcl(commandOptions.members,commandOptions.action.name(), studyAclUpdateParams);
    }
    ...
    private RestResponse<Study> search() throws ClientException {
        ...
        return openCGAClient.getStudyClient().search(commandOptions.project.name(), queryParams);
    }
    ...
    private RestResponse<Group> updateGroups() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updateGroups(commandOptions.study, groupCreateParams);
    }
    ...
    private RestResponse<Group> updateUsers() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updateUsers(commandOptions.study,commandOptions.group);
    }
    ...
    private RestResponse<PermissionRule> permissionRules() throws ClientException {
        ...
        return openCGAClient.getStudyClient().permissionRules(commandOptions.study);
    }
    ...
    private RestResponse<PermissionRule> updatePermissionRules() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updatePermissionRules(commandOptions.study, permissionRule);
    }
    ...
    private RestResponse<VariableSet> updateVariableSets() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updateVariableSets(commandOptions.study, variableSetCreateParams);
    }
    ...
    private RestResponse<VariableSet> updateVariables() throws ClientException {
        ...
        return openCGAClient.getStudyClient().updateVariables(commandOptions.study,commandOptions.variableSet, variable);
    }
