...
/**
 * This class contains methods for the Alignment command line.
 *    Command line version: 1.0
 *    PATH: analysis/alignment
 */
@Parameters(commandNames = {"analysis - alignment"}, commandDescription = "Alignment commands")
public class AlignmentCommandOptions {
        ...
        public RunQcGeneCoverageStatsCommandOptions runQcGeneCoverageStatsCommandOptions;
    ...
    public AlignmentCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.runQcGeneCoverageStatsCommandOptions = new RunQcGeneCoverageStatsCommandOptions();
    ...
    @Parameters(commandNames = {"run-bwa"}, commandDescription = "BWA is a software package for mapping low-divergent sequences against a "
    ...
    @Parameters(commandNames = {"run-coverage-index"}, commandDescription = "Compute coverage for a list of alignment files.")
    ...
    @Parameters(commandNames = {"run-qc-gene-coverage-stats"}, commandDescription = "Compute gene coverage stats for a given alignment "
                              + "file and a list of genes.")
    public class RunQcGeneCoverageStatsCommandOptions {
    ...
    @Parameters(commandNames = {"query-coverage"}, commandDescription = "Query the coverage of an alignment file for regions or genes.")
    public class QueryCoverageCommandOptions {
        ...
        @Parameter(names = {"--region"}, description = "Comma separated list of regions 'chr:start-end, e.g.: 2,3:63500-65000",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--range"}, description = "Range of coverage values to be reported. Minimum and maximum values are separated "
                              + "by '-', e.g.: 20-40 (for coverage values greater or equal to 20 and less or equal to 40). A single "
                              + "value means to report coverage values less or equal to that value", required = false, arity = 1)
        public String range; 
    
        @Parameter(names = {"--window-size"}, description = "Window size for the region coverage (if a coverage range is provided, "
                              + "window size must be 1)", required = false, arity = 1)
        public int windowSize; 
    ...
    @Parameters(commandNames = {"ratio-coverage"}, commandDescription = "Compute coverage ratio from file #1 vs file #2, (e.g. somatic vs "
                              + "germline).")
    ...
    @Parameters(commandNames = {"stats-coverage"}, commandDescription = "Compute coverage stats per transcript for a list of genes.")
    public class StatsCoverageCommandOptions {
        ...
        @Parameter(names = {"--threshold"}, description = "Only regions whose coverage depth is under this threshold will be reported.",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-deeptools"}, commandDescription = "Deeptools is a suite of python tools particularly developed for "
                              + "the efficient analysis of high-throughput sequencing data, such as ChIP-seq, RNA-seq or MNase-seq.")
    ...
    @Parameters(commandNames = {"run-fastqc"}, commandDescription = "A high throughput sequence QC analysis tool.")
    ...
    @Parameters(commandNames = {"run-index"}, commandDescription = "Index alignment file.")
    ...
    @Parameters(commandNames = {"run-picard"}, commandDescription = "Picard is a set of command line tools (in Java) for manipulating "
                              + "high-throughput sequencing (HTS) data and formats such as SAM/BAM/CRAM and VCF. Supported Picard "
                              + "commands: CollectHsMetrics, CollectWgsMetrics, BedToIntervalList.")
    ...
    @Parameters(commandNames = {"run-qc"}, commandDescription = "Compute quality control (QC) metrics for a given alignment file "
                              + "(including samtools stats, samtools flag stats, FastQC and HS metrics).")
    ...
    public class QueryCommandOptions {
        ...
        @Parameter(names = {"--region-contained"}, description = "Return alignments contained within boundaries of region",
                              required = false, arity = 1)
        public boolean regionContained; 
    
        @Parameter(names = {"--force-md-field"}, description = "Force SAM MD optional field to be set with the alignments",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-samtools"}, commandDescription = "Samtools is a program for interacting with high-throughput "
                              + "sequencing data in SAM, BAM and CRAM formats. Supported Samtools commands: sort, index, view, stats, "
                              + "flagstat, dict, faidx, depth, plot-bamstats.")
