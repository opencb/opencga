...
public class UserCommandExecutor extends OpencgaCommandExecutor {
    ...
    public UserCommandExecutor(UserCommandOptions userCommandOptions) {
        super(userCommandOptions.commonCommandOptions);
    ...
    private RestResponse<AuthenticationResponse> login() throws ClientException {
        logger.debug("Executing login in User command line");

        UserCommandOptions.LoginCommandOptions commandOptions = userCommandOptions.loginCommandOptions;
        LoginParams loginParams = new LoginParams()
                .setUser(commandOptions.user)
                .setPassword(commandOptions.password)
                .setRefreshToken(commandOptions.refreshToken);

        return openCGAClient.getUserClient().login(loginParams);
    }
    ...
    private RestResponse<ObjectMap> updateConfigs() throws ClientException {
        ...
        return openCGAClient.getUserClient().updateConfigs(commandOptions.user, configUpdateParams);
    }
    ...
    private RestResponse<UserFilter> updateFilters() throws ClientException {
        ...
        return openCGAClient.getUserClient().updateFilters(commandOptions.user, userFilter);
    }
