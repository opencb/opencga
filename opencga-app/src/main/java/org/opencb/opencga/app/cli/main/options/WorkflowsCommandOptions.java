...
public class WorkflowsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--minimum-requirements-cpu"}, description = "Minimum number of cpu cores required to execute the workflow.", required = false, arity = 1)
        public Integer minimumRequirementsCpu;
    
        @Parameter(names = {"--minimum-requirements-memory"}, description = "Minimum memory required to execute the workflow (expressed in GB).", required = false, arity = 1)
        public Integer minimumRequirementsMemory;
    
        @Parameter(names = {"--minimum-requirements-disk"}, description = "Minimum disk required to execute the workflow", required = false, arity = 1)
        public Integer minimumRequirementsDisk;
