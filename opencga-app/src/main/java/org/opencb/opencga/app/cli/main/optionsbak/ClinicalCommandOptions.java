...
/**
 * This class contains methods for the Clinical command line.
 *    Command line version: 1.0
 *    PATH: analysis/clinical
 */
@Parameters(commandNames = {"analysis - clinical"}, commandDescription = "Clinical commands")
public class ClinicalCommandOptions {
    ...
    public ClinicalCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
