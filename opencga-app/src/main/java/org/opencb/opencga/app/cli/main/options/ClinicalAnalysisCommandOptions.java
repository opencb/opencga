...
/**
 * This class contains methods for the ClinicalAnalysis command line.
 *    Command line version: 2.1.0
 *    PATH: analysis/clinical
 */

@Parameters(commandNames = {"analysis - clinical"}, commandDescription = "ClinicalAnalysis commands")
public class ClinicalAnalysisCommandOptions {
    ...
    public ClinicalAnalysisCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--propagate"}, description = "Propagate permissions to related families, individuals, samples and files",
                              required = false, arity = 1)
        public boolean propagate; 
    
        @Parameter(names = {"--clinical-analysis"}, description = "The body web service clinicalAnalysis parameter",
                              required = false, arity = 1)
    ...
    public class UpdateClinicalConfigurationCommandOptions {
        ...
        @Parameter(names = {"--flags"}, description = "The body web service flags parameter", required = false, arity = 1)
        public Map flags; 
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--create-default-interpretation"}, description = "Flag to create and initialise a default primary "
                              + "interpretation (Id will be '{clinicalAnalysisId}.1')", required = false, arity = 1)
    ...
    public class DistinctCommandOptions {
        ...
        @Parameter(names = {"--due-date"}, description = "Due date (Format: yyyyMMddHHmmss. Examples: >2018, 2017-2018, <201805...)",
                              required = false, arity = 1)
        public String dueDate; 
        ...
        @Parameter(names = {"--sample"}, description = "Sample id associated to the proband or any member of a family",
                              required = false, arity = 1)
    ...
    public class InfoInterpretationCommandOptions {
        ...
        @Parameter(names = {"--interpretations"}, description = "Comma separated list of clinical interpretation IDs  up to a maximum of "
                              + "100", required = false, arity = 1)
        ...
        @Parameter(names = {"--version"}, description = "Comma separated list of interpretation versions. 'all' to get all the "
                              + "interpretation versions. Not supported if multiple interpretation ids are provided.",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-interpreter-cancer-tiering"}, commandDescription = "Run cancer tiering interpretation analysis.")
    ...
    public class RunInterpreterTeamCommandOptions {
        ...
        @Parameter(names = {"--family-segregation"}, description = "The body web service familySegregation parameter",
                              required = false, arity = 1)
    ...
    public class RunInterpreterZettaCommandOptions {
        ...
        @Parameter(names = {"--sample-metadata"}, description = "The body web service sampleMetadata parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--cohort-stats-ref"}, description = "The body web service cohortStatsRef parameter",
                              required = false, arity = 1)
        public String cohortStatsRef; 
    
        @Parameter(names = {"--cohort-stats-alt"}, description = "The body web service cohortStatsAlt parameter",
                              required = false, arity = 1)
        public String cohortStatsAlt; 
    
        @Parameter(names = {"--cohort-stats-maf"}, description = "The body web service cohortStatsMaf parameter",
                              required = false, arity = 1)
        public String cohortStatsMaf; 
    
        @Parameter(names = {"--cohort-stats-mgf"}, description = "The body web service cohortStatsMgf parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--family-disorder"}, description = "The body web service familyDisorder parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--protein-substitution"}, description = "The body web service proteinSubstitution parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--population-frequency-alt"}, description = "The body web service populationFrequencyAlt parameter",
                              required = false, arity = 1)
        public String populationFrequencyAlt; 
    
        @Parameter(names = {"--population-frequency-ref"}, description = "The body web service populationFrequencyRef parameter",
                              required = false, arity = 1)
        public String populationFrequencyRef; 
    
        @Parameter(names = {"--population-frequency-maf"}, description = "The body web service populationFrequencyMaf parameter",
                              required = false, arity = 1)
        public String populationFrequencyMaf; 
    
        @Parameter(names = {"--transcript-flag"}, description = "The body web service transcriptFlag parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--protein-keyword"}, description = "The body web service proteinKeyword parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--functional-score"}, description = "The body web service functionalScore parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--clinical-significance"}, description = "The body web service clinicalSignificance parameter",
                              required = false, arity = 1)
        public String clinicalSignificance; 
    
        @Parameter(names = {"--clinical-confirmed-status"}, description = "The body web service clinicalConfirmedStatus parameter",
                              required = false, arity = 1)
        public boolean clinicalConfirmedStatus; 
    
        @Parameter(names = {"--custom-annotation"}, description = "The body web service customAnnotation parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--panel-mode-of-inheritance"}, description = "The body web service panelModeOfInheritance parameter",
                              required = false, arity = 1)
        public String panelModeOfInheritance; 
    
        @Parameter(names = {"--panel-confidence"}, description = "The body web service panelConfidence parameter",
                              required = false, arity = 1)
        public String panelConfidence; 
    
        @Parameter(names = {"--panel-role-in-cancer"}, description = "The body web service panelRoleInCancer parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"aggregation-stats-rga"}, commandDescription = "RGA aggregation stats.")
    public class AggregationStatsRgaCommandOptions {
        ...
        @Parameter(names = {"--field"}, description = "List of fields separated by semicolons, e.g.: clinicalSignificances;type. For "
                              + "nested fields use >>, e.g.: type>>clinicalSignificances;knockoutType", required = true, arity = 1)
        public String field; 
    ...
    public class QueryRgaGeneCommandOptions {
        ...
        @Parameter(names = {"--include-individual"}, description = "Include only the comma separated list of individuals to the response",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--limit-individual"}, description = "Limit number of individuals returned (default: 1000)",
                              required = false, arity = 1)
    ...
    public class RunRgaIndexCommandOptions {
        ...
        @Parameter(names = {"--auxiliar-index"}, description = "Index auxiliar collection to improve performance assuming RGA is "
                              + "completely indexed.", required = false, arity = 1)
    ...
    @Parameters(commandNames = {"acl"}, commandDescription = "Returns the acl of the clinical analyses. If member is provided, it will "
    ...
    public class AclCommandOptions {
        ...
        @Parameter(names = {"--clinical-analyses"}, description = "Comma separated list of clinical analysis IDs or names up to a "
                              + "maximum of 100", required = true, arity = 1)
    ...
    public class DeleteCommandOptions {
        ...
        @Parameter(names = {"--force"}, description = "Force deletion if the ClinicalAnalysis contains interpretations or is locked",
                              required = false, arity = 1)
        public boolean force; 
    
        @Parameter(names = {"--clinical-analyses"}, description = "Comma separated list of clinical analysis IDs or names up to a "
                              + "maximum of 100", required = false, arity = 1)
        public String clinicalAnalyses; 
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--clinical-analyses"}, description = "Comma separated list of clinical analysis IDs",
                              required = false, arity = 1)
        public String clinicalAnalyses; 
        ...
        @Parameter(names = {"--comments-action"}, description = "Action to be performed if the array of comments is being updated.",
                              required = false, arity = 1)
        public String commentsAction; 
    
        @Parameter(names = {"--flags-action"}, description = "Action to be performed if the array of flags is being updated.",
                              required = false, arity = 1)
        public String flagsAction; 
    
        @Parameter(names = {"--files-action"}, description = "Action to be performed if the array of files is being updated.",
                              required = false, arity = 1)
    ...
    public class InfoCommandOptions {
        ...
        @Parameter(names = {"--clinical-analysis"}, description = "Comma separated list of clinical analysis IDs or names up to a "
                              + "maximum of 100", required = false, arity = 1)
        public String clinicalAnalysis; 
    ...
    public class CreateInterpretationCommandOptions {
        ...
        @Parameter(names = {"-s","--study"}, description = "[[user@]project:]study id", required = false, arity = 1)
        public String study; 
        ...
        @Parameter(names = {"--clinical-analysis-id"}, description = "The body web service clinicalAnalysisId parameter",
                              required = false, arity = 1)
        public String clinicalAnalysisId; 
    ...
    @Parameters(commandNames = {"clear-interpretation"}, commandDescription = "Clear the fields of the main interpretation of the "
                              + "Clinical Analysis.")
    ...
    public class DeleteInterpretationCommandOptions {
        ...
        @Parameter(names = {"--set-as-primary"}, description = "Interpretation id to set as primary from the list of secondaries in case "
                              + "of deleting the actual primary one", required = false, arity = 1)
    ...
    public class MergeInterpretationCommandOptions {
        ...
        @Parameter(names = {"--secondary-interpretation-id"}, description = "Secondary Interpretation ID to merge from",
                              required = false, arity = 1)
        public String secondaryInterpretationId; 
    
        @Parameter(names = {"--findings"}, description = "Comma separated list of findings to merge. If not provided, all findings will "
                              + "be merged.", required = false, arity = 1)
        public String findings; 
    
  }
  
  
    @Parameters(commandNames = {"revert-interpretation"}, commandDescription = "Revert to a previous interpretation version.")
    ...
    public class UpdateInterpretationCommandOptions {
        ...
        @Parameter(names = {"--primary-findings-action"}, description = "Action to be performed if the array of primary findings is "
                              + "being updated.", required = false, arity = 1)
        public String primaryFindingsAction; 
    
        @Parameter(names = {"--methods-action"}, description = "Action to be performed if the array of methods is being updated.",
                              required = false, arity = 1)
        public String methodsAction; 
    
        @Parameter(names = {"--secondary-findings-action"}, description = "Action to be performed if the array of secondary findings is "
                              + "being updated.", required = false, arity = 1)
        public String secondaryFindingsAction; 
    
        @Parameter(names = {"--comments-action"}, description = "Action to be performed if the array of comments is being updated. To "
                              + "REMOVE or REPLACE, the date will need to be provided to identify the comment.",
                              required = false, arity = 1)
        public String commentsAction; 
