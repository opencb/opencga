 ...
 */
@Parameters(commandNames = {"analysis - alignment"}, commandDescription = "Analysis - Alignment commands")
public class AnalysisAlignmentCommandOptions {
    ...
    @Parameters(commandNames = {"run-bwa"}, commandDescription ="BWA is a software package for mapping low-divergent sequences against a large reference genome.")
    ...
    @Parameters(commandNames = {"run-qc-geneCoverageStats"}, commandDescription ="Compute gene coverage stats for a given alignment file and a list of genes")
    ...
    @Parameters(commandNames = {"ratio-coverage"}, commandDescription ="Compute coverage ratio from file #1 vs file #2, (e.g. somatic vs germline)")
    ...
    @Parameters(commandNames = {"run-deeptools"}, commandDescription ="Deeptools is a suite of python tools particularly developed for the efficient analysis of high-throughput sequencing data, such as ChIP-seq, RNA-seq or MNase-seq.")
    ...
    @Parameters(commandNames = {"run-picard"}, commandDescription ="Picard is a set of command line tools (in Java) for manipulating high-throughput sequencing (HTS) data and formats such as SAM/BAM/CRAM and VCF. Supported Picard commands: CollectHsMetrics, CollectWgsMetrics, BedToIntervalList")
    ...
    @Parameters(commandNames = {"run-qc"}, commandDescription ="Compute quality control (QC) metrics for a given alignment file (including samtools stats, samtools flag stats, FastQC and HS metrics)")
    ...
    @Parameters(commandNames = {"run-samtools"}, commandDescription ="Samtools is a program for interacting with high-throughput sequencing data in SAM, BAM and CRAM formats. Supported Samtools commands: sort, index, view, stats, flagstat, dict, faidx, depth, plot-bamstats")
