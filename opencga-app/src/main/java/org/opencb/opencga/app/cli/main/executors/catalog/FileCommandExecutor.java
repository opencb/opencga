...
public class FileCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws ClientException {
        ...
        return openCGAClient.getFileClient().updateAcl(commandOptions.members,commandOptions.action.name(), fileAclUpdateParams, queryParams);
    }
    ...
    private RestResponse<Job> loadAnnotationSets() throws ClientException {
        ...
        return openCGAClient.getFileClient().loadAnnotationSets(commandOptions.variableSetId.name(),commandOptions.path.name(), tsvAnnotationParams, queryParams);
    }
    ...
    private RestResponse<File> distinct() throws ClientException {
        ...
        return openCGAClient.getFileClient().distinct(commandOptions.field.name(), queryParams);
    }
    ...
    private RestResponse<File> updateAnnotations() throws ClientException {
        ...
        return openCGAClient.getFileClient().updateAnnotations(commandOptions.file,commandOptions.annotationSet, queryParams);
    }
