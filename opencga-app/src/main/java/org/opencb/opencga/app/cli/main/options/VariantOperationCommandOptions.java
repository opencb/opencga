...
public class VariantOperationCommandOptions {
    ...
    public class ConfigureVariantCommandOptions {
        ...
        @Parameter(names = {"--object-map"}, description = "The body web service objectMap parameter", required = false, arity = 1)
    ...
    public class IndexVariantFamilyCommandOptions {
        ...
        @Parameter(names = {"--skip-incomplete-families"}, description = "The body web service skipIncompleteFamilies parameter",
                              required = false, arity = 1)
    ...
    public class RepairVariantMetadataCommandOptions {
        ...
        @Parameter(names = {"--samples-batch-size"}, description = "The body web service samplesBatchSize parameter",
                              required = false, arity = 1)
    ...
    public class IndexVariantStatsCommandOptions {
        ...
        @Parameter(names = {"--overwrite-stats"}, description = "The body web service overwriteStats parameter",
                              required = false, arity = 1)
