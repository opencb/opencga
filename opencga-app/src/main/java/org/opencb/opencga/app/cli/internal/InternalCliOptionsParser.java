...
//        variantSubCommands.addCommand("ibs", variantCommandOptions.ibsVariantCommandOptions);
        ...
        variantSubCommands.addCommand(JULIE_RUN_COMMAND, variantCommandOptions.julieRunCommandOptions);
        ...
        variantSubCommands.addCommand(FAMILY_QC_RUN_COMMAND, variantCommandOptions.familyVariantQcCommandOptions);
        variantSubCommands.addCommand(INDIVIDUAL_QC_RUN_COMMAND, variantCommandOptions.individualVariantQcCommandOptions);
        variantSubCommands.addCommand(SAMPLE_QC_RUN_COMMAND, variantCommandOptions.sampleVariantQcCommandOptions);
