/*
* Copyright 2015-2022-05-25 OpenCB
*
...
*    Command line version: 2.3.0-SNAPSHOT
*    Command line commit: 4b0acfc86edba3f106b42ac6da6439344cfd2aa0
*/
...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> jobsList = asList( "aggregationStats","create","distinct","retry","search","top","delete","info","update","head-log","tail-log")
            .stream()
            .map(Candidate::new)
            .collect(toList());
    ...
    private List<Candidate> studiesList = asList( "update-acl","create","search","acl","aggregationStats","info","search-audit","groups","update-groups","update-groups-users","permissionRules","update-permissionRules","pipelines","update-pipelines","run-templates","upload-templates","delete-templates","update","variableSets","update-variableSets","update-variableSets-variables")
            .stream()
            .map(Candidate::new)
            .collect(toList());

    private List<Candidate> filesList = asList( "update-acl","aggregationStats","load-annotationSets","create","distinct","fetch","link","run-link","run-postlink","search","upload","acl","delete","info","unlink","update","update-annotationSets-annotations","download","grep","head","image","refresh","tail","list","tree")
            .stream()
            .map(Candidate::new)
            .collect(toList());
