...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> adminList = asList( "audit-group-by","catalog-index-stats","catalog-install","catalog-jwt","users-create","users-import","users-search","users-sync","users-groups-update")
            .stream()
            .map(Candidate::new)
            .collect(toList());
