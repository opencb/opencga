...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> clinicalList = asList( "acl-update","aggregationstats","annotation-sets-load","clinical-configuration-update","create","distinct","emedgene-import","interpretation-aggregation-stats","interpretation-distinct","interpretation-search","interpretation-info","interpreter","interpreter-exomiser-run","interpreter-rd","interpreter-rd-run","interpreter-run","load","pharmacogenomics-allele-typer","pharmacogenomics-allele-typer-run","pharmacogenomics-annotation-run","pharmacogenomics-openarray-run","pipeline-affy-run","pipeline-genomics-run","pipeline-prepare-run","rga-aggregation-stats","rga-gene-query","rga-gene-summary","rga-index-run","rga-individual-query","rga-individual-summary","rga-variant-query","rga-variant-summary","search","variant-query","acl","delete","update","annotation-sets-annotations-update","info","interpretation-create","interpretation-clear","interpretation-delete","interpretation-revert","interpretation-update","report-update")
            .stream()
            .map(Candidate::new)
            .collect(toList());
