/*
* Copyright 2015-2022-06-14 OpenCB
*
...
*    Command line commit: 49cb0b2b6d94f45db2f0ab7e8b441f6423b99bca
*/
...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> clinicalList = asList( "acl-update","clinical-configuration-update","create","distinct","interpretation-distinct","interpretation-search","interpretation-info","interpreter-cancer-tiering-run","interpreter-team-run","interpreter-tiering-run","interpreter-zetta-run","rga-aggregation-stats","rga-gene-query","rga-gene-summary","rga-index-run","rga-individual-query","rga-individual-summary","rga-variant-query","rga-variant-summary","search","variant-actionable","variant-query","acl","delete","update","info","interpretation-create","interpretation-clear","interpretation-delete","interpretation-revert","interpretation-update")
            .stream()
            .map(Candidate::new)
            .collect(toList());
    ...
    private List<Candidate> usersList = asList( "create","login","password","info","configs","configs-update","filters","filters-update","filters-update","password-reset","projects","update")
            .stream()
            .map(Candidate::new)
            .collect(toList());
