/*
* Copyright 2015-2021-11-26 OpenCB
*
...
*    Command line commit: 4d5bb6ec990f09bd44faf59ea29da520455cf639
*/
...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> studiesList = asList( "update-acl","create","search","acl","aggregationStats","info","search-audit","groups","update-groups","update-users","permissionRules","update-permissionRules","run-templates","update","variableSets","update-variableSets","update-variables")
            .stream()
            .map(Candidate::new)
            .collect(toList());
