...
public abstract class OpenCgaCompleter implements Completer {
    ...
    private List<Candidate> variantList = asList( "aggregationstats","annotation-metadata","annotation-query","circos-run","cohort-stats-delete","cohort-stats-info","cohort-stats-run","exomiser-run","export-run","family-genotypes","family-qc-run","file-delete","gatk-run","genome-plot-run","gwas-run","hr-detect-run","index-run","individual-qc-run","knockout-gene-query","knockout-individual-query","knockout-run","liftover-run","metadata","plink-run","query","rvtests-run","sample-aggregation-stats","sample-eligibility-run","sample-qc-run","sample-query","sample-run","sample-stats-query","sample-stats-run","stats-export-run","stats-run","walker-run")
            .stream()
            .map(Candidate::new)
            .collect(toList());
