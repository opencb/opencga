...
public class StudiesCommandOptions extends ParentStudiesCommandOptions {
    ...
    public class UpdatePipelinesCommandOptions {
        ...
        @Parameter(names = {"--action"}, description = "Action to be performed: ADD, REMOVE or REPLACE a pipeline", required = false, arity = 1)
        public String action; 
        ...
        @Parameter(names = {"--config-retry"}, description = "The body web service retry parameter", required = false, arity = 1)
        public Integer configRetry;
    
        @Parameter(names = {"--config-timeout"}, description = "The body web service timeout parameter", required = false, arity = 1)
