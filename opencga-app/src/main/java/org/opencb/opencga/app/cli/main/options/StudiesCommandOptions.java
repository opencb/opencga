...
public class StudiesCommandOptions extends ParentStudiesCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name StudyCreateParams web service parameter", required = false, arity = 1)
        public String name;
    ...
    public class UpdateGroupsCommandOptions {
        ...
        @Parameter(names = {"--users"}, description = "The body users GroupCreateParams web service parameter", required = false, arity = 1)
        public String users;
    ...
    public class UpdateVariableSetsCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name VariableSetCreateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--unique"}, description = "The body unique VariableSetCreateParams web service parameter", required = false, arity = 1)
        public Boolean unique;
    
        @Parameter(names = {"--confidential"}, description = "The body confidential VariableSetCreateParams web service parameter", required = false, arity = 1)
