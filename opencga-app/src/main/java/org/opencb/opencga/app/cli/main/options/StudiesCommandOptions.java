...
public class StudiesCommandOptions extends ParentStudiesCommandOptions {
        ...
        public PipelinesCommandOptions pipelinesCommandOptions;
        public UpdatePipelinesCommandOptions updatePipelinesCommandOptions;
    ...
    public StudiesCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.pipelinesCommandOptions = new PipelinesCommandOptions();
        this.updatePipelinesCommandOptions = new UpdatePipelinesCommandOptions();
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--type-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String typeId;
    
        @Parameter(names = {"--type-description"}, description = "The body web service description parameter", required = false, arity = 1)
    ...
    @Parameters(commandNames = {"pipelines"}, commandDescription ="Return the pipelines available for the study.")
    public class PipelinesCommandOptions {
        ...
        @Parameter(names = {"--pipeline-id"}, description = "Pipeline id. If provided, it will only fetch the requested pipeline.", required = false, arity = 1)
        public String pipelineId; 
    
  }
    @Parameters(commandNames = {"pipelines-update"}, commandDescription ="Add or remove a pipeline")
    public class UpdatePipelinesCommandOptions {
        ...
        @Parameter(names = {"--disabled"}, description = "The body web service disabled parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--jobs-access-order"}, description = "The body web service accessOrder parameter", required = false, arity = 1)
        public Boolean jobsAccessOrder;
