...
public class StudiesCommandOptions {
    ...
    public class GroupsCommandOptions {
        ...
        @Parameter(names = {"--study"}, description = "Study [[user@]project:]study where study and project can be either the ID or UUID", required = true, arity = 1)
        public String study; 
    ...
    public class UpdateGroupsCommandOptions {
        ...
        @Parameter(names = {"--study"}, description = "Study [[user@]project:]study where study and project can be either the ID or UUID", required = false, arity = 1)
        public String study; 
