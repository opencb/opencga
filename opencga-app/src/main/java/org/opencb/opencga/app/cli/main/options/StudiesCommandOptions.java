...
public class StudiesCommandOptions extends ParentStudiesCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--type-id"}, description = "The body web service id parameter", required = true, arity = 1)
    ...
    @Parameters(commandNames = {"users-update"}, commandDescription ="Add, set or remove users from an existing group")
    ...
    @Parameters(commandNames = {"permissionRules-update"}, commandDescription ="Add or remove a permission rule")
    ...
    @Parameters(commandNames = {"variableSets-update"}, commandDescription ="Add or remove a variableSet")
    ...
    @Parameters(commandNames = {"variables-update"}, commandDescription ="Add or remove variables to a VariableSet")
