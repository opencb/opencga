...
/**
 * This class contains methods for the Variant command line.
 *    Command line version: 2.1.0
 *    PATH: analysis/variant
 */

@Parameters(commandNames = {"analysis - variant"}, commandDescription = "Variant commands")
public class VariantCommandOptions {
    ...
    public VariantCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
    ...
    @Parameters(commandNames = {"aggregation-stats"}, commandDescription = "Calculate and fetch aggregation stats.")
    public class AggregationStatsCommandOptions {
        ...
        @Parameter(names = {"--region"}, description = "List of regions, these can be just a single chromosome name or regions in the "
                              + "format chr:start-end, e.g.: 2,3:100000-200000", required = false, arity = 1)
        public String region; 
    
        @Parameter(names = {"--type"}, description = "List of types, accepted values are SNV, MNV, INDEL, SV, COPY_NUMBER, "
                              + "COPY_NUMBER_LOSS, COPY_NUMBER_GAIN, INSERTION, DELETION, DUPLICATION, TANDEM_DUPLICATION, BREAKEND, "
                              + "e.g. SNV,INDEL", required = false, arity = 1)
        public String type; 
        ...
        @Parameter(names = {"-s","--study"}, description = "Filter variants from the given studies, these can be either the numeric ID "
                              + "or the alias with the format user@project:study", required = false, arity = 1)
        public String study; 
        ...
        @Parameter(names = {"--cohort-stats-ref"}, description = "Reference Allele Frequency: [{study:}]{cohort}[<|>|<=|>=]{number}. "
                              + "e.g. ALL<=0.4", required = false, arity = 1)
        public String cohortStatsRef; 
    
        @Parameter(names = {"--cohort-stats-alt"}, description = "Alternate Allele Frequency: [{study:}]{cohort}[<|>|<=|>=]{number}. "
                              + "e.g. ALL<=0.4", required = false, arity = 1)
        public String cohortStatsAlt; 
    
        @Parameter(names = {"--cohort-stats-maf"}, description = "Minor Allele Frequency: [{study:}]{cohort}[<|>|<=|>=]{number}. e.g. "
                              + "ALL<=0.4", required = false, arity = 1)
        public String cohortStatsMaf; 
    
        @Parameter(names = {"--cohort-stats-mgf"}, description = "Minor Genotype Frequency: [{study:}]{cohort}[<|>|<=|>=]{number}. e.g. "
                              + "ALL<=0.4", required = false, arity = 1)
        public String cohortStatsMgf; 
    
        @Parameter(names = {"--cohort-stats-pass"}, description = "Filter PASS frequency: [{study:}]{cohort}[<|>|<=|>=]{number}. e.g. "
                              + "ALL>0.8", required = false, arity = 1)
        ...
        @Parameter(names = {"--gene"}, description = "List of genes, most gene IDs are accepted (HGNC, Ensembl gene, ...). This is an "
                              + "alias to 'xref' parameter", required = false, arity = 1)
        public String gene; 
    
        @Parameter(names = {"--ct"}, description = "List of SO consequence types, e.g. missense_variant,stop_lost or "
                              + "SO:0001583,SO:0001578", required = false, arity = 1)
        public String ct; 
    
        @Parameter(names = {"--xref"}, description = "List of any external reference, these can be genes, proteins or variants. Accepted "
                              + "IDs include HGNC, Ensembl genes, dbSNP, ClinVar, HPO, Cosmic, ...", required = false, arity = 1)
        public String xref; 
    
        @Parameter(names = {"--biotype"}, description = "List of biotypes, e.g. protein_coding", required = false, arity = 1)
        public String biotype; 
    
        @Parameter(names = {"--protein-substitution"}, description = "Protein substitution scores include SIFT and PolyPhen. You can "
                              + "query using the score {protein_score}[<|>|<=|>=]{number} or the description "
                              + "{protein_score}[~=|=]{description} e.g. polyphen>0.1,sift=tolerant", required = false, arity = 1)
        public String proteinSubstitution; 
    
        @Parameter(names = {"--conservation"}, description = "Filter by conservation score: {conservation_score}[<|>|<=|>=]{number} e.g. "
                              + "phastCons>0.5,phylop<0.1,gerp>0.1", required = false, arity = 1)
        public String conservation; 
    
        @Parameter(names = {"--population-frequency-alt"}, description = "Alternate Population Frequency: "
                              + "{study}:{population}[<|>|<=|>=]{number}. e.g. 1kG_phase3:ALL<0.01", required = false, arity = 1)
        public String populationFrequencyAlt; 
    
        @Parameter(names = {"--population-frequency-ref"}, description = "Reference Population Frequency: "
                              + "{study}:{population}[<|>|<=|>=]{number}. e.g. 1kG_phase3:ALL<0.01", required = false, arity = 1)
        public String populationFrequencyRef; 
    
        @Parameter(names = {"--population-frequency-maf"}, description = "Population minor allele frequency: "
                              + "{study}:{population}[<|>|<=|>=]{number}. e.g. 1kG_phase3:ALL<0.01", required = false, arity = 1)
        public String populationFrequencyMaf; 
    
        @Parameter(names = {"--transcript-flag"}, description = "List of transcript annotation flags. e.g. CCDS, basic, cds_end_NF, "
                              + "mRNA_end_NF, cds_start_NF, mRNA_start_NF, seleno", required = false, arity = 1)
        public String transcriptFlag; 
    
        @Parameter(names = {"--gene-trait-id"}, description = "List of gene trait association id. e.g. \"umls:C0007222\" , "
        ...
        @Parameter(names = {"--protein-keyword"}, description = "List of Uniprot protein variant annotation keywords",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--functional-score"}, description = "Functional score: {functional_score}[<|>|<=|>=]{number} e.g. "
                              + "cadd_scaled>5.2 , cadd_raw<=0.3", required = false, arity = 1)
        ...
        @Parameter(names = {"--clinical-significance"}, description = "Clinical significance: benign, likely_benign, likely_pathogenic, "
                              + "pathogenic", required = false, arity = 1)
        ...
        @Parameter(names = {"--custom-annotation"}, description = "Custom annotation: {key}[<|>|<=|>=]{number} or {key}[~=|=]{text}",
                              required = false, arity = 1)
        public String customAnnotation; 
    
        @Parameter(names = {"--trait"}, description = "List of traits, based on ClinVar, HPO, COSMIC, i.e.: IDs, histologies, "
                              + "descriptions,...", required = false, arity = 1)
        public String trait; 
    
        @Parameter(names = {"--field"}, description = "List of facet fields separated by semicolons, e.g.: studies;type. For nested "
                              + "faceted fields use >>, e.g.: chromosome>>type;percentile(gerp)", required = false, arity = 1)
        public String field; 
    ...
    public class QueryAnnotationCommandOptions {
        ...
        @Parameter(names = {"--id"}, description = "List of IDs, these can be rs IDs (dbSNP) or variants in the format "
                              + "chrom:start:ref:alt, e.g. rs116600158,19:7177679:C:T", required = false, arity = 1)
        public String id; 
    ...
    public class RunCircosCommandOptions {
        ...
        @Parameter(names = {"-s","--study"}, description = "study", required = false, arity = 1)
        public String study; 
    ...
    public class DeleteCohortStatsCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "Cohort ID or name", required = false, arity = 1)
        public String cohort; 
    ...
    public class InfoCohortStatsCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "Comma separated list of cohort names or IDs up to a maximum of 100",
    ...
    public class RunCohortStatsCommandOptions {
        ...
        @Parameter(names = {"--sample-annotation"}, description = "The body web service sampleAnnotation parameter",
                              required = false, arity = 1)
    ...
    public class RunExportCommandOptions {
        ...
        @Parameter(names = {"--output-file-name"}, description = "The body web service outputFileName parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-family-qc"}, commandDescription = "Run quality control (QC) for a given family. It computes the "
    ...
    public class RunFamilyQcCommandOptions {
        ...
        @Parameter(names = {"--relatedness-method"}, description = "The body web service relatednessMethod parameter",
                              required = false, arity = 1)
        public String relatednessMethod; 
    
        @Parameter(names = {"--relatedness-maf"}, description = "The body web service relatednessMaf parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"delete-file"}, commandDescription = "Remove variant files from the variant storage.")
    ...
    @Parameters(commandNames = {"run-gatk"}, commandDescription = "GATK is a Genome Analysis Toolkit for variant discovery in "
                              + "high-throughput sequencing data. Supported Gatk commands: HaplotypeCaller.")
    public class RunGatkCommandOptions {
        ...
        @Parameter(names = {"--gatk-params"}, description = "The body web service gatkParams parameter", required = false, arity = 1)
        public Map gatkParams; 
    
  }
  
  
    @Parameters(commandNames = {"run-genome-plot"}, commandDescription = "Generate a genome plot for a given sample.")
    ...
    public class RunGwasCommandOptions {
        ...
        @Parameter(names = {"--case-cohort-samples-annotation"}, description = "The body web service caseCohortSamplesAnnotation "
                              + "parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--control-cohort-samples-annotation"}, description = "The body web service controlCohortSamplesAnnotation "
                              + "parameter", required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-index"}, commandDescription = "Index variant files into the variant storage.")
    public class RunIndexCommandOptions {
        ...
        @Parameter(names = {"--normalization-skip"}, description = "The body web service normalizationSkip parameter",
                              required = false, arity = 1)
        public boolean normalizationSkip; 
    
        @Parameter(names = {"--reference-genome"}, description = "The body web service referenceGenome parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--load-multi-file-data"}, description = "The body web service loadMultiFileData parameter",
                              required = false, arity = 1)
        public boolean loadMultiFileData; 
    
        @Parameter(names = {"--load-sample-index"}, description = "The body web service loadSampleIndex parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--exclude-genotypes"}, description = "The body web service excludeGenotypes parameter",
                              required = false, arity = 1)
        public boolean excludeGenotypes; 
    
        @Parameter(names = {"--include-sample-data"}, description = "The body web service includeSampleData parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--deduplication-policy"}, description = "The body web service deduplicationPolicy parameter",
                              required = false, arity = 1)
        public String deduplicationPolicy; 
    
        @Parameter(names = {"--calculate-stats"}, description = "The body web service calculateStats parameter",
                              required = false, arity = 1)
        public boolean calculateStats; 
    
        @Parameter(names = {"--aggregation-mapping-file"}, description = "The body web service aggregationMappingFile parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--overwrite-annotations"}, description = "The body web service overwriteAnnotations parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--skip-indexed-files"}, description = "The body web service skipIndexedFiles parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-individual-qc"}, commandDescription = "Run quality control (QC) for a given individual. It includes "
                              + "inferred sex and  mendelian errors (UDP).")
    public class RunIndividualQcCommandOptions {
        ...
        @Parameter(names = {"--inferred-sex-method"}, description = "The body web service inferredSexMethod parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-inferred-sex"}, commandDescription = "Infer sex from chromosome mean coverages.")
    ...
    @Parameters(commandNames = {"query-knockout-individual"}, commandDescription = "Fetch values from KnockoutAnalysis result, by "
                              + "individuals.")
    ...
    public class RunKnockoutCommandOptions {
        ...
        @Parameter(names = {"--consequence-type"}, description = "The body web service consequenceType parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-mendelian-error"}, commandDescription = "Run mendelian error analysis to infer uniparental disomy "
                              + "regions.")
    ...
    public class MetadataCommandOptions {
        ...
        @Parameter(names = {"--file"}, description = "Filter variants from the files specified. This will set includeFile parameter when "
                              + "not provided", required = false, arity = 1)
        public String file; 
    
        @Parameter(names = {"--sample"}, description = "Filter variants by sample genotype. This will automatically set 'includeSample' "
                              + "parameter when not provided. This filter accepts multiple 3 forms: 1) List of samples: Samples that "
                              + "contain the main variant. Accepts AND (;) and OR (,) operators.  e.g. HG0097,HG0098 . 2) List of "
                              + "samples with genotypes: {sample}:{gt1},{gt2}. Accepts AND (;) and OR (,) operators.  e.g. "
                              + "HG0097:0/0;HG0098:0/1,1/1 . Unphased genotypes (e.g. 0/1, 1/1) will also include phased genotypes (e.g. "
                              + "0|1, 1|0, 1|1), but not vice versa. When filtering by multi-allelic genotypes, any secondary allele "
                              + "will match, regardless of its position e.g. 1/2 will match with genotypes 1/2, 1/3, 1/4, .... Genotype "
                              + "aliases accepted: HOM_REF, HOM_ALT, HET, HET_REF, HET_ALT, HET_MISS and MISS  e.g. "
                              + "HG0097:HOM_REF;HG0098:HET_REF,HOM_ALT . 3) Sample with segregation mode: {sample}:{segregation}. Only "
                              + "one sample accepted.Accepted segregation modes: [ autosomalDominant, autosomalRecessive, "
                              + "XLinkedDominant, XLinkedRecessive, YLinked, mitochondrial, deNovo, mendelianError, compoundHeterozygous "
                              + "]. Value is case insensitive. e.g. HG0097:DeNovo Sample must have parents defined and indexed. ",
                              required = false, arity = 1)
        public String sample; 
    
        @Parameter(names = {"--include-study"}, description = "List of studies to include in the result. Accepts 'all' and 'none'.",
                              required = false, arity = 1)
        public String includeStudy; 
    
        @Parameter(names = {"--include-file"}, description = "List of files to be returned. Accepts 'all' and 'none'. If undefined, "
                              + "automatically includes files used for filtering. If none, no file is included.",
                              required = false, arity = 1)
        public String includeFile; 
    
        @Parameter(names = {"--include-sample"}, description = "List of samples to be included in the result. Accepts 'all' and 'none'. "
                              + "If undefined, automatically includes samples used for filtering. If none, no sample is included.",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"query-mutational-signature"}, commandDescription = "Run mutational signature analysis for a given "
                              + "sample. Use context index.")
    public class QueryMutationalSignatureCommandOptions {
        ...
        @Parameter(names = {"--file-data"}, description = "Filter by file data (i.e. FILTER, QUAL and INFO columns from VCF file). "
                              + "[{file}:]{key}{op}{value}[,;]* . If no file is specified, will use all files from \"file\" filter. e.g. "
                              + "AN>200 or file_1.vcf:AN>200;file_2.vcf:AN<10 . Many fields can be combined. e.g. "
                              + "file_1.vcf:AN>200;DB=true;file_2.vcf:AN<10,FILTER=PASS,LowDP", required = false, arity = 1)
        public String fileData; 
    
        @Parameter(names = {"--filter"}, description = "Specify the FILTER for any of the files. If 'file' filter is provided, will "
                              + "match the file and the filter. e.g.: PASS,LowGQX", required = false, arity = 1)
        public String filter; 
    
        @Parameter(names = {"--qual"}, description = "Specify the QUAL for any of the files. If 'file' filter is provided, will match "
                              + "the file and the qual. e.g.: >123.4", required = false, arity = 1)
        public String qual; 
        ...
        @Parameter(names = {"--panel-mode-of-inheritance"}, description = "Filter genes from specific panels that match certain mode of "
                              + "inheritance. Accepted values : [ autosomalDominant, autosomalRecessive, XLinkedDominant, "
                              + "XLinkedRecessive, YLinked, mitochondrial, deNovo, mendelianError, compoundHeterozygous ]",
                              required = false, arity = 1)
        public String panelModeOfInheritance; 
    
        @Parameter(names = {"--panel-confidence"}, description = "Filter genes from specific panels that match certain confidence. "
                              + "Accepted values : [ high, medium, low, rejected ]", required = false, arity = 1)
        public String panelConfidence; 
    
        @Parameter(names = {"--panel-role-in-cancer"}, description = "Filter genes from specific panels that match certain role in "
                              + "cancer. Accepted values : [ both, oncogene, tumorSuppressorGene, fusion ]", required = false, arity = 1)
        public String panelRoleInCancer; 
    
        @Parameter(names = {"--fitting"}, description = "Compute the relative proportions of the different mutational signatures "
                              + "demonstrated by the tumour", required = false, arity = 1)
        public boolean fitting; 
    
  }
  
  
    @Parameters(commandNames = {"run-mutational-signature"}, commandDescription = "Run mutational signature analysis for a given sample.")
    ...
    @Parameters(commandNames = {"run-plink"}, commandDescription = "Plink is a whole genome association analysis toolset, designed to "
    ...
    public class RunPlinkCommandOptions {
        ...
        @Parameter(names = {"--plink-params"}, description = "The body web service plinkParams parameter", required = false, arity = 1)
        public Map plinkParams; 
    ...
    public class QueryCommandOptions {
        ...
        @Parameter(names = {"--approximate-count"}, description = "Get an approximate count, instead of an exact total count. Reduces "
                              + "execution time", required = false, arity = 1)
        public boolean approximateCount; 
    
        @Parameter(names = {"--approximate-count-sampling-size"}, description = "Sampling size to get the approximate count. Larger "
                              + "values increase accuracy but also increase execution time", required = false, arity = 1)
        ...
        @Parameter(names = {"--genotype"}, description = "Samples with a specific genotype: "
                              + "{samp_1}:{gt_1}(,{gt_n})*(;{samp_n}:{gt_1}(,{gt_n})*)* e.g. HG0097:0/0;HG0098:0/1,1/1. Unphased "
                              + "genotypes (e.g. 0/1, 1/1) will also include phased genotypes (e.g. 0|1, 1|0, 1|1), but not vice versa. "
                              + "When filtering by multi-allelic genotypes, any secondary allele will match, regardless of its position "
                              + "e.g. 1/2 will match with genotypes 1/2, 1/3, 1/4, .... Genotype aliases accepted: HOM_REF, HOM_ALT, "
                              + "HET, HET_REF, HET_ALT, HET_MISS and MISS  e.g. HG0097:HOM_REF;HG0098:HET_REF,HOM_ALT. This will "
                              + "automatically set 'includeSample' parameter when not provided", required = false, arity = 1)
        public String genotype; 
    
        @Parameter(names = {"--sample-data"}, description = "Filter by any SampleData field from samples. "
                              + "[{sample}:]{key}{op}{value}[,;]* . If no sample is specified, will use all samples from \"sample\" or "
                              + "\"genotype\" filter. e.g. DP>200 or HG0097:DP>200,HG0098:DP<10 . Many FORMAT fields can be combined. "
                              + "e.g. HG0097:DP>200;GT=1/1,0/1,HG0098:DP<10", required = false, arity = 1)
        public String sampleData; 
    
        @Parameter(names = {"--sample-annotation"}, description = "Selects some samples using metadata information from Catalog. e.g. "
                              + "age>20;phenotype=hpo:123,hpo:456;name=smith", required = false, arity = 1)
        public String sampleAnnotation; 
    
        @Parameter(names = {"--sample-metadata"}, description = "Return the samples metadata group by study. Sample names will appear in "
                              + "the same order as their corresponding genotypes.", required = false, arity = 1)
        ...
        @Parameter(names = {"--sample-limit"}, description = "Limit the number of samples to be included in the result",
                              required = false, arity = 1)
        public int sampleLimit; 
    
        @Parameter(names = {"--sample-skip"}, description = "Skip some samples from the result. Useful for sample pagination.",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--family"}, description = "Filter variants where any of the samples from the given family contains the "
                              + "variant (HET or HOM_ALT)", required = false, arity = 1)
        public String family; 
    
        @Parameter(names = {"--family-disorder"}, description = "Specify the disorder to use for the family segregation",
                              required = false, arity = 1)
        public String familyDisorder; 
    
        @Parameter(names = {"--family-segregation"}, description = "Filter by segregation mode from a given family. Accepted values: [ "
                              + "autosomalDominant, autosomalRecessive, XLinkedDominant, XLinkedRecessive, YLinked, mitochondrial, "
                              + "deNovo, mendelianError, compoundHeterozygous ]", required = false, arity = 1)
        ...
        @Parameter(names = {"--family-proband"}, description = "Specify the proband child to use for the family segregation",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--include-sample-data"}, description = "List of Sample Data keys (i.e. FORMAT column from VCF file) from "
                              + "Sample Data to include in the output. e.g: DP,AD. Accepts 'all' and 'none'.", required = false, arity = 1)
        public String includeSampleData; 
    
        @Parameter(names = {"--include-genotype"}, description = "Include genotypes, apart of other formats defined with includeFormat",
                              required = false, arity = 1)
    ...
    public class RunRelatednessCommandOptions {
        ...
        @Parameter(names = {"--minor-allele-freq"}, description = "The body web service minorAlleleFreq parameter",
                              required = false, arity = 1)
    ...
    @Parameters(commandNames = {"run-rvtests"}, commandDescription = "Rvtests is a flexible software package for genetic association "
    ...
    public class RunRvtestsCommandOptions {
        ...
        @Parameter(names = {"--rvtests-params"}, description = "The body web service rvtestsParams parameter", required = false, arity = 1)
        public Map rvtestsParams; 
    
  }
  
  
    @Parameters(commandNames = {"aggregation-stats-sample"}, commandDescription = "Calculate and fetch sample aggregation stats.")
    public class AggregationStatsSampleCommandOptions {
        ...
        @Parameter(names = {"--field"}, description = "List of facet fields separated by semicolons, e.g.: studies;type. For nested "
                              + "faceted fields use >>, e.g.: chromosome>>type . Accepted values: chromosome, type, genotype, "
                              + "consequenceType, biotype, clinicalSignificance, dp, qual, filter", required = false, arity = 1)
        public String field; 
    
  }
  
  
    @Parameters(commandNames = {"run-sample-eligibility"}, commandDescription = "Filter samples by a complex query involving metadata and "
                              + "variants data.")
    ...
    @Parameters(commandNames = {"run-sample-qc"}, commandDescription = "Run quality control (QC) for a given sample. It includes variant "
                              + "stats, and if the sample is somatic, mutational signature and genome plot are calculated.")
    public class RunSampleQcCommandOptions {
        ...
        @Parameter(names = {"--variant-stats-id"}, description = "The body web service variantStatsId parameter",
                              required = false, arity = 1)
        public String variantStatsId; 
    
        @Parameter(names = {"--variant-stats-description"}, description = "The body web service variantStatsDescription parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--signature-description"}, description = "The body web service signatureDescription parameter",
                              required = false, arity = 1)
        public String signatureDescription; 
    
        @Parameter(names = {"--signature-query"}, description = "The body web service signatureQuery parameter",
                              required = false, arity = 1)
        public ObjectMap signatureQuery; 
    
        @Parameter(names = {"--signature-release"}, description = "The body web service signatureRelease parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--genome-plot-description"}, description = "The body web service genomePlotDescription parameter",
                              required = false, arity = 1)
        public String genomePlotDescription; 
    
        @Parameter(names = {"--genome-plot-config-file"}, description = "The body web service genomePlotConfigFile parameter",
                              required = false, arity = 1)
    ...
    public class QuerySampleCommandOptions {
        ...
        @Parameter(names = {"-s","--study"}, description = "Study where all the samples belong to", required = false, arity = 1)
        public String study; 
    ...
    public class RunSampleCommandOptions {
        ...
        @Parameter(names = {"--samples-in-all-variants"}, description = "The body web service samplesInAllVariants parameter",
                              required = false, arity = 1)
    ...
    public class RunSampleStatsCommandOptions {
        ...
        @Parameter(names = {"--index-overwrite"}, description = "The body web service indexOverwrite parameter",
                              required = false, arity = 1)
        ...
        @Parameter(names = {"--index-description"}, description = "The body web service indexDescription parameter",
                              required = false, arity = 1)
