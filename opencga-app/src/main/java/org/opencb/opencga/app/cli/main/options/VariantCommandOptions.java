...
public class VariantCommandOptions {
    ...
    public class AggregationStatsCommandOptions {
        ...
        @Parameter(names = {"--study"}, description = "Filter variants from the given studies, these can be either the numeric ID or the "
                              + "alias with the format user@project:study", required = false, arity = 1)
        public String study; 
    ...
    public class RunCircosCommandOptions {
        ...
        @Parameter(names = {"--study"}, description = "study", required = false, arity = 1)
        public String study; 
    ...
    public class QuerySampleCommandOptions {
        ...
        @Parameter(names = {"--study"}, description = "Study where all the samples belong to", required = false, arity = 1)
        public String study; 
