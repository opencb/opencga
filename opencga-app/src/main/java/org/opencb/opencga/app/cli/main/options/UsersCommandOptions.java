...
public class UsersCommandOptions extends ParentUsersCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--id"}, description = "The body id UserCreateParams web service parameter", required = true, arity = 1)
        public String id;
    ...
    public class PasswordCommandOptions {
        ...
        @Parameter(names = {"--user", "-u"}, description = "The body user PasswordChangeParams web service parameter", required = false, arity = 1)
        public String user;
    
        @Parameter(names = {"--password"}, description = "The body password PasswordChangeParams web service parameter", required = false, arity = 1)
        public String password;
    
        @Parameter(names = {"--new-password"}, description = "The body newPassword PasswordChangeParams web service parameter", required = false, arity = 1)
        public String newPassword;
    
        @Parameter(names = {"--reset"}, description = "The body reset PasswordChangeParams web service parameter", required = false, arity = 1)
        public String reset;
    ...
    public class UpdateConfigsCommandOptions {
        ...
        @DynamicParameter(names = {"--configuration"}, description = "The body configuration ConfigUpdateParams web service parameter. Use: --configuration key=value", required = false)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--email"}, description = "The body email UserUpdateParams web service parameter", required = false, arity = 1)
        public String email;
    
        @Parameter(names = {"--organization"}, description = "The body organization UserUpdateParams web service parameter", required = false, arity = 1)
        public String organization;
