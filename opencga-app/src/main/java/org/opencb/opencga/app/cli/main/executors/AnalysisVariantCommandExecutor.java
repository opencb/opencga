...
public class AnalysisVariantCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<Job> runExport() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "id",commandOptions.bodyId, true);
             ...
             putNestedIfNotNull(beanParams, "panelIntersection",commandOptions.bodyPanelIntersection, true);
             ...
             putNestedIfNotEmpty(beanParams, "clinicalConfirmedStatus",commandOptions.bodyClinicalConfirmedStatus, true);
             ...
             putNestedIfNotEmpty(beanParams, "savedFilter",commandOptions.bodySavedFilter, true);
             putNestedIfNotEmpty(beanParams, "chromosome",commandOptions.bodyChromosome, true);
             putNestedIfNotEmpty(beanParams, "reference",commandOptions.bodyReference, true);
             putNestedIfNotEmpty(beanParams, "alternate",commandOptions.bodyAlternate, true);
             putNestedIfNotEmpty(beanParams, "release",commandOptions.bodyRelease, true);
             putNestedIfNotEmpty(beanParams, "includeStudy",commandOptions.bodyIncludeStudy, true);
             putNestedIfNotEmpty(beanParams, "includeSample",commandOptions.bodyIncludeSample, true);
             putNestedIfNotEmpty(beanParams, "includeFile",commandOptions.bodyIncludeFile, true);
             putNestedIfNotEmpty(beanParams, "includeSampleData",commandOptions.bodyIncludeSampleData, true);
             putNestedIfNotEmpty(beanParams, "includeSampleId",commandOptions.bodyIncludeSampleId, true);
             putNestedIfNotEmpty(beanParams, "includeGenotype",commandOptions.bodyIncludeGenotype, true);
             ...
             putNestedIfNotEmpty(beanParams, "genotype",commandOptions.bodyGenotype, true);
             putNestedIfNotEmpty(beanParams, "sample",commandOptions.bodySample, true);
             putNestedIfNotNull(beanParams, "sampleLimit",commandOptions.bodySampleLimit, true);
             putNestedIfNotNull(beanParams, "sampleSkip",commandOptions.bodySampleSkip, true);
             ...
             putNestedIfNotEmpty(beanParams, "missingAlleles",commandOptions.bodyMissingAlleles, true);
             putNestedIfNotEmpty(beanParams, "missingGenotypes",commandOptions.bodyMissingGenotypes, true);
             putNestedIfNotNull(beanParams, "annotationExists",commandOptions.bodyAnnotationExists, true);
             putNestedIfNotEmpty(beanParams, "score",commandOptions.bodyScore, true);
             putNestedIfNotEmpty(beanParams, "polyphen",commandOptions.bodyPolyphen, true);
             putNestedIfNotEmpty(beanParams, "sift",commandOptions.bodySift, true);
             putNestedIfNotEmpty(beanParams, "geneTraitId",commandOptions.bodyGeneTraitId, true);
             putNestedIfNotEmpty(beanParams, "geneTraitName",commandOptions.bodyGeneTraitName, true);
             putNestedIfNotEmpty(beanParams, "trait",commandOptions.bodyTrait, true);
             putNestedIfNotEmpty(beanParams, "cosmic",commandOptions.bodyCosmic, true);
             putNestedIfNotEmpty(beanParams, "clinvar",commandOptions.bodyClinvar, true);
             putNestedIfNotEmpty(beanParams, "hpo",commandOptions.bodyHpo, true);
             ...
             putNestedIfNotEmpty(beanParams, "unknownGenotype",commandOptions.bodyUnknownGenotype, true);
             putNestedIfNotNull(beanParams, "sampleMetadata",commandOptions.bodySampleMetadata, true);
             putNestedIfNotNull(beanParams, "sort",commandOptions.bodySort, true);
             putNestedIfNotEmpty(beanParams, "outdir",commandOptions.bodyOutdir, true);
             putNestedIfNotEmpty(beanParams, "outputFileName",commandOptions.bodyOutputFileName, true);
             putNestedIfNotEmpty(beanParams, "outputFileFormat",commandOptions.bodyOutputFileFormat, true);
    ...
    private RestResponse<Signature> queryMutationalSignature() throws Exception {
        ...
        queryParams.putIfNotEmpty("nBoot", commandOptions.nBoot);
        queryParams.putIfNotEmpty("sigVersion", commandOptions.sigVersion);
        queryParams.putIfNotEmpty("organ", commandOptions.organ);
        queryParams.putIfNotEmpty("thresholdPerc", commandOptions.thresholdPerc);
        queryParams.putIfNotEmpty("thresholdPval", commandOptions.thresholdPval);
        queryParams.putIfNotEmpty("maxRareSigs", commandOptions.maxRareSigs);
        if (queryParams.get("study") == null && OpencgaMain.isShellMode()) {
            queryParams.putIfNotEmpty("study", sessionManager.getSession().getCurrentStudy());
        }
    ...
    private RestResponse<Job> runMutationalSignature() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "id",commandOptions.id, true);
             ...
             putNestedIfNotEmpty(beanParams, "nBoot",commandOptions.nBoot, true);
             ...
             putNestedIfNotEmpty(beanParams, "thresholdPerc",commandOptions.thresholdPerc, true);
             putNestedIfNotEmpty(beanParams, "thresholdPval",commandOptions.thresholdPval, true);
             putNestedIfNotEmpty(beanParams, "maxRareSigs",commandOptions.maxRareSigs, true);
             putNestedIfNotEmpty(beanParams, "outdir",commandOptions.outdir, true);
    ...
    private RestResponse<Job> runSampleQc() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "sample",commandOptions.sample, true);
             ...
             putNestedIfNotEmpty(beanParams, "signatureQuery",commandOptions.signatureQuery, true);
    ...
    private RestResponse<Job> runSample() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "id",commandOptions.id, true);
             ...
             putNestedIfNotEmpty(beanParams, "clinicalConfirmedStatus",commandOptions.clinicalConfirmedStatus, true);
