    ...
    private RestResponse<Job> runSampleQc() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "sample",commandOptions.sample, true);
             ...
             putNestedIfNotEmpty(beanParams, "signatureFitMethod",commandOptions.signatureFitMethod, true);
             putNestedIfNotNull(beanParams, "signatureNBoot",commandOptions.signatureNBoot, true);
             putNestedIfNotEmpty(beanParams, "signatureSigVersion",commandOptions.signatureSigVersion, true);
             putNestedIfNotEmpty(beanParams, "signatureOrgan",commandOptions.signatureOrgan, true);
