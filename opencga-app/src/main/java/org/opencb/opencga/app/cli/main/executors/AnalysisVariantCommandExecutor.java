    ...
    private RestResponse<Job> runExport() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            putNestedIfNotEmpty(beanParams, "body_id",commandOptions.bodyId, true);
             ...
             putNestedIfNotNull(beanParams, "body_panelIntersection",commandOptions.bodyPanelIntersection, true);
             ...
             putNestedIfNotEmpty(beanParams, "body_clinicalConfirmedStatus",commandOptions.bodyClinicalConfirmedStatus, true);
             putNestedIfNotEmpty(beanParams, "body_project",commandOptions.bodyProject, true);
             putNestedIfNotEmpty(beanParams, "body_study",commandOptions.bodyStudy, true);
             putNestedIfNotEmpty(beanParams, "body_savedFilter",commandOptions.bodySavedFilter, true);
             putNestedIfNotEmpty(beanParams, "body_chromosome",commandOptions.bodyChromosome, true);
             putNestedIfNotEmpty(beanParams, "body_reference",commandOptions.bodyReference, true);
             putNestedIfNotEmpty(beanParams, "body_alternate",commandOptions.bodyAlternate, true);
             putNestedIfNotEmpty(beanParams, "body_release",commandOptions.bodyRelease, true);
             putNestedIfNotEmpty(beanParams, "body_includeStudy",commandOptions.bodyIncludeStudy, true);
             putNestedIfNotEmpty(beanParams, "body_includeSample",commandOptions.bodyIncludeSample, true);
             putNestedIfNotEmpty(beanParams, "body_includeFile",commandOptions.bodyIncludeFile, true);
             putNestedIfNotEmpty(beanParams, "body_includeSampleData",commandOptions.bodyIncludeSampleData, true);
             putNestedIfNotEmpty(beanParams, "body_includeSampleId",commandOptions.bodyIncludeSampleId, true);
             putNestedIfNotEmpty(beanParams, "body_includeGenotype",commandOptions.bodyIncludeGenotype, true);
             ...
             putNestedIfNotEmpty(beanParams, "body_genotype",commandOptions.bodyGenotype, true);
             putNestedIfNotEmpty(beanParams, "body_sample",commandOptions.bodySample, true);
             putNestedIfNotNull(beanParams, "body_sampleLimit",commandOptions.bodySampleLimit, true);
             putNestedIfNotNull(beanParams, "body_sampleSkip",commandOptions.bodySampleSkip, true);
             ...
             putNestedIfNotEmpty(beanParams, "body_missingAlleles",commandOptions.bodyMissingAlleles, true);
             putNestedIfNotEmpty(beanParams, "body_missingGenotypes",commandOptions.bodyMissingGenotypes, true);
             putNestedIfNotNull(beanParams, "body_annotationExists",commandOptions.bodyAnnotationExists, true);
             putNestedIfNotEmpty(beanParams, "body_score",commandOptions.bodyScore, true);
             putNestedIfNotEmpty(beanParams, "body_polyphen",commandOptions.bodyPolyphen, true);
             putNestedIfNotEmpty(beanParams, "body_sift",commandOptions.bodySift, true);
             putNestedIfNotEmpty(beanParams, "body_geneTraitId",commandOptions.bodyGeneTraitId, true);
             putNestedIfNotEmpty(beanParams, "body_geneTraitName",commandOptions.bodyGeneTraitName, true);
             putNestedIfNotEmpty(beanParams, "body_trait",commandOptions.bodyTrait, true);
             putNestedIfNotEmpty(beanParams, "body_cosmic",commandOptions.bodyCosmic, true);
             putNestedIfNotEmpty(beanParams, "body_clinvar",commandOptions.bodyClinvar, true);
             putNestedIfNotEmpty(beanParams, "body_hpo",commandOptions.bodyHpo, true);
             ...
             putNestedIfNotEmpty(beanParams, "body_unknownGenotype",commandOptions.bodyUnknownGenotype, true);
             putNestedIfNotNull(beanParams, "body_sampleMetadata",commandOptions.bodySampleMetadata, true);
             putNestedIfNotNull(beanParams, "body_sort",commandOptions.bodySort, true);
             putNestedIfNotEmpty(beanParams, "body_outdir",commandOptions.bodyOutdir, true);
             putNestedIfNotEmpty(beanParams, "body_outputFileName",commandOptions.bodyOutputFileName, true);
             putNestedIfNotEmpty(beanParams, "body_outputFileFormat",commandOptions.bodyOutputFileFormat, true);
             putNestedIfNotEmpty(beanParams, "body_variantsFile",commandOptions.bodyVariantsFile, true);
             ...
             putNestedIfNotNull(beanParams, "body_compress",commandOptions.bodyCompress, true);
             putNestedIfNotNull(beanParams, "body_limit",commandOptions.bodyLimit, true);
             putNestedIfNotNull(beanParams, "body_skip",commandOptions.bodySkip, true);
             putNestedIfNotNull(beanParams, "body_summary",commandOptions.bodySummary, true);
