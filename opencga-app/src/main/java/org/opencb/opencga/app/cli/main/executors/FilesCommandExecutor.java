...
public class FilesCommandExecutor extends ParentFilesCommandExecutor {
    ...
    private RestResponse<File> create() throws Exception {
        ...
        switch (commandOptions.type) {
            case "FILE":
            typeParam=File.Type.FILE;
            break;
            case "DIRECTORY":
            typeParam=File.Type.DIRECTORY;
            break;
        }
        File.Format formatParam = null;
        switch (commandOptions.format) {
            case "VCF":
            formatParam=File.Format.VCF;
            break;
            case "BCF":
            formatParam=File.Format.BCF;
            break;
            case "GVCF":
            formatParam=File.Format.GVCF;
            break;
            case "TBI":
            formatParam=File.Format.TBI;
            break;
            case "BIGWIG":
            formatParam=File.Format.BIGWIG;
            break;
            case "SAM":
            formatParam=File.Format.SAM;
            break;
            case "BAM":
            formatParam=File.Format.BAM;
            break;
            case "BAI":
            formatParam=File.Format.BAI;
            break;
            case "CRAM":
            formatParam=File.Format.CRAM;
            break;
            case "CRAI":
            formatParam=File.Format.CRAI;
            break;
            case "FASTQ":
            formatParam=File.Format.FASTQ;
            break;
            case "FASTA":
            formatParam=File.Format.FASTA;
            break;
            case "PED":
            formatParam=File.Format.PED;
            break;
            case "TAB_SEPARATED_VALUES":
            formatParam=File.Format.TAB_SEPARATED_VALUES;
            break;
            case "COMMA_SEPARATED_VALUES":
            formatParam=File.Format.COMMA_SEPARATED_VALUES;
            break;
            case "XML":
            formatParam=File.Format.XML;
            break;
            case "PROTOCOL_BUFFER":
            formatParam=File.Format.PROTOCOL_BUFFER;
            break;
            case "JSON":
            formatParam=File.Format.JSON;
            break;
            case "AVRO":
            formatParam=File.Format.AVRO;
            break;
            case "PARQUET":
            formatParam=File.Format.PARQUET;
            break;
            case "IMAGE":
            formatParam=File.Format.IMAGE;
            break;
            case "PLAIN":
            formatParam=File.Format.PLAIN;
            break;
            case "BINARY":
            formatParam=File.Format.BINARY;
            break;
            case "NONE":
            formatParam=File.Format.NONE;
            break;
            case "UNKNOWN":
            formatParam=File.Format.UNKNOWN;
            break;
        }
        File.Bioformat bioformatParam = null;
        switch (commandOptions.bioformat) {
            case "MICROARRAY_EXPRESSION_ONECHANNEL_AGILENT":
            bioformatParam=File.Bioformat.MICROARRAY_EXPRESSION_ONECHANNEL_AGILENT;
            break;
            case "MICROARRAY_EXPRESSION_ONECHANNEL_AFFYMETRIX":
            bioformatParam=File.Bioformat.MICROARRAY_EXPRESSION_ONECHANNEL_AFFYMETRIX;
            break;
            case "MICROARRAY_EXPRESSION_ONECHANNEL_GENEPIX":
            bioformatParam=File.Bioformat.MICROARRAY_EXPRESSION_ONECHANNEL_GENEPIX;
            break;
            case "MICROARRAY_EXPRESSION_TWOCHANNELS_AGILENT":
            bioformatParam=File.Bioformat.MICROARRAY_EXPRESSION_TWOCHANNELS_AGILENT;
            break;
            case "MICROARRAY_EXPRESSION_TWOCHANNELS_GENEPIX":
            bioformatParam=File.Bioformat.MICROARRAY_EXPRESSION_TWOCHANNELS_GENEPIX;
            break;
            case "DATAMATRIX_EXPRESSION":
            bioformatParam=File.Bioformat.DATAMATRIX_EXPRESSION;
            break;
            case "IDLIST":
            bioformatParam=File.Bioformat.IDLIST;
            break;
            case "IDLIST_RANKED":
            bioformatParam=File.Bioformat.IDLIST_RANKED;
            break;
            case "ANNOTATION_GENEVSANNOTATION":
            bioformatParam=File.Bioformat.ANNOTATION_GENEVSANNOTATION;
            break;
            case "OTHER_NEWICK":
            bioformatParam=File.Bioformat.OTHER_NEWICK;
            break;
            case "OTHER_BLAST":
            bioformatParam=File.Bioformat.OTHER_BLAST;
            break;
            case "OTHER_INTERACTION":
            bioformatParam=File.Bioformat.OTHER_INTERACTION;
            break;
            case "OTHER_GENOTYPE":
            bioformatParam=File.Bioformat.OTHER_GENOTYPE;
            break;
            case "OTHER_PLINK":
            bioformatParam=File.Bioformat.OTHER_PLINK;
            break;
            case "OTHER_VCF":
            bioformatParam=File.Bioformat.OTHER_VCF;
            break;
            case "OTHER_PED":
            bioformatParam=File.Bioformat.OTHER_PED;
            break;
            case "VCF4":
            bioformatParam=File.Bioformat.VCF4;
            break;
            case "VARIANT":
            bioformatParam=File.Bioformat.VARIANT;
            break;
            case "ALIGNMENT":
            bioformatParam=File.Bioformat.ALIGNMENT;
            break;
            case "COVERAGE":
            bioformatParam=File.Bioformat.COVERAGE;
            break;
            case "SEQUENCE":
            bioformatParam=File.Bioformat.SEQUENCE;
            break;
            case "PEDIGREE":
            bioformatParam=File.Bioformat.PEDIGREE;
            break;
            case "REFERENCE_GENOME":
            bioformatParam=File.Bioformat.REFERENCE_GENOME;
            break;
            case "NONE":
            bioformatParam=File.Bioformat.NONE;
            break;
            case "UNKNOWN":
            bioformatParam=File.Bioformat.UNKNOWN;
            break;
        }
