...
public class CohortsCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--samples-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String samplesId; 
    
        @Parameter(names = {"--samples-uuid"}, description = "The body web service uuid parameter", required = false, arity = 1)
        public String samplesUuid; 
    
        @Parameter(names = {"--annotation-sets-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String annotationSetsId; 
    
        @Parameter(names = {"--annotation-sets-name"}, description = "The body web service name parameter", required = false, arity = 1)
        public String annotationSetsName; 
    
        @Parameter(names = {"--annotation-sets-variable-set-id"}, description = "The body web service variableSetId parameter", required = false, arity = 1)
        public String annotationSetsVariableSetId; 
    
        @Parameter(names = {"--annotation-sets-creation-date"}, description = "The body web service creationDate parameter", required = false, arity = 1)
        public String annotationSetsCreationDate; 
    
        @Parameter(names = {"--annotation-sets-release"}, description = "The body web service release parameter", required = false, arity = 1)
        public Integer annotationSetsRelease; 
