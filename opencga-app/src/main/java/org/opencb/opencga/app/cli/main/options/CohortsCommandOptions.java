...
public class CohortsCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "The body cohort CohortAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class LoadAnnotationSetsCommandOptions {
        ...
        @Parameter(names = {"--content"}, description = "The body content TsvAnnotationParams web service parameter", required = false, arity = 1)
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name CohortCreateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--type"}, description = "The body type CohortCreateParams web service parameter", required = false, arity = 1)
        public String type;
        ...
        @Parameter(names = {"--status-name"}, description = "The body name StatusParams web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name CohortUpdateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--type"}, description = "The body type CohortUpdateParams web service parameter", required = false, arity = 1)
        public String type;
