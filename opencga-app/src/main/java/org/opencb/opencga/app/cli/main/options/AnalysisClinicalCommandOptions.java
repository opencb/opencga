...
public class AnalysisClinicalCommandOptions {
    ...
    public class DistinctInterpretationCommandOptions {
        ...
        @Parameter(names = {"--creation-date", "--cd"}, description = "Creation date", required = false, arity = 1)
        public String creationDate; 
    
        @Parameter(names = {"--modification-date", "--md"}, description = "Modification date", required = false, arity = 1)
        public String modificationDate; 
