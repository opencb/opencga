...
public class AnalysisClinicalCommandOptions {
    ...
    @Parameters(commandNames = {"interpreter-cancertiering-run"}, commandDescription ="Run cancer tiering interpretation analysis")
    ...
    public class RunInterpreterTieringCommandOptions {
        ...
        @Parameter(names = {"--penetrance"}, description = "Enum param allowed values: COMPLETE, INCOMPLETE, UNKNOWN", required = false, arity = 1)
