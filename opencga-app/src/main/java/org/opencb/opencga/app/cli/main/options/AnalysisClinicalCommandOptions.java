...
public class AnalysisClinicalCommandOptions {
    ...
    public class UpdateClinicalConfigurationCommandOptions {
        ...
        @Parameter(names = {"--priorities-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String prioritiesId; 
    
        @Parameter(names = {"--priorities-description"}, description = "The body web service description parameter", required = false, arity = 1)
        public String prioritiesDescription; 
    
        @Parameter(names = {"--priorities-rank"}, description = "The body web service rank parameter", required = false, arity = 1)
        public Integer prioritiesRank; 
    
        @Parameter(names = {"--priorities-default-priority"}, description = "The body web service defaultPriority parameter", required = false, arity = 1)
        public Boolean prioritiesDefaultPriority; 
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--files-id"}, description = "The body web service id parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--panels-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String panelsId; 
        ...
        @Parameter(names = {"--comments-message"}, description = "The body web service message parameter", required = false, arity = 1)
        public String commentsMessage; 
    
        @Parameter(names = {"--comments-tags"}, description = "The body web service tags parameter", required = false, arity = 1)
        public String commentsTags; 
    
        @Parameter(names = {"--comments-date"}, description = "The body web service date parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--flags-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String flagsId; 
    ...
    public class CreateInterpretationCommandOptions {
        ...
        @Parameter(names = {"--primary-findings-discussion"}, description = "The body web service discussion parameter", required = false, arity = 1)
        public String primaryFindingsDiscussion; 
    
        @Parameter(names = {"--primary-findings-chromosome"}, description = "The body web service chromosome parameter", required = false, arity = 1)
        public String primaryFindingsChromosome; 
    
        @Parameter(names = {"--primary-findings-alternate"}, description = "The body web service alternate parameter", required = false, arity = 1)
        public String primaryFindingsAlternate; 
    
        @Parameter(names = {"--primary-findings-strand"}, description = "The body web service strand parameter", required = false, arity = 1)
        public String primaryFindingsStrand; 
    
        @Parameter(names = {"--primary-findings-ids"}, description = "The body web service ids parameter", required = false, arity = 1)
        public String primaryFindingsIds; 
    
        @Parameter(names = {"--primary-findings-end"}, description = "The body web service end parameter", required = false, arity = 1)
        public Integer primaryFindingsEnd; 
    
        @Parameter(names = {"--primary-findings-start"}, description = "The body web service start parameter", required = false, arity = 1)
        public Integer primaryFindingsStart; 
    
        @Parameter(names = {"--primary-findings-names"}, description = "The body web service names parameter", required = false, arity = 1)
        public String primaryFindingsNames; 
    
        @Parameter(names = {"--primary-findings-length"}, description = "The body web service length parameter", required = false, arity = 1)
        public Integer primaryFindingsLength; 
    
        @Parameter(names = {"--primary-findings-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String primaryFindingsId; 
    
        @Parameter(names = {"--primary-findings-reference"}, description = "The body web service reference parameter", required = false, arity = 1)
        public String primaryFindingsReference; 
    
        @Parameter(names = {"--secondary-findings-discussion"}, description = "The body web service discussion parameter", required = false, arity = 1)
        public String secondaryFindingsDiscussion; 
    
        @Parameter(names = {"--secondary-findings-chromosome"}, description = "The body web service chromosome parameter", required = false, arity = 1)
        public String secondaryFindingsChromosome; 
    
        @Parameter(names = {"--secondary-findings-alternate"}, description = "The body web service alternate parameter", required = false, arity = 1)
        public String secondaryFindingsAlternate; 
    
        @Parameter(names = {"--secondary-findings-strand"}, description = "The body web service strand parameter", required = false, arity = 1)
        public String secondaryFindingsStrand; 
    
        @Parameter(names = {"--secondary-findings-ids"}, description = "The body web service ids parameter", required = false, arity = 1)
        public String secondaryFindingsIds; 
    
        @Parameter(names = {"--secondary-findings-end"}, description = "The body web service end parameter", required = false, arity = 1)
        public Integer secondaryFindingsEnd; 
    
        @Parameter(names = {"--secondary-findings-start"}, description = "The body web service start parameter", required = false, arity = 1)
        public Integer secondaryFindingsStart; 
    
        @Parameter(names = {"--secondary-findings-names"}, description = "The body web service names parameter", required = false, arity = 1)
        public String secondaryFindingsNames; 
    
        @Parameter(names = {"--secondary-findings-length"}, description = "The body web service length parameter", required = false, arity = 1)
        public Integer secondaryFindingsLength; 
    
        @Parameter(names = {"--secondary-findings-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String secondaryFindingsId; 
    
        @Parameter(names = {"--secondary-findings-reference"}, description = "The body web service reference parameter", required = false, arity = 1)
        public String secondaryFindingsReference; 
        ...
        @Parameter(names = {"--primary-findings-status"}, description = "Enum param allowed values: NOT_REVIEWED, REVIEW_REQUESTED, REVIEWED, DISCARDED, REPORTED", required = false, arity = 1)
        public String primaryFindingsStatus; 
    
        @Parameter(names = {"--primary-findings-type"}, description = "Enum param allowed values: SNV, MNV, INDEL, SV, INSERTION, DELETION, TRANSLOCATION, INVERSION, COPY_NUMBER, COPY_NUMBER_GAIN, COPY_NUMBER_LOSS, DUPLICATION, TANDEM_DUPLICATION, BREAKEND, NO_VARIATION, SYMBOLIC, MIXED, SNP, MNP, CNV", required = false, arity = 1)
        public String primaryFindingsType; 
    
        @Parameter(names = {"--secondary-findings-status"}, description = "Enum param allowed values: NOT_REVIEWED, REVIEW_REQUESTED, REVIEWED, DISCARDED, REPORTED", required = false, arity = 1)
        public String secondaryFindingsStatus; 
    
        @Parameter(names = {"--secondary-findings-type"}, description = "Enum param allowed values: SNV, MNV, INDEL, SV, INSERTION, DELETION, TRANSLOCATION, INVERSION, COPY_NUMBER, COPY_NUMBER_GAIN, COPY_NUMBER_LOSS, DUPLICATION, TANDEM_DUPLICATION, BREAKEND, NO_VARIATION, SYMBOLIC, MIXED, SNP, MNP, CNV", required = false, arity = 1)
        public String secondaryFindingsType; 
