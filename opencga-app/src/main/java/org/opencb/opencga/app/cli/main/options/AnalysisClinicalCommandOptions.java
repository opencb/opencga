...
public class AnalysisClinicalCommandOptions {
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--disorder-id"}, description = "The body web service id parameter", required = true, arity = 1)
        public String disorderId;
    
        @Parameter(names = {"--proband-id"}, description = "The body web service id parameter", required = true, arity = 1)
        public String probandId;
    
        @Parameter(names = {"--family-id"}, description = "The body web service id parameter", required = true, arity = 1)
        ...
        @Parameter(names = {"--interpretation-creation-date", "--cd"}, description = "The body web service creationDate parameter", required = false, arity = 1)
        public String interpretationCreationDate;
    
        @Parameter(names = {"--interpretation-modification-date", "--md"}, description = "The body web service modificationDate parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--priority-id"}, description = "The body web service id parameter", required = true, arity = 1)
        public String priorityId;
    
        @Parameter(names = {"--status-id"}, description = "The body web service id parameter", required = true, arity = 1)
    ...
    public class DistinctInterpretationCommandOptions {
        ...
        @Parameter(names = {"--methods-name"}, description = "Interpretation method name", required = false, arity = 1)
