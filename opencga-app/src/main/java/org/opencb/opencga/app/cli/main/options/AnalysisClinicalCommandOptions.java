...
public class AnalysisClinicalCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--clinical-analysis"}, description = "The body clinicalAnalysis ClinicalAnalysisAclUpdateParams web service parameter", required = false, arity = 1)
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--type"}, description = "The body type ClinicalAnalysisCreateParams web service parameter", required = false, arity = 1)
        public String type;
        ...
        @Parameter(names = {"--proband-id"}, description = "The body id ProbandParam web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--analyst-id"}, description = "The body id ClinicalAnalystParam web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--interpretation-description"}, description = "Field to store information of the item", required = false, arity = 1)
        public String interpretationDescription;
    
        @Parameter(names = {"--interpretation-clinical-analysis-id"}, description = "The body clinicalAnalysisId InterpretationCreateParams web service parameter", required = false, arity = 1)
        public String interpretationClinicalAnalysisId;
    
        @Parameter(names = {"--interpretation-creation-date"}, description = "The creation date of the item", required = false, arity = 1)
        ...
        @Parameter(names = {"--due-date"}, description = "The body dueDate ClinicalAnalysisCreateParams web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--type"}, description = "The body type ClinicalAnalysisUpdateParams web service parameter", required = false, arity = 1)
        public String type;
        ...
        @Parameter(names = {"--locked"}, description = "The body locked ClinicalAnalysisUpdateParams web service parameter", required = false, arity = 1)
        public Boolean locked;
        ...
        @Parameter(names = {"--due-date"}, description = "The body dueDate ClinicalAnalysisUpdateParams web service parameter", required = false, arity = 1)
        public String dueDate;
    ...
    public class CreateInterpretationCommandOptions {
        ...
        @Parameter(names = {"--clinical-analysis-id"}, description = "The body clinicalAnalysisId InterpretationCreateParams web service parameter", required = false, arity = 1)
        public String clinicalAnalysisId;
