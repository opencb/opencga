...
public class AnalysisClinicalCommandOptions {
    ...
    @Parameters(commandNames = {"rga-aggregationStats"}, commandDescription ="RGA aggregation stats")
    ...
    @Parameters(commandNames = {"interpretation-merge"}, commandDescription ="Merge interpretation")
