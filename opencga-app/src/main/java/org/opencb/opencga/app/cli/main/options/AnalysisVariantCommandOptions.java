...
public class AnalysisVariantCommandOptions {
    ...
    public class RunGwasCommandOptions {
        ...
        @Parameter(names = {"--method"}, description = "Enum param allowed values: FISHER_TEST, CHI_SQUARE_TEST", required = false, arity = 1)
        public String method;
    
        @Parameter(names = {"--fisher-mode"}, description = "Enum param allowed values: LESS, GREATER, TWO_SIDED", required = false, arity = 1)
