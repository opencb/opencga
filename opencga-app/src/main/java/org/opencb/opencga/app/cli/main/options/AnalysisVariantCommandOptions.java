...
public class AnalysisVariantCommandOptions {
        ...
        public RunRegenieBuilderCommandOptions runRegenieBuilderCommandOptions;
    ...
    public AnalysisVariantCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.runRegenieBuilderCommandOptions = new RunRegenieBuilderCommandOptions();
    ...
    @Parameters(commandNames = {"regenie-builder-run"}, commandDescription ="Regenie is a program for whole genome regression modelling of large genome-wide association studies. The tool regenie-builder creates the regenie-walker docker with the files from step1, to execute the step2 of the regenie analysis in the OpenCGA framework.")
    public class RunRegenieBuilderCommandOptions {
        ...
        @DynamicParameter(names = {"--regenie-file-options"}, description = "Regenie options for files as described in the Regenie documentation that will be include in the regenie-walker docker to use in step2. Key-values examples: '--bgen'='file://regenie/example.bgen'. Use: --regenie-file-options key=value", required = false)
        public Map<String, ?> regenieFileOptions = new HashMap<>(); //Dynamic parameters must be initialized;
