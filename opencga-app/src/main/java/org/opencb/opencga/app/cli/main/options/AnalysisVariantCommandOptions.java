...
public class AnalysisVariantCommandOptions {
    ...
    public class RunExportCommandOptions {
        ...
        @Parameter(names = {"--body_clinical-confirmed-status"}, description = "The body web service clinicalConfirmedStatus parameter", required = false, help = true, arity = 0)
        public boolean bodyClinicalConfirmedStatus = false;
        ...
        @Parameter(names = {"--body_sample-metadata"}, description = "The body web service sampleMetadata parameter", required = false, help = true, arity = 0)
        public boolean bodySampleMetadata = false;
    
        @Parameter(names = {"--body_sort"}, description = "The body web service sort parameter", required = false, help = true, arity = 0)
        public boolean bodySort = false;
        ...
        @Parameter(names = {"--body_summary"}, description = "The body web service summary parameter", required = false, help = true, arity = 0)
        public boolean bodySummary = false;
    ...
    public class QueryMutationalSignatureCommandOptions {
        ...
        @Parameter(names = {"--fitting"}, description = "Compute the relative proportions of the different mutational signatures demonstrated by the tumour", required = false, help = true, arity = 0)
    ...
    public class RunMutationalSignatureCommandOptions {
        ...
        @Parameter(names = {"--fitting"}, description = "The body web service fitting parameter", required = false, help = true, arity = 0)
        public boolean fitting = false;
    ...
    public class RunSampleQcCommandOptions {
        ...
        @Parameter(names = {"--variant-stats-query-clinical-confirmed-status"}, description = "The body web service clinicalConfirmedStatus parameter", required = false, help = true, arity = 0)
        public boolean variantStatsQueryClinicalConfirmedStatus = false;
