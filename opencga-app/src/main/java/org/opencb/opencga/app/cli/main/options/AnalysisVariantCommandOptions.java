...
public class AnalysisVariantCommandOptions {
    ...
    @Parameters(commandNames = {"exomiser-run"}, commandDescription ="The Exomiser is a Java program that finds potential disease-causing"
    ...
    public class RunExomiserCommandOptions {
        ...
        @Parameter(names = {"--json-file"}, description = "File with the body data in JSON format. Note, that using this parameter will"
                + " ignore all the other parameters.", arity = 1)
        public String jsonFile;

        @Parameter(names = {"--json-data-model"}, description = "Show example of file structure for body data.", help = true, arity = 0)
        public Boolean jsonDataModel = false;

        @Parameter(names = {"--study", "-s"}, description = "study", required = true, arity = 1)
        public String study;

        @Parameter(names = {"--job-id"}, description = "Job ID. It must be a unique string within the study. An ID will be autogenerated"
                + " automatically if not provided.", arity = 1)
        public String jobId;
        ...
        @Parameter(names = {"--sample"}, description = "Sample ID.", arity = 1)
        public String sample;

        @Parameter(names = {"--exomiser-version"}, description = "Exomiser version.", arity = 1)
        public String exomiserVersion;

        @Parameter(names = {"--outdir"}, description = "Output dir for the job.", arity = 1)
        public String outdir;
