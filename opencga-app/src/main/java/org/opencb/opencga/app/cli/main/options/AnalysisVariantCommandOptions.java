...
public class AnalysisVariantCommandOptions {
    ...
    public class RunLiftoverCommandOptions {
        ...
        @Parameter(names = {"--vcf-destination"}, description = "Destination path where the lifted-over VCF files will be stored. If left empty, the VCF files will be stored in the job folder. If the keyword OPENCCGA_VCF_INPUT_FOLDER is used, they will be stored in the same folder as the input VCF files. Otherwise, they will be stored in the specified destination path", required = false, arity = 1)
