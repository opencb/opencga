...
public class AnalysisVariantCommandOptions {
    ...
    public class RunCohortStatsCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "The body cohort CohortVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String cohort;
        ...
        @Parameter(names = {"--outdir"}, description = "The body outdir CohortVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String outdir;
    ...
    public class RunExportCommandOptions {
        ...
        @Parameter(names = {"--panel-feature-type"}, description = "The body panelFeatureType AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--gene-role-in-cancer"}, description = "The body sift VariantQueryParams web service parameter", required = false, arity = 1)
    ...
    public class RunGwasCommandOptions {
        ...
        @Parameter(names = {"--phenotype"}, description = "The body phenotype GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String phenotype;
    
        @Parameter(names = {"--index"}, description = "The body index GwasAnalysisParams web service parameter", required = false, help = true, arity = 0)
        public boolean index = false;
    
        @Parameter(names = {"--index-score-id"}, description = "The body indexScoreId GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String indexScoreId;
    
        @Parameter(names = {"--method"}, description = "The body method GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String method;
    
        @Parameter(names = {"--fisher-mode"}, description = "The body fisherMode GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String fisherMode;
    
        @Parameter(names = {"--case-cohort"}, description = "The body caseCohort GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String caseCohort;
    
        @Parameter(names = {"--case-cohort-samples-annotation"}, description = "The body caseCohortSamplesAnnotation GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String caseCohortSamplesAnnotation;
    
        @Parameter(names = {"--case-cohort-samples"}, description = "The body caseCohortSamples GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String caseCohortSamples;
    
        @Parameter(names = {"--control-cohort"}, description = "The body controlCohort GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String controlCohort;
    
        @Parameter(names = {"--control-cohort-samples-annotation"}, description = "The body controlCohortSamplesAnnotation GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String controlCohortSamplesAnnotation;
    
        @Parameter(names = {"--control-cohort-samples"}, description = "The body controlCohortSamples GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String controlCohortSamples;
    
        @Parameter(names = {"--outdir"}, description = "The body outdir GwasAnalysisParams web service parameter", required = false, arity = 1)
        public String outdir;
    ...
    public class RunKnockoutCommandOptions {
        ...
        @Parameter(names = {"--sample"}, description = "The body sample KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String sample;
    
        @Parameter(names = {"--gene"}, description = "The body gene KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String gene;
    
        @Parameter(names = {"--panel"}, description = "The body panel KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String panel;
    
        @Parameter(names = {"--biotype"}, description = "The body biotype KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String biotype;
    
        @Parameter(names = {"--consequence-type"}, description = "The body consequenceType KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String consequenceType;
    
        @Parameter(names = {"--filter"}, description = "The body filter KnockoutAnalysisParams web service parameter", required = false, arity = 1)
        public String filter;
    ...
    public class RunSampleQcCommandOptions {
        ...
        @Parameter(names = {"--vs-query-panel-feature-type"}, description = "The body panelFeatureType AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
    ...
    public class RunSampleStatsCommandOptions {
        ...
        @Parameter(names = {"--sample"}, description = "The body sample SampleVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String sample;
    
        @Parameter(names = {"--individual"}, description = "The body individual SampleVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String individual;
    
        @Parameter(names = {"--variant-query-id"}, description = "The body id AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryId;
    
        @Parameter(names = {"--variant-query-region"}, description = "The body region AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryRegion;
    
        @Parameter(names = {"--variant-query-gene"}, description = "The body gene AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryGene;
    
        @Parameter(names = {"--variant-query-type"}, description = "The body type AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryType;
    
        @Parameter(names = {"--variant-query-panel"}, description = "The body panel AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPanel;
    
        @Parameter(names = {"--variant-query-panel-mode-of-inheritance"}, description = "The body panelModeOfInheritance AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPanelModeOfInheritance;
    
        @Parameter(names = {"--variant-query-panel-confidence"}, description = "The body panelConfidence AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--variant-query-panel-feature-type"}, description = "The body panelFeatureType AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPanelFeatureType;
    
        @Parameter(names = {"--variant-query-cohort-stats-alt"}, description = "The body cohortStatsAlt AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryCohortStatsAlt;
    
        @Parameter(names = {"--variant-query-cohort-stats-maf"}, description = "The body cohortStatsMaf AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryCohortStatsMaf;
    
        @Parameter(names = {"--variant-query-ct"}, description = "The body ct AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryCt;
    
        @Parameter(names = {"--variant-query-xref"}, description = "The body xref AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryXref;
    
        @Parameter(names = {"--variant-query-biotype"}, description = "The body type AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryBiotype;
    
        @Parameter(names = {"--variant-query-protein-substitution"}, description = "The body proteinSubstitution AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryProteinSubstitution;
    
        @Parameter(names = {"--variant-query-conservation"}, description = "The body conservation AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryConservation;
    
        @Parameter(names = {"--variant-query-population-frequency-maf"}, description = "The body populationFrequencyMaf AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPopulationFrequencyMaf;
    
        @Parameter(names = {"--variant-query-population-frequency-alt"}, description = "The body populationFrequencyAlt AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPopulationFrequencyAlt;
    
        @Parameter(names = {"--variant-query-population-frequency-ref"}, description = "The body populationFrequencyRef AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryPopulationFrequencyRef;
    
        @Parameter(names = {"--variant-query-transcript-flag"}, description = "The body transcriptFlag AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryTranscriptFlag;
    
        @Parameter(names = {"--variant-query-functional-score"}, description = "The body functionalScore AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        public String variantQueryFunctionalScore;
    
        @Parameter(names = {"--variant-query-clinical"}, description = "The body clinical AnnotationVariantQueryParams web service parameter", required = false, arity = 1)
        ...
        @Parameter(names = {"--index-description"}, description = "The body indexDescription SampleVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String indexDescription;
    
        @Parameter(names = {"--batch-size"}, description = "The body batchSize SampleVariantStatsAnalysisParams web service parameter", required = false, arity = 1)
    ...
    public class RunStatsExportCommandOptions {
        ...
        @Parameter(names = {"--cohorts"}, description = "The body cohorts VariantStatsExportParams web service parameter", required = false, arity = 1)
        public String cohorts;
    
        @Parameter(names = {"--output"}, description = "The body output VariantStatsExportParams web service parameter", required = false, arity = 1)
        public String output;
    
        @Parameter(names = {"--region"}, description = "The body region VariantStatsExportParams web service parameter", required = false, arity = 1)
        public String region;
    
        @Parameter(names = {"--gene"}, description = "The body gene VariantStatsExportParams web service parameter", required = false, arity = 1)
        public String gene;
    
        @Parameter(names = {"--output-file-format"}, description = "The body outputFileFormat VariantStatsExportParams web service parameter", required = false, arity = 1)
        public String outputFileFormat;
    ...
    public class RunStatsCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "The body cohort VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String cohort;
    
        @Parameter(names = {"--samples"}, description = "The body samples VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String samples;
    
        @Parameter(names = {"--region"}, description = "The body region VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String region;
    
        @Parameter(names = {"--gene"}, description = "The body gene VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String gene;
    
        @Parameter(names = {"--outdir"}, description = "The body outdir VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String outdir;
    
        @Parameter(names = {"--output-file-name"}, description = "The body outputFileName VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String outputFileName;
    
        @Parameter(names = {"--aggregated"}, description = "The body aggregated VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String aggregated;
    
        @Parameter(names = {"--aggregation-mapping-file"}, description = "The body aggregationMappingFile VariantStatsAnalysisParams web service parameter", required = false, arity = 1)
        public String aggregationMappingFile;
