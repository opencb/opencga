 ...
 */
@Parameters(commandNames = {"analysis - variant"}, commandDescription = "Analysis - Variant commands")
public class AnalysisVariantCommandOptions {
    ...
    public class InfoCohortStatsCommandOptions {
        ...
        @Parameter(names = {"--cohort"}, description = "Comma separated list of cohort names or IDs up to a maximum of 100", required = true, arity = 1)
        public String cohort; 
    ...
    public class RunIndexCommandOptions {
        ...
        @Parameter(names = {"--exclude-genotypes"}, description = "The body web service excludeGenotypes parameter", required = false, arity = 1)
