...
public class AnalysisVariantCommandOptions {
    ...
    public class RunCircosCommandOptions {
        ...
        @Parameter(names = {"--tracks-id"}, description = "The body web service id parameter", required = false, arity = 1)
        public String tracksId; 
    
        @Parameter(names = {"--tracks-type"}, description = "The body web service type parameter", required = false, arity = 1)
        public String tracksType; 
