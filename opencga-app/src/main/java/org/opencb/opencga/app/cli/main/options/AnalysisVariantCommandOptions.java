...
public class AnalysisVariantCommandOptions {
    ...
    public class QueryMutationalSignatureCommandOptions {
        ...
        public String thresholdPerc = "5f"; 
        ...
        public String thresholdPval = "0.05f"; 
    ...
    public class RunSampleQcCommandOptions {
        ...
        @Parameter(names = {"--signature-query"}, description = "The body web service signatureQuery parameter", required = false, arity = 1)
