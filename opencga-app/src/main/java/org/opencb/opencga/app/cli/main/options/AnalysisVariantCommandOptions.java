...
public class AnalysisVariantCommandOptions {
    ...
    public class RunMutationalSignatureCommandOptions {
        ...
        @Parameter(names = {"--query"}, description = "Signature query in JSON format.", required = false, arity = 1)
        public String query;
    ...
    public class RunSampleQcCommandOptions {
        ...
        @Parameter(names = {"--signature-id"}, description = "Signature ID.", required = false, arity = 1)
        public String signatureId;
    
        @Parameter(names = {"--signature-description"}, description = "Signature description.", required = false, arity = 1)
        public String signatureDescription;
    
        @Parameter(names = {"--signature-query"}, description = "Signature query in JSON format.", required = false, arity = 1)
        public String signatureQuery;
    
        @Parameter(names = {"--signature-fit-method"}, description = "Either Fit or FitMS. If not specified then FitMS", required = false, arity = 1)
        public String signatureFitMethod = "FitMS";
    
        @Parameter(names = {"--signature-n-boot"}, description = "Number of bootstrap to be used.", required = false, arity = 1)
        public Integer signatureNBoot;
    
        @Parameter(names = {"--signature-sig-version"}, description = "Either COSMICv2, COSMICv3.2, RefSigv1 or RefSigv2. If not specified RefSigv2.", required = false, arity = 1)
        public String signatureSigVersion = "RefSigv2";
    
        @Parameter(names = {"--signature-organ"}, description = "When using RefSigv1 or RefSigv2 as SIGVERSION, organ-specific signatures will be used. If SIGVERSION is COSMICv2 or COSMICv3.2, then a selection of signatures found in the given organ will be used. Available organs depend on the selected SIGVERSION. For RefSigv1 or RefSigv2: Biliary, Bladder, Bone_SoftTissue, Breast, Cervix (v1 only), CNS, Colorectal, Esophagus, Head_neck, Kidney, Liver, Lung, Lymphoid, NET (v2 only), Oral_Oropharyngeal (v2 only), Ovary, Pancreas, Prostate, Skin, Stomach, Uterus.", required = false, arity = 1)
        public String signatureOrgan;
    
        @Parameter(names = {"--signature-threshold-perc"}, description = "Threshold in percentage of total mutations in a sample, only exposures larger than THRPERC are considered. If not specified 5.", required = false, arity = 1)
        public Float signatureThresholdPerc = 5f;
    
        @Parameter(names = {"--signature-threshold-pval"}, description = "P-value to determine the empirical probability that the exposure is lower than the threshold. If not specified then 0.05.", required = false, arity = 1)
