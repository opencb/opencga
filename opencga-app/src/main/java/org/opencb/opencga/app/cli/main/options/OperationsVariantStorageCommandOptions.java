 ...
 */
@Parameters(commandNames = {"operations - variant storage"}, commandDescription = "Operations - Variant Storage commands")
public class OperationsVariantStorageCommandOptions {
    ...
    public class ConfigureCellbaseCommandOptions {
        ...
        @Parameter(names = {"--project"}, description = "Project [user@]project where project can be either the ID or the alias", required = false, arity = 1)
