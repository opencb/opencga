...
public class OperationsVariantStorageCommandOptions {
    ...
    @Parameters(commandNames = {"variant-family-index"}, commandDescription ="Build the family index")
    ...
    @Parameters(commandNames = {"variant-sample-index"}, commandDescription ="Build and annotate the sample index")
    ...
    @Parameters(commandNames = {"variant-sample-index-configure"}, commandDescription ="Update SampleIndex configuration")
    ...
    @Parameters(commandNames = {"variant-secondaryindex-delete"}, commandDescription ="Remove a secondary index from the search engine for a specific set of samples.")
