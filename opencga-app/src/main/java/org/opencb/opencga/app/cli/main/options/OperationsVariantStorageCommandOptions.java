...
public class OperationsVariantStorageCommandOptions {
    ...
    public class PruneVariantCommandOptions {
        ...
        @Parameter(names = {"--dry-run"}, description = "The body web service dryRun parameter", required = false, arity = 1)
    ...
    @Parameters(commandNames = {"variant-secondary-index"}, commandDescription ="Creates a secondary index using a search engine. If samples are provided, sample data will be added to the secondary index.")
