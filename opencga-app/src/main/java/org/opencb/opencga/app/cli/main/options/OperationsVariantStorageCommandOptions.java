...
public class OperationsVariantStorageCommandOptions {
    ...
    @Parameters(commandNames = {"aggregate-variant"}, commandDescription ="Find variants where not all the samples are present, and fill the empty values, excluding HOM-REF (0/0) values.")
    ...
    @Parameters(commandNames = {"save-variant-annotation"}, commandDescription ="Save a copy of the current variant annotation at the database")
    ...
    @Parameters(commandNames = {"aggregate-variant-family"}, commandDescription ="Find variants where not all the samples are present, and fill the empty values.")
    ...
    @Parameters(commandNames = {"index-variant"}, commandDescription ="Index variant files into the variant storage")
    ...
    @Parameters(commandNames = {"launcher-variant-index"}, commandDescription ="Detect non-indexed VCF files in the study, and submit a job for indexing them.")
    public class LauncherVariantIndexCommandOptions {
        ...
        @Parameter(names = {"--index-params-description"}, description = "The body web service DESCRIPTION parameter", required = false, arity = 1)
    ...
    @Parameters(commandNames = {"repair-variant-metadata"}, commandDescription ="Execute some repairs on Variant Storage Metadata. Advanced users only.")
    ...
    @Parameters(commandNames = {"delete-variant-sample"}, commandDescription ="Remove variant samples from the variant storage")
    ...
    @Parameters(commandNames = {"secondaryIndex-variant"}, commandDescription ="Creates a secondary index using a search engine. If samples are provided, sample data will be added to the secondary index.")
    ...
    @Parameters(commandNames = {"delete-variant-secondaryIndex"}, commandDescription ="Remove a secondary index from the search engine for a specific set of samples.")
    ...
    @Parameters(commandNames = {"index-variant-stats"}, commandDescription ="Compute variant stats for any cohort and any set of variants and index the result in the variant storage database.")
