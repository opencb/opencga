...
public class OperationsVariantStorageCommandOptions {
    ...
    @Parameters(commandNames = {"variant-secondaryIndex"}, commandDescription ="Creates a secondary index using a search engine. If samples are provided, sample data will be added to the secondary index.")
    ...
    @Parameters(commandNames = {"delete-variant-study"}, commandDescription ="Remove whole study from the variant storage")
