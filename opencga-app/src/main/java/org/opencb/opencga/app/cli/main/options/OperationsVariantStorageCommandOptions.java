...
public class OperationsVariantStorageCommandOptions {
    ...
    @Parameters(commandNames = {"variant-family-index"}, commandDescription ="DEPRECATED: integrated in index (Build the family index)")
    ...
    @Parameters(commandNames = {"variant-sample-index"}, commandDescription ="DEPRECATED Instead you should use the command 'variant-secondary-sample-index'.")
    ...
    @Parameters(commandNames = {"variant-sample-index-configure"}, commandDescription ="DEPRECATED Instead you should use the command 'configure-variant-secondary-sample-index'.")
    ...
    @Parameters(commandNames = {"variant-secondary-annotation-index"}, commandDescription ="Creates a secondary index using a search engine. If samples are provided, sample data will be added to the secondary index.")
    ...
    @Parameters(commandNames = {"variant-secondary-sample-index"}, commandDescription ="Build and annotate the sample index")
    ...
    @Parameters(commandNames = {"configure-variant-secondary-sample-index"}, commandDescription ="Update SampleIndex configuration")
    ...
    @Parameters(commandNames = {"variant-secondary-index"}, commandDescription ="DEPRECATED Instead you should use the command 'variant-secondary-annotation-index'.")
