...
import static org.opencb.commons.app.cli.GeneralCliOptions.*;
...
public class OperationsVariantStorageCommandOptions {
    ...
    public class IndexVariantAnnotationCommandOptions {
        ...
        @Parameter(names = {"--sample-index-annotation"}, description = "Enum param allowed values: YES, NO, AUTO", required = false, arity = 1)
