...
public class VariantCommandExecutor extends OpencgaCommandExecutor {
    ...
    private RestResponse<Variant> metadataAnnotation() throws ClientException {
    ...
    private RestResponse<VariantSetStats> infoCohortStats() throws ClientException {
        ...
        return openCGAClient.getVariantClient().infoCohortStats(commandOptions.cohort.name(), queryParams);
    }
    ...
    private RestResponse<ObjectMap> genotypesFamily() throws ClientException {
        ...
        return openCGAClient.getVariantClient().genotypesFamily(queryParams);
    }
    ...
    private RestResponse<SampleVariantStats> querySampleStats() throws ClientException {
        ...
        return openCGAClient.getVariantClient().querySampleStats(commandOptions.sample.name(), queryParams);
    }
