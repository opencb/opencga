...
public class JobsCommandExecutor extends ParentJobsCommandExecutor {
    ...
    private RestResponse<ObjectMap> updateAcl() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            PrintUtils.println(getObjectAsJSON(object));
            return res;
        } else if (commandOptions.jsonFile != null) {
            object = JacksonUtils.getDefaultObjectMapper()
                    .readValue(new java.io.File(commandOptions.jsonFile), Object.class);
        }
        return openCGAClient.getJobClient().updateAcl(commandOptions.members, commandOptions.action, object);
    }
    ...
    private RestResponse<Job> create() throws Exception {
        ...
        if (commandOptions.jsonDataModel) {
            ...
            JobResult resultParam = new JobResult();
            ...
            jobCreateParams.setExecutionId(commandOptions.executionId);
    ...
    private RestResponse<Job> retry() throws Exception {
        ...
        return openCGAClient.getJobClient().retry(executionRetryParams, queryParams);
    }
