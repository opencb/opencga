...
public class JobsCommandExecutor extends ParentJobsCommandExecutor {
    ...
    private RestResponse<Job> create() throws Exception {
        ...
        invokeSetter(jobResult, "id", commandOptions.resultId);
        ...
        ((JobCreateParams)jobCreateParams)
            ...
            .setExecutionId(commandOptions.executionId)
            .setTool(toolInfo)
    ...
    private RestResponse<Job> retry() throws Exception {
        ...
        ((ExecutionRetryParams)executionRetryParams)
            .setExecution(commandOptions.execution);
