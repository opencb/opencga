...
public class DiseasePanelsCommandOptions {
    ...
    public class UpdateAclCommandOptions {
        ...
        @Parameter(names = {"--panel"}, description = "The body panel PanelAclUpdateParams web service parameter", required = false, arity = 1)
        public String panel;
    ...
    public class CreateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name PanelCreateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--description"}, description = "Field to store information of the item", required = false, arity = 1)
        public String description;
    
        @Parameter(names = {"--author"}, description = "The body author PanelCreateParams web service parameter", required = false, arity = 1)
    ...
    public class UpdateCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "The body name PanelUpdateParams web service parameter", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--description"}, description = "Field to store information of the item", required = false, arity = 1)
        public String description;
    
        @Parameter(names = {"--author"}, description = "The body author PanelUpdateParams web service parameter", required = false, arity = 1)
        public String author;
