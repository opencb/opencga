...
public class DiseasePanelsCommandOptions {
    ...
    public class ImportCommandOptions {
        ...
        @Parameter(names = {"--source"}, description = "Source id from where the panels will be imported. It can be either PANEL_APP or CANCER_GENE_CENSUS.", required = false, arity = 1)
        public String source;
    
        @Parameter(names = {"--id"}, description = "Deprecated parameter. Use 'panelIds' parameter instead.", required = false, arity = 1)
        public String id;
    
        @Parameter(names = {"--panel-ids"}, description = "Panel id list to be imported from the source", required = false, arity = 1)
        public String panelIds;
    
        @Parameter(names = {"--content"}, description = "Panel content. Only expected for CANCER_GENE_CENSUS source currently.", required = false, arity = 1)
