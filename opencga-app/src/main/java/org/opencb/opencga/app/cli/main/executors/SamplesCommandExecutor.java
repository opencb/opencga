...
public class SamplesCommandExecutor extends OpencgaCommandExecutor {
    ...
    private void acls() throws CatalogException,IOException {
        ...
        logger.debug("Acls");
        ObjectMap objectMap = new ObjectMap();
        QueryResponse<Object> acls = openCGAClient.getSampleClient().getAllAcl(samplesCommandOptions.aclsCommandOptions.id,
                objectMap);
    ...
    private void aclMemberInfo() throws CatalogException,IOException {
        ...
        ObjectMap objectMap = new ObjectMap();
        QueryResponse<Object> acls = openCGAClient.getSampleClient().getAcl(samplesCommandOptions.aclsMemberInfoCommandOptions.id,
                samplesCommandOptions.aclsMemberInfoCommandOptions.memberId, objectMap);
        System.out.println(acls.toString());
    }
    ...
    private void aclMemberUpdate() throws CatalogException,IOException {
        ...
        QueryResponse<Object> acl = openCGAClient.getSampleClient().updateAcl(samplesCommandOptions.aclsMemberUpdateCommandOptions.id,
