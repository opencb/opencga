...
public class SamplesCommandExecutor extends OpencgaCommandExecutor {
    ...
    public SamplesCommandExecutor(SamplesCommandOptions samplesCommandOptions) {
    ...
    private RestResponse<Object> distinct() throws Exception {
        ...
        queryParams.putIfNotEmpty("collectionTissue", commandOptions.collectionTissue);
        queryParams.putIfNotEmpty("collectionOrgan", commandOptions.collectionOrgan);
