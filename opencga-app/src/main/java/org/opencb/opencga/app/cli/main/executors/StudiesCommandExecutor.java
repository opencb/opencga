...
public class StudiesCommandExecutor extends ParentStudiesCommandExecutor {
    ...
    private RestResponse<Pipeline> updatePipelines() throws Exception {
        ...
        invokeSetter(linkedHashMap, "accessOrder", commandOptions.jobsAccessOrder);
        ...
        ((PipelineCreateParams)pipelineCreateParams)
            .setId(commandOptions.id)
            .setDescription(commandOptions.description)
            .setCreationDate(commandOptions.creationDate)
            .setModificationDate(commandOptions.modificationDate)
            .setJobs(linkedHashMap);

            if (commandOptions.disabled != null){
                ((PipelineCreateParams)pipelineCreateParams).setDisabled(commandOptions.disabled);
             }
