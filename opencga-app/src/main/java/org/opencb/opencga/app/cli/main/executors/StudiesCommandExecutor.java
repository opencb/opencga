...
//            LinkedHashMap jobsParam = new LinkedHashMap();
//            jobsParam.setToolId(commandOptions.jobsToolId);
//            //jobsParam.setExecutable(commandOptions.jobsExecutable);  // Unsupported param. FIXME
//            jobsParam.setName(commandOptions.jobsName);
//            jobsParam.setDescription(commandOptions.jobsDescription);
//            jobsParam.setParams(new HashMap<>(commandOptions.jobsParams));
//            jobsParam.setTags(splitWithTrim(commandOptions.jobsTags));
//            jobsParam.setDependsOn(splitWithTrim(commandOptions.jobsDependsOn));
...
//            pipelineCreateParams.setJobs(jobsParam);
