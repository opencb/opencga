...
class OptionCliGenerator(RestClientGenerator):
    ...
    def get_imports(self):
        ...
        headers.append('*/')
        headers.append('')
        headers.append('package org.opencb.opencga.app.cli.main.options;')
        headers.append('')
    ...
    def get_class_definition(self, category):
        ...
        for attribute in class_attributes.values():
            if self.check_ignore_command(category["name"], attribute.lower()):
                append_text(text,
        ...
        text.append('')
        text.append(
            '{}public {}CommandOptions(JCommander jCommander) {{'.format(
