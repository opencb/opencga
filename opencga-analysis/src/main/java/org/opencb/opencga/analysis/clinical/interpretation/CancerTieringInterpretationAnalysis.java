...
public class CancerTieringInterpretationAnalysis extends InterpretationAnalysis {
    ...
    public InterpretationResult compute() throws Exception {
        ...
        if (clinicalAnalysis == null) {
            throw new AnalysisException("Clinical analysis is null for ID " + clinicalAnalysisId);
        }
        ...
        if (CollectionUtils.isNotEmpty(somaticSamples)) {
            ...
            List<ReportedVariant> reportedGermlineVariants = getReportedGermlineVariants(clinicalAnalysis.getProband(), germlineSamples,
                    phenotypes);
        ...
        Interpretation interpretation = new Interpretation()
                ...
                .setSoftware(new Software().setName("CancerTieringAnalysis"))
    ...
    private List<ReportedVariant> getReportedGermlineVariants(Individual proband, List<Sample> germlineSamples, List<String> phenotypes)
        ...
        query.put(VariantQueryParam.GENE.key(), getGeneIdsFromDiseasePanels(panels));
