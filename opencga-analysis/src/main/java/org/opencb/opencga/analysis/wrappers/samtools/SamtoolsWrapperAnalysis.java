...
//                                SamtoolsStats alignmentStats = parseSamtoolsStats(outputFile, inputCatalogFile.getId());
...
//    }
    ...
    public static SamtoolsStats parseSamtoolsStats(File file, String fileId) throws IOException {
