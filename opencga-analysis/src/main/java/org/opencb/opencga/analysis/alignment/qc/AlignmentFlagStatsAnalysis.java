...
public class AlignmentFlagStatsAnalysis extends OpenCgaToolScopeStudy {
    ...
    protected void run() throws ToolException {
        ...
        try {
            Map<String, Object> params = new AlignmentStatsParams(analysisParams.getFile(), null)
                    .toParams(new ObjectMap(ParamConstants.STUDY_PARAM, study));

            catalogManager.getJobManager()
                    .submit(study, AlignmentStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by " + getId() + " - "
                                    + getJobId(), Collections.emptyList(), Collections.emptyList(), token);
