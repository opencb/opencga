...
public class AuxiliarRgaDataModel {
    ...
    static {
        ...
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.VARIANTS, ID);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.DB_SNPS, DB_SNP);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.TYPES, TYPE);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.KNOCKOUT_TYPES, KNOCKOUT_TYPES);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.CONSEQUENCE_TYPES, CONSEQUENCE_TYPES);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.CLINICAL_SIGNIFICANCES, CLINICAL_SIGNIFICANCES);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.GENE_ID, GENE_IDS);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.GENE_NAME, GENE_NAMES);
        MAIN_TO_AUXILIAR_DATA_MODEL_MAP.put(RgaDataModel.TRANSCRIPT_ID, TRANSCRIPT_IDS);
    }
