...
public class FileLinkTask extends OpenCgaTool {
    ...
    protected void run() throws Exception {
        List<String> postLinkFileIds = new ArrayList<>(toolParams.getUri().size());
        ...
        if (!postLinkFileIds.isEmpty()) {
            ...
            Job postLinkJob = catalogManager.getJobManager()
                    .submit(getStudy(), JobType.NATIVE_TOOL, PostLinkSampleAssociation.ID, Enums.Priority.MEDIUM, params, null,
