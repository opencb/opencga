...
//        }
    ...
    private void runClinicalInterpretationAnalysis() throws ToolException {
        RdInterpretationAnalysis rdInterpretationAnalysis = new RdInterpretationAnalysis(analysisParams.getClinicalAnalysisId(),
                configPath, study, getCatalogManager(), getVariantStorageManager(), token);

        Interpretation interpretation;
        try {
            interpretation = rdInterpretationAnalysis.run();
        } catch (CatalogException e) {
            throw new ToolException(e);
        }
