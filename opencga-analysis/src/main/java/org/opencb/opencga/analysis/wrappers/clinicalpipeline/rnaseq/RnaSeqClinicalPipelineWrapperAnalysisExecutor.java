...
@ToolExecutor(id = RnaSeqClinicalPipelineWrapperAnalysisExecutor.ID,
        tool = AffyClinicalPipelineWrapperAnalysis.ID,
        source = ToolExecutor.Source.STORAGE,
        framework = ToolExecutor.Framework.LOCAL)
public class RnaSeqClinicalPipelineWrapperAnalysisExecutor extends DockerWrapperAnalysisExecutor {
    ...
    private RnaSeqPipelineConfig pipelineConfig;
    private List<String> pipelineSteps;

    @Override
    protected void run() throws Exception {
        try {
            RnaSeqPipelineConfig pipeline = ClinicalPipelineUtils.copyPipelineConfig(pipelineConfig);
    ...
    private String buildScriptCli(RnaSeqPipelineConfig pipeline, List<AbstractMap.SimpleEntry<String, String>> inputBindings,
    ...
    public RnaSeqClinicalPipelineWrapperAnalysisExecutor setStudy(String study) {
        this.study = study;
        return this;
    }
    ...
    public RnaSeqClinicalPipelineWrapperAnalysisExecutor setScriptPath(Path scriptPath) {
        this.scriptPath = scriptPath;
        return this;
    }

    public RnaSeqPipelineConfig getPipelineConfig() {
        return pipelineConfig;
    }

    public RnaSeqClinicalPipelineWrapperAnalysisExecutor setPipelineConfig(RnaSeqPipelineConfig pipelineConfig) {
    ...
    public RnaSeqClinicalPipelineWrapperAnalysisExecutor setPipelineSteps(List<String> pipelineSteps) {
