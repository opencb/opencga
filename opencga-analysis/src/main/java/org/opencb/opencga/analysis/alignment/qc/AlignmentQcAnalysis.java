            ...
            try {
                if (runFlagStats) {
                    ...
                    OpenCGAResult<Job> flagStatsJobResult = catalogManager.getJobManager()
                            .submit(study, JobType.NATIVE_TOOL, AlignmentFlagStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
            ...
            try {
                if (runStats) {
                    ...
                    OpenCGAResult<Job> statsJobResult = catalogManager.getJobManager()
                            .submit(study, JobType.NATIVE_TOOL, AlignmentStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
                                    + getId() + " - " + getJobId(), Collections.emptyList(), Collections.emptyList(), getJobId(), null,
                                    false, token);
            ...
            try {
                if (runFastqc) {
                    ...
                    OpenCGAResult<Job> fastQcMetricsJobResult = catalogManager.getJobManager()
                            .submit(study, JobType.NATIVE_TOOL, AlignmentFastQcMetricsAnalysis.ID, Enums.Priority.MEDIUM, params, null,
