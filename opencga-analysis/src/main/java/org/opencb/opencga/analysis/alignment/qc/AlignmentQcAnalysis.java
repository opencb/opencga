    ...
    protected void run() throws ToolException {
        ...
        step(() -> {
            try {
                ...
                OpenCGAResult<Job> statsJobResult;
                OpenCGAResult<Job> flagStatsJobResult;
                ...
                if (runStats) {
                    ...
                    statsJobResult = catalogManager.getJobManager()
                ...
                if (runFlagStats) {
                    ...
                    flagStatsJobResult = catalogManager.getJobManager()
                ...
                if (runFastqc) {
                    ...
                    fastQcMetricsJobResult = catalogManager.getJobManager()
                ...
                if (runHsmetrics) {
                    ...
                    hsMetricsJobResult = catalogManager.getJobManager()
