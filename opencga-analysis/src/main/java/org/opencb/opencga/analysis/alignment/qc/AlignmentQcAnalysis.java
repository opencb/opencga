            ...
            try {
                if (runFlagStats) {
                    ...
                    OpenCGAResult<Job> flagStatsJobResult = catalogManager.getJobManager()
                            .submit(organizationId, study, AlignmentFlagStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
            ...
            try {
                if (runStats) {
                    ...
                    OpenCGAResult<Job> statsJobResult = catalogManager.getJobManager()
                            .submit(organizationId, study, AlignmentStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
                                    + getId() + " - " + getJobId(), Collections.emptyList(), Collections.emptyList(), token);
            ...
            try {
                if (runFastqc) {
                    ...
                    OpenCGAResult<Job> fastQcMetricsJobResult = catalogManager.getJobManager()
                            .submit(organizationId, study, AlignmentFastQcMetricsAnalysis.ID, Enums.Priority.MEDIUM, params, null,
