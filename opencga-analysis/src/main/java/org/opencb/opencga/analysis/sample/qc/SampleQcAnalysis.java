            ...
            try {
                if (runVariantStats) {
                    ...
                    OpenCGAResult<Job> variantStatsJobResult = catalogManager.getJobManager()
                            .submit(study, JobType.NATIVE_TOOL, SampleVariantStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
            ...
            try {
                if (runSignatureCatalogue || runSignatureFitting) {
                    ...
                    OpenCGAResult<Job> signatureJobResult = catalogManager.getJobManager()
                            .submit(getStudy(), JobType.NATIVE_TOOL, MutationalSignatureAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
                                    + getId() + " - " + getJobId(), Collections.emptyList(), Collections.emptyList(), getJobId(), null,
                                    false, token);
            ...
            try {
                if (runGenomePlot) {
                    ...
                    OpenCGAResult<Job> genomePlotJobResult = catalogManager.getJobManager()
                            .submit(getStudy(), JobType.NATIVE_TOOL, GenomePlotAnalysis.ID, Enums.Priority.MEDIUM, params, null,
