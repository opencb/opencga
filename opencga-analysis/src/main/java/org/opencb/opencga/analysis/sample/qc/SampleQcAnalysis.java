        ...
        step(() -> {
            try {
                ...
                if (runSignature) {
                    ...
                    params = new MutationalSignatureAnalysisParams(analysisParams.getMutationalSignatureId(),
                            analysisParams.getMutationalSignatureDescription(), analysisParams.getSample(),
                            analysisParams.getMutationalSignatureQuery(), true, null)
                            .toParams(new ObjectMap(ParamConstants.STUDY_PARAM, getStudy()));
                    // Be sure to update sample quality control
                    params.put(MutationalSignatureAnalysis.QC_UPDATE_KEYNAME, true);
