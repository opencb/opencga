            ...
            try {
                if (runVariantStats) {
                    ...
                    OpenCGAResult<Job> variantStatsJobResult = catalogManager.getJobManager()
                            .submit(organizationId, study, SampleVariantStatsAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
            ...
            try {
                if (runSignatureCatalogue || runSignatureFitting) {
                    ...
                    OpenCGAResult<Job> signatureJobResult = catalogManager.getJobManager()
                            .submit(organizationId, getStudy(), MutationalSignatureAnalysis.ID, Enums.Priority.MEDIUM, params, null, "Job generated by "
                                    + getId() + " - " + getJobId(), Collections.emptyList(), Collections.emptyList(), token);
            ...
            try {
                if (runGenomePlot) {
                    ...
                    OpenCGAResult<Job> genomePlotJobResult = catalogManager.getJobManager()
                            .submit(organizationId, getStudy(), GenomePlotAnalysis.ID, Enums.Priority.MEDIUM, params, null,
