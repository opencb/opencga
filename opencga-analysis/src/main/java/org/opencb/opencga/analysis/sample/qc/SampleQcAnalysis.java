    ...
    protected void run() throws ToolException {
        step(() -> {
            try {
                ...
                OpenCGAResult<Execution> variantStatsJobResult;
                OpenCGAResult<Execution> signatureJobResult;
                OpenCGAResult<Execution> genomePlotJobResult;
                ...
                if (runVariantStats) {
                    ...
                    variantStatsJobResult = catalogManager.getExecutionManager()
                ...
                if (runSignature) {
                    ...
                    signatureJobResult = catalogManager.getExecutionManager()
                ...
                if (runGenomePlot) {
                    ...
                    genomePlotJobResult = catalogManager.getExecutionManager()
