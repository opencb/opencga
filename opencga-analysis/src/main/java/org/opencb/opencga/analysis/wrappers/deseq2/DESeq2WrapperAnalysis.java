...
import static org.opencb.opencga.analysis.wrappers.WrapperUtils.INPUT_FILE_PREFIX;
...
public class DESeq2WrapperAnalysis extends OpenCgaToolScopeStudy {
    ...
    private DESeq2WrapperParams updatedParams;
    ...
    protected void check() throws Exception {
        ...
        updatedParams = new DESeq2WrapperParams();
        ...
        updatedParams.getDESeq2Params2Params().getInput().setCountsFile(path);
        ...
        updatedParams.getDESeq2Params2Params().getInput().setMetadataFile(path);
        ...
        updatedParams.getDESeq2Params2Params().setAnalysis(analysisParams.getDESeq2Params2Params().getAnalysis());
        String testMethod = updatedParams.getDESeq2Params2Params().getAnalysis().getTestMethod();
        if (StringUtils.isEmpty(testMethod)) {
            updatedParams.getDESeq2Params2Params().getAnalysis().setTestMethod(WALD_TEST_METHOD);
        ...
        updatedParams.getDESeq2Params2Params().setOutput(analysisParams.getDESeq2Params2Params().getOutput());
    }
    ...
    protected void runDESeq2() throws ToolException {
        ...
        executor.setStudy(study)
                .setDESeq2WrapperParams(updatedParams)
                .execute();
    }
}
