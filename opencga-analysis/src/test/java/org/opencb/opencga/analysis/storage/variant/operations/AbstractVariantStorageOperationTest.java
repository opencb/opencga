...
public abstract class AbstractVariantStorageOperationTest extends GenericTest {
    ...
    protected org.opencb.opencga.analysis.storage.variant.VariantStorageManager variantManager;
    ...
    public final void setUpAbstract() throws Exception {
        ...
        variantManager = new org.opencb.opencga.analysis.storage.variant.VariantStorageManager(catalogManager, factory);
