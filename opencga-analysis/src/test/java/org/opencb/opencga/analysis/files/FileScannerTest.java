...
public class FileScannerTest extends TestCase {
    ...
    public void testDeleteExisting() throws IOException, CatalogException {
        ...
        assertEquals(File.FileStatus.TRASHED, catalogManager.getFile(file.getId(), sessionIdUser).first().getFileStatus());
    }
    ...
    public void testDeleteTrashed() throws IOException, CatalogException {
        ...
        assertEquals(File.FileStatus.TRASHED, file.getFileStatus());
        ...
        file = catalogManager.getFile(file.getId(), sessionIdUser).first();
        assertEquals(File.FileStatus.DELETED, file.getFileStatus());
    ...
    public void testReplaceExisting() throws IOException, CatalogException {
        ...
        assertEquals(File.FileStatus.READY, replacedFile.getFileStatus());
    ...
    public void testScanStudyURI() throws IOException, CatalogException {
        ...
        files.forEach((f) -> assertEquals(f.getFileStatus(), File.FileStatus.READY));
    ...
    public void testResyncStudy() throws IOException, CatalogException {
        ...
        assertEquals(File.FileStatus.READY, file.getFileStatus());
        ...
        assertEquals(1, files.size());
        assertEquals(File.FileStatus.MISSING, files.get(0).getFileStatus());
        ...
        assertEquals(1, files.size());
        assertEquals(File.FileStatus.READY, files.get(0).getFileStatus());
    ...
    public void testComplexAdd() throws IOException, CatalogException {
        ...
        files.forEach((file) -> assertEquals(File.FileStatus.READY, file.getFileStatus()));
