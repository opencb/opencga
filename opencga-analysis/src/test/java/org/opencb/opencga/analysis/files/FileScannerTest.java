...
public class FileScannerTest extends TestCase {
    ...
    public void testDeleteExisting() throws IOException, CatalogException {
        ...
        assertEquals(File.Status.TRASHED, catalogManager.getFile(file.getId(), sessionIdUser).first().getFileStatus());
    }
    ...
    public void testDeleteTrashed() throws IOException, CatalogException {
        ...
        assertEquals(File.Status.TRASHED, file.getFileStatus());
        ...
        file = catalogManager.getFile(file.getId(), sessionIdUser).first();
        assertEquals(File.Status.DELETED, file.getFileStatus());
    ...
    public void testReplaceExisting() throws IOException, CatalogException {
        ...
        assertEquals(File.Status.READY, replacedFile.getFileStatus());
    ...
    public void testScanStudyURI() throws IOException, CatalogException {
        ...
        files.forEach((f) -> assertEquals(f.getFileStatus(), File.Status.READY));
    ...
    public void testResyncStudy() throws IOException, CatalogException {
        ...
        assertEquals(File.Status.READY, file.getFileStatus());
        ...
        assertEquals(1, files.size());
        assertEquals(File.Status.MISSING, files.get(0).getFileStatus());
        ...
        assertEquals(1, files.size());
        assertEquals(File.Status.READY, files.get(0).getFileStatus());
    ...
    public void testComplexAdd() throws IOException, CatalogException {
        ...
        files.forEach((file) -> assertEquals(File.Status.READY, file.getFileStatus()));
