...
//        checkExecutionResult(er, false);
    ...
    public void testSampleQcVS() throws IOException, ToolException, CatalogException {
        ...
        ExecutionResult result = toolRunner.execute(SampleQcAnalysis.class, STUDY, params, outDir, null, false, token);
        System.out.println("outDir = " + outDir);
    ...
    public void testSampleQcVSError() throws IOException, CatalogException {
        ...
        try {
            result = toolRunner.execute(SampleQcAnalysis.class, CANCER_STUDY, params, outDir, null, false, token);
        } catch (ToolException e) {
    ...
    public void testSampleQcMutationalSignatureCatalogueSNV() throws IOException, ToolException, CatalogException {
        ...
        ExecutionResult result = toolRunner.execute(SampleQcAnalysis.class, CANCER_STUDY, params, outDir, null, false, token);
        System.out.println("outDir = " + outDir);
