...
public class VariantAnalysisTest {
    ...
    private static String family = "NAxxx";
...
//        Configurator.reconfigure();
        if (!indexed) {
            ...
            catalogManager.getFamilyManager().create(
                    STUDY,
                    new Family(family, family, Collections.singletonList(phenotype), disorderList, null, null, 3, null, null),
...
//        checkExecutionResult(er, false);
    ...
    public void testPedigreeGraph() throws CatalogException {
        ...
        OpenCGAResult<Family> results = catalogManager.getFamilyManager().get(STUDY, family, QueryOptions.empty(), token);
