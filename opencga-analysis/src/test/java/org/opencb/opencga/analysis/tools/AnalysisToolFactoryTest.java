...
public class AnalysisToolFactoryTest {
    ...
    public static class MyTest extends OpenCgaAnalysisTool {
        @Override
    ...
    public static class MyTest1 extends OpenCgaAnalysisTool {
        @Override
        protected void run() throws Exception {
        }
    }
    ...
    @Tool(id = ID_DUP, resource = Enums.Resource.FUNCTIONAL)
    public static class MyTest2 extends OpenCgaAnalysisTool {
        @Override
        protected void run() throws Exception {
        }
    }
    ...
    public void testFactoryById() throws ToolException {
        AnalysisToolFactory toolFactory = new AnalysisToolFactory();
