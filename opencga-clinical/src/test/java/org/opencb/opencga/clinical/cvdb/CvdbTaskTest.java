...
public class CvdbTaskTest {
    ...
    public void testFactoryToolCvdbIndexTask() throws ToolException {
        Class<? extends OpenCgaTool> tool = new ToolFactory().getToolClass(CvdbIndexTask.ID, Arrays.asList("org.opencb.opencga"));
    ...
    public void testFactoryToolCvdbUpdateAclTask() throws ToolException {
        Class<? extends OpenCgaTool> tool = new ToolFactory().getToolClass(CvdbUpdateAclTask.ID, Arrays.asList("org.opencb.opencga"));
        System.out.println("tool.getName() = " + tool.getName());
