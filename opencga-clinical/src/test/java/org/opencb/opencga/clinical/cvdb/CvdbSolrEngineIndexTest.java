...
import org.opencb.opencga.clinical.cvdb.iterators.ClinicalSolrIterator;
...
import static org.opencb.opencga.clinical.cvdb.parsers.ClinicalQueryParam.CA_ID_NAME;
import static org.opencb.opencga.clinical.cvdb.parsers.ClinicalQueryParam.CI_ID_NAME;
...
//    public CatalogManagerExternalResource catalogManagerResource = new CatalogManagerExternalResource();
    public OpenCGACatalogManagerExternalResource catalogManagerResource = new OpenCGACatalogManagerExternalResource();
    ...
    public void testIndexProject() throws CatalogException, IOException, CvdbException, SolrServerException {
        ...
        QueryResponse response = cvdbEngine.getSolrClient().query(collectionNameGenerator.getClinicalAnalysisCollectionName(collectionPrefix),
                solrQuery);
    ...
    public void testIndexStudy() throws CatalogException, IOException, CvdbException, SolrServerException {
        ...
        // Execute the Solr query
        QueryResponse response = cvdbEngine.getSolrClient().query(collectionNameGenerator.getClinicalAnalysisCollectionName(collectionPrefix), solrQuery);
