...
public class EnterpriseClientsGenerator {
...
//        classes.add(AdminWSServer.class);
        ...
        for (Class value : EnterpriseResourceConfig.enterpriseClasses.values()) {
            classes.add(value);
        }
    ...
    private static void libraries(RestApi restApi) throws IOException {
        ...
        generateLibrary("java", restApiFilePath, "opencga-enterprise-client/src/main/java/com/zettagenomics/opencga/enterprise/client/rest/clients/");
        generateLibrary("python", restApiFilePath, "opencga-enterprise-client/src/main/python/pyopencga/rest_clients/");
        generateLibrary("javascript", restApiFilePath, "opencga-enterprise-client/src/main/javascript/");
        generateLibrary("r", restApiFilePath, "opencga-enterprise-client/src/main/R/R/");
    ...
    private static void generateLibrary(String language, String restFilePath, String outDir) {
        String binary = "opencga-enterprise-app/app/misc/clients/" + language + "_client_generator.py";
