...
import org.opencb.opencga.storage.core.variant.index.sample.schema.CtBtFtCombinationIndexSchema;
import org.opencb.opencga.storage.core.variant.index.core.IndexField;
import org.opencb.opencga.storage.core.variant.index.core.RangeIndexField;
...
import org.opencb.opencga.storage.core.variant.index.core.filters.NoOpIndexFieldFilter;
...
import static org.opencb.opencga.storage.core.variant.index.sample.annotation.SampleIndexVariantAnnotationConverter.*;
...
public class SampleIndexQueryParser {
    ...
    public SampleIndexQueryParser(VariantStorageMetadataManager metadataManager, SampleIndexSchemaFactory schemaFactory) {
        ...
        this.extendedFilteringRegionDefault = metadataManager.getConfiguration().getInt(
                VariantStorageOptions.SAMPLE_INDEX_QUERY_EXTENDED_REGION_FILTER.key(),
                VariantStorageOptions.SAMPLE_INDEX_QUERY_EXTENDED_REGION_FILTER.defaultValue());
    }
