...
public final class VariantQueryParam implements QueryParam {
    ...
    public static final String ANNOT_POPULATION_ALTERNATE_FREQUENCY_DESCR
            = "Alternate Population Frequency: {study}:{population}[<|>|<=|>=]{number}. e.g. " + ParamConstants.POP_FREQ_1000G + ":ALL<0.01";
    ...
    public static final String ANNOT_POPULATION_REFERENCE_FREQUENCY_DESCR
            = "Reference Population Frequency: {study}:{population}[<|>|<=|>=]{number}. e.g. " + ParamConstants.POP_FREQ_1000G + ":ALL<0.01";
    ...
    public static final String ANNOT_POPULATION_MINOR_ALLELE_FREQUENCY_DESCR
            = "Population minor allele frequency: {study}:{population}[<|>|<=|>=]{number}. e.g. " + ParamConstants.POP_FREQ_1000G + ":ALL<0.01";
