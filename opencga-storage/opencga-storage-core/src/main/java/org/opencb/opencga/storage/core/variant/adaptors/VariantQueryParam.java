...
public final class VariantQueryParam implements QueryParam {
    ...
    public static final VariantQueryParam ID
            = new VariantQueryParam("id", TEXT_ARRAY, ID_DESCR);
    ...
    public static final String STUDY_DESCR
            = "";
    public static final VariantQueryParam STUDY
            = new VariantQueryParam("study", TEXT_ARRAY, STUDY_DESCR);
    ...
    public static final VariantQueryParam INCLUDE_STUDY
            = new VariantQueryParam("includeStudy", TEXT_ARRAY, INCLUDE_STUDY_DESCR);
    ...
    public static final VariantQueryParam SAMPLE
            = new VariantQueryParam("sample", TEXT_ARRAY, SAMPLE_DESCR);
    ...
    public static final VariantQueryParam INCLUDE_SAMPLE
            = new VariantQueryParam("includeSample", TEXT_ARRAY, INCLUDE_SAMPLE_DESCR);
    ...
    public static final VariantQueryParam FILE
            = new VariantQueryParam("file", TEXT_ARRAY, FILE_DESCR);
    ...
    public static final VariantQueryParam INCLUDE_FILE
            = new VariantQueryParam("includeFile", TEXT_ARRAY, INCLUDE_FILE_DESCR);


    public static final String COHORT_DESCR
            = "Select variants with calculated stats for the selected cohorts";
    public static final VariantQueryParam COHORT
            = new VariantQueryParam("cohort", TEXT_ARRAY, COHORT_DESCR);
    ...
    public static final String ANNOT_TRANSCRIPTION_FLAG_DESCR = "List of transcript annotation flags. e.g. CCDS,basic,cds_end_NF,"
    ...
    public static final VariantQueryParam ANNOT_TRAIT
            = new VariantQueryParam("trait", TEXT_ARRAY, ANNOT_TRAIT_DESCR);
    ...
    public static final VariantQueryParam ANNOT_HPO
            = new VariantQueryParam("hpo", TEXT_ARRAY, ANNOT_HPO_DESCR);
    ...
    public static final VariantQueryParam ANNOT_GO
            = new VariantQueryParam("go", TEXT_ARRAY, ANNOT_GO_DESCR);
    ...
    public static final VariantQueryParam ANNOT_EXPRESSION
            = new VariantQueryParam("expression", TEXT_ARRAY, ANNOT_EXPRESSION_DESCR);
    ...
    public static final VariantQueryParam ANNOT_DRUG
            = new VariantQueryParam("drug", TEXT_ARRAY, ANNOT_DRUG_DESCR);
