...
import org.opencb.opencga.storage.core.variant.index.core.*;
import org.opencb.opencga.storage.core.variant.index.sample.codecs.AlleleCodec;
    ...
    protected static class VariantOriginalCallToBytesConverter
        ...
        public Pair<Variant, ByteBuffer> to(Pair<Variant, OriginalCall> pair) {
            if (pair == null) {
                ...
                String alternateAndExtras = VariantKeyFactory
        ...
        public Pair<Variant, OriginalCall> from(Pair<Variant, ByteBuffer> pair) {
            ...
            if (byteBuffer == null || variant == null || byteBuffer.limit() == 0) {
                ...
                String variantId = VariantKeyFactory.buildVariant(variant.getChromosome(), start, reference, alternate, null, null)
                        .toString();
