...
//            System.out.println("[" + i + "] = " + IndexUtils.byteToString(bytes[i]));
            for (int b = 0; b < Byte.SIZE; b++) {
                byte read = inputStream.readByte(1);
