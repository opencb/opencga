...
public class RangeTest {
    ...
    public void buildFromIndex() {
        FieldConfiguration configuration = new FieldConfiguration(FieldConfiguration.Source.FILE, "QUAL", new double[]{20d, 30d, 250d}, FieldConfiguration.Type.RANGE_LT);
        ...
        configuration = new FieldConfiguration(FieldConfiguration.Source.FILE, "QUAL", new double[]{20d, 30d, 250d}, FieldConfiguration.Type.RANGE_GT);
