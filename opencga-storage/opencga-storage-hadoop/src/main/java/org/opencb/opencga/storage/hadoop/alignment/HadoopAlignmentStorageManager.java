...
public class HadoopAlignmentStorageManager extends AlignmentStorageManager {
    ...
    public HadoopAlignmentStorageManager(StorageConfiguration configuration) {
        ...
        try {
            this.storageETL = newStorageETL(true);
...
//
//        return this.storageETL.extract(input, ouput);
//    }
//
//    @Override
...
//        AlignmentUtils.checkBamOrCramFile(fileSystem.open(new Path(inputUri)), inputUri.getPath(), false);
//        return inputUri;
//    }
//
//    @Override
