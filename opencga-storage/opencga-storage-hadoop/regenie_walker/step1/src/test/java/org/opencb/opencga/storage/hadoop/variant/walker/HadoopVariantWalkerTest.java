...
//        variantStorageEngine.walkData(outdir.resolve("variant4.txt.gz"), VariantWriterFactory.VariantOutputFormat.JSON, new Query(), new QueryOptions(), "opencb/opencga-base", cmdPython1);
    ...
    public void tesRegenieWalker() throws Exception {
        ...
        String regenieDockerImage = "regenie-walker:latest";
        ...
        variantStorageEngine.walkData(outdir.resolve("variant4.txt.gz"), VariantWriterFactory.VariantOutputFormat.VCF, variantQuery, new QueryOptions(), regenieDockerImage, cmdPython1);
