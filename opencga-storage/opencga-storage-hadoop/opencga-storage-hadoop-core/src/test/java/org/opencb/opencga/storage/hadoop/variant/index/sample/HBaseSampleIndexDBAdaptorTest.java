...
public class HBaseSampleIndexDBAdaptorTest {
    ...
    public void testSplitRegion() {
        ...
        List<LocusQuery> split = HBaseSampleIndexDBAdaptor.splitLocusQuery(
                new LocusQuery(
        ...
        Assert.assertEquals(Arrays.asList(
                ...
                split);
        Assert.assertFalse(HBaseSampleIndexDBAdaptor.startsAtBatch(split.get(0).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.endsAtBatch(split.get(0).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.startsAtBatch(split.get(1).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.endsAtBatch(split.get(1).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.startsAtBatch(split.get(2).getRegions().get(0)));
        Assert.assertFalse(HBaseSampleIndexDBAdaptor.endsAtBatch(split.get(2).getRegions().get(0)));

        region = new Region("1", 1000000, 16400000);
        split = HBaseSampleIndexDBAdaptor.splitLocusQuery(new LocusQuery(SampleIndexSchema.getChunkRegion(region, 0), Collections.singletonList(region), Collections.emptyList()));
        Assert.assertEquals(Arrays.asList(
                ...
                new LocusQuery(new Region("1", 16000000, 17000000), Collections.singletonList(new Region("1", 16000000, 16400000)), Collections.emptyList())),
                split);
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.startsAtBatch(split.get(0).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.endsAtBatch(split.get(0).getRegions().get(0)));
        Assert.assertTrue(HBaseSampleIndexDBAdaptor.startsAtBatch(split.get(1).getRegions().get(0)));
        Assert.assertFalse(HBaseSampleIndexDBAdaptor.endsAtBatch(split.get(1).getRegions().get(0)));
    }
