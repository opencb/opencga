...
public class HBaseSampleIndexDBAdaptor extends SampleIndexDBAdaptor {
    ...
    public SampleGenotypeIndexer newSampleGenotypeIndexer(VariantStorageEngine engine) throws StorageEngineException {
        return new HBaseSampleGenotypeIndexer(this, ((HadoopVariantStorageEngine) engine).getMRExecutor());
    }
    ...
    public SampleAnnotationIndexer newSampleAnnotationIndexer(VariantStorageEngine engine)
            throws StorageEngineException {
        return new HBaseSampleAnnotationIndexer(this, ((HadoopVariantStorageEngine) engine).getMRExecutor());
    }

    @Override
    public SampleFamilyIndexer newSampleFamilyIndexer(VariantStorageEngine engine) throws StorageEngineException {
        return new HBaseSampleFamilyIndexer(this, tableNameGenerator,
                ((HadoopVariantStorageEngine) engine).getMRExecutor());
    }
