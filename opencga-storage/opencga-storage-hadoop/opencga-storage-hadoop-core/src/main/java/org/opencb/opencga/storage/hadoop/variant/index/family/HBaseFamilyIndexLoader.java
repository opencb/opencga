...
public class HBaseFamilyIndexLoader extends FamilyIndexLoader {

    private final MRExecutor mrExecutor;
    private final Logger logger = LoggerFactory.getLogger(HBaseFamilyIndexLoader.class);
    private final HBaseVariantTableNameGenerator tableNameGenerator;
    private final HBaseSampleIndexDBAdaptor sampleIndexDBAdaptor;

    public HBaseFamilyIndexLoader(HBaseSampleIndexDBAdaptor sampleIndexDBAdaptor, HBaseVariantTableNameGenerator tableNameGenerator,
