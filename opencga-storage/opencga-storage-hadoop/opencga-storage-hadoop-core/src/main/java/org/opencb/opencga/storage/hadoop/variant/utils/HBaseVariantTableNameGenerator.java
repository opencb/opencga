...
public class HBaseVariantTableNameGenerator {
    ...
    public HBaseVariantTableNameGenerator(String dbName, ObjectMap options) {
        this(options.getString(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName);
    }

    public HBaseVariantTableNameGenerator(String dbName, Configuration conf) {
        this(conf.get(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName);
    }
    ...
    public static String getArchiveTableNameFromVariantsTable(String variantsTableName, int studyId, Configuration conf) {
        ...
        return getArchiveTableName(conf.get(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName, studyId);
    }
    ...
    public static String getArchiveTableName(String dbName, int studyId, ObjectMap options) {
        return getArchiveTableName(options.getString(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName, studyId);
    }
    ...
    public static String getVariantTableName(String dbName, ObjectMap options) {
        return getVariantTableName(options.getString(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName);
    }

    public static String getVariantTableName(String dbName, Configuration conf) {
        return getVariantTableName(conf.get(HadoopVariantStorageEngineOptions.HBASE_NAMESPACE.key(), ""), dbName);
    }
