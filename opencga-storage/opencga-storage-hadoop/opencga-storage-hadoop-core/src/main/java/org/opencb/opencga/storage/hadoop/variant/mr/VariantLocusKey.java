...
import org.opencb.opencga.storage.core.variant.walker.ChromosomeUtils;
...
public class VariantLocusKey implements WritableComparable<VariantLocusKey>  {
     ...
     * @see ChromosomeUtils#naturalConsecutiveChromosomes(String, String)
     */
    public static boolean naturalConsecutiveChromosomes(String prevChromosome, String newChromosome) {
        return ChromosomeUtils.naturalConsecutiveChromosomes(prevChromosome, newChromosome);
    }
    ...
    public static boolean isSingleDigitChromosome(String chromosome) {
        return ChromosomeUtils.isSingleDigitChromosome(chromosome);
    }
