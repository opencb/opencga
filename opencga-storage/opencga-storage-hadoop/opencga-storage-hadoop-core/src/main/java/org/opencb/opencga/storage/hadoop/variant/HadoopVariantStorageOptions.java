...
public enum HadoopVariantStorageOptions implements ConfigurationOption {
    ...
    SAMPLE_INDEX_QUERY_SAMPLE_INDEX_ONLY_MOC_BUFFER("storage.hadoop.sampleIndex.query.sampleIndexOnly.missingOriginalCall.buffer", 10000),
    SAMPLE_INDEX_QUERY_SAMPLE_INDEX_ONLY_MOC_BATCH("storage.hadoop.sampleIndex.query.sampleIndexOnly.missingOriginalCall.batch", 250),
