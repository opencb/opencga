...
import org.opencb.opencga.storage.core.variant.index.sample.SampleIndexAnnotationLoader;
 ...
 */
public class HBaseSampleIndexAnnotationLoader extends SampleIndexAnnotationLoader {

    private final HBaseVariantTableNameGenerator tableNameGenerator;
    private final MRExecutor mrExecutor;
    private final HBaseSampleIndexDBAdaptor sampleIndexDBAdaptor;
    private final Logger logger = LoggerFactory.getLogger(HBaseSampleIndexAnnotationLoader.class);

    HBaseSampleIndexAnnotationLoader(HBaseSampleIndexDBAdaptor sampleIndexDBAdaptor, MRExecutor mrExecutor) {
