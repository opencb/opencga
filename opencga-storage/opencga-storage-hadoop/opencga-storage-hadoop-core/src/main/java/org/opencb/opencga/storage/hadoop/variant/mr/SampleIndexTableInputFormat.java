...
public class SampleIndexTableInputFormat extends TableInputFormat {
     ...
     */
    public static class SampleIndexTableRecordReader extends TableRecordReader {
        ...
        public SampleIndexTableRecordReader(Configuration conf) {
            ...
            String variantsTableName = conf.get(INPUT_TABLE);
            ...
            operation = VariantQueryUtils.parseGenotypeFilter(conf.get(VariantQueryParam.GENOTYPE.key()), map);
            samples = map.entrySet()
                    .stream()
