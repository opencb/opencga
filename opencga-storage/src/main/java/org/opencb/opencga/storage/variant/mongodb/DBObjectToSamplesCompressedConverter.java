 ...
 */
public class DBObjectToSamplesCompressedConverter extends DBObjectToSamplesConverter {
     ...
     */
    public DBObjectToSamplesCompressedConverter() {
        this.samples = null;
     ...
     */
    public DBObjectToSamplesCompressedConverter(List<String> samples) {
     ...
     */
    public DBObjectToSamplesCompressedConverter(MongoCredentials credentials) {
        try {
            this.samples = null;
    ...
    public ArchivedVariantFile convertToDataModelType(DBObject object) {
        if (samples == null) { // Not set as constructor argument, need to query
