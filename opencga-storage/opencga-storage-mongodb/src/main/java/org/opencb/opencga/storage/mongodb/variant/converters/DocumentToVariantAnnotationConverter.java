...
public class DocumentToVariantAnnotationConverter
    ...
    public static final String CONSERVED_REGION_PHYLOP_SCORE = ANNOTATION_FIELD + '.' + CONSERVED_REGION_PHYLOP_FIELD
            + '.' + SCORE_SCORE_FIELD;
    public static final String CONSERVED_REGION_PHASTCONS_SCORE = ANNOTATION_FIELD + '.' + CONSERVED_REGION_PHASTCONS_FIELD
            + '.' + SCORE_SCORE_FIELD;
