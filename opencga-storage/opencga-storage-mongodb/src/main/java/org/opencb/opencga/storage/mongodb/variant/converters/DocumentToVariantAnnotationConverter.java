...
public class DocumentToVariantAnnotationConverter
    ...
    public static final String CT_PROTEIN_POLYPHEN_SCORE = CONSEQUENCE_TYPE + '.' + CT_PROTEIN_POLYPHEN_FIELD + '.' + SCORE_SCORE_FIELD;
    public static final String CT_PROTEIN_POLYPHEN_DESCRIPTION = CONSEQUENCE_TYPE + '.' + CT_PROTEIN_POLYPHEN_FIELD
            + '.' + SCORE_DESCRIPTION_FIELD;
    ...
    public static final String CONSERVED_REGION_PHYLOP_SCORE = ANNOTATION_FIELD + '.' + CONSERVED_REGION_PHYLOP_FIELD + '.' + SCORE_SCORE_FIELD;
    public static final String CONSERVED_REGION_PHASTCONS_SCORE = ANNOTATION_FIELD + '.' + CONSERVED_REGION_PHASTCONS_FIELD + '.' + SCORE_SCORE_FIELD;
    public static final String CONSERVED_REGION_GERP_SCORE = ANNOTATION_FIELD + '.' + CONSERVED_REGION_GERP_FIELD + '.' + SCORE_SCORE_FIELD;
