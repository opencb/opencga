...
public class ClinicalAggregationTest {
    ...
    @Before
    public void before() throws IOException, CvaException {
    ...
    public void testAggregationWithFacetPivot() throws IOException, SolrServerException {
        ...
        QueryResponse response = cvaEngine.getSolrClient().query(CLINICAL_VARIANT_EVIDENCES_COLLECTION, solrQuery);
