...
setMethod("metaClient", "OpencgaR", function(OpencgaR, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/meta/about2:
        #' Returns info about current OpenCGA code.

        about2=fetchOpenCGA(object=OpencgaR, category="meta", categoryId=NULL, subcategory=NULL, subcategoryId=NULL,
                action="about2", params=params, httpMethod="GET", as.queryParam=NULL, ...),
        ...
        #' @section Endpoint /{apiVersion}/meta/sso:
        #' Single Sign On.
        #' @param url Callback URL.
        sso=fetchOpenCGA(object=OpencgaR, category="meta", categoryId=NULL, subcategory=NULL, subcategoryId=NULL,
                action="sso", params=params, httpMethod="GET", as.queryParam=NULL, ...),
