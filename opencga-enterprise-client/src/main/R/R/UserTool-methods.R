...
#' | runWalker | /{apiVersion}/tools/walker/{toolId}/run | toolId[*], version, project, study, jobId, jobDescription, jobDependsOn, jobTags, jobScheduledStartTime, jobPriority, jobDryRun, body[*] |
...
setMethod("usertoolClient", "OpencgaR", function(OpencgaR, members, toolId, tools, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/tools/walker/{toolId}/run:
        #' Execute an analysis from a custom binary.
        #' @param toolId Comma separated list of external tool IDs up to a maximum of 100. Also admits basic regular expressions using the operator '~', i.e. '~{perl-regex}' e.g. '~value' for case sensitive, '~/value/i' for case insensitive search.
        #' @param version Tool version. If not provided, the latest version will be used.
