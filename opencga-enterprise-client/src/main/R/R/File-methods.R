...
#    Autogenerated on: 2023-03-13 13:26:12
#    
...
setMethod("fileClient", "OpencgaR", function(OpencgaR, members, file, files, annotationSet, folder, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @param fileFormat File format. Allowed values: ['VCF BCF GVCF TBI BIGWIG SAM BAM BAI CRAM CRAI FASTQ FASTA PED TAB_SEPARATED_VALUES COMMA_SEPARATED_VALUES XML PROTOCOL_BUFFER JSON AVRO PARQUET IMAGE PLAIN BINARY NONE UNKNOWN']
