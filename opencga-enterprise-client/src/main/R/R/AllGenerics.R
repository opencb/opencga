...
# ##############################################################################
## StudyClient
setGeneric("studyClient", function(OpencgaR, studies, templateId, variableSet, study, members, group, endpointName, params=NULL, ...)
...
# ##############################################################################
## ClinicalClient
setGeneric("clinicalClient", function(OpencgaR, interpretation, interpretations, annotationSet, clinicalAnalyses, members, clinicalAnalysis, endpointName, params=NULL, ...)
