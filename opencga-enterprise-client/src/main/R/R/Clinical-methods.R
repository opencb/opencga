...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, clinicalAnalyses, members, annotationSet, interpretations, interpretation, endpointName, params=NULL, ...) {
    switch(endpointName,
