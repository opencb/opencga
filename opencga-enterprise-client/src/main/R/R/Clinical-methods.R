...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretation, clinicalAnalyses, clinicalAnalysis, interpretations, members, annotationSet, endpointName, params=NULL, ...) {
    switch(endpointName,
