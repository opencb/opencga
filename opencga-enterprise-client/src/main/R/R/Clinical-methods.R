...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretation, interpretations, annotationSet, clinicalAnalyses, members, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
