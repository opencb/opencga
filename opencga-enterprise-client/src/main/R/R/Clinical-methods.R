...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, interpretations, clinicalAnalyses, members, clinicalAnalysis, interpretation, annotationSet, endpointName, params=NULL, ...) {
    switch(endpointName,
