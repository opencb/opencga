...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, clinicalAnalysis, interpretations, annotationSet, interpretation, members, clinicalAnalyses, endpointName, params=NULL, ...) {
    switch(endpointName,
