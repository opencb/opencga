...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, annotationSet, interpretations, clinicalAnalyses, members, interpretation, clinicalAnalysis, endpointName, params=NULL, ...) {
    switch(endpointName,
