...
#' | cvdbVariantStats | /{apiVersion}/analysis/clinical/cvdb/variant/{variantIds}/stats | variantIds[*], organizationId, project, ciStatusId |
...
setMethod("clinicalClient", "OpencgaR", function(OpencgaR, annotationSet, clinicalAnalyses, clinicalAnalysis, interpretation, interpretations, members, variantIds, endpointName, params=NULL, ...) {
    switch(endpointName,
        ...
        #' @section Endpoint /{apiVersion}/analysis/clinical/cvdb/variant/{variantIds}/stats:
