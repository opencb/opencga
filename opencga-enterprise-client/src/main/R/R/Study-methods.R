...
<<<<<<< HEAD
setMethod("studyClient", "OpencgaR", function(OpencgaR, members, study, studies, variableSet, templateId, group, endpointName, params=NULL, ...) {
=======
setMethod("studyClient", "OpencgaR", function(OpencgaR, members, templateId, studies, group, study, variableSet, endpointName, params=NULL, ...) {
>>>>>>> develop
    switch(endpointName,
