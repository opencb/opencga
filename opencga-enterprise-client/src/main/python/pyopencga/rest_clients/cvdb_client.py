...
class CVDB(_ParentRestClient):
    ...
    def update_user(self, data=None, **options):
        """
        Index clinical analyses of a OpenCGA project, a study or a list of
            clinical analyses into CVDB.
        PATH: /{apiVersion}/analysis/cvdb/user/update

        :param dict data: Parameters: Update users in CVDB for a list clinical
            analyses, or for all clinical analyses in a study or in a project.
            (REQUIRED)
        :param str study: Study [[organization@]project:]study where study and
            project can be either the ID or UUID.
        :param str job_id: Job ID. It must be a unique string within the
        ...
        return self._post(category='analysis', resource='update', subcategory='cvdb/user', data=data, **options)
