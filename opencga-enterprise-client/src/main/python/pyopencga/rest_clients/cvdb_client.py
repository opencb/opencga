...
class Cvdb(_ParentRestClient):
    ...
    def aggregation_stats_variant(self, **options):
        """
        Calculate and fetch clinical variant aggregation stats.
        PATH: /{apiVersion}/cvdb/variant/aggregationStats
        ...
        return self._get(category='cvdb', resource='aggregationStats', subcategory='variant', **options)

    def query_variant(self, **options):
        """
        Filter and fetch clinical variants from CVDB.
        PATH: /{apiVersion}/cvdb/variant/query
        ...
        return self._get(category='cvdb', resource='query', subcategory='variant', **options)

    def aggregation_stats_variant_evidence(self, **options):
        """
        Calculate and fetch clinical variant evidence aggregation stats.
        PATH: /{apiVersion}/cvdb/variantEvidence/aggregationStats
        ...
        return self._get(category='cvdb', resource='aggregationStats', subcategory='variantEvidence', **options)

    def query_variant_evidence(self, **options):
        """
        Filter and fetch clinical variant evidences from CVDB.
        PATH: /{apiVersion}/cvdb/variantEvidence/query
        ...
        return self._get(category='cvdb', resource='query', subcategory='variantEvidence', **options)
