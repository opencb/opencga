...
export default class CVDB extends OpenCGAParentClass {
    ...
    */
    ...
    /** Index clinical analyses of a OpenCGA project, a study or a list of clinical analyses into CVDB
    * @param {Object} data - Parameters: Update users in CVDB for a list clinical analyses, or for all clinical analyses in a study or in a
    *     project.
    * @param {Object} [params] - The Object containing the following optional parameters:
    * @param {String} [params.study] - Study [[organization@]project:]study where study and project can be either the ID or UUID.
    * @param {String} [params.jobId] - Job ID. It must be a unique string within the study. An ID will be autogenerated automatically if not
    ...
    */
    updateUser(data, params) {
        return this._post("analysis", null, "cvdb/user", null, "update", data, params);
    }
