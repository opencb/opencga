...
export default class Cvdb extends OpenCGAParentClass {
    ...
    * @param {String} [params.clinicalAnalysisId] - Clinical analysis ID (or list of clinical analysis IDs separated by commas).
    ...
    * @param {String} [params.variantId] - Variant ID (or list of variant IDs separated by commas), e.g.: 6:31356248:G:C,X:53196017:G:A.
    * @returns {Promise} Promise object in the form of RestResponse instance.
    */
    queryCase(params) {
    ...
    */
    info(caseId, params) {
        return this._get("cvdb", caseId, null, null, "info", params);
    }
