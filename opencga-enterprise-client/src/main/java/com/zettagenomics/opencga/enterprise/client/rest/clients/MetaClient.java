...
public class MetaClient extends EnterpriseAbstractParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<ObjectMap> about2() throws ClientException {
        ObjectMap params = new ObjectMap();
        return execute("meta", null, null, null, "about2", params, GET, ObjectMap.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<ObjectMap> sso(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("meta", null, null, null, "sso", params, GET, ObjectMap.class);
    }
