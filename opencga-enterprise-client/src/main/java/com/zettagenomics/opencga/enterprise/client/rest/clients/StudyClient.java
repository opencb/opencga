...
public class StudyClient extends AbstractParentClient {
     ...
     */
    public RestResponse<StudyAclEntryList> updateAcl(String members, String action, StudyAclUpdateParams data) throws ClientException {
        ObjectMap params = new ObjectMap();
        params.putIfNotNull("action", action);
        params.put("body", data);
        return execute("studies", null, "acl", members, "update", params, POST, StudyAclEntryList.class);
    }
     ...
     * @param studies Comma separated list of Studies [[organization@]project:]study where study and project can be either the ID or UUID
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Note> createNotes(String study, NoteCreateParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("studies", study, "notes", null, "create", params, POST, Note.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Note> searchNotes(String study, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("studies", study, "notes", null, "search", params, GET, Note.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Note> deleteNotes(String study, String id, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("studies", study, "notes", id, "delete", params, DELETE, Note.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Note> updateNotes(String study, String id, NoteUpdateParams data, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        params.put("body", data);
        return execute("studies", study, "notes", id, "update", params, POST, Note.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<Boolean> deleteTemplates(String study, String templateId) throws ClientException {
        ObjectMap params = new ObjectMap();
