...
public class JobClient extends AbstractParentClient {
     ...
     */
    public RestResponse<JobAclEntryList> updateAcl(String members, String action, JobAclUpdateParams data) throws ClientException {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<JobAclEntryList> acl(String jobs, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("jobs", jobs, null, null, "acl", params, GET, JobAclEntryList.class);
    }
