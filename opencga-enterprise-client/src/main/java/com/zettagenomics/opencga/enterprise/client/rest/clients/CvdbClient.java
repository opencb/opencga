...
public class CvdbClient extends AbstractParentClient {
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<FacetField> aggregationStatsVariant(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cvdb", null, "variant", null, "aggregationStats", params, GET, FacetField.class);
    }
    ...
    public RestResponse<ClinicalVariant> queryVariant(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cvdb", null, "variant", null, "query", params, GET, ClinicalVariant.class);
    }
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<FacetField> aggregationStatsVariantEvidence(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cvdb", null, "variantEvidence", null, "aggregationStats", params, GET, FacetField.class);
    }
    ...
    public RestResponse<ClinicalVariantEvidence> queryVariantEvidence(ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cvdb", null, "variantEvidence", null, "query", params, GET, ClinicalVariantEvidence.class);
    }
}
