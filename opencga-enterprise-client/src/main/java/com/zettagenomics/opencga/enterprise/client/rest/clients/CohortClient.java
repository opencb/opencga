...
import com.zettagenomics.opencga.enterprise.client.rest.EnterpriseAbstractParentClient;
 ...
 *    Client version: 2.8.0-SNAPSHOT [5d8b4db7615ec71b0caea65a445797c0e93f6f88]
 *    PATH: cohorts
 */
public class CohortClient extends EnterpriseAbstractParentClient {
     ...
     */
    public RestResponse<CohortAclEntryList> updateAcl(String members, String action, CohortAclUpdateParams data, ObjectMap params)
     ...
     * @throws ClientException ClientException if there is any server error.
     */
    public RestResponse<CohortAclEntryList> acl(String cohorts, ObjectMap params) throws ClientException {
        params = params != null ? params : new ObjectMap();
        return execute("cohorts", cohorts, null, null, "acl", params, GET, CohortAclEntryList.class);
    }
