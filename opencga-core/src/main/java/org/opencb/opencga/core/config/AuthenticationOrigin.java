...
public class AuthenticationOrigin {
    ...
    public static final String FULLNAME_KEY = "fullNameKey";  // key to get user's full name, e.g. "displayname"
    public static final String DN_KEY = "dnKey";  // key for user's unique ID, e.g. "uid", "gecos"
    public static final String DN_FORMAT = "dnFormat";  // distinguished name format string
