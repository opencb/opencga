...
public class JobCreateParams {
    ...
    public JobCreateParams(String id, String description, JobType type, ToolInfo tool, Enums.Priority priority, String commandLine,
    ...
    public static JobCreateParams of(Job job) {
        return new JobCreateParams(job.getId(), job.getDescription(), job.getType(), job.getTool(), job.getPriority(), job.getCommandLine(),
    ...
    public JobCreateParams setType(JobType type) {
        this.type = type;
        return this;
    }
    ...
    public Job toJob() {
        return new Job(id, null, description, type, tool, null, commandLine, params, creationDate, null,
                priority,
                ...
                Collections.emptyList(), null, null, false, tags, result, false, stdout != null ? stdout.toFile() : null,
