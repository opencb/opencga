...
//            + "contains all the configuration necessary to be able to communicate with the external authentication origins.";
    ...
    // Notification
    public static final String NOTIFICATION_OPERATION_ID_DESCRIPTION = "Autogenerated UUID code containing the operation ID. When the "
    ...
    public static final String NOTIFICATION_CONTENT_DESCRIPTION = "Notification message.";
    public static final String NOTIFICATION_LEVEL_DESCRIPTION = "Notification level: INFO, WARNING or CRITICAL.";
    ...
    public static final String NOTIFICATION_TARGET_DESCRIPTION = "Target of the notification. It may be any of"
            + " (ORGANIZATION_ADMINISTRATORS, PROJECT_ADMINISTRATORS, STUDY_ADMINISTRATORS, STUDY_MEMBERS, ANY_USER) or specific"
            + " groups or users.";
    ...
    public static final String USER_NOTIFICATIONS = "User notifications configuration";
