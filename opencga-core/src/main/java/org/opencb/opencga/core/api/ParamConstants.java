...
public class ParamConstants {
    ...
    public static final String ALIGNMENT_QC_DESCRIPTION = "Compute quality control (QC) metrics for a given alignment file (including stats, flag stats, FastQC and HS metrics)";
