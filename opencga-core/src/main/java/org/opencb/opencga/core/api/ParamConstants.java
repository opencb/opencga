...
public class ParamConstants {
    ...
    public static final String EXECUTION_ID_CREATION_DESCRIPTION = "Execution ID. It must be a unique string within the study. An ID will"
            + " be autogenerated automatically if not provided.";
    public static final String EXECUTION_DESCRIPTION = "executionDescription";
    public static final String EXECUTION_DESCRIPTION_DESCRIPTION = "Execution description";
    public static final String EXECUTION_DEPENDS_ON = "executionDependsOn";
