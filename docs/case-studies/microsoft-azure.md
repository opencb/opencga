...
| --------------------- | ----- | ----------------- | ----- | ----------- | -------------- |
| **Hadoop Master**     | 3     | Standard_D12\_V2  | 4     | 28          | Data Lake Gen2 |
| **Hadoop Worker**     | 10    | Standard_DS13\_V2 | 8     | 56          | Data Lake Gen2 |
...
| filter=PASS,region,ct=(lof,missense_variant),biotype=protein_coding,sample(1, OR) | 3.908                              | 5.060              | 3.284          | 1.795     | 1.804          | 1.588       | 3.619    | 3.758    | 1.714    | 0.802    | 1.549    | 1.443  |
| filter=PASS,region,ct=(lof,missense_variant),sample(1, OR)                        | 5.905                              | 3.856              | 3.394          | 2.304     | 2.737          | 1.422       | 3.283    | 4.136    | 1.913    | 0.85     | 1.78     | 1.461  |
| filter=PASS,region,ct=(lof,missense_variant),sample(2, OR)                        | 7.762                              | 5.686              | 3.996          | 2.561     | 3.348          | 2.017       | 3.912    | 4.209    | 2.375    | 1.765    | 2.533    | 4.981  |
| filter=PASS,region,ct=(lof,missense_variant),sample(3, OR)                        | 7.069                              | 6.668              | 4.145          | 2.121     | 3.588          | 2.173       | 4.568    | 5.724    | 2.539    | 1.147    | 2.019    | 1.959  |
| filter=PASS,region,ct=(lof,missense_variant),sample(4, OR)                        | 6.918                              | 6.488              | 4.908          | 3.000     | 3.867          | 2.622       | 5.013    | 5.987    | 3.065    | 1.229    | 2.01     | 1.754  |
| filter=PASS,region,ct=(lof,missense_variant),sample(5, OR)                        | 8.917                              | 9.043              | 4.799          | 2.202     | 3.251          | 2.569       | 5.996    | 6.64     | 2.981    | 1.653    | 2.732    | 2.115  |
