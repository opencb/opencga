# Individual
## Overview
Data model details for class: org.opencb.opencga.core.models.individual.Individual
### Summary 
...
| **father**<br>*<a href="https://docs.opencga.opencb.org/data-models//individual"><em>Individual</em></a>* <br> | <p>Father of the individual</p> |
| **mother**<br>*<a href="https://docs.opencga.opencb.org/data-models//individual"><em>Individual</em></a>* <br> | <p>Mother of the individual</p> |
| **familyIds**<br>*List* <br> | <p>List of ids of the family members</p> |
| **location**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#location"><em>Location</em></a>* <br> | <p>Location of the individual</p> |
| **qualityControl**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#individualqualitycontrol"><em>IndividualQualityControl</em></a>* <br> | <p>Contains different metrics to evaluate the quality of the individual.</p> |
| **sex**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#sexontologytermannotation"><em>SexOntologyTermAnnotation</em></a>* <br> | <p>Sex of the individual</p> |
| **karyotypicSex**<br>*KaryotypicSex* <br> | <p>Karyotypic sex of the individual</p> |
| **ethnicity**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#ontologytermannotation"><em>OntologyTermAnnotation</em></a>* <br> | <p>Ethnicity of the individual</p> |
| **ethnicity**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#individualpopulation"><em>IndividualPopulation</em></a>* <br> | <p>Ethnicity of the individual</p> |
...
| **phenotypes**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#phenotype"><em>Phenotype</em></a>>* <br> | <p>List of phenotypes </p> |
...
| **status**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#customstatus"><em>CustomStatus</em></a>* <br><br>_since_: 2.0 | <p>Object to set a custom status</p> |
...
| **uuid**<br>*String* <br> | <p>Unique 32-character identifier assigned automatically by OpenCGA.</p> |
| **source**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#externalsource"><em>ExternalSource</em></a>* <br><br>_since_: 2.2 | <p>The external source from where the example was imported</p> |
| **processing**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#sampleprocessing"><em>SampleProcessing</em></a>* <br><br>_since_: 2.0 | <p>Describes how the sample was processed in the lab.</p> |
| **collection**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#samplecollection"><em>SampleCollection</em></a>* <br><br>_since_: 2.0 | <p>Describes how the sample was collected.</p> |
| **qualityControl**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#samplequalitycontrol"><em>SampleQualityControl</em></a>* <br><br>_since_: 2.0 | <p>Contains different metrics to evaluate the quality of the sample.</p> |
| **creationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was first registered.</p> |
| **modificationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was last modified.</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
...
| **status**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#customstatus"><em>CustomStatus</em></a>* <br><br>_since_: 2.0 | <p>Cohort ids of the sample</p> |
| **attributes**<br>*Map* <br><br>_since_: 1.0 | <p>Dictionary that can be customised by users to store any additional information users may require..</p> |
| **release**<br>*int* <br> | <p>An integer describing the current data release.</p> |
| **version**<br>*int* <br> | <p>Autoincremental version assigned to the registered entry. By default, updates does not create new versions. To enable versioning, users must set the `incVersion` flag from the /update web service when updating the document.</p> |
| **internal**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#sampleinternal"><em>SampleInternal</em></a>* <br><br>_since_: 2.0 | <p>Sample internal information</p> |
...
| **comments**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#clinicalcomment"><em>ClinicalComment</em></a>>* <br> | <p>Comments for the quality control of the sample</p> |
| **variant**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#samplevariantqualitycontrolmetrics"><em>SampleVariantQualityControlMetrics</em></a>* <br> | <p>Describes variant quality control</p> |
...
| Field | Description |
| :---  | :--- |
| **product**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#ontologytermannotation"><em>OntologyTermAnnotation</em></a>>* <br> | <p>Describes which product was used to process the sample in the lab.</p> |
...
| Field | Description |
| :---  | :--- |
| **RgaIndex.rga**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#rgaindex"><em>RgaIndex</em></a>* <br> | <p>Rga index for Sample internal</p> |
| **status**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#status"><em>Status</em></a>* <br> | <p>Status of the internal object</p> |
...
| Field | Description |
| :---  | :--- |
| **from**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#ontologytermannotation"><em>OntologyTermAnnotation</em></a>>* <br> | <p>OntologyTermAnnotation list</p> |
...
| Field | Description |
| :---  | :--- |
| **variantStats**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#sampleqcvariantstats"><em>SampleQcVariantStats</em></a>>* <br> | <p>Variant stats for the quality control of the sample</p> |
| **signatures**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#signature"><em>Signature</em></a>>* <br> | <p>Signature for the quality control of the sample</p> |
| **genomePlot**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#genomeplot"><em>GenomePlot</em></a>* <br> | <p>Genome plot for the quality control of the sample</p> |
...
| **counts**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#genomecontextcount"><em>GenomeContextCount</em></a>>* <br> | <p>List of GenomeContextCount</p> |
| **files**<br>*List* <br> | <p>List of files of signature</p> |
| **fitting**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#signaturefitting"><em>SignatureFitting</em></a>* <br> | <p>Signature fitting</p> |
...
| **id**<br>*String* <br> | <p>Id to identify the object</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
| **config**<br>*<a href="https://docs.opencga.opencb.org/data-models/individual#genomeplotconfig"><em>GenomePlotConfig</em></a>* <br> | <p>Config of the genomePlot</p> |
...
| **tracks**<br>*List<<a href="https://docs.opencga.opencb.org/data-models//individual#genomeplottrack"><em>GenomePlotTrack</em></a>>* <br> | <p>List of GenomePlotTrack</p> |
