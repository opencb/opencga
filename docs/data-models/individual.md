...
| **sex**<br>*[SexOntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/individual#sexontologytermannotation)* <br> | <p>Sex of the individual</p> |
| **karyotypicSex**<br>*KaryotypicSex* <br> | <p>Karyotypic sex of the individual</p> |
| **ethnicity**<br>*[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/individual#ontologytermannotation)* <br> | <p>Ethnicity of the individual</p> |
| **ethnicity**<br>*[IndividualPopulation](https://docs.opencga.opencb.org/data-models/individual#individualpopulation)* <br> | <p>Ethnicity of the individual</p> |
...
| **phenotypes**<br>*List<[Phenotype](https://docs.opencga.opencb.org/data-models/individual#phenotype)>* <br> | <p>List of phenotypes </p> |
| **disorders**<br>*List<[Disorder](https://docs.opencga.opencb.org/data-models/individual#disorder)>* <br> | <p>List of the individual disorders</p> |
...
| **uuid**<br>*String* <br> | <p>Unique 32-character identifier assigned automatically by OpenCGA.</p> |
| **source**<br>*[ExternalSource](https://docs.opencga.opencb.org/data-models/individual#externalsource)* <br><br>_since_: 2.2 | <p>The external source from where the example was imported</p> |
| **processing**<br>*[SampleProcessing](https://docs.opencga.opencb.org/data-models/individual#sampleprocessing)* <br><br>_since_: 2.0 | <p>Describes how the sample was processed in the lab.</p> |
| **collection**<br>*[SampleCollection](https://docs.opencga.opencb.org/data-models/individual#samplecollection)* <br><br>_since_: 2.0 | <p>Describes how the sample was collected.</p> |
| **qualityControl**<br>*[SampleQualityControl](https://docs.opencga.opencb.org/data-models/individual#samplequalitycontrol)* <br><br>_since_: 2.0 | <p>Contains different metrics to evaluate the quality of the sample.</p> |
| **creationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was first registered.</p> |
| **modificationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was last modified.</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
...
| **status**<br>*[CustomStatus](https://docs.opencga.opencb.org/data-models/individual#customstatus)* <br><br>_since_: 2.0 | <p>Cohort ids of the sample</p> |
| **attributes**<br>*Map* <br><br>_since_: 1.0 | <p>Dictionary that can be customised by users to store any additional information users may require..</p> |
| **release**<br>*int* <br> | <p>An integer describing the current data release.</p> |
| **version**<br>*int* <br> | <p>Autoincremental version assigned to the registered entry. By default, updates does not create new versions. To enable versioning, users must set the `incVersion` flag from the /update web service when updating the document.</p> |
| **internal**<br>*[SampleInternal](https://docs.opencga.opencb.org/data-models/individual#sampleinternal)* <br><br>_since_: 2.0 | <p>Sample internal information</p> |
...
| Field | Description |
| :---  | :--- |
| **from**<br>*List<[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/individual#ontologytermannotation)>* <br> | <p>OntologyTermAnnotation list</p> |
...
| **comments**<br>*List<[ClinicalComment](https://docs.opencga.opencb.org/data-models/individual#clinicalcomment)>* <br> | <p>Comments for the quality control of the sample</p> |
| **variant**<br>*[SampleVariantQualityControlMetrics](https://docs.opencga.opencb.org/data-models/individual#samplevariantqualitycontrolmetrics)* <br> | <p>Describes variant quality control</p> |
...
| Field | Description |
| :---  | :--- |
| **variantStats**<br>*List<[SampleQcVariantStats](https://docs.opencga.opencb.org/data-models/individual#sampleqcvariantstats)>* <br> | <p>Variant stats for the quality control of the sample</p> |
| **signatures**<br>*List<[Signature](https://docs.opencga.opencb.org/data-models/individual#signature)>* <br> | <p>Signature for the quality control of the sample</p> |
| **genomePlot**<br>*[GenomePlot](https://docs.opencga.opencb.org/data-models/individual#genomeplot)* <br> | <p>Genome plot for the quality control of the sample</p> |
...
| **id**<br>*String* <br> | <p>Id to identify the object</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
| **config**<br>*[GenomePlotConfig](https://docs.opencga.opencb.org/data-models/individual#genomeplotconfig)* <br> | <p>Config of the genomePlot</p> |
...
| Field | Description |
| :---  | :--- |
| **product**<br>*List<[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/individual#ontologytermannotation)>* <br> | <p>Describes which product was used to process the sample in the lab.</p> |
...
| **tracks**<br>*List<[GenomePlotTrack](https://docs.opencga.opencb.org/data-models/individual#genomeplottrack)>* <br> | <p>List of GenomePlotTrack</p> |
...
| **counts**<br>*List<[GenomeContextCount](https://docs.opencga.opencb.org/data-models/individual#genomecontextcount)>* <br> | <p>List of GenomeContextCount</p> |
| **files**<br>*List* <br> | <p>List of files of signature</p> |
| **fitting**<br>*[SignatureFitting](https://docs.opencga.opencb.org/data-models/individual#signaturefitting)* <br> | <p>Signature fitting</p> |
...
| Field | Description |
| :---  | :--- |
| **RgaIndex.rga**<br>*[RgaIndex](https://docs.opencga.opencb.org/data-models/individual#rgaindex)* <br> | <p>Rga index for Sample internal</p> |
