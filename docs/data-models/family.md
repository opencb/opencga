...
| :--- | :---: | :---: |:---: |:---: |
| id | <img src="https://github.com/opencb/opencga/blob/develop/docs/data-models/no.png?raw=true"> | <img src="https://github.com/opencb/opencga/blob/develop/docs/data-models/yes.png?raw=true"> |<img src="https://github.com/opencb/opencga/blob/develop/docs/data-models/yes.png?raw=true"> | <img src="https://github.com/opencb/opencga/blob/develop/docs/data-models/yes.png?raw=true"> |
...
### Individual
You can find the Java code [here](https://github.com/opencb/opencga/tree/issue-1806/opencga-core/src/main/java/org/opencb/opencga/core/models/individual/Individual.java).
...
| **location**<br>*[Location](https://docs.opencga.opencb.org/data-models/family#location)* <br> | <p>Location of the individual</p> |
| **qualityControl**<br>*[IndividualQualityControl](https://docs.opencga.opencb.org/data-models/family#individualqualitycontrol)* <br> | <p>Contains different metrics to evaluate the quality of the individual.</p> |
| **sex**<br>*[SexOntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/family#sexontologytermannotation)* <br> | <p>Sex of the individual</p> |
| **karyotypicSex**<br>*KaryotypicSex* <br> | <p>Karyotypic sex of the individual</p> |
| **ethnicity**<br>*[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/family#ontologytermannotation)* <br> | <p>Ethnicity of the individual</p> |
| **ethnicity**<br>*[IndividualPopulation](https://docs.opencga.opencb.org/data-models/family#individualpopulation)* <br> | <p>Ethnicity of the individual</p> |
| **dateOfBirth**<br>*String* <br> | <p>Date of birth of the individual</p> |
| **creationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was first registered.</p> |
| **modificationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was last modified.</p> |
| **lifeStatus**<br>*LifeStatus* <br> | <p>Life status of the of the individual ALIVE, ABORTED, DECEASED, UNBORN, STILLBORN, MISCARRIAGE, UNKNOWN</p> |
| **phenotypes**<br>*List<[Phenotype](https://docs.opencga.opencb.org/data-models/family#phenotype)>* <br> | <p>List of phenotypes </p> |
| **disorders**<br>*List<[Disorder](https://docs.opencga.opencb.org/data-models/family#disorder)>* <br> | <p>List of the individual disorders</p> |
| **samples**<br>*List<[Sample](https://docs.opencga.opencb.org/data-models/sample)>* <br> | <p>List of the individual samples</p> |
...
| **uuid**<br>*String* <br> | <p>Unique 32-character identifier assigned automatically by OpenCGA.</p> |
| **source**<br>*[ExternalSource](https://docs.opencga.opencb.org/data-models/family#externalsource)* <br><br>_since_: 2.2 | <p>The external source from where the example was imported</p> |
| **processing**<br>*[SampleProcessing](https://docs.opencga.opencb.org/data-models/family#sampleprocessing)* <br><br>_since_: 2.0 | <p>Describes how the sample was processed in the lab.</p> |
| **collection**<br>*[SampleCollection](https://docs.opencga.opencb.org/data-models/family#samplecollection)* <br><br>_since_: 2.0 | <p>Describes how the sample was collected.</p> |
| **qualityControl**<br>*[SampleQualityControl](https://docs.opencga.opencb.org/data-models/family#samplequalitycontrol)* <br><br>_since_: 2.0 | <p>Contains different metrics to evaluate the quality of the sample.</p> |
| **creationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was first registered.</p> |
| **modificationDate**<br>*String* <br><br>_since_: 1.0 | <p>Autogenerated date following the format YYYYMMDDhhmmss containing the date when the entry was last modified.</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
...
| **status**<br>*[CustomStatus](https://docs.opencga.opencb.org/data-models/family#customstatus)* <br><br>_since_: 2.0 | <p>Cohort ids of the sample</p> |
| **attributes**<br>*Map* <br><br>_since_: 1.0 | <p>Dictionary that can be customised by users to store any additional information users may require..</p> |
| **release**<br>*int* <br> | <p>An integer describing the current data release.</p> |
| **version**<br>*int* <br> | <p>Autoincremental version assigned to the registered entry. By default, updates does not create new versions. To enable versioning, users must set the `incVersion` flag from the /update web service when updating the document.</p> |
| **internal**<br>*[SampleInternal](https://docs.opencga.opencb.org/data-models/family#sampleinternal)* <br><br>_since_: 2.0 | <p>Sample internal information</p> |
...
| Field | Description |
| :---  | :--- |
| **RgaIndex.rga**<br>*[RgaIndex](https://docs.opencga.opencb.org/data-models/family#rgaindex)* <br> | <p>Rga index for Sample internal</p> |
...
| Field | Description |
| :---  | :--- |
| **product**<br>*List<[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/family#ontologytermannotation)>* <br> | <p>Describes which product was used to process the sample in the lab.</p> |
...
| Field | Description |
| :---  | :--- |
| **from**<br>*List<[OntologyTermAnnotation](https://docs.opencga.opencb.org/data-models/family#ontologytermannotation)>* <br> | <p>OntologyTermAnnotation list</p> |
...
| **comments**<br>*List<[ClinicalComment](https://docs.opencga.opencb.org/data-models/family#clinicalcomment)>* <br> | <p>Comments for the quality control of the sample</p> |
| **variant**<br>*[SampleVariantQualityControlMetrics](https://docs.opencga.opencb.org/data-models/family#samplevariantqualitycontrolmetrics)* <br> | <p>Describes variant quality control</p> |
...
| Field | Description |
| :---  | :--- |
| **variantStats**<br>*List<[SampleQcVariantStats](https://docs.opencga.opencb.org/data-models/family#sampleqcvariantstats)>* <br> | <p>Variant stats for the quality control of the sample</p> |
| **signatures**<br>*List<[Signature](https://docs.opencga.opencb.org/data-models/family#signature)>* <br> | <p>Signature for the quality control of the sample</p> |
| **genomePlot**<br>*[GenomePlot](https://docs.opencga.opencb.org/data-models/family#genomeplot)* <br> | <p>Genome plot for the quality control of the sample</p> |
...
| **id**<br>*String* <br> | <p>Id to identify the object</p> |
| **description**<br>*String* <br> | <p>Users may provide a description for the entry.</p> |
| **config**<br>*[GenomePlotConfig](https://docs.opencga.opencb.org/data-models/family#genomeplotconfig)* <br> | <p>Config of the genomePlot</p> |
...
| **tracks**<br>*List<[GenomePlotTrack](https://docs.opencga.opencb.org/data-models/family#genomeplottrack)>* <br> | <p>List of GenomePlotTrack</p> |
...
| **counts**<br>*List<[GenomeContextCount](https://docs.opencga.opencb.org/data-models/family#genomecontextcount)>* <br> | <p>List of GenomeContextCount</p> |
| **files**<br>*List* <br> | <p>List of files of signature</p> |
| **fitting**<br>*[SignatureFitting](https://docs.opencga.opencb.org/data-models/family#signaturefitting)* <br> | <p>Signature fitting</p> |
