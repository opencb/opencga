...
| modificationDate | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/check.png" width="16px" heigth="16px"> | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/error.png" width="16px" heigth="16px"> |<img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/error.png" width="16px" heigth="16px"> | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/error.png" width="16px" heigth="16px"> |
| description | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/error.png" width="16px" heigth="16px"> | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/check.png" width="16px" heigth="16px"> |<img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/check.png" width="16px" heigth="16px"> | <img src="http://docs.opencb.org/s/en_GB/7101/4f8ce896bdf903a209ab02696e335acf844f5c2c/_/images/icons/emoticons/check.png" width="16px" heigth="16px"> |
...
| :--- | :--- | :--- |
| **id** <br> *String*  |required<br> create<br> immutable | <p>Unique Sample ID in the study, this can be repeated across different studies. This is a mandatory parameter in the creation and<br> cannot be changed at the moment.</p> |
| **uuid** <br> *String*  |internal<br> unique<br> immutable | <p>Global unique ID in any study of any OpenCGA installation. This is created during the sample creation and cannot be changed.</p> |
| **processing**<br>*<a href="Sample.md#SampleProcessing"><em>SampleProcessing</em></a>* <br> |required | <p>An object describing how to sample was processed.</p> |
| **collection**<br>*<a href="Sample.md#SampleCollection"><em>SampleCollection</em></a>* <br><br>since: 2.1 | | <p>An object describing how the sample was collected.</p>*The sample collection is a list of samples* |
| **qualityControl**<br>*<a href="Sample.md#SampleQualityControl"><em>SampleQualityControl</em></a>* <br><br>since: 2.1 | | <p>An object describing how the sample was collected.</p>*The sample collection is a list of samples*</br><a href="https://www.zettagenomics.com">ZetaGenomics</a> |
| **release** <br> *int*  |internal<br> unique<br> immutable | <p>An integer describing the current release.</p> |
| **version** <br> *int*  |internal<br> unique<br> immutable | <p>An integer describing the current version.</p> |
| **creationDate** <br> *String*  |internal<br> unique<br> immutable | <p>An string describing the creation date.</p> |
| **modificationDate** <br> *String*  |internal<br> unique<br> immutable | <p>An string describing the last modification date.</p> |
| **description** <br> *String*  |required | <p>An string to describe the properties of the sample.</p> |
| **somatic** <br> *boolean*  |required | <p>An string to describe the properties of the sample.</p> |
| **phenotypes**<br> List<*<a href="Sample.md#DaemonService"><em>DaemonService</em></a>*> <br> |required<br> unique<br> immutable | <p>A List with related phenotypes.</p> |
| **individualId** <br> *String*  |required | <p>A reference to the Individual containing this sample. Notice that samples can exist without and Individual ID, this field is not<br> mandatory..</p></br><a href="https://www.zettagenomics.com">ZetaGenomics</a> |
| **fileIds**<br> List<*String*> <br> |unique<br> immutable | <p>List of File ID containing this sample, eg BAM, VCF, QC images, ...</p> |
| **status**<br>*<a href="Sample.md#CustomStatus"><em>CustomStatus</em></a>* <br> |unique<br> immutable | <p>An object describing the status of the Sample.</p> |
| **internal**<br>*<a href="Sample.md#SampleInternal"><em>SampleInternal</em></a>* <br> |unique<br> immutable | <p>An object describing the status of the Sample.</p> |
...
| Field | Tags | Description |
| :--- | :--- | :--- |
| **product** <br> *String*  |required<br> immutable | <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum aliquet lobortis. Pellentesque venenatis lacus quis nibh<br> interdum finibus.</p> |
| **preparationMethod** <br> *String*  |required | <p>Proin aliquam ante in ligula tincidunt, cursus volutpat urna suscipit. Phasellus interdum, libero at posuere blandit, felis dui<br> dignissim leo, quis ullamcorper felis elit a augue.</p> |
| **extractionMethod** <br> *String*  |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
| **~~labSampleId~~** <br> Deprecated<br> *String*  |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
| **quantity** <br> *String*  |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
...
| **attributes**<br> Map<*Object*,*String*> <br> |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
### SampleCollection
...
| Field | Tags | Description |
| :--- | :--- | :--- |
| **status**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br><br>since: 2.1 | | <p>Proin aliquam ante in ligula tincidunt, cursus volutpat urna suscipit. Phasellus interdum, libero at posuere blandit, felis dui<br> dignissim leo, quis ullamcorper felis elit a augue.</p>*The sample collection is a list of samples*</br><a href="https://www.zettagenomics.com">ZetaGenomics</a> |
| **~~rga~~** <br> Deprecated<br>*<a href="Sample.md#RgaIndex"><em>RgaIndex</em></a>* <br> |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
### RgaIndex
...
| Field | Tags | Description |
| :--- | :--- | :--- |
| **status**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
| **date** <br> *String*  |internal<br> unique<br> immutable | <p>Nullam commodo tortor nec lectus cursus finibus. Sed quis orci fringilla, cursus diam quis, vehicula sapien. Etiam bibendum dapibus<br> lectus, ut ultrices nunc vulputate ac.</p> |
### RgaIndex.Status
...
| Field | Tags | Description |
| :--- | :--- | :--- |
| **NOT_INDEXED**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> | | <p></p> |
| **INDEXED**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> | | <p></p> |
| **INVALID_PERMISSIONS**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> | | <p></p> |
| **INVALID_METADATA**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> | | <p></p> |
| **INVALID**<br>*<a href="Sample.md#Status"><em>Status</em></a>* <br> | | <p></p> |
### Status
...
| **name** <br> *String*  | | <p></p> |
| **date** <br> *String*  | | <p></p> |
| **description** <br> *String*  | | <p></p> |
| **message** <br> *String*  | | <p></p> |
| **READY** <br> *String*  | | <p>READY name means that the object is being used.</p> |
| **DELETED** <br> *String*  | | <p>DELETED name means that the object is marked as removed, so it can be completely removed from the database with a clean action.</p> |
