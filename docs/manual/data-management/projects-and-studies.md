...
The first step is [login](../login.md) into OpenCGA with a `FULL` account \(See  [Data Management](../../components-1/catalog/data-management.md#DataManagement-Users)\). Then, a Project can be created using the next command:
