...
//                                authorizationManager.removePermissionRuleAndRestorePermissions(organizationId, study,
//                                permissionRule.getId(), entry);
//                                break;
//                            case REMOVE:
//                            default:
//                                logger.info("Removing permission rule {} and removing applied permissions for {}",
//                                        permissionRule.getId().split(INTERNAL_DELIMITER)[0], entry);
//                                authorizationManager.removePermissionRuleAndRemovePermissions(organizationId, study,
//                                permissionRule.getId(), entry);
//                                break;
//                        }
//                    }
