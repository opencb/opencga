...
public class SampleManager extends AnnotationSetManager<Sample> {
    ...
    SampleManager(AuthorizationManager authorizationManager, EventManager eventManager, AuditManager auditManager,
    ...
    public OpenCGAResult<Sample> create(String studyStr, Sample sample, QueryOptions options, String token) throws CatalogException {
        ...
        try {
            ...
            eventManager.notify("sample.create", new OpencgaEvent(organizationId, "sample.create", auditParams, userId, study.getFqn(),
                    sample.getId(), token, insert));
            return insert;
