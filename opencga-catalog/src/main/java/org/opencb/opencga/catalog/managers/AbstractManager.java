...
public abstract class AbstractManager {
     ...
     */
    public static QueryOptions keepFieldInQueryOptions(QueryOptions options, String field) {
     ...
     * @return a new QueryOptions with the necessary modifications.
     */
    public static QueryOptions keepFieldsInQueryOptions(QueryOptions options, List<String> fields) {
