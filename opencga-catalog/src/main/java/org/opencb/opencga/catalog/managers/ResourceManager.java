 ...
 */
public abstract class ResourceManager<R extends IPrivateStudyUid, S extends Enum<S>> extends AbstractManager<R> {
...
//                            size));
    ...
    protected OpenCGAResult<R> create(Object object, QueryOptions options, String token, ExecuteOperationForSingleEntry<R> execution)
            throws CatalogException {
        return create(new ObjectMap(), null, object, options, token, null, execution);
    }
