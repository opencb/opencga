...
public class AuditManager {
    ...
    public AuditManager(AuthorizationManager authorizationManager, EventManager eventManager, CatalogManager catalogManager,
        ...
        eventManager.subscribe("*.*", new OpenCgaObserver(opencgaEvent -> { },
