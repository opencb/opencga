...
public class ClinicalAnalysisManagerTest extends GenericTest {
    ...
    public void createAndUpdateClinicalAnalysisWithQualityControl() throws CatalogException, InterruptedException {
        ...
        catalogManager.getIndividualManager().create(organizationId, STUDY, individual, null, sessionIdUser);
    ...
    public void automaticallyLockCaseTest() throws CatalogException {
        ...
        catalogManager.getIndividualManager().create(organizationId, STUDY, individual, QueryOptions.empty(), sessionIdUser);

        ClinicalAnalysis clinicalAnalysis = new ClinicalAnalysis()
                .setId("Clinical")
                .setType(ClinicalAnalysis.Type.SINGLE)
                .setProband(individual);
        OpenCGAResult<ClinicalAnalysis> clinical = catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis,
                INCLUDE_RESULT, sessionIdUser);
        assertTrue(StringUtils.isEmpty(clinical.first().getStatus().getId()));
        assertFalse(clinical.first().isLocked());

        clinical = catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, clinicalAnalysis.getId(),
        ...
        clinicalAnalysis = new ClinicalAnalysis()
                ...
                .setProband(individual);
        clinical = catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis, INCLUDE_RESULT, sessionIdUser);
        assertEquals("CLOSED", clinical.first().getStatus().getId());
        assertTrue(clinical.first().isLocked());
    }
    ...
    public void queryClinicalAnalysisByDate() throws CatalogException {
        ...
        OpenCGAResult<ClinicalAnalysis> search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, query, QueryOptions.empty(), sessionIdUser);
        ...
        ClinicalAnalysisUpdateParams updateParams = new ClinicalAnalysisUpdateParams()
                .setDueDate(dueDate);
        catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, result.first().getId(), updateParams, QueryOptions.empty(), sessionIdUser);
        search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, query, QueryOptions.empty(), sessionIdUser);
    ...
    public void createClinicalWithMissingSamplesInFamily() throws CatalogException {
        ...
        DataResult<ClinicalAnalysis> clinicalAnalysisDataResult = catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY,
    ...
    public void updateClinicalAnalysis() throws CatalogException {
        ...
        ClinicalAnalysis clinical = catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis, INCLUDE_RESULT, sessionIdUser).first();
        ...
        clinical = catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, clinicalAnalysis.getId(), updateParams, INCLUDE_RESULT, sessionIdUser).first();
    ...
    public void updatePrimaryFindings() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), clinicalAnalysis.getId() + ".1", updateParams, null, options,
                sessionIdUser);
        interpretation =
        ...
        try {
            catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), clinicalAnalysis.getId() + ".1", updateParams, null,
    ...
    public void updateSecondaryFindings() throws CatalogException {
        ...
        catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, ca, QueryOptions.empty(), sessionIdUser);
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1", updateParams, null, options,
                sessionIdUser);
        interpretation =
        ...
        // Add existing finding
        try {
            catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1", updateParams, null,
                    options, sessionIdUser);
            fail("It should not allow adding an already existing finding");
        } catch (CatalogException e) {
            assertTrue(e.getMessage().contains("repeated"));
    ...
    public void updateInterpretationComments() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), clinicalAnalysis.getId() + ".1", new InterpretationUpdateParams()
        ...
        try {
            catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), clinicalAnalysis.getId() + ".1",
    ...
    public void updateClinicalAnalysisTest() throws CatalogException {
        ...
        OpenCGAResult<ClinicalAnalysis> update = catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, dummyEnvironment.first().getId(),
    ...
    public void updateCustomStatusTest() throws CatalogException {
        Study study = catalogManager.getStudyManager().get(organizationId, STUDY, QueryOptions.empty(), sessionIdUser).first();
    ...
    public void updateCustomFlagTest() throws CatalogException {
        ...
        update = catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, dummyEnvironment.first().getId(), updateParams, options,
                sessionIdUser);
        assertEquals(1, update.getNumUpdated());
    ...
    public void updateInterpretationCustomStatusTest() throws CatalogException {
        ...
        InterpretationUpdateParams updateParams = new InterpretationUpdateParams()
                .setStatus(new StatusParam(status.getId()));
        OpenCGAResult<Interpretation> update = catalogManager.getInterpretationManager().update(organizationId, STUDY, dummyEnvironment.first().getId(),
    ...
    public void createInterpretationTest() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), new Interpretation(), ParamUtils.SaveInterpretationAs.PRIMARY,
                QueryOptions.empty(), sessionIdUser);
        ...
        catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), new Interpretation(),
                ParamUtils.SaveInterpretationAs.PRIMARY, QueryOptions.empty(), sessionIdUser);
        catalogManager.getInterpretationManager().delete(organizationId, STUDY, ca.getId(), Collections.singletonList(ca.getId() + ".1"), sessionIdUser);

        ca = catalogManager.getClinicalAnalysisManager().get(organizationId, STUDY, ca.getId(), QueryOptions.empty(), sessionIdUser).first();
        assertNotNull(ca.getInterpretation());
        assertEquals(ca.getId() + ".2", ca.getInterpretation().getId());
        assertEquals(0, ca.getSecondaryInterpretations().size());
        assertEquals(0, catalogManager.getInterpretationManager().search(organizationId, STUDY,
        ...
        assertEquals(1, catalogManager.getInterpretationManager().search(organizationId, STUDY, new Query()
        ...
        catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), new Interpretation(), null, QueryOptions.empty(), sessionIdUser);
    }
    ...
    public void clearPrimaryInterpretation() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), interpretation, ParamUtils.SaveInterpretationAs.PRIMARY,
                QueryOptions.empty(), sessionIdUser);
        ...
        catalogManager.getInterpretationManager().clear(organizationId, STUDY, ca.getId(), Collections.singletonList(ca.getId() + ".1"), sessionIdUser);
    ...
    public void clearSecondaryInterpretation() throws CatalogException {
        ...
        Interpretation interpretation = new Interpretation()
                ...
                .setSecondaryFindings(Collections.singletonList(new ClinicalVariant(new VariantAvro("id", Collections.emptyList(), "chr1"
                        , 1, 2, "ref", "alt", "+", null, 1, null, null, null))))
                .setComments(Collections.singletonList(new ClinicalComment("me", "message", null, TimeUtils.getTime())));
        catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), interpretation, ParamUtils.SaveInterpretationAs.SECONDARY,
                QueryOptions.empty(), sessionIdUser);
    ...
    public void updateInterpretationFindingsTest() throws CatalogException {
        ...
        OpenCGAResult<Interpretation> result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1",
                params, null, QueryOptions.empty(), sessionIdUser);
        assertEquals(1, result.getNumUpdated());

        thrown.expect(CatalogException.class);
        thrown.expectMessage("repeated");
        catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1", params, null, QueryOptions.empty(),
                sessionIdUser);
    }
...
//    }
    ...
    public void revertInterpretationVersion() throws CatalogException {
        ...
        // TEST REVERT
        try {
            catalogManager.getInterpretationManager().revert(organizationId, STUDY, ca.getId(), ca.getId() + ".1", 0, sessionIdUser);
            fail("A CatalogException should be raised pointing we cannot set to a version equal or inferior to 0");
        } catch (CatalogException e) {
        }

        try {
            catalogManager.getInterpretationManager().revert(organizationId, STUDY, ca.getId(), ca.getId() + ".1", 5, sessionIdUser);
            fail("A CatalogException should be raised pointing we cannot set to a version above the current one");
        } catch (CatalogException e) {
        }

        OpenCGAResult<Interpretation> result = catalogManager.getInterpretationManager().revert(organizationId, STUDY, ca.getId(), ca.getId() + ".1", 2,
                sessionIdUser);
        assertEquals(1, result.getNumUpdated());
        ...
        result = catalogManager.getInterpretationManager().revert(organizationId, STUDY, ca.getId(), ca.getId() + ".1", 3, sessionIdUser);
        assertEquals(1, result.getNumUpdated());
        ...
        result = catalogManager.getInterpretationManager().revert(organizationId, STUDY, ca.getId(), ca.getId() + ".1", 4, sessionIdUser);
        assertEquals(1, result.getNumUpdated());
    ...
    public void updateInterpretationTest() throws CatalogException {
        ...
        params = new InterpretationUpdateParams()
                .setDescription("my description");
        result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".3", params, null, QueryOptions.empty(),
                sessionIdUser);
        assertEquals(1, result.getNumUpdated());
        ...
        params = new InterpretationUpdateParams();
        result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".3", params,
                ParamUtils.SaveInterpretationAs.PRIMARY, QueryOptions.empty(), sessionIdUser);
        assertEquals(1, result.getNumUpdated());
        ...
        params = new InterpretationUpdateParams();
        result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".4", params,
                ParamUtils.SaveInterpretationAs.PRIMARY, QueryOptions.empty(), sessionIdUser);
        assertEquals(1, result.getNumUpdated());
        ...
        // Scalate to primary
        params = new InterpretationUpdateParams();
        result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".2", params,
                ParamUtils.SaveInterpretationAs.PRIMARY, QueryOptions.empty(), sessionIdUser);
        assertEquals(1, result.getNumUpdated());
    ...
    public void updatePrimarySecondaryLockedInterpretationTest() throws CatalogException {
        ...
        // Scalate secondary interpretation to primary and delete
        InterpretationUpdateParams params = new InterpretationUpdateParams();
        OpenCGAResult<Interpretation> result = catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".3",
    ...
    public void deleteInterpretationTest() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1", new InterpretationUpdateParams()
        ...
        OpenCGAResult delete = catalogManager.getInterpretationManager().delete(organizationId, STUDY, ca.getId(),
        ...
        OpenCGAResult<Interpretation> search = catalogManager.getInterpretationManager().search(organizationId, STUDY, query, QueryOptions.empty(),
                sessionIdUser);
        assertEquals(0, search.getNumResults());
        ...
        query = new Query()
                .append(InterpretationDBAdaptor.QueryParams.ID.key(), Arrays.asList(ca.getId() + ".1", ca.getId() + ".3"));
        OpenCGAResult<Interpretation> result = catalogManager.getInterpretationManager().search(organizationId, STUDY, query, QueryOptions.empty(),
                sessionIdUser);
        ...
        result = catalogManager.getInterpretationManager().search(organizationId, STUDY, query, QueryOptions.empty(), sessionIdUser);
    ...
    public void searchClinicalAnalysisByProband() throws CatalogException {
        ...
        OpenCGAResult<ClinicalAnalysis> search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY,
    ...
    public void searchClinicalAnalysisByStatus() throws CatalogException {
        ...
        search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY,
        ...
        catalogManager.getClinicalAnalysisManager().update(organizationId, STUDY, search.first().getId(),
    ...
    public void deleteClinicalAnalysisTest() throws CatalogException {
        DataResult<ClinicalAnalysis> dummyEnvironment = createDummyEnvironment(true, false);
        OpenCGAResult delete = catalogManager.getClinicalAnalysisManager().delete(organizationId, STUDY,
    ...
    public void deleteClinicalAnalysisWithEmptyInterpretations() throws CatalogException {
        ...
        assertEquals(0,
                catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, new Query(ClinicalAnalysisDBAdaptor.QueryParams.ID.key(),
                        ca.getId()), QueryOptions.empty(), sessionIdUser).getNumResults());
        assertEquals(0,
                catalogManager.getInterpretationManager().search(organizationId, STUDY, new Query(InterpretationDBAdaptor.QueryParams.ID.key(),
    ...
    public void deleteClinicalAnalysisWithInterpretations() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, ca.getId(), ca.getId() + ".1",
        ...
        OpenCGAResult delete = catalogManager.getClinicalAnalysisManager().delete(organizationId, STUDY, Collections.singletonList(ca.getId()),
        ...
        assertEquals(5, catalogManager.getInterpretationManager().search(organizationId, STUDY, new Query()
    ...
    public void searchByDisorderTest() throws CatalogException {
        ...
        OpenCGAResult<ClinicalAnalysis> result = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY,
        ...
        result = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, new Query(), QueryOptions.empty(), sessionIdUser);
        assertEquals(2, result.getNumResults());
    }
    ...
    public void createClinicalAnalysisWithPanels() throws CatalogException {
        ...
        ClinicalAnalysis ca = catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis, INCLUDE_RESULT,
                sessionIdUser).first();
    ...
    public void createInterpretationWithPanels() throws CatalogException {
        ...
        interpretation = catalogManager.getInterpretationManager().create(organizationId, STUDY, ca.getId(), interpretation,
    ...
    public void updatePanelsInClinicalAnalysis() throws CatalogException {
        ...
        catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis, QueryOptions.empty(), sessionIdUser).first();
    ...
    public void testQueriesInFamilyCase() throws CatalogException {
        ...
        catalogManager.getFamilyManager().update(organizationId, STUDY, dummyFamily.first().getId(), new FamilyUpdateParams()
        ...
        OpenCGAResult<ClinicalAnalysis> search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, query, includeClinicalIds,
                sessionIdUser);
        assertEquals(1, search.getNumResults());

        query = new Query(ClinicalAnalysisDBAdaptor.QueryParams.INDIVIDUAL.key(), "child1");
        search = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, query, includeClinicalIds, sessionIdUser);
        assertEquals(1, search.getNumResults());
    ...
    private List<Panel> createPanels(int nPanels) throws CatalogException {
        ...
        for (int i = 0; i < nPanels; i++) {
            panelList.add(catalogManager.getPanelManager().create(organizationId, STUDY, new Panel().setId("panel" + i), INCLUDE_RESULT,
                    sessionIdUser).first());
        }
        return panelList;
    }
    ...
    public void createClinicalAnalysisWithPanelsTest() throws CatalogException {
        ...
        Individual proband = catalogManager.getIndividualManager().create(organizationId, STUDY,
                new Individual()
                        .setId("proband")
                        .setSamples(Collections.singletonList(new Sample().setId("sample"))),
        ...
        OpenCGAResult<ClinicalAnalysis> result =
                catalogManager.getClinicalAnalysisManager().create(organizationId, STUDY, clinicalAnalysis, INCLUDE_RESULT, sessionIdUser);
        assertEquals(1, result.getNumResults());
    ...
    public void fetchInterpretationWithFullPanelInformationTest() throws CatalogException {
        ...
        Interpretation interpretation = catalogManager.getInterpretationManager().search(organizationId, STUDY,
...
//                .setPanels(panels.subList(0, 2))
        ...
        OpenCGAResult<Interpretation> interpretation = catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(),
        ...
        options = new QueryOptions()
                .append(Constants.ACTIONS, actionMap)
                .append(ParamConstants.INCLUDE_RESULT_PARAM, true);
        interpretation = catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(),
                intepretationId, new InterpretationUpdateParams()
                        .setPanels(Collections.singletonList(new PanelReferenceParam(panels.get(2).getId()))),
                null, options, sessionIdUser);
        assertEquals(1, interpretation.getNumResults());
    ...
    public void setPanelLockWithInterpretationWithPanelSubsetTest() throws CatalogException {
        ...
        catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), clinicalAnalysis.getInterpretation().getId(),
                new InterpretationUpdateParams()
    ...
    public void updatePanelsFromClinicalAnalysisWithPanelLockTest() throws CatalogException {
        ...
        Interpretation interpretation = catalogManager.getInterpretationManager().create(organizationId, STUDY, clinicalAnalysis.getId(),
    ...
    public void updatePanelLockWithDifferentPanels() throws CatalogException {
        ...
        actionMap.put(ClinicalAnalysisDBAdaptor.QueryParams.PANELS.key(), ParamUtils.BasicUpdateAction.SET);
        QueryOptions options = new QueryOptions(Constants.ACTIONS, actionMap);
        catalogManager.getInterpretationManager().update(organizationId, STUDY, clinicalAnalysis.getId(), interpretation.getId(),
    ...
    public void createClinicalAnalysisWithFiles() throws CatalogException {
        ...
        for (File file : files) {
            catalogManager.getFileManager().update(organizationId, STUDY, file.getPath(),
    ...
    public void fetchCasesWithSameProbandAndDifferentSample() throws CatalogException, IOException {
        ...
        catalogManager.getIndividualManager().create(organizationId, STUDY, proband, QueryOptions.empty(), sessionIdUser);
        ...
        OpenCGAResult<ClinicalAnalysis> result = catalogManager.getClinicalAnalysisManager().search(organizationId, STUDY, new Query(),
                QueryOptions.empty(), sessionIdUser);
        assertEquals(2, result.getNumResults());
