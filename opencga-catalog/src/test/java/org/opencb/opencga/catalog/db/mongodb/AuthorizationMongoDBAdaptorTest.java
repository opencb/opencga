...
public class AuthorizationMongoDBAdaptorTest {
    ...
    public void before() throws IOException, CatalogException {
        ...
        dbAdaptorFactory.getCatalogSampleDBAdaptor().insert(studyId, new Sample("s1", TimeUtils.getTime(), null, null, null, 1, 1, "", false,
...
//        sampleDBAdaptor.setSampleAcl(s1.getId(), newAcl, true);
    ...
    public void testPermissionRulesPlusManualPermissions() throws CatalogException {
        ...
        dbAdaptorFactory.getCatalogSampleDBAdaptor().insert(studyId, new Sample("s2", TimeUtils.getTime(), null, null, null, 1, 1, "",
                false, Collections.emptyList(), new ArrayList<>(), new CustomStatus(), SampleInternal.init(), Collections.emptyMap()),
                Collections.emptyList(), QueryOptions.empty());
