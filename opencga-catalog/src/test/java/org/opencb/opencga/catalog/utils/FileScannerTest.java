...
public class FileScannerTest {
    ...
    public void setUp() throws IOException, CatalogException {
        ...
        study = catalogManager.getStudyManager().create(project.getId(), "phase1", null, "Phase 1", Study.Type.TRIO, null, "Done", null, null, null, null, null, null, null, null, null, sessionIdUser).first();
