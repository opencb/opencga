...
public class FileMongoDBAdaptorTest extends AbstractMongoDBAdaptorTest {

//    @Test
//    public void createFileToStudyTest() throws CatalogException {
//        File file = new File("jobs/", File.Type.DIRECTORY, File.Format.PLAIN, File.Bioformat.NONE, "jobs/", null, "", FileInternal.init(), 1000, 1);
...
//        System.out.println(catalogFileDBAdaptor.insert(studyUid, file, null, null, null, null));
...
////        DataResult<Job> jobInsert = catalogJobDBAdaptor.insert(myJob, studyUid, queryOptions);
////
////        // We create a new file giving that job
////        File file = new File().setName("Filename").setPath("data/Filename").setJob(jobInsert.first());
////        DataResult<File> fileInsert = catalogFileDBAdaptor.insert(file, studyUid, queryOptions);
////
////        // Get the file
...
//        long studyUid = user3.getProjects().get(0).getStudies().get(0).getUid();
//        new InternalStatus();
//        catalogSampleDBAdaptor.insert(studyUid, new Sample().setId("sample1").setInternal(SampleInternal.init()),
//                Collections.emptyList(), QueryOptions.empty());
//        Sample sample1 = getSample(studyUid, "sample1");
//        new InternalStatus();
//        catalogSampleDBAdaptor.insert(studyUid, new Sample().setId("sample2").setInternal(SampleInternal.init()),
//                Collections.emptyList(), QueryOptions.empty());
...
//
//        catalogSampleDBAdaptor.insert(studyUid, new Sample().setId("sample3").setInternal(SampleInternal.init()),
//                Collections.emptyList(), QueryOptions.empty());
