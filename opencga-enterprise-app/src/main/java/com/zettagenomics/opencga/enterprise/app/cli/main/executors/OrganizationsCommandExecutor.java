...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.OrganizationsCommandOptions;
 ...
 */
public class OrganizationsCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Organization> create() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().create(organizationCreateParams, queryParams);
    }
    ...
    private RestResponse<Note> createNotes() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().createNotes(noteCreateParams, queryParams);
    }
    ...
    private RestResponse<Note> searchNotes() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().searchNotes(queryParams);
    }
    ...
    private RestResponse<User> userUpdateStatus() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().userUpdateStatus(commandOptions.user, userStatusUpdateParams, queryParams);
    }
    ...
    private RestResponse<User> updateUser() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().updateUser(commandOptions.user, organizationUserUpdateParams, queryParams);
    }
    ...
    private RestResponse<OrganizationConfiguration> updateConfiguration() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().updateConfiguration(commandOptions.organization, organizationConfiguration, queryParams);
    }
    ...
    private RestResponse<CatalogEvent> queryEvents() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().queryEvents(commandOptions.organization, queryParams);
    }
    ...
    private RestResponse<CatalogEvent> archiveEvents() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().archiveEvents(commandOptions.organization, commandOptions.eventId);
    }
    ...
    private RestResponse<CatalogEvent> retryEvents() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().retryEvents(commandOptions.organization, commandOptions.eventId);
    }
    ...
    private RestResponse<Organization> info() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().info(commandOptions.organization, queryParams);
    }
    ...
    private RestResponse<Organization> update() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseOrganizationClient().update(commandOptions.organization, organizationUpdateParams, queryParams);
    }
}