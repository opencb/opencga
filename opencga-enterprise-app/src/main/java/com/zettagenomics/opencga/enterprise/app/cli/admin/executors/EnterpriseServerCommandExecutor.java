...
public class EnterpriseServerCommandExecutor extends CommandExecutor {

    private final AdminCliOptionsParser.ServerCommandOptions serverCommandOptions;

    public EnterpriseServerCommandExecutor(AdminCliOptionsParser.ServerCommandOptions serverCommandOptions) {
    ...
    private void rest() throws Exception {
        ...
        if (serverCommandOptions.restServerCommandOptions.start) {
            logger.info("Starting down OpenCGA Enterprise REST server ...");
