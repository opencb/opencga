...
public class AnalysisVariantCommandOptions {
        ...
        public RunLiftoverCommandOptions runLiftoverCommandOptions;
        ...
        public RunVariantCallerPipelineCommandOptions runVariantCallerPipelineCommandOptions;
    ...
    public AnalysisVariantCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.runLiftoverCommandOptions = new RunLiftoverCommandOptions();
        ...
        this.runVariantCallerPipelineCommandOptions = new RunVariantCallerPipelineCommandOptions();
    ...
    @Parameters(commandNames = {"liftover-run"}, commandDescription ="BCFtools liftover plugin maps coordinates from assembly 37 to 38.")
    public class RunLiftoverCommandOptions {
    ...
    @Parameters(commandNames = {"variant-caller-pipeline-run"}, commandDescription ="Variant caller pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant indexing in OpenCGA storage.")
    public class RunVariantCallerPipelineCommandOptions {
