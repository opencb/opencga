...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.JobsCommandOptions;
 ...
 */
public class JobsCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Job> buildTool() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseJobClient().buildTool(jobToolBuildParams, queryParams);
    }
    ...
    private RestResponse<Job> runTool() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseJobClient().runTool(customToolInlineParams, queryParams);
    }
    ...
    private RestResponse<Job> kill() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseJobClient().kill(commandOptions.job, queryParams);
    }
