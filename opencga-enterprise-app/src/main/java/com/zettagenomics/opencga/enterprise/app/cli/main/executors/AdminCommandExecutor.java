...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.AdminCommandOptions;
...
public class AdminCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<String> listOrganizations() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseAdminClient().listOrganizations();
    }
    ...
    private RestResponse<Job> fetchResource() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseAdminClient().fetchResource(resourceFetcherToolParams, queryParams);
    }
    ...
    private RestResponse<Acl> permissionsUsers() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseAdminClient().permissionsUsers(queryParams);
    }
    ...
    private RestResponse<Group> syncUsers() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseAdminClient().syncUsers(deprecatedGroupSyncParams, queryParams);
    }
    ...
    private RestResponse<Group> usersUpdateGroups() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseAdminClient().usersUpdateGroups(commandOptions.user, userUpdateGroup, queryParams);
    }
}