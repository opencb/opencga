...
public class UserToolsCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Job> runCustomDocker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runCustomDocker(customToolInlineParams, queryParams);
    }
    ...
    private RestResponse<Job> runWalker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runWalker(commandOptions.toolId, variantWalkerToolParams, queryParams);
    }
    ...
    private RestResponse<Job> runWorkflow() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseUserToolClient().runWorkflow(commandOptions.toolId, workflowToolParams, queryParams);
    }
