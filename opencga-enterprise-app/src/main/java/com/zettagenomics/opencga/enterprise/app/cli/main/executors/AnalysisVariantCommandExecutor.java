...
public class AnalysisVariantCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Job> runVariantCallerPipeline() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseVariantClient().runVariantCallerPipeline(variantCallerPipelineWrapperParams, queryParams);
    }
    ...
    private RestResponse<Job> runWalker() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseVariantClient().runWalker(variantWalkerParams, queryParams);
    }
}