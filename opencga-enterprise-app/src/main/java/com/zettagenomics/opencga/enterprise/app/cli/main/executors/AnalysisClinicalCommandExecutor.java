...
public class AnalysisClinicalCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Interpretation> queryInterpreterRd() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().queryInterpreterRd(queryParams);
    }
    ...
    private RestResponse<Job> runInterpreterRd() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().runInterpreterRd(rdInterpretationAnalysisToolParams, queryParams);
    }
