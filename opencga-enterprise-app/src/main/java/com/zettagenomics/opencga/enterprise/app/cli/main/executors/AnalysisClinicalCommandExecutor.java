...
import com.zettagenomics.opencga.enterprise.app.cli.main.options.AnalysisClinicalCommandOptions;
...
public class AnalysisClinicalCommandExecutor extends com.zettagenomics.opencga.enterprise.app.cli.main.executors.EnterpriseOpencgaCommandExecutor {
    ...
    private RestResponse<Job> loadAnnotationSets() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().loadAnnotationSets(commandOptions.variableSetId, commandOptions.path, tsvAnnotationParams, queryParams);
    }
    ...
    private RestResponse<Job> load() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().load(clinicalAnalysisLoadParams, queryParams);
    }
    ...
    private RestResponse<Job> runNgsPipeline() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().runNgsPipeline(ngsPipelineWrapperParams, queryParams);
    }
    ...
    private RestResponse<Job> runPipelineAffy() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().runPipelineAffy(affyClinicalPipelineWrapperParams, queryParams);
    }
    ...
    private RestResponse<Job> runPipelineGenomics() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().runPipelineGenomics(genomicsClinicalPipelineWrapperParams, queryParams);
    }
    ...
    private RestResponse<Job> runPipelinePrepare() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().runPipelinePrepare(clinicalPipelinePrepareWrapperParams, queryParams);
    }
    ...
    private RestResponse<Sample> updateAnnotationSetsAnnotations() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().updateAnnotationSetsAnnotations(commandOptions.clinicalAnalysis, commandOptions.annotationSet, objectMap, queryParams);
    }
    ...
    private RestResponse<ClinicalReport> updateReport() throws Exception {
        ...
        return enterpriseOpenCGAClient.getEnterpriseClinicalAnalysisClient().updateReport(commandOptions.clinicalAnalysis, clinicalReport, queryParams);
    }
}