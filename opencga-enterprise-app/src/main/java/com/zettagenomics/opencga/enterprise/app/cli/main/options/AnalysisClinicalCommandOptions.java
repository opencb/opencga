...
public class AnalysisClinicalCommandOptions {
    ...
    public class RunInterpreterRdCommandOptions {
        ...
        @Parameter(names = {"--name", "-n"}, description = "RD interpretation name", required = false, arity = 1)
        public String name;
    
        @Parameter(names = {"--description"}, description = "RD interpretation description", required = false, arity = 1)
        public String description;
