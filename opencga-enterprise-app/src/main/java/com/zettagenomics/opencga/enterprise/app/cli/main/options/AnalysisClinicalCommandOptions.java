...
public class AnalysisClinicalCommandOptions {
        ...
        public RunInterpreterCustomTieringCommandOptions runInterpreterCustomTieringCommandOptions;
    ...
    public AnalysisClinicalCommandOptions(CommonCommandOptions commonCommandOptions, JCommander jCommander) {
        ...
        this.runInterpreterCustomTieringCommandOptions = new RunInterpreterCustomTieringCommandOptions();
    ...
    public class RunInterpreterCustomTieringCommandOptions {
        ...
        @Parameter(names = {"--primary"}, description = "Set the clinical interpretation computed as primary (true) or secondary (false).", required = false, help = true, arity = 0)
        public boolean primary = false;
    
        @Parameter(names = {"--clinical-interpretation-params-penetrance"}, description = "Penetrance of the clinical analysis: COMPLETE, INCOMPLETE or UNKNOWN.", required = false, arity = 1)
        public String clinicalInterpretationParamsPenetrance;
    
        @Parameter(names = {"--clinical-interpretation-params-discard-untiered-evidences"}, description = "Do not report untiered evidences (and variants) in the clinical interpretation.", required = false, arity = 1)
        public Boolean clinicalInterpretationParamsDiscardUntieredEvidences = true;
    
        @Parameter(names = {"--clinical-interpretation-params-one-consequence-per-evidence"}, description = "Report only one variant consequence per evidence in the clinical interpretation.", required = false, arity = 1)
        public Boolean clinicalInterpretationParamsOneConsequencePerEvidence = false;
    
        @Parameter(names = {"--config-file"}, description = "Clinical interpretation configuration file, if not provided default configuration will be used.", required = false, arity = 1)
