...
public class AnalysisClinicalCommandOptions {
    ...
    @Parameters(commandNames = {"ngs-pipeline-run"}, commandDescription ="NGS pipeline that performs QC (e.g.: FastQC), mapping (e.g.: BWA), variant calling (e.g., GATK) and variant indexing in OpenCGA storage.")
    public class RunNgsPipelineCommandOptions {
