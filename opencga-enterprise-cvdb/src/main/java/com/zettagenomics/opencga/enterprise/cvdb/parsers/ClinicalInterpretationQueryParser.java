...
public class ClinicalInterpretationQueryParser extends ClinicalQueryParser {
    ...
    public ClinicalInterpretationQueryParser(String opencgaDbPrefix, String cvdbPrefix,
    ...
    public SolrQuery parse(Query query, QueryOptions queryOptions) throws CvdbException {
        ...
        join = "{!join from=ciId to=id fromIndex=" + CvdbUtils.getCollectionName(opencgaDbPrefix, cvdbPrefix, projectId,
