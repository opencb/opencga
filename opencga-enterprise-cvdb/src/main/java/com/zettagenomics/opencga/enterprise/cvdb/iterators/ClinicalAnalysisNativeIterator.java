...
public class ClinicalAnalysisNativeIterator implements Iterator<ClinicalAnalysisSearch>, AutoCloseable {
    ...
    private Iterator<ClinicalAnalysisSearch> solrIterator;
    ...
    @Deprecated
    public ClinicalAnalysisNativeIterator(Iterator<ClinicalAnalysisSearch> solrIterator) {
        this.solrIterator = solrIterator;
    }

    public ClinicalAnalysisNativeIterator(SolrClient solrClient, String collection, SolrQuery solrQuery)
    ...
    public boolean hasNext() {
        ...
        if (solrIterator.hasNext()) {
            ...
            try {
                ...
                solrIterator = solrResponse.getBeans(ClinicalAnalysisSearch.class).iterator();
    ...
    @Override
    public ClinicalAnalysisSearch next() {
        // Sanity check
        if (hasNext()) {
