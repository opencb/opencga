 ...
 */
public class OpenCGAEnterpriseCatalogManagerExternalResource extends CatalogManagerExternalResource {

    public static final String ADMIN_PASSWORD = "4dMiNiStR4t0R.";
    public static final String PASSWORD = "p4sSw0rD.";

    public OpenCGAEnterpriseCatalogManagerExternalResource() {
    ...
    public void loadClinicalAnalsysesInCatalog(List<String> caFilenames, String studyId, String sessionIdUser)
        ...
        for (String caFilename : caFilenames) {
            InputStream is = OpenCGAEnterpriseCatalogManagerExternalResource.class.getClassLoader().getResourceAsStream(caFilename);
